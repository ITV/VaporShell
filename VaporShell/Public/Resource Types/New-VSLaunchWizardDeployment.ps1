function New-VSLaunchWizardDeployment {
    <#
    .SYNOPSIS
        Adds an AWS::LaunchWizard::Deployment resource to the template.
    ...
    [OutputType('Vaporshell.Resource.LaunchWizard.Deployment')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.LaunchWizard.Deployment.Tags"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LaunchWizard.Deployment'
