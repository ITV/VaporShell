function New-VSCustomerProfilesDomain {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::Domain resource to the template. The AWS::CustomerProfiles::Domain resource specifies an Amazon Connect Customer Profiles Domain.
