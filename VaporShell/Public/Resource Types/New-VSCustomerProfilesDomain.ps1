function New-VSCustomerProfilesDomain {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::Domain resource to the template.
    ...
    .PARAMETER DataStore
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-customerprofiles-domain.html#cfn-customerprofiles-domain-datastore
        UpdateType: Mutable
        Type: DataStore
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.Domain')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.Domain'
