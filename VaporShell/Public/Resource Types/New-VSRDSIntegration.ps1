function New-VSRDSIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::Integration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RDS.Integration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.Integration'
