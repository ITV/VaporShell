function New-VSLookoutEquipmentInferenceScheduler {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutEquipment::InferenceScheduler resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LookoutEquipment.InferenceScheduler')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutEquipment.InferenceScheduler'
