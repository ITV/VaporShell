function New-VSSecurityHubAutomationRuleV2 {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2 resource to the template.
    ...
    .PARAMETER Actions
        ...
        UpdateType: Mutable
        Type: List
        ItemType: AutomationRulesActionV2
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SecurityHub.AutomationRuleV2.AutomationRulesActionV2"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2'
