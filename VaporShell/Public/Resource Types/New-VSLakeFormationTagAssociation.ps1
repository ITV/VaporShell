function New-VSLakeFormationTagAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::LakeFormation::TagAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LakeFormation.TagAssociation')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LFTags {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LFTags -Value @($LFTags)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.TagAssociation'
