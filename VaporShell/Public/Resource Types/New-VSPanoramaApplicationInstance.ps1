function New-VSPanoramaApplicationInstance {
    <#
    .SYNOPSIS
        Adds an AWS::Panorama::ApplicationInstance resource to the template. Creates an application instance and deploys it to a device.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Panorama.ApplicationInstance')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Panorama.ApplicationInstance'
