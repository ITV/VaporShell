function New-VSLogsTransformer {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Transformer resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Logs.Transformer')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Logs.Transformer.Processor"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TransformerConfig {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TransformerConfig -Value @($TransformerConfig)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Transformer'
