function New-VSWorkSpacesWebNetworkSettings {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::NetworkSettings resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.NetworkSettings')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.NetworkSettings'
