function New-VSLightsailInstanceSnapshot {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::InstanceSnapshot resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Lightsail.InstanceSnapshot')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.InstanceSnapshot'
