function New-VSOSISPipeline {
    <#
    .SYNOPSIS
        Adds an AWS::OSIS::Pipeline resource to the template.
    ...
    .PARAMETER PipelineRoleArn
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-osis-pipeline.html#cfn-osis-pipeline-pipelinerolearn
        UpdateType: Mutable
        PrimitiveType: String
    ...
    .PARAMETER ResourcePolicy
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-osis-pipeline.html#cfn-osis-pipeline-resourcepolicy
        UpdateType: Mutable
        Type: ResourcePolicy
    ...
    [OutputType('Vaporshell.Resource.OSIS.Pipeline')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OSIS.Pipeline'
