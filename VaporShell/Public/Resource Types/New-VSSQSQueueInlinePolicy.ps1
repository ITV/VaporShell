function New-VSSQSQueueInlinePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::SQS::QueueInlinePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SQS.QueueInlinePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SQS.QueueInlinePolicy'
