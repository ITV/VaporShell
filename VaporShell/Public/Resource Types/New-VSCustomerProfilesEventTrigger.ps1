function New-VSCustomerProfilesEventTrigger {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::EventTrigger resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.EventTrigger')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CustomerProfiles.EventTrigger.EventTriggerCondition"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                EventTriggerConditions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EventTriggerConditions -Value @($EventTriggerConditions)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.EventTrigger'
