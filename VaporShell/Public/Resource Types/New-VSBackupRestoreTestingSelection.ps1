function New-VSBackupRestoreTestingSelection {
    <#
    .SYNOPSIS
        Adds an AWS::Backup::RestoreTestingSelection resource to the template. 
    ...
    .PARAMETER ProtectedResourceType
    ...
    .PARAMETER ProtectedResourceArns
    ...
    .PARAMETER ValidationWindowHours
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Backup.RestoreTestingSelection')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ProtectedResourceArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ProtectedResourceArns -Value @($ProtectedResourceArns)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Backup.RestoreTestingSelection'
