function New-VSRedshiftEndpointAuthorization {
    <#
    .SYNOPSIS
        Adds an AWS::Redshift::EndpointAuthorization resource to the template. Describes an endpoint authorization for authorizing Redshift-managed VPC endpoint access to a cluster across AWS accounts.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Redshift.EndpointAuthorization')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                VpcIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name VpcIds -Value @($VpcIds)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Redshift.EndpointAuthorization'
