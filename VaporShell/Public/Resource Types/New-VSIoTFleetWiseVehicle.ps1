function New-VSIoTFleetWiseVehicle {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Vehicle resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.Vehicle')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTFleetWise.Vehicle.StateTemplateAssociation"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'StateTemplates' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name StateTemplates -Value @($StateTemplates)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Vehicle'
