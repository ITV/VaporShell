function New-VSVpcLatticeResourceGateway {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::ResourceGateway resource to the template.
    ...
    .PARAMETER Ipv4AddressesPerEni
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-vpclattice-resourcegateway.html#cfn-vpclattice-resourcegateway-ipv4addressespereni
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.VpcLattice.ResourceGateway')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.ResourceGateway'
