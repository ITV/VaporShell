function New-VSDocDBEventSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::DocDB::EventSubscription resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DocDB.EventSubscription')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DocDB.EventSubscription'
