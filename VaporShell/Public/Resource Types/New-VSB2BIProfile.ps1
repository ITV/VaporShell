function New-VSB2BIProfile {
    <#
    .SYNOPSIS
        Adds an AWS::B2BI::Profile resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.B2BI.Profile')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.B2BI.Profile'
