function New-VSMediaLiveCloudWatchAlarmTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::CloudWatchAlarmTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.CloudWatchAlarmTemplate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.CloudWatchAlarmTemplate'
