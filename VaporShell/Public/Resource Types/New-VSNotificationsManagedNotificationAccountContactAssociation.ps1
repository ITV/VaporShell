function New-VSNotificationsManagedNotificationAccountContactAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::ManagedNotificationAccountContactAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.ManagedNotificationAccountContactAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.ManagedNotificationAccountContactAssociation'
