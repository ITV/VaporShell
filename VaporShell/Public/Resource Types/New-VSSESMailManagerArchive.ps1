function New-VSSESMailManagerArchive {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerArchive resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerArchive')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerArchive'
