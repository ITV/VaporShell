function New-VSSESEmailIdentity {
    <#
    .SYNOPSIS
        Adds an AWS::SES::EmailIdentity resource to the template.
    ...
    .PARAMETER Tags
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-emailidentity.html#cfn-ses-emailidentity-tags
        UpdateType: Mutable
        Type: List
        ItemType: Tag
    ...
    [OutputType('Vaporshell.Resource.SES.EmailIdentity')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.EmailIdentity'
