function New-VSEC2NetworkPerformanceMetricSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::NetworkPerformanceMetricSubscription resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.NetworkPerformanceMetricSubscription')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.NetworkPerformanceMetricSubscription'
