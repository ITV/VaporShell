function New-VSIoTWirelessServiceProfile {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::ServiceProfile resource to the template. Creates a new service profile.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.ServiceProfile')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.ServiceProfile'
