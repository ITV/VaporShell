function New-VSWisdomAIPromptVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIPromptVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIPromptVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIPromptVersion'
