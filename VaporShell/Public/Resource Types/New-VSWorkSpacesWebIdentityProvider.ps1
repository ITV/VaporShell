function New-VSWorkSpacesWebIdentityProvider {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::IdentityProvider resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.IdentityProvider')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.IdentityProvider'
