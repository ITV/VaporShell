function New-VSQBusinessDataSource {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::DataSource resource to the template.
    ...
    .PARAMETER DocumentEnrichmentConfiguration
    ...
    [OutputType('Vaporshell.Resource.QBusiness.DataSource')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.DataSource'
