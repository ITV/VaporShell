function New-VSConnectHoursOfOperation {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::HoursOfOperation resource to the template.
    ...
    .PARAMETER ChildHoursOfOperations
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-hoursofoperation.html#cfn-connect-hoursofoperation-childhoursofoperations
        UpdateType: Mutable
        Type: List
        ItemType: HoursOfOperationsIdentifier
        DuplicatesAllowed: True

    .PARAMETER ParentHoursOfOperations
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-hoursofoperation.html#cfn-connect-hoursofoperation-parenthoursofoperations
        UpdateType: Mutable
        Type: List
        ItemType: HoursOfOperationsIdentifier
        DuplicatesAllowed: True
    ...
    [OutputType('Vaporshell.Resource.Connect.HoursOfOperation')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Connect.HoursOfOperation.HoursOfOperationConfig"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Connect.HoursOfOperation.HoursOfOperationsIdentifier"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Config' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Config -Value @($Config)
                }
                'ChildHoursOfOperations' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ChildHoursOfOperations -Value @($ChildHoursOfOperations)
                }
                'ParentHoursOfOperations' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ParentHoursOfOperations -Value @($ParentHoursOfOperations)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.HoursOfOperation'
