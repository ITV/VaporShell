function New-VSLakeFormationPrincipalPermissions {
    <#
    .SYNOPSIS
        Adds an AWS::LakeFormation::PrincipalPermissions resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LakeFormation.PrincipalPermissions')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                PermissionsWithGrantOption {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PermissionsWithGrantOption -Value @($PermissionsWithGrantOption)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.PrincipalPermissions'
