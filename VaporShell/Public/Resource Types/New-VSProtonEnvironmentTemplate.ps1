function New-VSProtonEnvironmentTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::Proton::EnvironmentTemplate resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Proton.EnvironmentTemplate')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Proton.EnvironmentTemplate'
