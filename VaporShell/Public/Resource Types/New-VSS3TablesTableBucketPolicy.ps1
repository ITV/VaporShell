function New-VSS3TablesTableBucketPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::S3Tables::TableBucketPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Tables.TableBucketPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Tables.TableBucketPolicy'
