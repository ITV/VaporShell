function New-VSMSKClusterPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::MSK::ClusterPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MSK.ClusterPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.ClusterPolicy'
