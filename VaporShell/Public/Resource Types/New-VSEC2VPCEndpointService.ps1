function New-VSEC2VPCEndpointService {
    ...
    [OutputType('Vaporshell.Resource.EC2.VPCEndpointService')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'SupportedIpAddressTypes' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SupportedIpAddressTypes -Value @($SupportedIpAddressTypes)
                }
                'GatewayLoadBalancerArns' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'SupportedRegions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SupportedRegions -Value @($SupportedRegions)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPCEndpointService'
