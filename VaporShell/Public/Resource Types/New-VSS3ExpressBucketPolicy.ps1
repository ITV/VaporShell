function New-VSS3ExpressBucketPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::S3Express::BucketPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.S3Express.BucketPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Express.BucketPolicy'
