function New-VSFraudDetectorOutcome {
    <#
    .SYNOPSIS
        Adds an AWS::FraudDetector::Outcome resource to the template. Creates or updates an outcome.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.FraudDetector.Outcome')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FraudDetector.Outcome'
