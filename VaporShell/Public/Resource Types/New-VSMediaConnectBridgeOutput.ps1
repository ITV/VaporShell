function New-VSMediaConnectBridgeOutput {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::BridgeOutput resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.BridgeOutput')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.BridgeOutput'
