function New-VSEntityResolutionPolicyStatement {
    <#
    .SYNOPSIS
        Adds an AWS::EntityResolution::PolicyStatement resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EntityResolution.PolicyStatement')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Action {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Action -Value @($Action)
                }
                Principal {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Principal -Value @($Principal)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EntityResolution.PolicyStatement'
