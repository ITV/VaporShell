function New-VSKinesisVideoSignalingChannel {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisVideo::SignalingChannel resource to the template. Specifies a signaling channel.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.KinesisVideo.SignalingChannel')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisVideo.SignalingChannel'
