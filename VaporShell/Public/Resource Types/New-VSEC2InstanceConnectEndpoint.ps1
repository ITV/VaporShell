function New-VSEC2InstanceConnectEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::InstanceConnectEndpoint resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.InstanceConnectEndpoint')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.InstanceConnectEndpoint'
