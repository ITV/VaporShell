function New-VSQBusinessPlugin {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Plugin resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QBusiness.Plugin')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Plugin'
