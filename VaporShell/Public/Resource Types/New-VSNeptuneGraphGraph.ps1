function New-VSNeptuneGraphGraph {
    <#
    .SYNOPSIS
        Adds an AWS::NeptuneGraph::Graph resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.NeptuneGraph.Graph')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NeptuneGraph.Graph'
