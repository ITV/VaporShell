function New-VSS3ExpressDirectoryBucket {
    <#
    .SYNOPSIS
        Adds an AWS::S3Express::DirectoryBucket resource to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Express.DirectoryBucket')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Express.DirectoryBucket'
