function New-VSWorkspacesInstancesVolume {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::Volume resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.Volume')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.WorkspacesInstances.Volume.TagSpecification"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.Volume'
