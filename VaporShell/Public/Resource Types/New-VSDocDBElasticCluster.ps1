function New-VSDocDBElasticCluster {
    <#
    .SYNOPSIS
        Adds an AWS::DocDBElastic::Cluster resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DocDBElastic.Cluster')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DocDBElastic.Cluster'
