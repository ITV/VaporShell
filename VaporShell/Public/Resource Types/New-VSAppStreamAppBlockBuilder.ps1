function New-VSAppStreamAppBlockBuilder {
    <#
    .SYNOPSIS
        Adds an AWS::AppStream::AppBlockBuilder resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppStream.AppBlockBuilder')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AppStream.AppBlockBuilder.AccessEndpoint"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                AppBlockArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AppBlockArns -Value @($AppBlockArns)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppStream.AppBlockBuilder'
