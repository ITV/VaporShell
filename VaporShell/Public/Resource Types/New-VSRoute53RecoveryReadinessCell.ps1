function New-VSRoute53RecoveryReadinessCell {
    <#
    .SYNOPSIS
        Adds an AWS::Route53RecoveryReadiness::Cell resource to the template. Creates a cell in an account.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53RecoveryReadiness.Cell')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53RecoveryReadiness.Cell'
