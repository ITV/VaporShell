function New-VSIoTBillingGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::BillingGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.BillingGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.BillingGroup'
