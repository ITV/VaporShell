function New-VSSyntheticsGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Synthetics::Group resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Synthetics.Group')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Synthetics.Group'
