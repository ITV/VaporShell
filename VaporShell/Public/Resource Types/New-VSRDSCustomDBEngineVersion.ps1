function New-VSRDSCustomDBEngineVersion {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::CustomDBEngineVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RDS.CustomDBEngineVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.CustomDBEngineVersion'
