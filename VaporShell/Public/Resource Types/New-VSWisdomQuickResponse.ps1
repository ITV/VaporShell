function New-VSWisdomQuickResponse {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::QuickResponse resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.QuickResponse')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Channels' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Channels -Value @($Channels)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.QuickResponse'
