function New-VSKinesisResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::Kinesis::ResourcePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Kinesis.ResourcePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kinesis.ResourcePolicy'
