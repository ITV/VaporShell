function New-VSCassandraKeyspace {
    <#
    .SYNOPSIS
        Adds an AWS::Cassandra::Keyspace resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Cassandra.Keyspace')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cassandra.Keyspace'
