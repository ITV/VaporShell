function New-VSHealthImagingDatastore {
    <#
    .SYNOPSIS
        Adds an AWS::HealthImaging::Datastore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.HealthImaging.Datastore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.HealthImaging.Datastore'
