function New-VSXRayResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::XRay::ResourcePolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.XRay.ResourcePolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.XRay.ResourcePolicy'
