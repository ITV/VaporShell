function New-VSQBusinessApplication {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Application resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QBusiness.Application')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ClientIdsForOIDC {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ClientIdsForOIDC -Value @($ClientIdsForOIDC)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Application'
