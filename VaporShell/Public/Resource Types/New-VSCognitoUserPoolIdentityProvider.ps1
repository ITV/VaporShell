...
+ IDPSignout optional
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Cognito.UserPoolIdentityProvider')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                IdpIdentifiers {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name IdpIdentifiers -Value @($IdpIdentifiers)
                }
                AttributeMapping {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.UserPoolIdentityProvider'
