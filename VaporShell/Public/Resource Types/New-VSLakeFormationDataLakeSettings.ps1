function New-VSLakeFormationDataLakeSettings {
    ...
    .PARAMETER ReadOnlyAdmins
        Type: ReadOnlyAdmins
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-lakeformation-datalakesettings.html#cfn-lakeformation-datalakesettings-readonlyadmins
        UpdateType: Mutable

    .PARAMETER AllowFullTableExternalDataAccess
    ...
    [OutputType('Vaporshell.Resource.LakeFormation.DataLakeSettings')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.DataLakeSettings'
