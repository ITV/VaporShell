function New-VSBedrockGuardrailVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::GuardrailVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.GuardrailVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.GuardrailVersion'
