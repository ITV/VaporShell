function New-VSPipesPipe {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Pipes.Pipe')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe'
