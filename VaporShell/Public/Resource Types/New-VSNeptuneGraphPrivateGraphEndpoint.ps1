function New-VSNeptuneGraphPrivateGraphEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::NeptuneGraph::PrivateGraphEndpoint resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.NeptuneGraph.PrivateGraphEndpoint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NeptuneGraph.PrivateGraphEndpoint'
