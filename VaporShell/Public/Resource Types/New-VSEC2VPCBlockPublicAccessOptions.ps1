function New-VSEC2VPCBlockPublicAccessOptions {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VPCBlockPublicAccessOptions resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.VPCBlockPublicAccessOptions')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPCBlockPublicAccessOptions'
