function New-VSComprehendFlywheel {
    <#
    .SYNOPSIS
        Adds an AWS::Comprehend::Flywheel resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Comprehend.Flywheel')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Comprehend.Flywheel'
