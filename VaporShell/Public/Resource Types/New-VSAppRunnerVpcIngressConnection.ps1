function New-VSAppRunnerVpcIngressConnection {
    <#
    .SYNOPSIS
        Adds an AWS::AppRunner::VpcIngressConnection resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppRunner.VpcIngressConnection')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppRunner.VpcIngressConnection'
