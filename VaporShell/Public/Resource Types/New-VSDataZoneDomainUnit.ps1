function New-VSDataZoneDomainUnit {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DomainUnit resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.DomainUnit')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DomainUnit'
