function New-VSOamSink {
    <#
    .SYNOPSIS
        Adds an AWS::Oam::Sink resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Oam.Sink')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Oam.Sink'
