function New-VSPCAConnectorADTemplateGroupAccessControlEntry {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::TemplateGroupAccessControlEntry resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.PCAConnectorAD.TemplateGroupAccessControlEntry')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.TemplateGroupAccessControlEntry'
