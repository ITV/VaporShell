function New-VSRAMPermission {
    <#
    .SYNOPSIS
        Adds an AWS::RAM::Permission resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RAM.Permission')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RAM.Permission'
