function New-VSWorkSpacesWebUserSettings {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::UserSettings resource to the template.
    ...
    .PARAMETER WebAuthnAllowed
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-usersettings.html#cfn-workspacesweb-usersettings-webauthnallowed
        UpdateType: Mutable
        PrimitiveType: String
    ...
    .PARAMETER BrandingConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-usersettings.html#cfn-workspacesweb-usersettings-brandingconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.UserSettings')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.UserSettings'
