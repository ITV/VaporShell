function New-VSSupportAppSlackChannelConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::SupportApp::SlackChannelConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SupportApp.SlackChannelConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SupportApp.SlackChannelConfiguration'
