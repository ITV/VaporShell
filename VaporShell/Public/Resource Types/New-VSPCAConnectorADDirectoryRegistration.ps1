function New-VSPCAConnectorADDirectoryRegistration {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::DirectoryRegistration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.PCAConnectorAD.DirectoryRegistration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.DirectoryRegistration'
