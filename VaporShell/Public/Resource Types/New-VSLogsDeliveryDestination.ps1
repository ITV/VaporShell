function New-VSLogsDeliveryDestination {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::DeliveryDestination resource to the template.
    ...
    .PARAMETER DestinationResourceArn
    ...
    .PARAMETER DeliveryDestinationType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-deliverydestination.html#cfn-logs-deliverydestination-deliverydestinationtype
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.Logs.DeliveryDestination')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.DeliveryDestination'
