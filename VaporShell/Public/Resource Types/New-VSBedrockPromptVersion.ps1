function New-VSBedrockPromptVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion'
