function New-VSDMSReplicationConfig {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::ReplicationConfig resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DMS.ReplicationConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.ReplicationConfig'
