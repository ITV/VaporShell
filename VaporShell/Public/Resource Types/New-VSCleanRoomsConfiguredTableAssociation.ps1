function New-VSCleanRoomsConfiguredTableAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::ConfiguredTableAssociation resource to the template.
    ...
    .PARAMETER ConfiguredTableAssociationAnalysisRules
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.ConfiguredTableAssociation')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CleanRooms.ConfiguredTableAssociation.ConfiguredTableAssociationAnalysisRule"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ConfiguredTableAssociationAnalysisRules {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ConfiguredTableAssociationAnalysisRules -Value @($ConfiguredTableAssociationAnalysisRules)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.ConfiguredTableAssociation'
