function New-VSOpenSearchServiceDomain {
    ...
    .PARAMETER SkipShardMigrationWait
    ...
    .PARAMETER AIMLOptions
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-opensearchservice-domain.html#cfn-opensearchservice-domain-aimloptions
        UpdateType: Mutable
        Type: AIMLOptions
    ...
    [OutputType('Vaporshell.Resource.OpenSearchService.Domain')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain'
