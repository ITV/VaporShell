function New-VSIoTFleetWiseSignalCatalog {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::SignalCatalog resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.SignalCatalog')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTFleetWise.SignalCatalog.Node"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.SignalCatalog'
