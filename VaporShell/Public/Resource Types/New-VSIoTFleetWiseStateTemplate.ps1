function New-VSIoTFleetWiseStateTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::StateTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.StateTemplate')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                StateTemplateProperties {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name StateTemplateProperties -Value @($StateTemplateProperties)
                }
                DataExtraDimensions {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                MetadataExtraDimensions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name MetadataExtraDimensions -Value @($MetadataExtraDimensions)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.StateTemplate'
