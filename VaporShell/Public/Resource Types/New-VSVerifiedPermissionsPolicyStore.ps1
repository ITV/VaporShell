function New-VSVerifiedPermissionsPolicyStore {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::PolicyStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VerifiedPermissions.PolicyStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.PolicyStore'
