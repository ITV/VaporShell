function New-VSResourceExplorer2Index {
    <#
    .SYNOPSIS
        Adds an AWS::ResourceExplorer2::Index resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ResourceExplorer2.Index')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ResourceExplorer2.Index'
