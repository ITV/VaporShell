function New-VSSchedulerSchedule {
    <#
    .SYNOPSIS
        Adds an AWS::Scheduler::Schedule resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Scheduler.Schedule')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Scheduler.Schedule'
