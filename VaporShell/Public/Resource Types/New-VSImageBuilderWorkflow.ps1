function New-VSImageBuilderWorkflow {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::Workflow resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.Workflow')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.Workflow'
