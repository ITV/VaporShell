function New-VSLightsailAlarm {
    ...
    [OutputType('Vaporshell.Resource.Lightsail.Alarm')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ContactProtocols {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ContactProtocols -Value @($ContactProtocols)
                }
                NotificationTriggers {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name NotificationTriggers -Value @($NotificationTriggers)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.Alarm'
