function New-VSResilienceHubResiliencyPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::ResilienceHub::ResiliencyPolicy resource to the template. Defines a resiliency policy.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ResilienceHub.ResiliencyPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ResilienceHub.ResiliencyPolicy'
