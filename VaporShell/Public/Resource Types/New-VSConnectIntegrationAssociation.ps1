function New-VSConnectIntegrationAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::IntegrationAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Connect.IntegrationAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.IntegrationAssociation'
