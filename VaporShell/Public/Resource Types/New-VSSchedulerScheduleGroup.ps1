function New-VSSchedulerScheduleGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Scheduler::ScheduleGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Scheduler.ScheduleGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Scheduler.ScheduleGroup'
