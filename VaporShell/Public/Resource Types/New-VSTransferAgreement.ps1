function New-VSTransferAgreement {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::Agreement resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Transfer.Agreement')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.Agreement'
