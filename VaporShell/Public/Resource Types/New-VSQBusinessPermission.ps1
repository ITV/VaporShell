function New-VSQBusinessPermission {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Permission resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QBusiness.Permission')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QBusiness.Permission.Condition"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Permission'
