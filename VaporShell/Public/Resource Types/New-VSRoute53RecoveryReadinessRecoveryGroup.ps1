function New-VSRoute53RecoveryReadinessRecoveryGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Route53RecoveryReadiness::RecoveryGroup resource to the template. Creates a recovery group in an account. A recovery group corresponds to an application and includes a list of the cells that make up the application.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53RecoveryReadiness.RecoveryGroup')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Cells {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Cells -Value @($Cells)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53RecoveryReadiness.RecoveryGroup'
