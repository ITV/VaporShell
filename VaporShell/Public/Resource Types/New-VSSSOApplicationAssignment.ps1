function New-VSSSOApplicationAssignment {
    <#
    .SYNOPSIS
        Adds an AWS::SSO::ApplicationAssignment resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSO.ApplicationAssignment')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSO.ApplicationAssignment'
