function New-VSCloudFormationLambdaHook {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFormation::LambdaHook resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFormation.LambdaHook')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFormation.LambdaHook'
