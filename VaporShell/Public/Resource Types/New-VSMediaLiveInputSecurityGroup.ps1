function New-VSMediaLiveInputSecurityGroup {
    ...
    [OutputType('Vaporshell.Resource.MediaLive.InputSecurityGroup')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.InputSecurityGroup.InputWhitelistRuleCidr"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                WhitelistRules {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name WhitelistRules -Value @($WhitelistRules)
                }
                Tags {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.InputSecurityGroup'
