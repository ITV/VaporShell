function New-VSShieldProtection {
    <#
    .SYNOPSIS
        Adds an AWS::Shield::Protection resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Shield.Protection')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                HealthCheckArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name HealthCheckArns -Value @($HealthCheckArns)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Shield.Protection'
