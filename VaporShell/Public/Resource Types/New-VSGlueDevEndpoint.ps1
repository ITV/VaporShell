function New-VSGlueDevEndpoint {
    ...
    [OutputType('Vaporshell.Resource.Glue.DevEndpoint')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                PublicKeys {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PublicKeys -Value @($PublicKeys)
                }
                SecurityGroupIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.DevEndpoint'
