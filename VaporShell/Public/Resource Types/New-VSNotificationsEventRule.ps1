function New-VSNotificationsEventRule {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::EventRule resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.EventRule')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.EventRule'
