function New-VSQuickSightRefreshSchedule {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::RefreshSchedule resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.RefreshSchedule')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.RefreshSchedule'
