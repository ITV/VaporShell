function New-VSLogsDeliverySource {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::DeliverySource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Logs.DeliverySource')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.DeliverySource'
