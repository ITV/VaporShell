function New-VSStepFunctionsStateMachineAlias {
    <#
    .SYNOPSIS
        Adds an AWS::StepFunctions::StateMachineAlias resource to the template. 
    ...
    .PARAMETER DeploymentPreference
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.StepFunctions.StateMachineAlias')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.StepFunctions.StateMachineAlias.RoutingConfigurationVersion"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RoutingConfiguration {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RoutingConfiguration -Value @($RoutingConfiguration)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.StepFunctions.StateMachineAlias'
