function New-VSConnectPrompt {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Prompt resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.Prompt')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Prompt'
