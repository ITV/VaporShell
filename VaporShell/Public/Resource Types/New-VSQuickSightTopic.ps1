function New-VSQuickSightTopic {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Topic resource to the template.
    ...
    .PARAMETER CustomInstructions
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-quicksight-topic.html#cfn-quicksight-topic-custominstructions
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Topic')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Topic.DatasetMetadata"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Topic'
