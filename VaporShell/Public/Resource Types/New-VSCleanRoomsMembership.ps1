function New-VSCleanRoomsMembership {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Membership resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.Membership')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Membership'
