function New-VSEKSAddon {
    ...
    .PARAMETER NamespaceConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-eks-addon.html#cfn-eks-addon-namespaceconfig
        UpdateType: Immutable
        Type: NamespaceConfig

    .PARAMETER PreserveOnDelete
    ...
    [OutputType('Vaporshell.Resource.EKS.Addon')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Addon'
