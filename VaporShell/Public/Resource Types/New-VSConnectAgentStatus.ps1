function New-VSConnectAgentStatus {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::AgentStatus resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.AgentStatus')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.AgentStatus'
