function New-VSTransferCertificate {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::Certificate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Transfer.Certificate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.Certificate'
