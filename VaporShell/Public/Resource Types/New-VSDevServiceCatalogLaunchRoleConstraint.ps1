function New-VSDevServiceCatalogLaunchRoleConstraint {
    <#
    .SYNOPSIS
        Adds an Dev::ServiceCatalog::LaunchRoleConstraint resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Dev.ServiceCatalog.LaunchRoleConstraint')]
    [CmdletBinding()]
    ...
    Begin {
        $ResourceParams = @{
            LogicalId = $LogicalId
            Type = "Dev::ServiceCatalog::LaunchRoleConstraint"
        }
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Dev.ServiceCatalog.LaunchRoleConstraint'
