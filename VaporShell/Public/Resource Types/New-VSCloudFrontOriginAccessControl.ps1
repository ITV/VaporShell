function New-VSCloudFrontOriginAccessControl {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::OriginAccessControl resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudFront.OriginAccessControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.OriginAccessControl'
