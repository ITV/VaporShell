function New-VSCloudTrailResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::ResourcePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudTrail.ResourcePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.ResourcePolicy'
