function New-VSGrafanaWorkspace {
    <#
    .SYNOPSIS
        Adds an AWS::Grafana::Workspace resource to the template. 
    ...
    .PARAMETER NotificationDestinations
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Grafana.Workspace')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                NotificationDestinations {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name NotificationDestinations -Value @($NotificationDestinations)
                }
                OrganizationalUnits {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name OrganizationalUnits -Value @($OrganizationalUnits)
                }
                DataSources {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                AuthenticationProviders {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AuthenticationProviders -Value @($AuthenticationProviders)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Grafana.Workspace'
