function New-VSOmicsAnnotationStore {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::AnnotationStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Omics.AnnotationStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.AnnotationStore'
