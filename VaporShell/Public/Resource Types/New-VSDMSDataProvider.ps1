function New-VSDMSDataProvider {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::DataProvider resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DMS.DataProvider')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.DataProvider'
