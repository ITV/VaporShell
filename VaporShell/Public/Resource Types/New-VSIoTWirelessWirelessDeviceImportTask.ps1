function New-VSIoTWirelessWirelessDeviceImportTask {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::WirelessDeviceImportTask resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTWireless.WirelessDeviceImportTask')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.WirelessDeviceImportTask'
