function New-VSCognitoManagedLoginBranding {
    <#
    .SYNOPSIS
        Adds an AWS::Cognito::ManagedLoginBranding resource to the template.
    ...
    .PARAMETER UseCognitoProvidedValues
    ...
    .PARAMETER ReturnMergedResources
    ...
    [OutputType('Vaporshell.Resource.Cognito.ManagedLoginBranding')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Cognito.ManagedLoginBranding.AssetType"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Assets {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Assets -Value @($Assets)
                }
                Settings {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.ManagedLoginBranding'
