function New-VSOrganizationsAccount {
    <#
    .SYNOPSIS
        Adds an AWS::Organizations::Account resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Organizations.Account')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ParentIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ParentIds -Value @($ParentIds)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Organizations.Account'
