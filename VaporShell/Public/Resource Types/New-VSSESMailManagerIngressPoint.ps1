function New-VSSESMailManagerIngressPoint {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerIngressPoint resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerIngressPoint')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerIngressPoint'
