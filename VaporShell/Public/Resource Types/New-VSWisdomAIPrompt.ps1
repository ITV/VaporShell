function New-VSWisdomAIPrompt {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIPrompt resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIPrompt')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIPrompt'
