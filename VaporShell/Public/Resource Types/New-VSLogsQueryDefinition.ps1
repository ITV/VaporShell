function New-VSLogsQueryDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::QueryDefinition resource to the template. Creates a query definition for CloudWatch Logs Insights. For more information, see  Analyzing Log Data with CloudWatch Logs Insights: https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AnalyzingLogData.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Logs.QueryDefinition')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LogGroupNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LogGroupNames -Value @($LogGroupNames)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.QueryDefinition'
