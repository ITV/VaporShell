function New-VSIoTWirelessMulticastGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::MulticastGroup resource to the template. A multicast group.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.MulticastGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.MulticastGroup'
