function New-VSServiceCatalogServiceAction {
    <#
    .SYNOPSIS
        Adds an AWS::ServiceCatalog::ServiceAction resource to the template. Creates a self-service action.
...
+ zh - Chinese
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ServiceCatalog.ServiceAction')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ServiceCatalog.ServiceAction.DefinitionParameter"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Definition {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Definition -Value @($Definition)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalog.ServiceAction'
