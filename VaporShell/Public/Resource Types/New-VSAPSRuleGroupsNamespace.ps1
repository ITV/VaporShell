function New-VSAPSRuleGroupsNamespace {
    <#
    .SYNOPSIS
        Adds an AWS::APS::RuleGroupsNamespace resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.APS.RuleGroupsNamespace')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.RuleGroupsNamespace'
