function New-VSDeadlineLicenseEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::LicenseEndpoint resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Deadline.LicenseEndpoint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.LicenseEndpoint'
