function New-VSCloudFrontDistributionTenant {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::DistributionTenant resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.DistributionTenant')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CloudFront.DistributionTenant.Parameter"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.DistributionTenant'
