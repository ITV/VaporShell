function New-VSECSClusterCapacityProviderAssociations {
    ...
    [OutputType('Vaporshell.Resource.ECS.ClusterCapacityProviderAssociations')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.ClusterCapacityProviderAssociations'
