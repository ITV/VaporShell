function New-VSConnectQueue {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Queue resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.Queue')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                QuickConnectArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name QuickConnectArns -Value @($QuickConnectArns)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Queue'
