function New-VSFSxDataRepositoryAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::DataRepositoryAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.FSx.DataRepositoryAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.DataRepositoryAssociation'
