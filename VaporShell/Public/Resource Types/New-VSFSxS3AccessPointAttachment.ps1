function New-VSFSxS3AccessPointAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::S3AccessPointAttachment resource to the template.
    ...
    .PARAMETER OntapConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-fsx-s3accesspointattachment.html#cfn-fsx-s3accesspointattachment-ontapconfiguration
        UpdateType: Immutable
    ...
    [OutputType('Vaporshell.Resource.FSx.S3AccessPointAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.S3AccessPointAttachment'
