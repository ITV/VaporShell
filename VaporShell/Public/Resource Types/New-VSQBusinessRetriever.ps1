function New-VSQBusinessRetriever {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Retriever resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QBusiness.Retriever')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Retriever'
