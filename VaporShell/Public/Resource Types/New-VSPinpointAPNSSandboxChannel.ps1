function New-VSPinpointAPNSSandboxChannel {
    <#
    .SYNOPSIS
        Adds an AWS::Pinpoint::APNSSandboxChannel resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Pinpoint.APNSSandboxChannel')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pinpoint.APNSSandboxChannel'
