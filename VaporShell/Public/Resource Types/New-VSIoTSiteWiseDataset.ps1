function New-VSIoTSiteWiseDataset {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::Dataset resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTSiteWise.Dataset')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.Dataset'
