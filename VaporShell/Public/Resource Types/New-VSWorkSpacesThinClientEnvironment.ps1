function New-VSWorkSpacesThinClientEnvironment {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesThinClient::Environment resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WorkSpacesThinClient.Environment')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                DeviceCreationTags {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DeviceCreationTags -Value @($DeviceCreationTags)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesThinClient.Environment'
