function New-VSEC2SecurityGroupVpcAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::SecurityGroupVpcAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.SecurityGroupVpcAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.SecurityGroupVpcAssociation'
