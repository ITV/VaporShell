function New-VSCloudTrailDashboard {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::Dashboard resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudTrail.Dashboard')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CloudTrail.Dashboard.Widget"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Widgets {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Widgets -Value @($Widgets)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.Dashboard'
