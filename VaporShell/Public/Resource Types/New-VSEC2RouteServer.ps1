function New-VSEC2RouteServer {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::RouteServer resource to the template.
    ...
    .PARAMETER SnsNotificationsEnabled
    ...
    .PARAMETER PersistRoutesDuration
    ...
    [OutputType('Vaporshell.Resource.EC2.RouteServer')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.RouteServer'
