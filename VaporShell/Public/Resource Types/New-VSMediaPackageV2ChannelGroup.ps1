function New-VSMediaPackageV2ChannelGroup {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackageV2::ChannelGroup resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaPackageV2.ChannelGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaPackageV2.ChannelGroup'
