function New-VSEC2KeyPair {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::KeyPair resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.KeyPair')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.KeyPair'
