function New-VSMediaLiveSdiSource {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::SdiSource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.SdiSource')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.SdiSource.Tags"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.SdiSource'
