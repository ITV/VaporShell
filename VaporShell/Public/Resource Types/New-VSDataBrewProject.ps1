function New-VSDataBrewProject {
    <#
    .SYNOPSIS
        Adds an AWS::DataBrew::Project resource to the template. Specifies a new AWS Glue DataBrew project.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataBrew.Project')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataBrew.Project'
