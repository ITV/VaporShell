function New-VSTransferWebApp {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::WebApp resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Transfer.WebApp')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.WebApp'
