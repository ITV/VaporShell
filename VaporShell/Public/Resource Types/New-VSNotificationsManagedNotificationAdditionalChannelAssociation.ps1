function New-VSNotificationsManagedNotificationAdditionalChannelAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::ManagedNotificationAdditionalChannelAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.ManagedNotificationAdditionalChannelAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.ManagedNotificationAdditionalChannelAssociation'
