function New-VSControlTowerLandingZone {
    <#
    .SYNOPSIS
        Adds an AWS::ControlTower::LandingZone resource to the template.
    ...
    .PARAMETER RemediationTypes
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-controltower-landingzone.html#cfn-controltower-landingzone-remediationtypes
        UpdateType: Mutable
        Type: List
    ...
    [OutputType('Vaporshell.Resource.ControlTower.LandingZone')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'RemediationTypes' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RemediationTypes -Value @($RemediationTypes)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ControlTower.LandingZone'
