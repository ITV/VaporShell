function New-VSIoTSoftwarePackage {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::SoftwarePackage resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoT.SoftwarePackage')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.SoftwarePackage'
