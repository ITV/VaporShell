function New-VSWAFRegionalGeoMatchSet {
    ...
    [OutputType('Vaporshell.Resource.WAFRegional.GeoMatchSet')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.WAFRegional.GeoMatchSet.GeoMatchConstraint"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                GeoMatchConstraints {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name GeoMatchConstraints -Value @($GeoMatchConstraints)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFRegional.GeoMatchSet'
