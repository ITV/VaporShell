function New-VSDeadlineFleet {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Fleet resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Deadline.Fleet')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Fleet'
