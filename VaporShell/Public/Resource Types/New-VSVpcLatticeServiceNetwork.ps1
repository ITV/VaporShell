function New-VSVpcLatticeServiceNetwork {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::ServiceNetwork resource to the template.
    ...
    [OutputType('Vaporshell.Resource.VpcLattice.ServiceNetwork')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.ServiceNetwork'
