function New-VSRoute53ResolverResolverQueryLoggingConfigAssociation {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53Resolver.ResolverQueryLoggingConfigAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Resolver.ResolverQueryLoggingConfigAssociation'
