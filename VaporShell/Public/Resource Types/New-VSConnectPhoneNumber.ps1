function New-VSConnectPhoneNumber {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::PhoneNumber resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.PhoneNumber')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.PhoneNumber'
