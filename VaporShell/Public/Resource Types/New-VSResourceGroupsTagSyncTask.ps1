function New-VSResourceGroupsTagSyncTask {
    <#
    .SYNOPSIS
        Adds an AWS::ResourceGroups::TagSyncTask resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ResourceGroups.TagSyncTask')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ResourceGroups.TagSyncTask'
