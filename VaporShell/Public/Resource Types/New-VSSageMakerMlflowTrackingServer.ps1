function New-VSSageMakerMlflowTrackingServer {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::MlflowTrackingServer resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.MlflowTrackingServer')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.MlflowTrackingServer'
