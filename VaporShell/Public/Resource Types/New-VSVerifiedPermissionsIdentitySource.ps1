function New-VSVerifiedPermissionsIdentitySource {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::IdentitySource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.VerifiedPermissions.IdentitySource')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.IdentitySource'
