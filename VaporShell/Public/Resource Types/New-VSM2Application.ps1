function New-VSM2Application {
    <#
    .SYNOPSIS
        Adds an AWS::M2::Application resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.M2.Application')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.M2.Application'
