function New-VSDataZoneGroupProfile {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::GroupProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.GroupProfile')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.GroupProfile'
