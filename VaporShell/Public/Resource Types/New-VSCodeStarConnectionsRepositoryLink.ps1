function New-VSCodeStarConnectionsRepositoryLink {
    <#
    .SYNOPSIS
        Adds an AWS::CodeStarConnections::RepositoryLink resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CodeStarConnections.RepositoryLink')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeStarConnections.RepositoryLink'
