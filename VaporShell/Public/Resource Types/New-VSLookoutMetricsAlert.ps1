function New-VSLookoutMetricsAlert {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutMetrics::Alert resource to the template. The AWS::LookoutMetrics::Alert type creates an alert for an anomaly detector.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LookoutMetrics.Alert')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutMetrics.Alert'
