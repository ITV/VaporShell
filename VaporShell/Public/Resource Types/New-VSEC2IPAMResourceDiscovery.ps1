function New-VSEC2IPAMResourceDiscovery {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::IPAMResourceDiscovery resource to the template.
    ...
    .PARAMETER OrganizationalUnitExclusions
        ...
        UpdateType: Mutable
        Type: List
        ItemType: IpamResourceDiscoveryOrganizationalUnitExclusion
    ...
    [OutputType('Vaporshell.Resource.EC2.IPAMResourceDiscovery')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.IPAMResourceDiscovery.IpamResourceDiscoveryOrganizationalUnitExclusion"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.IPAMResourceDiscovery.IpamOperatingRegion"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'OrganizationalUnitExclusions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name OrganizationalUnitExclusions -Value @($OrganizationalUnitExclusions)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'OperatingRegions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name OperatingRegions -Value @($OperatingRegions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.IPAMResourceDiscovery'
