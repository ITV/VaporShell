function New-VSDataZoneProjectProfile {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::ProjectProfile resource to the template.
    ...
    .PARAMETER EnvironmentConfigurations
        ...
        UpdateType: Mutable
        Type: List
        ItemType: EnvironmentConfiguration
    ...
    [OutputType('Vaporshell.Resource.DataZone.ProjectProfile')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DataZone.ProjectProfile.EnvironmentConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'EnvironmentConfigurations' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EnvironmentConfigurations -Value @($EnvironmentConfigurations)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.ProjectProfile'
