function New-VSEC2VerifiedAccessInstance {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessInstance resource to the template. 
    ...
    .PARAMETER VerifiedAccessTrustProviders
    ...
    .PARAMETER LoggingConfigurations
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.VerifiedAccessInstance')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VerifiedAccessInstance.VerifiedAccessTrustProvider"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                VerifiedAccessTrustProviders {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name VerifiedAccessTrustProviders -Value @($VerifiedAccessTrustProviders)
                }
                VerifiedAccessTrustProviderIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name VerifiedAccessTrustProviderIds -Value @($VerifiedAccessTrustProviderIds)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessInstance'
