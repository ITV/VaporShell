function New-VSLakeFormationTag {
    <#
    .SYNOPSIS
        Adds an AWS::LakeFormation::Tag resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LakeFormation.Tag')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TagValues {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TagValues -Value @($TagValues)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.Tag'
