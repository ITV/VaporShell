function New-VSFraudDetectorList {
    <#
    .SYNOPSIS
        Adds an AWS::FraudDetector::List resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.FraudDetector.List')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Elements {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Elements -Value @($Elements)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FraudDetector.List'
