function New-VSLakeFormationDataCellsFilter {
    <#
    .SYNOPSIS
        Adds an AWS::LakeFormation::DataCellsFilter resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LakeFormation.DataCellsFilter')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ColumnNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ColumnNames -Value @($ColumnNames)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.DataCellsFilter'
