function New-VSIVSStage {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::Stage resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVS.Stage')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.Stage'
