function New-VSKinesisStream {
    ...
    .PARAMETER WarmThroughputMiBps
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesis-stream.html#cfn-kinesis-stream-warmthroughputmibps
        UpdateType: Mutable
        PrimitiveType: Integer

    .PARAMETER MaxRecordSizeInKiB
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesis-stream.html#cfn-kinesis-stream-maxrecordsizeinkib
        UpdateType: Mutable
        PrimitiveType: Integer
    ...
    .PARAMETER DesiredShardLevelMetrics
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'DesiredShardLevelMetrics' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DesiredShardLevelMetrics -Value @($DesiredShardLevelMetrics)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
