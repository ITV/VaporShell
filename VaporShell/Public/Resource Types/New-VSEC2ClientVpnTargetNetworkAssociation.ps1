function New-VSEC2ClientVpnTargetNetworkAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::ClientVpnTargetNetworkAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.ClientVpnTargetNetworkAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.ClientVpnTargetNetworkAssociation'
