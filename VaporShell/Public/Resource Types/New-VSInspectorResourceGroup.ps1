function New-VSInspectorResourceGroup {
    ...
    [OutputType('Vaporshell.Resource.Inspector.ResourceGroup')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ResourceGroupTags {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ResourceGroupTags -Value @($ResourceGroupTags)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Inspector.ResourceGroup'
