function New-VSGlueUsageProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::UsageProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Glue.UsageProfile')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.UsageProfile'
