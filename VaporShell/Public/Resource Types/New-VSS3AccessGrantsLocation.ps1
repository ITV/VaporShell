function New-VSS3AccessGrantsLocation {
    <#
    .SYNOPSIS
        Adds an AWS::S3::AccessGrantsLocation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.AccessGrantsLocation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.AccessGrantsLocation'
