function New-VSQuickSightVPCConnection {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::VPCConnection resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.VPCConnection')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                DnsResolvers {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DnsResolvers -Value @($DnsResolvers)
                }
                SecurityGroupIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.VPCConnection'
