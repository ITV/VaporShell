function New-VSConnectRule {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Rule resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.Rule')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Rule'
