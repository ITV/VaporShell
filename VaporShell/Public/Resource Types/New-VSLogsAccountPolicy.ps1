function New-VSLogsAccountPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::AccountPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Logs.AccountPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.AccountPolicy'
