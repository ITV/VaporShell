function New-VSNeptuneEventSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::Neptune::EventSubscription resource to the template.
    ...
    .PARAMETER Tags
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-eventsubscription.html#cfn-neptune-eventsubscription-tags
        UpdateType: Mutable
        Type: List
        ItemType: Tag
    ...
    [OutputType('Vaporshell.Resource.Neptune.EventSubscription')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Neptune.EventSubscription'
