function New-VSEC2LocalGatewayRouteTableVirtualInterfaceGroupAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::LocalGatewayRouteTableVirtualInterfaceGroupAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.LocalGatewayRouteTableVirtualInterfaceGroupAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.LocalGatewayRouteTableVirtualInterfaceGroupAssociation'
