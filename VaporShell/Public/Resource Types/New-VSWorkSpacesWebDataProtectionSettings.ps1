function New-VSWorkSpacesWebDataProtectionSettings {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::DataProtectionSettings resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.DataProtectionSettings')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.DataProtectionSettings'
