function New-VSARCZonalShiftZonalAutoshiftConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ARCZonalShift::ZonalAutoshiftConfiguration resource to the template. 
    ...
    .PARAMETER PracticeRunConfiguration
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ARCZonalShift.ZonalAutoshiftConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCZonalShift.ZonalAutoshiftConfiguration'
