function New-VSRolesAnywhereCRL {
    <#
    .SYNOPSIS
        Adds an AWS::RolesAnywhere::CRL resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.RolesAnywhere.CRL')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RolesAnywhere.CRL'
