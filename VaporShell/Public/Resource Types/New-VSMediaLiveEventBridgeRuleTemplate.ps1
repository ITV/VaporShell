function New-VSMediaLiveEventBridgeRuleTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::EventBridgeRuleTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.EventBridgeRuleTemplate')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.EventBridgeRuleTemplate.EventBridgeRuleTemplateTarget"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                EventTargets {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EventTargets -Value @($EventTargets)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.EventBridgeRuleTemplate'
