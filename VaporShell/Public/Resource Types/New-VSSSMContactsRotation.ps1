function New-VSSSMContactsRotation {
    <#
    .SYNOPSIS
        Adds an AWS::SSMContacts::Rotation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSMContacts.Rotation')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ContactIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ContactIds -Value @($ContactIds)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSMContacts.Rotation'
