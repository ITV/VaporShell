function New-VSConnectContactFlowVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::ContactFlowVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.ContactFlowVersion')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.ContactFlowVersion'
