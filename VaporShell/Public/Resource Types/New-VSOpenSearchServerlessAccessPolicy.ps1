function New-VSOpenSearchServerlessAccessPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::AccessPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.AccessPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.AccessPolicy'
