function New-VSSecurityHubHubV2 {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::HubV2 resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.HubV2')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.HubV2'
