function New-VSDevOpsGuruLogAnomalyDetectionIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::DevOpsGuru::LogAnomalyDetectionIntegration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DevOpsGuru.LogAnomalyDetectionIntegration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DevOpsGuru.LogAnomalyDetectionIntegration'
