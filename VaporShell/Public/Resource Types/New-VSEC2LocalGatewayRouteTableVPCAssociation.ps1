function New-VSEC2LocalGatewayRouteTableVPCAssociation {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.LocalGatewayRouteTableVPCAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.LocalGatewayRouteTableVPCAssociation'
