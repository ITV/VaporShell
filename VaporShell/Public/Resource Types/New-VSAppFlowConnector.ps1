function New-VSAppFlowConnector {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Connector resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppFlow.Connector')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Connector'
