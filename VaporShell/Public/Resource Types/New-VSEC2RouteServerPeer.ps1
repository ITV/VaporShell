function New-VSEC2RouteServerPeer {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::RouteServerPeer resource to the template.
    ...
    .PARAMETER RouteServerEndpointId
    ...
    [OutputType('Vaporshell.Resource.EC2.RouteServerPeer')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.RouteServerPeer'
