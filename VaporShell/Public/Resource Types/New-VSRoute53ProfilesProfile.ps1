function New-VSRoute53ProfilesProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Route53Profiles::Profile resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53Profiles.Profile')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Profiles.Profile'
