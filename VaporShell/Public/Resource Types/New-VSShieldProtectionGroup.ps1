function New-VSShieldProtectionGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Shield::ProtectionGroup resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Shield.ProtectionGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Shield.ProtectionGroup'
