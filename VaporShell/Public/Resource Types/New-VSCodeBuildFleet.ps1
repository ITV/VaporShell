function New-VSCodeBuildFleet {
    <#
    .SYNOPSIS
        Adds an AWS::CodeBuild::Fleet resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CodeBuild.Fleet')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeBuild.Fleet'
