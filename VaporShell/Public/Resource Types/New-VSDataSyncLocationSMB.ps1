function New-VSDataSyncLocationSMB {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationSMB resource to the template.
    ...
    .PARAMETER CmkSecretConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datasync-locationsmb.html#cfn-datasync-locationsmb-cmksecretconfig
        UpdateType: Mutable
    ...
    .PARAMETER CustomSecretConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datasync-locationsmb.html#cfn-datasync-locationsmb-customsecretconfig
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationSMB')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'DnsIpAddresses' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DnsIpAddresses -Value @($DnsIpAddresses)
                }
                'AgentArns' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AgentArns -Value @($AgentArns)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationSMB'
