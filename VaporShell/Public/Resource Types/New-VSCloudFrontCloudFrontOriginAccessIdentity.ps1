function New-VSCloudFrontCloudFrontOriginAccessIdentity {
    ...
    [OutputType('Vaporshell.Resource.CloudFront.CloudFrontOriginAccessIdentity')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.CloudFrontOriginAccessIdentity'
