function New-VSIoTWirelessDestination {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::Destination resource to the template. Creates a new destination that maps a device message to an AWS IoT rule.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.Destination')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.Destination'
