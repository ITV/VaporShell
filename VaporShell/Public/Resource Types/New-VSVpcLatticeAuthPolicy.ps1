function New-VSVpcLatticeAuthPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::AuthPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VpcLattice.AuthPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.AuthPolicy'
