function New-VSDataSyncStorageSystem {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::StorageSystem resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.StorageSystem')]
    [cmdletbinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSAvoidUsingPlainTextForPassword","ServerCredentials")]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSAvoidUsingUserNameAndPasswordParams","ServerCredentials")]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.StorageSystem'
