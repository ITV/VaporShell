function New-VSGameLiftStreamsStreamGroup {
    <#
    .SYNOPSIS
        Adds an AWS::GameLiftStreams::StreamGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.GameLiftStreams.StreamGroup')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GameLiftStreams.StreamGroup.LocationConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'LocationConfigurations' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LocationConfigurations -Value @($LocationConfigurations)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLiftStreams.StreamGroup'
