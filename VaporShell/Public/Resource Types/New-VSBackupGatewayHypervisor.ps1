function New-VSBackupGatewayHypervisor {
    <#
    .SYNOPSIS
        Adds an AWS::BackupGateway::Hypervisor resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.BackupGateway.Hypervisor')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BackupGateway.Hypervisor'
