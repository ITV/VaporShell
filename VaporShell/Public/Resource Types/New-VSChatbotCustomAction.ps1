function New-VSChatbotCustomAction {
    <#
    .SYNOPSIS
        Adds an AWS::Chatbot::CustomAction resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Chatbot.CustomAction')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Chatbot.CustomAction.CustomActionAttachment"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Chatbot.CustomAction'
