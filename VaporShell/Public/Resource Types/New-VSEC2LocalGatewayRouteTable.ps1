function New-VSEC2LocalGatewayRouteTable {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::LocalGatewayRouteTable resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.LocalGatewayRouteTable')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.LocalGatewayRouteTable'
