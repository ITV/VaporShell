function New-VSIVSPublicKey {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::PublicKey resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVS.PublicKey')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.PublicKey'
