function New-VSIoTFleetWiseModelManifest {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::ModelManifest resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.ModelManifest')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.ModelManifest'
