function New-VSVerifiedPermissionsPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::Policy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VerifiedPermissions.Policy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.Policy'
