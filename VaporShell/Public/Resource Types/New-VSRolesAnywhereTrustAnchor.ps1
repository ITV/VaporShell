function New-VSRolesAnywhereTrustAnchor {
    <#
    .SYNOPSIS
        Adds an AWS::RolesAnywhere::TrustAnchor resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.RolesAnywhere.TrustAnchor')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.RolesAnywhere.TrustAnchor.NotificationSetting"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                NotificationSettings {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name NotificationSettings -Value @($NotificationSettings)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RolesAnywhere.TrustAnchor'
