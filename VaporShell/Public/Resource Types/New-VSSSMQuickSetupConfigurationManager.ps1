function New-VSSSMQuickSetupConfigurationManager {
    <#
    .SYNOPSIS
        Adds an AWS::SSMQuickSetup::ConfigurationManager resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSMQuickSetup.ConfigurationManager')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SSMQuickSetup.ConfigurationManager.ConfigurationDefinition"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ConfigurationDefinitions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ConfigurationDefinitions -Value @($ConfigurationDefinitions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSMQuickSetup.ConfigurationManager'
