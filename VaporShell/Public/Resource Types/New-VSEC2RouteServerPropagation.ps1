function New-VSEC2RouteServerPropagation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::RouteServerPropagation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.RouteServerPropagation')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.RouteServerPropagation'
