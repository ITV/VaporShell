function New-VSIVSStorageConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::StorageConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVS.StorageConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.StorageConfiguration'
