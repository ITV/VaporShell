function New-VSInternetMonitorMonitor {
    <#
    .SYNOPSIS
        Adds an AWS::InternetMonitor::Monitor resource to the template.
    ...
    [OutputType('Vaporshell.Resource.InternetMonitor.Monitor')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ResourcesToAdd {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ResourcesToAdd -Value @($ResourcesToAdd)
                }
                ResourcesToRemove {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ResourcesToRemove -Value @($ResourcesToRemove)
                }
                Resources {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.InternetMonitor.Monitor'
