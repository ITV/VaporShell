function New-VSCleanRoomsPrivacyBudgetTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::PrivacyBudgetTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.PrivacyBudgetTemplate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.PrivacyBudgetTemplate'
