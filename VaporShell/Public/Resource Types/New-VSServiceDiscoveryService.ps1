function New-VSServiceDiscoveryService {
    ...
    [OutputType('Vaporshell.Resource.ServiceDiscovery.Service')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceDiscovery.Service'
