function New-VSODBCloudAutonomousVmCluster {
    <#
    .SYNOPSIS
        Adds an AWS::ODB::CloudAutonomousVmCluster resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ODB.CloudAutonomousVmCluster')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ODB.CloudAutonomousVmCluster'
