function New-VSSESVdmAttributes {
    <#
    .SYNOPSIS
        Adds an AWS::SES::VdmAttributes resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SES.VdmAttributes')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.VdmAttributes'
