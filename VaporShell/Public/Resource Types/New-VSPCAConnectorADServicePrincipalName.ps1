function New-VSPCAConnectorADServicePrincipalName {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::ServicePrincipalName resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.PCAConnectorAD.ServicePrincipalName')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.ServicePrincipalName'
