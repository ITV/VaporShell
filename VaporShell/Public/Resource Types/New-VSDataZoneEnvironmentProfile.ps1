function New-VSDataZoneEnvironmentProfile {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::EnvironmentProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.EnvironmentProfile')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DataZone.EnvironmentProfile.EnvironmentParameter"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.EnvironmentProfile'
