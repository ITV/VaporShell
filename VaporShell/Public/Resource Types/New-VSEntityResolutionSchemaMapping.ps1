function New-VSEntityResolutionSchemaMapping {
    <#
    .SYNOPSIS
        Adds an AWS::EntityResolution::SchemaMapping resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EntityResolution.SchemaMapping')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EntityResolution.SchemaMapping.SchemaInputAttribute"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                MappedInputFields {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name MappedInputFields -Value @($MappedInputFields)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EntityResolution.SchemaMapping'
