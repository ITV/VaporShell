function New-VSIAMUserPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::IAM::UserPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IAM.UserPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IAM.UserPolicy'
