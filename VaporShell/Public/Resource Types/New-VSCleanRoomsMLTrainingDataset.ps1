function New-VSCleanRoomsMLTrainingDataset {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRoomsML::TrainingDataset resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRoomsML.TrainingDataset')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CleanRoomsML.TrainingDataset.Dataset"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TrainingData {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TrainingData -Value @($TrainingData)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRoomsML.TrainingDataset'
