function New-VSSageMakerStudioLifecycleConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::StudioLifecycleConfig resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.StudioLifecycleConfig')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.StudioLifecycleConfig'
