function New-VSWorkSpacesWebBrowserSettings {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::BrowserSettings resource to the template.
    ...
    .PARAMETER WebContentFilteringPolicy
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-browsersettings.html#cfn-workspacesweb-browsersettings-webcontentfilteringpolicy
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.BrowserSettings')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.BrowserSettings'
