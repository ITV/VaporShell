function New-VSNetworkManagerVpcAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::VpcAttachment resource to the template.
    ...
    .PARAMETER RoutingPolicyLabel
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-vpcattachment.html#cfn-networkmanager-vpcattachment-routingpolicylabel
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.VpcAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.VpcAttachment'
