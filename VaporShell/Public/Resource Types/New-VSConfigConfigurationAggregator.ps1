function New-VSConfigConfigurationAggregator {
    ...
    [OutputType('Vaporshell.Resource.Config.ConfigurationAggregator')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Config.ConfigurationAggregator.AccountAggregationSource"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConfigurationAggregator'
