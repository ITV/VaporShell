function New-VSServiceDiscoveryPrivateDnsNamespace {
    ...
    [OutputType('Vaporshell.Resource.ServiceDiscovery.PrivateDnsNamespace')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceDiscovery.PrivateDnsNamespace'
