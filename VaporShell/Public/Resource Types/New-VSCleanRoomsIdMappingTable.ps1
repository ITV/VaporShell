function New-VSCleanRoomsIdMappingTable {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::IdMappingTable resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.IdMappingTable')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.IdMappingTable'
