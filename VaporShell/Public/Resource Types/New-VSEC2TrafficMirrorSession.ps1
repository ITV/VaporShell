function New-VSEC2TrafficMirrorSession {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::TrafficMirrorSession resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.TrafficMirrorSession')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.TrafficMirrorSession'
