function New-VSBedrockPrompt {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.Prompt')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Bedrock.Prompt.PromptVariant"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt'
