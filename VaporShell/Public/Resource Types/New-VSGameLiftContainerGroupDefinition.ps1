function New-VSGameLiftContainerGroupDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerGroupDefinition resource to the template.
    ...
    [OutputType('Vaporshell.Resource.GameLift.ContainerGroupDefinition')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GameLift.ContainerGroupDefinition.SupportContainerDefinition"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                SupportContainerDefinitions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SupportContainerDefinitions -Value @($SupportContainerDefinitions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerGroupDefinition'
