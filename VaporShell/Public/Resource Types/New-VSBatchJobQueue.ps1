function New-VSBatchJobQueue {
    ...
    .PARAMETER JobQueueType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-batch-jobqueue.html#cfn-batch-jobqueue-jobqueuetype
        UpdateType: Immutable
        PrimitiveType: String

    .PARAMETER ServiceEnvironmentOrder
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-batch-jobqueue.html#cfn-batch-jobqueue-serviceenvironmentorder
        UpdateType: Mutable
        Type: List
        ItemType: ServiceEnvironmentOrder
        DuplicatesAllowed: True
    ...
    [OutputType('Vaporshell.Resource.Batch.JobQueue')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Batch.JobQueue.ServiceEnvironmentOrder"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ServiceEnvironmentOrder' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ServiceEnvironmentOrder -Value @($ServiceEnvironmentOrder)
                }
                'JobStateTimeLimitActions' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobQueue'
