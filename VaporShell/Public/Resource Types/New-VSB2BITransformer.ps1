function New-VSB2BITransformer {
    <#
    .SYNOPSIS
        Adds an AWS::B2BI::Transformer resource to the template.
    ...
    [OutputType('Vaporshell.Resource.B2BI.Transformer')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.B2BI.Transformer'
