function New-VSAppRunnerAutoScalingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::AppRunner::AutoScalingConfiguration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppRunner.AutoScalingConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppRunner.AutoScalingConfiguration'
