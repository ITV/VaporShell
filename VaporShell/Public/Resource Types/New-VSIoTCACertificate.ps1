function New-VSIoTCACertificate {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::CACertificate resource to the template.
    ...
    .PARAMETER AutoRegistrationStatus
    ...
    .PARAMETER VerificationCertificatePem
    ...
    [OutputType('Vaporshell.Resource.IoT.CACertificate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.CACertificate'
