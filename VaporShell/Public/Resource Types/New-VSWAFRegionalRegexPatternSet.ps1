function New-VSWAFRegionalRegexPatternSet {
    ...
    [OutputType('Vaporshell.Resource.WAFRegional.RegexPatternSet')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RegexPatternStrings {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RegexPatternStrings -Value @($RegexPatternStrings)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFRegional.RegexPatternSet'
