function New-VSGlobalAcceleratorCrossAccountAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::GlobalAccelerator::CrossAccountAttachment resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.GlobalAccelerator.CrossAccountAttachment')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GlobalAccelerator.CrossAccountAttachment.Resource"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Principals {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Principals -Value @($Principals)
                }
                Resources {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GlobalAccelerator.CrossAccountAttachment'
