function New-VSMPAApprovalTeam {
    <#
    .SYNOPSIS
        Adds an AWS::MPA::ApprovalTeam resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MPA.ApprovalTeam')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MPA.ApprovalTeam.Policy"
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MPA.ApprovalTeam.Approver"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Approvers' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Approvers -Value @($Approvers)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MPA.ApprovalTeam'
