function New-VSVpcLatticeServiceNetworkResourceAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::ServiceNetworkResourceAssociation resource to the template.
    ...
    .PARAMETER PrivateDnsEnabled
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-vpclattice-servicenetworkresourceassociation.html#cfn-vpclattice-servicenetworkresourceassociation-privatednsenabled
        UpdateType: Immutable
        PrimitiveType: Boolean

    .PARAMETER ResourceConfigurationId
    ...
    [OutputType('Vaporshell.Resource.VpcLattice.ServiceNetworkResourceAssociation')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.ServiceNetworkResourceAssociation'
