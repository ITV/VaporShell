function New-VSOamLink {
    <#
    .SYNOPSIS
        Adds an AWS::Oam::Link resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Oam.Link')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ResourceTypes {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ResourceTypes -Value @($ResourceTypes)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Oam.Link'
