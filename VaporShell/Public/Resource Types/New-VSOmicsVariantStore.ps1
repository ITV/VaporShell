function New-VSOmicsVariantStore {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::VariantStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Omics.VariantStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.VariantStore'
