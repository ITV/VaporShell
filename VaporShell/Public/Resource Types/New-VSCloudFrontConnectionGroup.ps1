function New-VSCloudFrontConnectionGroup {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::ConnectionGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.ConnectionGroup')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.ConnectionGroup'
