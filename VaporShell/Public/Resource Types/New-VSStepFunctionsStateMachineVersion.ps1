function New-VSStepFunctionsStateMachineVersion {
    <#
    .SYNOPSIS
        Adds an AWS::StepFunctions::StateMachineVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.StepFunctions.StateMachineVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.StepFunctions.StateMachineVersion'
