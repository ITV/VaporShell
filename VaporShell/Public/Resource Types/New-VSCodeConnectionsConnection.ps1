function New-VSCodeConnectionsConnection {
    <#
    .SYNOPSIS
        Adds an AWS::CodeConnections::Connection resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CodeConnections.Connection')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeConnections.Connection'
