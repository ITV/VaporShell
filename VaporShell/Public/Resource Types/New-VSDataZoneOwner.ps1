function New-VSDataZoneOwner {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Owner resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Owner')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Owner'
