function New-VSOpenSearchServerlessLifecyclePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::LifecyclePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.LifecyclePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.LifecyclePolicy'
