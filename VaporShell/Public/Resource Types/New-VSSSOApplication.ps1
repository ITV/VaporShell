function New-VSSSOApplication {
    <#
    .SYNOPSIS
        Adds an AWS::SSO::Application resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSO.Application')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSO.Application'
