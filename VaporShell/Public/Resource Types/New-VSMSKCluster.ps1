function New-VSMSKCluster {
    ...
    .PARAMETER Rebalancing
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-msk-cluster.html#cfn-msk-cluster-rebalancing
        UpdateType: Mutable
        Type: Rebalancing
    ...
    [OutputType('Vaporshell.Resource.MSK.Cluster')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.Cluster'
