function New-VSAIOpsInvestigationGroup {
    <#
    .SYNOPSIS
        Adds an AWS::AIOps::InvestigationGroup resource to the template.
    ...
    .PARAMETER InvestigationGroupPolicy
    ...
    .PARAMETER ChatbotNotificationChannels
        ...
        UpdateType: Mutable
        Type: List
        ItemType: ChatbotNotificationChannel
        DuplicatesAllowed: False
    ...
    [OutputType('Vaporshell.Resource.AIOps.InvestigationGroup')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AIOps.InvestigationGroup.CrossAccountConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AIOps.InvestigationGroup.ChatbotNotificationChannel"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'CrossAccountConfigurations' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CrossAccountConfigurations -Value @($CrossAccountConfigurations)
                }
                'ChatbotNotificationChannels' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ChatbotNotificationChannels -Value @($ChatbotNotificationChannels)
                }
                'TagKeyBoundaries' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TagKeyBoundaries -Value @($TagKeyBoundaries)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AIOps.InvestigationGroup'
