function New-VSNetworkFirewallVpcEndpointAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::VpcEndpointAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.NetworkFirewall.VpcEndpointAssociation')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.VpcEndpointAssociation'
