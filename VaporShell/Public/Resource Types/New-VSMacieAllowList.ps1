function New-VSMacieAllowList {
    <#
    .SYNOPSIS
        Adds an AWS::Macie::AllowList resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Macie.AllowList')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Macie.AllowList'
