function New-VSMediaLiveMultiplexprogram {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Multiplexprogram resource to the template. 
    ...
    .PARAMETER PacketIdentifiersMap
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaLive.Multiplexprogram')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.Multiplexprogram.MultiplexProgramPipelineDetail"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                PipelineDetails {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PipelineDetails -Value @($PipelineDetails)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Multiplexprogram'
