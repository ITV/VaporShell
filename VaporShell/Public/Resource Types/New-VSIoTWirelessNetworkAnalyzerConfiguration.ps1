function New-VSIoTWirelessNetworkAnalyzerConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::NetworkAnalyzerConfiguration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.NetworkAnalyzerConfiguration')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                WirelessGateways {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name WirelessGateways -Value @($WirelessGateways)
                }
                WirelessDevices {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name WirelessDevices -Value @($WirelessDevices)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.NetworkAnalyzerConfiguration'
