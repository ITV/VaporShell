function New-VSGlueTableOptimizer {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::TableOptimizer resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Glue.TableOptimizer')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.TableOptimizer'
