function New-VSDeadlineStorageProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::StorageProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.StorageProfile')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Deadline.StorageProfile.FileSystemLocation"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.StorageProfile'
