function New-VSBillingConductorCustomLineItem {
    <#
    .SYNOPSIS
        Adds an AWS::BillingConductor::CustomLineItem resource to the template.
    ...
    .PARAMETER PresentationDetails
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-billingconductor-customlineitem.html#cfn-billingconductor-customlineitem-presentationdetails
        UpdateType: Immutable
    ...
    .PARAMETER ComputationRule
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-billingconductor-customlineitem.html#cfn-billingconductor-customlineitem-computationrule
        UpdateType: Immutable
        PrimitiveType: String

    .PARAMETER CustomLineItemChargeDetails
    ...
    [OutputType('Vaporshell.Resource.BillingConductor.CustomLineItem')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BillingConductor.CustomLineItem'
