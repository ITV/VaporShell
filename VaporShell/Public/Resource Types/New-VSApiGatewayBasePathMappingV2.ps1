function New-VSApiGatewayBasePathMappingV2 {
    <#
    .SYNOPSIS
        Adds an AWS::ApiGateway::BasePathMappingV2 resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ApiGateway.BasePathMappingV2')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGateway.BasePathMappingV2'
