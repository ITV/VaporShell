function New-VSECRRepositoryCreationTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::ECR::RepositoryCreationTemplate resource to the template.
    ...
    .PARAMETER ImageTagMutabilityExclusionFilters
        ...
        UpdateType: Mutable
        Type: List
        ItemType: ImageTagMutabilityExclusionFilter
    ...
    [OutputType('Vaporshell.Resource.ECR.RepositoryCreationTemplate')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ECR.RepositoryCreationTemplate.ImageTagMutabilityExclusionFilter"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ImageTagMutabilityExclusionFilters' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ImageTagMutabilityExclusionFilters -Value @($ImageTagMutabilityExclusionFilters)
                }
                'ResourceTags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'AppliedFor' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AppliedFor -Value @($AppliedFor)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECR.RepositoryCreationTemplate'
