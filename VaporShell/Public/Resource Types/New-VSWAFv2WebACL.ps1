function New-VSWAFv2WebACL {
    ...
    .PARAMETER ApplicationConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-wafv2-webacl.html#cfn-wafv2-webacl-applicationconfig
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'TokenDomains' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TokenDomains -Value @($TokenDomains)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL'
