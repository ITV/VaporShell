function New-VSVpcLatticeAccessLogSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::AccessLogSubscription resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VpcLattice.AccessLogSubscription')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.AccessLogSubscription'
