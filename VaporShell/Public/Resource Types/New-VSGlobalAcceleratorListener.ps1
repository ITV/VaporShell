function New-VSGlobalAcceleratorListener {
    ...
    [OutputType('Vaporshell.Resource.GlobalAccelerator.Listener')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GlobalAccelerator.Listener.PortRange"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GlobalAccelerator.Listener'
