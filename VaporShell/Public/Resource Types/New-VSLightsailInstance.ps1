function New-VSLightsailInstance {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::Instance resource to the template. The AWS::Lightsail::Instance resource specifies an Amazon Lightsail instance.
...
The Value of Tags is optional for Lightsail resources.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Lightsail.Instance')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Lightsail.Instance.AddOn"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.Instance'
