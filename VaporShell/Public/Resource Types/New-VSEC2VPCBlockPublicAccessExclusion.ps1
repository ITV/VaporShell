function New-VSEC2VPCBlockPublicAccessExclusion {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VPCBlockPublicAccessExclusion resource to the template.
    ...
    .PARAMETER InternetGatewayExclusionMode
    ...
    [OutputType('Vaporshell.Resource.EC2.VPCBlockPublicAccessExclusion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPCBlockPublicAccessExclusion'
