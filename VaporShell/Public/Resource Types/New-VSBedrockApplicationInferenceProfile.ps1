function New-VSBedrockApplicationInferenceProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::ApplicationInferenceProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.ApplicationInferenceProfile')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.ApplicationInferenceProfile'
