function New-VSWisdomMessageTemplateVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::MessageTemplateVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.MessageTemplateVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.MessageTemplateVersion'
