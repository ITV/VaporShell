function New-VSKendraFaq {
    <#
    .SYNOPSIS
        Adds an AWS::Kendra::Faq resource to the template. Specifies an new set of frequently asked question (FAQ questions and answers.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Kendra.Faq')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kendra.Faq'
