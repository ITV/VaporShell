function New-VSSQSQueue {
    <#
    .SYNOPSIS
        Adds an AWS::SQS::Queue resource to the template. The AWS::SQS::Queue resource creates an Amazon SQS standard or FIFO queue.
...
+  The Customer Master Keys section of the AWS Key Management Service Best Practices: https://d0.awsstatic.com/whitepapers/aws-kms-best-practices.pdf whitepaper
    ...
    .PARAMETER SqsManagedSseEnabled
        +   CreateQueue: https://docs.aws.amazon.com/AWSSimpleQueueService/latest/APIReference/API_CreateQueue.html  in the *Amazon SQS API Reference*
...
+ sourceQueueArns: The Amazon Resource Names ARNs of the source queues that can specify this queue as the dead-letter queue and redrive messages. You can specify this parameter only when the redrivePermission parameter is set to byQueue. You can specify up to 10 source queue ARNs. To allow more than 10 source queues to specify dead-letter queues, set the redrivePermission parameter to allowAll.
