function New-VSIoTCommand {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::Command resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.Command')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoT.Command.CommandParameter"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                MandatoryParameters {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name MandatoryParameters -Value @($MandatoryParameters)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.Command'
