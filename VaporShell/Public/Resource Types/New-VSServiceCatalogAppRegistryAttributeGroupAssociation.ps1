function New-VSServiceCatalogAppRegistryAttributeGroupAssociation {
    ...
    [OutputType('Vaporshell.Resource.ServiceCatalogAppRegistry.AttributeGroupAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalogAppRegistry.AttributeGroupAssociation'
