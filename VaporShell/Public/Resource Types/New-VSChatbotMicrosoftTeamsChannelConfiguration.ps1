function New-VSChatbotMicrosoftTeamsChannelConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Chatbot::MicrosoftTeamsChannelConfiguration resource to the template. 
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Chatbot.MicrosoftTeamsChannelConfiguration'
