function New-VSDataZoneProjectMembership {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::ProjectMembership resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.ProjectMembership')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.ProjectMembership'
