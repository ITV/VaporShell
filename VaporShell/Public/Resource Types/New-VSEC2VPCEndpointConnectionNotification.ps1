function New-VSEC2VPCEndpointConnectionNotification {
    ...
    [OutputType('Vaporshell.Resource.EC2.VPCEndpointConnectionNotification')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ConnectionEvents {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ConnectionEvents -Value @($ConnectionEvents)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPCEndpointConnectionNotification'
