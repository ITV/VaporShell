function New-VSResourceExplorer2DefaultViewAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::ResourceExplorer2::DefaultViewAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ResourceExplorer2.DefaultViewAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ResourceExplorer2.DefaultViewAssociation'
