function New-VSAppSyncSourceApiAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::AppSync::SourceApiAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.AppSync.SourceApiAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppSync.SourceApiAssociation'
