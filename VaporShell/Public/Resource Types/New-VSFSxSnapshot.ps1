function New-VSFSxSnapshot {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::Snapshot resource to the template.
    ...
    [OutputType('Vaporshell.Resource.FSx.Snapshot')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.Snapshot'
