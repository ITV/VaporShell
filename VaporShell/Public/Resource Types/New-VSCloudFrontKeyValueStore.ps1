function New-VSCloudFrontKeyValueStore {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::KeyValueStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudFront.KeyValueStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.KeyValueStore'
