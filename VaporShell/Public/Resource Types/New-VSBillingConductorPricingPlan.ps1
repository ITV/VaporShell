function New-VSBillingConductorPricingPlan {
    <#
    .SYNOPSIS
        Adds an AWS::BillingConductor::PricingPlan resource to the template. Creates a pricing plan that is used for computing AWS charges for billing groups.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.BillingConductor.PricingPlan')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                PricingRuleArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PricingRuleArns -Value @($PricingRuleArns)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BillingConductor.PricingPlan'
