function New-VSWisdomAIAgent {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIAgent resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIAgent')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIAgent'
