function New-VSVpcLatticeListener {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::Listener resource to the template.
    ...
    [OutputType('Vaporshell.Resource.VpcLattice.Listener')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.Listener'
