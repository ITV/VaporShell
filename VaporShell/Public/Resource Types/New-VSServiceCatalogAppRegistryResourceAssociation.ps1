function New-VSServiceCatalogAppRegistryResourceAssociation {
    ...
    [OutputType('Vaporshell.Resource.ServiceCatalogAppRegistry.ResourceAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalogAppRegistry.ResourceAssociation'
