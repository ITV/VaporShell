function New-VSKafkaConnectWorkerConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KafkaConnect::WorkerConfiguration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.KafkaConnect.WorkerConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KafkaConnect.WorkerConfiguration'
