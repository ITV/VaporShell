function New-VSSESMailManagerAddressList {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerAddressList resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerAddressList')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerAddressList'
