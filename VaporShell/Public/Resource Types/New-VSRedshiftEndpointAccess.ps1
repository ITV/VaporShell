function New-VSRedshiftEndpointAccess {
    <#
    .SYNOPSIS
        Adds an AWS::Redshift::EndpointAccess resource to the template. Creates a Redshift-managed VPC endpoint.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Redshift.EndpointAccess')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Redshift.EndpointAccess'
