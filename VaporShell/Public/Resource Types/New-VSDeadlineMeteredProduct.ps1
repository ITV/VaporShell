function New-VSDeadlineMeteredProduct {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::MeteredProduct resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.MeteredProduct')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.MeteredProduct'
