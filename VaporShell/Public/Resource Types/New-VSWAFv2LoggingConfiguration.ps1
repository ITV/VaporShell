function New-VSWAFv2LoggingConfiguration {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.LoggingConfiguration')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.WAFv2.LoggingConfiguration.FieldToMatch"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LogDestinationConfigs {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LogDestinationConfigs -Value @($LogDestinationConfigs)
                }
                RedactedFields {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.LoggingConfiguration'
