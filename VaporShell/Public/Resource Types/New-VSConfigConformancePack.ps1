function New-VSConfigConformancePack {
    ...
    [OutputType('Vaporshell.Resource.Config.ConformancePack')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Config.ConformancePack.ConformancePackInputParameter"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConformancePack'
