function New-VSCustomerProfilesIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::Integration resource to the template. The AWS::CustomerProfiles::Integration resource specifies an Amazon Connect Customer Profiles Integration.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CustomerProfiles.Integration')]
    [cmdletbinding()]
    Param
    (
        ...
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CustomerProfiles.Integration.ObjectTypeMapping"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ObjectTypeNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ObjectTypeNames -Value @($ObjectTypeNames)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.Integration'
