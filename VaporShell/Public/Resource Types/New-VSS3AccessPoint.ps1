function New-VSS3AccessPoint {
    ...
    .PARAMETER Tags
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3-accesspoint.html#cfn-s3-accesspoint-tags
        UpdateType: Mutable
        Type: List
        ItemType: Tag
    ...
    [OutputType('Vaporshell.Resource.S3.AccessPoint')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.AccessPoint'
