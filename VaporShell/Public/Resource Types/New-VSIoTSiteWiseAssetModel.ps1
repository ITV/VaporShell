function New-VSIoTSiteWiseAssetModel {
    ...
    .PARAMETER EnforcedAssetModelInterfaceRelationships
        ...
        UpdateType: Mutable
        Type: List
        ItemType: EnforcedAssetModelInterfaceRelationship
        DuplicatesAllowed: True
    ...
    [OutputType('Vaporshell.Resource.IoTSiteWise.AssetModel')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTSiteWise.AssetModel.EnforcedAssetModelInterfaceRelationship"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'AssetModelCompositeModels' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AssetModelCompositeModels -Value @($AssetModelCompositeModels)
                }
                'EnforcedAssetModelInterfaceRelationships' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EnforcedAssetModelInterfaceRelationships -Value @($EnforcedAssetModelInterfaceRelationships)
                }
                'AssetModelHierarchies' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.AssetModel'
