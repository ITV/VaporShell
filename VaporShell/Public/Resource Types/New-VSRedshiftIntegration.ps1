function New-VSRedshiftIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::Redshift::Integration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Redshift.Integration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Redshift.Integration'
