function New-VSKinesisAnalyticsV2ApplicationCloudWatchLoggingOption {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOption')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisAnalyticsV2.ApplicationCloudWatchLoggingOption'
