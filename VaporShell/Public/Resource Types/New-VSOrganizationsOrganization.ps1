function New-VSOrganizationsOrganization {
    <#
    .SYNOPSIS
        Adds an AWS::Organizations::Organization resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Organizations.Organization')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Organizations.Organization'
