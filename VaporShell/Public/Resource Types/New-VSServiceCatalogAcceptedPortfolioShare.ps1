function New-VSServiceCatalogAcceptedPortfolioShare {
    ...
    [OutputType('Vaporshell.Resource.ServiceCatalog.AcceptedPortfolioShare')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalog.AcceptedPortfolioShare'
