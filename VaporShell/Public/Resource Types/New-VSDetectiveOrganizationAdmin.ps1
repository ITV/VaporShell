function New-VSDetectiveOrganizationAdmin {
    <#
    .SYNOPSIS
        Adds an AWS::Detective::OrganizationAdmin resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Detective.OrganizationAdmin')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Detective.OrganizationAdmin'
