function New-VSAppIntegrationsDataIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::AppIntegrations::DataIntegration resource to the template. Creates and persists a DataIntegration resource.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppIntegrations.DataIntegration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppIntegrations.DataIntegration'
