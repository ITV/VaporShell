function New-VSResourceExplorer2View {
    <#
    .SYNOPSIS
        Adds an AWS::ResourceExplorer2::View resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ResourceExplorer2.View')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ResourceExplorer2.View.IncludedProperty"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                IncludedProperties {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name IncludedProperties -Value @($IncludedProperties)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ResourceExplorer2.View'
