function New-VSBedrockKnowledgeBase {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.KnowledgeBase')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase'
