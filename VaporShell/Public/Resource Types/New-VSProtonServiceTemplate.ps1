function New-VSProtonServiceTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::Proton::ServiceTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Proton.ServiceTemplate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Proton.ServiceTemplate'
