function New-VSConnectUserHierarchyStructure {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::UserHierarchyStructure resource to the template. 
    ...
    .PARAMETER UserHierarchyStructure
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Connect.UserHierarchyStructure')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.UserHierarchyStructure'
