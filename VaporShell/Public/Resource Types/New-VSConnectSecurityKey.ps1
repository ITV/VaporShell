function New-VSConnectSecurityKey {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::SecurityKey resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.SecurityKey')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.SecurityKey'
