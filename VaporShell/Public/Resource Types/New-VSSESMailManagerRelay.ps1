function New-VSSESMailManagerRelay {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerRelay resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerRelay')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerRelay'
