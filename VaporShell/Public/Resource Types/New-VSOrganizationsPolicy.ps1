function New-VSOrganizationsPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::Organizations::Policy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Organizations.Policy')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TargetIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TargetIds -Value @($TargetIds)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Organizations.Policy'
