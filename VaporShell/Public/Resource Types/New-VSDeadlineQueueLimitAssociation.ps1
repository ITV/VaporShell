function New-VSDeadlineQueueLimitAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::QueueLimitAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.QueueLimitAssociation')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.QueueLimitAssociation'
