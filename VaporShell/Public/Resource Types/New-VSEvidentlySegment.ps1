function New-VSEvidentlySegment {
    <#
    .SYNOPSIS
        Adds an AWS::Evidently::Segment resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Evidently.Segment')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Evidently.Segment'
