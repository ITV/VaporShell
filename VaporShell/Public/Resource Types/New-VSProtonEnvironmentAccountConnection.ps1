function New-VSProtonEnvironmentAccountConnection {
    <#
    .SYNOPSIS
        Adds an AWS::Proton::EnvironmentAccountConnection resource to the template. 
    ...
    .PARAMETER EnvironmentAccountId
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Proton.EnvironmentAccountConnection')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Proton.EnvironmentAccountConnection'
