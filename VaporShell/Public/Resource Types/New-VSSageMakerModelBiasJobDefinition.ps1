function New-VSSageMakerModelBiasJobDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelBiasJobDefinition resource to the template. Creates the definition for a model bias job.
    ...
    .PARAMETER ModelBiasJobOutputConfig
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.ModelBiasJobDefinition')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelBiasJobDefinition'
