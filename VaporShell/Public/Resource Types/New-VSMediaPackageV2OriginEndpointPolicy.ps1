function New-VSMediaPackageV2OriginEndpointPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackageV2::OriginEndpointPolicy resource to the template.
    ...
    .PARAMETER CdnAuthConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediapackagev2-originendpointpolicy.html#cfn-mediapackagev2-originendpointpolicy-cdnauthconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.MediaPackageV2.OriginEndpointPolicy')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaPackageV2.OriginEndpointPolicy'
