function New-VSMacieFindingsFilter {
    <#
    .SYNOPSIS
    ...
    [OutputType('Vaporshell.Resource.Macie.FindingsFilter')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Macie.FindingsFilter'
