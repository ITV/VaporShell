function New-VSNetworkFirewallRuleGroup {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::RuleGroup resource to the template.
    ...
    .PARAMETER SummaryConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-rulegroup.html#cfn-networkfirewall-rulegroup-summaryconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.NetworkFirewall.RuleGroup')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.RuleGroup'
