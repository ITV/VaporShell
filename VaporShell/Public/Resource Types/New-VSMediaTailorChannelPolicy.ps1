function New-VSMediaTailorChannelPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::ChannelPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaTailor.ChannelPolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.ChannelPolicy'
