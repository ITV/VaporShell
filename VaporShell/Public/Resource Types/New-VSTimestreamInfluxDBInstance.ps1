function New-VSTimestreamInfluxDBInstance {
    <#
    .SYNOPSIS
        Adds an AWS::Timestream::InfluxDBInstance resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Timestream.InfluxDBInstance')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Timestream.InfluxDBInstance'
