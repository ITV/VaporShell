function New-VSIoTFleetWiseFleet {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Fleet resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.Fleet')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Fleet'
