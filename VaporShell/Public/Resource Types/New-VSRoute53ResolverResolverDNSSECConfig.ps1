function New-VSRoute53ResolverResolverDNSSECConfig {
    ...
    [OutputType('Vaporshell.Resource.Route53Resolver.ResolverDNSSECConfig')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Resolver.ResolverDNSSECConfig'
