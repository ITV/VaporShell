function New-VSConnectViewVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::ViewVersion resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Connect.ViewVersion')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.ViewVersion'
