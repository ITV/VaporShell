function New-VSSecurityHubStandard {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::Standard resource to the template. 
    ...
    .PARAMETER DisabledStandardsControls
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.Standard')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SecurityHub.Standard.StandardsControl"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                DisabledStandardsControls {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DisabledStandardsControls -Value @($DisabledStandardsControls)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.Standard'
