function New-VSSSOInstance {
    <#
    .SYNOPSIS
        Adds an AWS::SSO::Instance resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSO.Instance')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSO.Instance'
