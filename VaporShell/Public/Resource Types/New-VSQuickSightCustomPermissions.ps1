function New-VSQuickSightCustomPermissions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::CustomPermissions resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.CustomPermissions')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.CustomPermissions'
