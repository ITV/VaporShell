function New-VSSecurityHubConfigurationPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::ConfigurationPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.ConfigurationPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.ConfigurationPolicy'
