function New-VSIoTFleetWiseDecoderManifest {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::DecoderManifest resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.DecoderManifest')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTFleetWise.DecoderManifest.SignalDecodersItems"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTFleetWise.DecoderManifest.NetworkInterfacesItems"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                SignalDecoders {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SignalDecoders -Value @($SignalDecoders)
                }
                NetworkInterfaces {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.DecoderManifest'
