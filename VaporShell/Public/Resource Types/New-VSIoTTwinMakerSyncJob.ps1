function New-VSIoTTwinMakerSyncJob {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::SyncJob resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTTwinMaker.SyncJob')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.SyncJob'
