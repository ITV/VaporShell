function New-VSConnectContactFlowModule {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::ContactFlowModule resource to the template. The AWS::Connect::ContactFlowModule resource specifies a contact flow module for the specified Amazon Connect instance.
