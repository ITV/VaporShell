function New-VSSSMContactsPlan {
    <#
    .SYNOPSIS
        Adds an AWS::SSMContacts::Plan resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSMContacts.Plan')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SSMContacts.Plan.Stage"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RotationIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RotationIds -Value @($RotationIds)
                }
                Stages {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSMContacts.Plan'
