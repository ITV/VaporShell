function New-VSMemoryDBParameterGroup {
    <#
    .SYNOPSIS
        Adds an AWS::MemoryDB::ParameterGroup resource to the template. Specifies a new MemoryDB parameter group. A parameter group is a collection of parameters and their values that are applied to all of the nodes in any cluster. For more information, see Configuring engine parameters using parameter groups: https://docs.aws.amazon.com/memorydb/latest/devguide/parametergroups.html.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MemoryDB.ParameterGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MemoryDB.ParameterGroup'
