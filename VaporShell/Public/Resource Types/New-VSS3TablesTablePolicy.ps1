function New-VSS3TablesTablePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::S3Tables::TablePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Tables.TablePolicy')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Tables.TablePolicy'
