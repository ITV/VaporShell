function New-VSFMSPolicy {
    ...
    .PARAMETER ResourceTagLogicalOperator
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ResourceSetIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ResourceSetIds -Value @($ResourceSetIds)
                }
                ResourceTypeList {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
