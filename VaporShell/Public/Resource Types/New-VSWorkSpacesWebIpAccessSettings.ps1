function New-VSWorkSpacesWebIpAccessSettings {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::IpAccessSettings resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.IpAccessSettings')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.WorkSpacesWeb.IpAccessSettings.IpRule"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                IpRules {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name IpRules -Value @($IpRules)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.IpAccessSettings'
