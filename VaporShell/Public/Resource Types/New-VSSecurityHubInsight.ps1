function New-VSSecurityHubInsight {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::Insight resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.Insight')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.Insight'
