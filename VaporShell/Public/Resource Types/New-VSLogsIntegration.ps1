function New-VSLogsIntegration {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Integration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Logs.Integration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Integration'
