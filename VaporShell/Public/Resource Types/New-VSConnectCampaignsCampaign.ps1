function New-VSConnectCampaignsCampaign {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaigns::Campaign resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ConnectCampaigns.Campaign')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaigns.Campaign'
