function New-VSEMRServerlessApplication {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EMRServerless.Application')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EMRServerless.Application.WorkerTypeSpecificationInput"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                InitialCapacity {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name InitialCapacity -Value @($InitialCapacity)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application'
