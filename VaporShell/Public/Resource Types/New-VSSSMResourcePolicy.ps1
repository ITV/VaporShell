function New-VSSSMResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::SSM::ResourcePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SSM.ResourcePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSM.ResourcePolicy'
