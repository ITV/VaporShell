function New-VSMediaTailorPlaybackConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::PlaybackConfiguration resource to the template.
    ...
    .PARAMETER AdDecisionServerConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-mediatailor-playbackconfiguration.html#cfn-mediatailor-playbackconfiguration-addecisionserverconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.MediaTailor.PlaybackConfiguration')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.PlaybackConfiguration'
