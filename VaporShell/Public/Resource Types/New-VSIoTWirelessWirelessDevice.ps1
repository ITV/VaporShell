function New-VSIoTWirelessWirelessDevice {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::WirelessDevice resource to the template. Provisions a wireless device.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.WirelessDevice')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.WirelessDevice'
