function New-VSMediaLiveInput {
    ...
    .PARAMETER InputNetworkLocation
    ...
    .PARAMETER RouterSettings
        Type: RouterSettings
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-medialive-input.html#cfn-medialive-input-routersettings
        UpdateType: Immutable
    ...
    .PARAMETER Smpte2110ReceiverGroupSettings
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Input')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.Input.InputDestinationRequest"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaLive.Input.MediaConnectFlowRequest"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'MediaConnectFlows' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name MediaConnectFlows -Value @($MediaConnectFlows)
                }
                'Sources' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'SdiSources' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SdiSources -Value @($SdiSources)
                }
                'InputSecurityGroups' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Input'
