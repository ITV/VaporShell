function New-VSAccessAnalyzerAnalyzer {
    ...
    [OutputType('Vaporshell.Resource.AccessAnalyzer.Analyzer')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AccessAnalyzer.Analyzer.ArchiveRule"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ArchiveRules {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ArchiveRules -Value @($ArchiveRules)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AccessAnalyzer.Analyzer'
