function New-VSBatchJobDefinition {
    ...
    .PARAMETER ResourceRetentionPolicy
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-batch-jobdefinition.html#cfn-batch-jobdefinition-resourceretentionpolicy
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.Batch.JobDefinition')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition'
