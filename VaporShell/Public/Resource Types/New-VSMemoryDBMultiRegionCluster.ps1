function New-VSMemoryDBMultiRegionCluster {
    <#
    .SYNOPSIS
        Adds an AWS::MemoryDB::MultiRegionCluster resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MemoryDB.MultiRegionCluster')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MemoryDB.MultiRegionCluster'
