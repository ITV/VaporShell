function New-VSPCSComputeNodeGroup {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::ComputeNodeGroup resource to the template.
    ...
    .PARAMETER CustomLaunchTemplate
    ...
    [OutputType('Vaporshell.Resource.PCS.ComputeNodeGroup')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.PCS.ComputeNodeGroup.InstanceConfig"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                InstanceConfigs {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name InstanceConfigs -Value @($InstanceConfigs)
                }
                SubnetIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.ComputeNodeGroup'
