function New-VSEC2VerifiedAccessTrustProvider {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessTrustProvider resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.VerifiedAccessTrustProvider')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessTrustProvider'
