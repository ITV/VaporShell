function New-VSSupportAppSlackWorkspaceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::SupportApp::SlackWorkspaceConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SupportApp.SlackWorkspaceConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SupportApp.SlackWorkspaceConfiguration'
