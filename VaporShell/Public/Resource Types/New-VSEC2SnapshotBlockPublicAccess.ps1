function New-VSEC2SnapshotBlockPublicAccess {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::SnapshotBlockPublicAccess resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.SnapshotBlockPublicAccess')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.SnapshotBlockPublicAccess'
