function New-VSVoiceIDDomain {
    <#
    .SYNOPSIS
        Adds an AWS::VoiceID::Domain resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VoiceID.Domain')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VoiceID.Domain'
