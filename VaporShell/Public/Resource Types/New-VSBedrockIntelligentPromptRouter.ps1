function New-VSBedrockIntelligentPromptRouter {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::IntelligentPromptRouter resource to the template.
    ...
    .PARAMETER Models
        ...
        UpdateType: Immutable
        Type: List
        ItemType: PromptRouterTargetModel
    ...
    [OutputType('Vaporshell.Resource.Bedrock.IntelligentPromptRouter')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Bedrock.IntelligentPromptRouter.PromptRouterTargetModel"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Models' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Models -Value @($Models)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.IntelligentPromptRouter'
