function New-VSPCSCluster {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster resource to the template.
    ...
    [OutputType('Vaporshell.Resource.PCS.Cluster')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster'
