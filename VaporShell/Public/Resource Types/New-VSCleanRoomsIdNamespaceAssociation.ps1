function New-VSCleanRoomsIdNamespaceAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::IdNamespaceAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CleanRooms.IdNamespaceAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.IdNamespaceAssociation'
