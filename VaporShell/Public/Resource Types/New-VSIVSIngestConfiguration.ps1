function New-VSIVSIngestConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::IngestConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVS.IngestConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.IngestConfiguration'
