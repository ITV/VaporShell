function New-VSLogsLogAnomalyDetector {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::LogAnomalyDetector resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Logs.LogAnomalyDetector')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LogGroupArnList {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LogGroupArnList -Value @($LogGroupArnList)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.LogAnomalyDetector'
