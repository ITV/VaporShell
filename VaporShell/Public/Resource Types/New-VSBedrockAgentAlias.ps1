function New-VSBedrockAgentAlias {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::AgentAlias resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.AgentAlias')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Bedrock.AgentAlias.AgentAliasRoutingConfigurationListItem"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.AgentAlias'
