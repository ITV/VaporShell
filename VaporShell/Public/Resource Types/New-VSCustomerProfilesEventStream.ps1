function New-VSCustomerProfilesEventStream {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::EventStream resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.EventStream')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.EventStream'
