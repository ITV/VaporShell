function New-VSInspectorV2CisScanConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::InspectorV2::CisScanConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.InspectorV2.CisScanConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.InspectorV2.CisScanConfiguration'
