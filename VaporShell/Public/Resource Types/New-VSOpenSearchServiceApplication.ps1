function New-VSOpenSearchServiceApplication {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Application resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchService.Application')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.OpenSearchService.Application.DataSource"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.OpenSearchService.Application.AppConfig"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                AppConfigs {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AppConfigs -Value @($AppConfigs)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Application'
