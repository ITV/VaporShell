function New-VSPCAConnectorADConnector {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::Connector resource to the template.
    ...
    [OutputType('Vaporshell.Resource.PCAConnectorAD.Connector')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.Connector'
