function New-VSSecurityHubDelegatedAdmin {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::DelegatedAdmin resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.DelegatedAdmin')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.DelegatedAdmin'
