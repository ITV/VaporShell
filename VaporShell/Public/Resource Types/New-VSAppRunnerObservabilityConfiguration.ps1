function New-VSAppRunnerObservabilityConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::AppRunner::ObservabilityConfiguration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppRunner.ObservabilityConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppRunner.ObservabilityConfiguration'
