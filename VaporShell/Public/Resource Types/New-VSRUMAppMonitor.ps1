function New-VSRUMAppMonitor {
    <#
    .SYNOPSIS
        Adds an AWS::RUM::AppMonitor resource to the template.
    ...
    .PARAMETER Platform
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rum-appmonitor.html#cfn-rum-appmonitor-platform
    ...
    [OutputType('Vaporshell.Resource.RUM.AppMonitor')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'DomainList' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DomainList -Value @($DomainList)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RUM.AppMonitor'
