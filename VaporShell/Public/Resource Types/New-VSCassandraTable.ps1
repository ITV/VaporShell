function New-VSCassandraTable {
    ...
    .PARAMETER WarmThroughput
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cassandra-table.html#cfn-cassandra-table-warmthroughput
        UpdateType: Mutable
        Type: WarmThroughput
    ...
    .PARAMETER AutoScalingSpecifications
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Cassandra.Table.ReplicaSpecification"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ReplicaSpecifications' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ReplicaSpecifications -Value @($ReplicaSpecifications)
                }
                'ClusteringKeyColumns' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
