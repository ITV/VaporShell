function New-VSPinpointEmailChannel {
    ...
    .PARAMETER OrchestrationSendingRoleArn
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Pinpoint.EmailChannel')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pinpoint.EmailChannel'
