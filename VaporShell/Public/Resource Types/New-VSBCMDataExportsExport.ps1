function New-VSBCMDataExportsExport {
    <#
    .SYNOPSIS
        Adds an AWS::BCMDataExports::Export resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.BCMDataExports.Export')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.BCMDataExports.Export.ResourceTag"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BCMDataExports.Export'
