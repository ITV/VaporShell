function New-VSApiGatewayV2RoutingRule {
    <#
    .SYNOPSIS
        Adds an AWS::ApiGatewayV2::RoutingRule resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ApiGatewayV2.RoutingRule')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ApiGatewayV2.RoutingRule.Action"
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ApiGatewayV2.RoutingRule.Condition"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGatewayV2.RoutingRule'
