function New-VSIdentityStoreGroupMembership {
    <#
    .SYNOPSIS
        Adds an AWS::IdentityStore::GroupMembership resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IdentityStore.GroupMembership')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IdentityStore.GroupMembership'
