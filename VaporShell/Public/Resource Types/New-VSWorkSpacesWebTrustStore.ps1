function New-VSWorkSpacesWebTrustStore {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::TrustStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.TrustStore')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                CertificateList {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CertificateList -Value @($CertificateList)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.TrustStore'
