function New-VSOpenSearchServerlessIndex {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::Index resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.Index')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.Index'
