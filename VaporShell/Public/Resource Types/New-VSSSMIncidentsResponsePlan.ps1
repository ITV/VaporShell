function New-VSSSMIncidentsResponsePlan {
    <#
    .SYNOPSIS
        Adds an AWS::SSMIncidents::ResponsePlan resource to the template. The AWS::SSMIncidents::ResponsePlan resource specifies the details of the response plan that are used when creating an incident.
