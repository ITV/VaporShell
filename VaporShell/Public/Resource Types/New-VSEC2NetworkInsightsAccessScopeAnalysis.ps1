function New-VSEC2NetworkInsightsAccessScopeAnalysis {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::NetworkInsightsAccessScopeAnalysis resource to the template. Describes a Network Access Scope analysis.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.NetworkInsightsAccessScopeAnalysis')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.NetworkInsightsAccessScopeAnalysis'
