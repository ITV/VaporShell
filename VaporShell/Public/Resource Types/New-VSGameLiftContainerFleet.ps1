function New-VSGameLiftContainerFleet {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerFleet resource to the template.
    ...
    .PARAMETER GameServerContainerGroupDefinitionName
    ...
    .PARAMETER PerInstanceContainerGroupDefinitionName
    ...
    .PARAMETER GameSessionCreationLimitPolicy
    ...
    .PARAMETER GameServerContainerGroupsPerInstance
    ...
    .PARAMETER InstanceConnectionPortRange
    ...
    .PARAMETER InstanceInboundPermissions
    ...
    [OutputType('Vaporshell.Resource.GameLift.ContainerFleet')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GameLift.ContainerFleet.ScalingPolicy"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GameLift.ContainerFleet.LocationConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GameLift.ContainerFleet.IpPermission"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ScalingPolicies {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ScalingPolicies -Value @($ScalingPolicies)
                }
                Locations {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Locations -Value @($Locations)
                }
                MetricGroups {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                InstanceInboundPermissions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name InstanceInboundPermissions -Value @($InstanceInboundPermissions)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerFleet'
