function New-VSRolesAnywhereProfile {
    <#
    .SYNOPSIS
        Adds an AWS::RolesAnywhere::Profile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RolesAnywhere.Profile')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.RolesAnywhere.Profile.AttributeMapping"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RoleArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RoleArns -Value @($RoleArns)
                }
                AttributeMappings {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AttributeMappings -Value @($AttributeMappings)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RolesAnywhere.Profile'
