function New-VSEC2VerifiedAccessGroup {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.VerifiedAccessGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessGroup'
