function New-VSIoTCertificateProvider {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::CertificateProvider resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoT.CertificateProvider')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                AccountDefaultForOperations {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AccountDefaultForOperations -Value @($AccountDefaultForOperations)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.CertificateProvider'
