function New-VSSESConfigurationSet {
    ...
    .PARAMETER Tags
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-configurationset.html#cfn-ses-configurationset-tags
        UpdateType: Mutable
        Type: List
        ItemType: Tag
    ...
    [OutputType('Vaporshell.Resource.SES.ConfigurationSet')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.ConfigurationSet'
