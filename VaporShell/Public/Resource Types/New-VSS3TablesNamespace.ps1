function New-VSS3TablesNamespace {
    <#
    .SYNOPSIS
        Adds an AWS::S3Tables::Namespace resource to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Tables.Namespace')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Tables.Namespace'
