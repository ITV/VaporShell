function New-VSNetworkManagerCoreNetwork {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::CoreNetwork resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.NetworkManager.CoreNetwork')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.CoreNetwork'
