function New-VSWisdomAIGuardrail {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIGuardrail resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIGuardrail')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIGuardrail'
