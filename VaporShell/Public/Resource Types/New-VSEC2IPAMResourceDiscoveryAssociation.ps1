function New-VSEC2IPAMResourceDiscoveryAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::IPAMResourceDiscoveryAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.IPAMResourceDiscoveryAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.IPAMResourceDiscoveryAssociation'
