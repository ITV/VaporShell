function New-VSLogsDelivery {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Delivery resource to the template.
    ...
    .PARAMETER S3EnableHiveCompatiblePath
    ...
    [OutputType('Vaporshell.Resource.Logs.Delivery')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RecordFields {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RecordFields -Value @($RecordFields)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Delivery'
