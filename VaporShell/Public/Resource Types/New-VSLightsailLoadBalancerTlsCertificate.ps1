function New-VSLightsailLoadBalancerTlsCertificate {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Lightsail.LoadBalancerTlsCertificate')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                CertificateAlternativeNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CertificateAlternativeNames -Value @($CertificateAlternativeNames)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.LoadBalancerTlsCertificate'
