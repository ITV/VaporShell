function New-VSBatchConsumableResource {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::ConsumableResource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Batch.ConsumableResource')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.ConsumableResource'
