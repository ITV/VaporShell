function New-VSGlueCustomEntityType {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::CustomEntityType resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Glue.CustomEntityType')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ContextWords {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ContextWords -Value @($ContextWords)
                }
                Tags {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.CustomEntityType'
