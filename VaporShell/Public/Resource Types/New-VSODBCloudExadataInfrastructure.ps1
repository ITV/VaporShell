function New-VSODBCloudExadataInfrastructure {
    <#
    .SYNOPSIS
        Adds an AWS::ODB::CloudExadataInfrastructure resource to the template.
    ...
    .PARAMETER MaintenanceWindow
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-odb-cloudexadatainfrastructure.html#cfn-odb-cloudexadatainfrastructure-maintenancewindow
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.ODB.CloudExadataInfrastructure')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ODB.CloudExadataInfrastructure.CustomerContact"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'CustomerContactsToSendToOCI' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CustomerContactsToSendToOCI -Value @($CustomerContactsToSendToOCI)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ODB.CloudExadataInfrastructure'
