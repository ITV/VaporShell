function New-VSSimSpaceWeaverSimulation {
    <#
    .SYNOPSIS
        Adds an AWS::SimSpaceWeaver::Simulation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SimSpaceWeaver.Simulation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SimSpaceWeaver.Simulation'
