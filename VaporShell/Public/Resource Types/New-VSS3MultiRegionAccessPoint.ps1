function New-VSS3MultiRegionAccessPoint {
    ...
    [OutputType('Vaporshell.Resource.S3.MultiRegionAccessPoint')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.S3.MultiRegionAccessPoint.Region"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.MultiRegionAccessPoint'
