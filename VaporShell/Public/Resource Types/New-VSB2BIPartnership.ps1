function New-VSB2BIPartnership {
    <#
    .SYNOPSIS
        Adds an AWS::B2BI::Partnership resource to the template.
    ...
    [OutputType('Vaporshell.Resource.B2BI.Partnership')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.B2BI.Partnership'
