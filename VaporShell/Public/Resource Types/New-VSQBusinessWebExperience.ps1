function New-VSQBusinessWebExperience {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::WebExperience resource to the template.
    ...
    [OutputType('Vaporshell.Resource.QBusiness.WebExperience')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.WebExperience'
