function New-VSSESMailManagerTrafficPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerTrafficPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerTrafficPolicy')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SES.MailManagerTrafficPolicy.PolicyStatement"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                PolicyStatements {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PolicyStatements -Value @($PolicyStatements)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerTrafficPolicy'
