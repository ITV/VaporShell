function New-VSS3AccessGrantsInstance {
    <#
    .SYNOPSIS
        Adds an AWS::S3::AccessGrantsInstance resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.S3.AccessGrantsInstance')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.AccessGrantsInstance'
