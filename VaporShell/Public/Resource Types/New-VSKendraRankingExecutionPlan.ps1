function New-VSKendraRankingExecutionPlan {
    <#
    .SYNOPSIS
        Adds an AWS::KendraRanking::ExecutionPlan resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.KendraRanking.ExecutionPlan')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KendraRanking.ExecutionPlan'
