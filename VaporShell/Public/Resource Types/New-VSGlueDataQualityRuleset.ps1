function New-VSGlueDataQualityRuleset {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::DataQualityRuleset resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Glue.DataQualityRuleset')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.DataQualityRuleset'
