function New-VSConnectPredefinedAttribute {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::PredefinedAttribute resource to the template.
    ...
    .PARAMETER AttributeConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-predefinedattribute.html#cfn-connect-predefinedattribute-attributeconfiguration
        UpdateType: Mutable
    ...
    .PARAMETER Purposes
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-predefinedattribute.html#cfn-connect-predefinedattribute-purposes
        UpdateType: Mutable
        Type: List
    ...
    [OutputType('Vaporshell.Resource.Connect.PredefinedAttribute')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Purposes' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Purposes -Value @($Purposes)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.PredefinedAttribute'
