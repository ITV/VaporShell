function New-VSServiceCatalogServiceActionAssociation {
    ...
    [OutputType('Vaporshell.Resource.ServiceCatalog.ServiceActionAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalog.ServiceActionAssociation'
