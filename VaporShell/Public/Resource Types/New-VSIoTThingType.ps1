function New-VSIoTThingType {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::ThingType resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.ThingType')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.ThingType'
