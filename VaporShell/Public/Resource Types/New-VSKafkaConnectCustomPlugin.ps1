function New-VSKafkaConnectCustomPlugin {
    <#
    .SYNOPSIS
        Adds an AWS::KafkaConnect::CustomPlugin resource to the template.
    ...
    [OutputType('Vaporshell.Resource.KafkaConnect.CustomPlugin')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KafkaConnect.CustomPlugin'
