function New-VSACMPCACertificateAuthorityActivation {
    ...
    [OutputType('Vaporshell.Resource.ACMPCA.CertificateAuthorityActivation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ACMPCA.CertificateAuthorityActivation'
