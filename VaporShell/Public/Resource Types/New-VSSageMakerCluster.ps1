function New-VSSageMakerCluster {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Cluster resource to the template.
    ...
    .PARAMETER NodeProvisioningMode
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-cluster.html#cfn-sagemaker-cluster-nodeprovisioningmode
        UpdateType: Mutable
        PrimitiveType: String
    ...
    .PARAMETER RestrictedInstanceGroups
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-cluster.html#cfn-sagemaker-cluster-restrictedinstancegroups
        UpdateType: Mutable
        Type: List
        ItemType: ClusterRestrictedInstanceGroup
        DuplicatesAllowed: True
    ...
    .PARAMETER AutoScaling
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-cluster.html#cfn-sagemaker-cluster-autoscaling
        UpdateType: Mutable
        Type: ClusterAutoScalingConfig

    .PARAMETER ClusterRole
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-cluster.html#cfn-sagemaker-cluster-clusterrole
        UpdateType: Mutable
        PrimitiveType: String
    ...
    .PARAMETER TieredStorageConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-sagemaker-cluster.html#cfn-sagemaker-cluster-tieredstorageconfig
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.SageMaker.Cluster')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SageMaker.Cluster.ClusterInstanceGroup"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SageMaker.Cluster.ClusterRestrictedInstanceGroup"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'InstanceGroups' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name InstanceGroups -Value @($InstanceGroups)
                }
                'RestrictedInstanceGroups' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RestrictedInstanceGroups -Value @($RestrictedInstanceGroups)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Cluster'
