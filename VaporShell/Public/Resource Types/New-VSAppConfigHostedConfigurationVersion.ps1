function New-VSAppConfigHostedConfigurationVersion {
    ...
    [OutputType('Vaporshell.Resource.AppConfig.HostedConfigurationVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppConfig.HostedConfigurationVersion'
