function New-VSSecurityLakeDataLake {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::DataLake resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityLake.DataLake')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.DataLake'
