function New-VSIoTWirelessTaskDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::TaskDefinition resource to the template. Creates a gateway task definition.
    ...
    .PARAMETER LoRaWANUpdateGatewayTaskEntry
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.TaskDefinition')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.TaskDefinition'
