function New-VSIVSPlaybackRestrictionPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::PlaybackRestrictionPolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IVS.PlaybackRestrictionPolicy')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                AllowedOrigins {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AllowedOrigins -Value @($AllowedOrigins)
                }
                AllowedCountries {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AllowedCountries -Value @($AllowedCountries)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.PlaybackRestrictionPolicy'
