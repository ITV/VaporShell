function New-VSAppStreamApplicationEntitlementAssociation {
    ...
    [OutputType('Vaporshell.Resource.AppStream.ApplicationEntitlementAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppStream.ApplicationEntitlementAssociation'
