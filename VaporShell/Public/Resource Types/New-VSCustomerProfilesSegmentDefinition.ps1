function New-VSCustomerProfilesSegmentDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::SegmentDefinition resource to the template.
    ...
    .PARAMETER SegmentSqlQuery
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-customerprofiles-segmentdefinition.html#cfn-customerprofiles-segmentdefinition-segmentsqlquery
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.SegmentDefinition')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.SegmentDefinition'
