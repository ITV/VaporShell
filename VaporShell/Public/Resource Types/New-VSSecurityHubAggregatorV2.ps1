function New-VSSecurityHubAggregatorV2 {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AggregatorV2 resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AggregatorV2')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'LinkedRegions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LinkedRegions -Value @($LinkedRegions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AggregatorV2'
