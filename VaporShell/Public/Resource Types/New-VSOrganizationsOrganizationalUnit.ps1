function New-VSOrganizationsOrganizationalUnit {
    <#
    .SYNOPSIS
        Adds an AWS::Organizations::OrganizationalUnit resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Organizations.OrganizationalUnit')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Organizations.OrganizationalUnit'
