function New-VSRekognitionStreamProcessor {
    <#
    .SYNOPSIS
        Adds an AWS::Rekognition::StreamProcessor resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Rekognition.StreamProcessor')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                BoundingBoxRegionsOfInterest {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name BoundingBoxRegionsOfInterest -Value @($BoundingBoxRegionsOfInterest)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Rekognition.StreamProcessor'
