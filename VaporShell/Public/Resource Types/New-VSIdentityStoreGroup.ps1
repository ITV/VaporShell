function New-VSIdentityStoreGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IdentityStore::Group resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IdentityStore.Group')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IdentityStore.Group'
