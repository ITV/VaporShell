function New-VSWorkspacesInstancesWorkspaceInstance {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::WorkspaceInstance resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance'
