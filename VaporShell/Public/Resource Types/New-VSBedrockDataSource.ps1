function New-VSBedrockDataSource {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataSource resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.DataSource')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataSource'
