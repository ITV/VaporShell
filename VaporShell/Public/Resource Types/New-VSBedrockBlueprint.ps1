function New-VSBedrockBlueprint {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Blueprint resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Blueprint')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Blueprint'
