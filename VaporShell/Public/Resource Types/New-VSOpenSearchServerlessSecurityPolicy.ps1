function New-VSOpenSearchServerlessSecurityPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::SecurityPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.SecurityPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.SecurityPolicy'
