function New-VSCloudFrontMonitoringSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::MonitoringSubscription resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudFront.MonitoringSubscription')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.MonitoringSubscription'
