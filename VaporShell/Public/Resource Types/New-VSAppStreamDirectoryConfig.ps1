function New-VSAppStreamDirectoryConfig {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppStream.DirectoryConfig')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                OrganizationalUnitDistinguishedNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name OrganizationalUnitDistinguishedNames -Value @($OrganizationalUnitDistinguishedNames)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppStream.DirectoryConfig'
