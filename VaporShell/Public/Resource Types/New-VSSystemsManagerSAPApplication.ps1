function New-VSSystemsManagerSAPApplication {
    <#
    .SYNOPSIS
        Adds an AWS::SystemsManagerSAP::Application resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SystemsManagerSAP.Application')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SystemsManagerSAP.Application.Credential"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SystemsManagerSAP.Application.ComponentInfo"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Credentials' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Credentials -Value @($Credentials)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'ComponentsInfo' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ComponentsInfo -Value @($ComponentsInfo)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SystemsManagerSAP.Application'
