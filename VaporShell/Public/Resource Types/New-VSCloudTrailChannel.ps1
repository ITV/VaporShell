function New-VSCloudTrailChannel {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::Channel resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudTrail.Channel')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CloudTrail.Channel.Destination"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.Channel'
