function New-VSSecurityHubProductSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::ProductSubscription resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.ProductSubscription')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.ProductSubscription'
