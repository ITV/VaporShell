function New-VSMPAIdentitySource {
    <#
    .SYNOPSIS
        Adds an AWS::MPA::IdentitySource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MPA.IdentitySource')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MPA.IdentitySource'
