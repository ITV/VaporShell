function New-VSIVSEncoderConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IVS::EncoderConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVS.EncoderConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVS.EncoderConfiguration'
