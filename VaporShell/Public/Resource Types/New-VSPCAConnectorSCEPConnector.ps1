function New-VSPCAConnectorSCEPConnector {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorSCEP::Connector resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.PCAConnectorSCEP.Connector')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorSCEP.Connector'
