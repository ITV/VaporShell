function New-VSDMSDataMigration {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::DataMigration resource to the template.
    ...
    .PARAMETER DataMigrationSettings
    ...
    [OutputType('Vaporshell.Resource.DMS.DataMigration')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DMS.DataMigration.SourceDataSettings"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                SourceDataSettings {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SourceDataSettings -Value @($SourceDataSettings)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.DataMigration'
