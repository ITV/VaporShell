function New-VSMediaPackageV2Channel {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackageV2::Channel resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaPackageV2.Channel')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaPackageV2.Channel'
