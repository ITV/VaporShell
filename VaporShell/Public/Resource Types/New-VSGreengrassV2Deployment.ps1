function New-VSGreengrassV2Deployment {
    <#
    .SYNOPSIS
        Adds an AWS::GreengrassV2::Deployment resource to the template.
    ...
    [OutputType('Vaporshell.Resource.GreengrassV2.Deployment')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GreengrassV2.Deployment.ComponentDeploymentSpecification"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GreengrassV2.Deployment'
