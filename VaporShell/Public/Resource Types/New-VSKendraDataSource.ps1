function New-VSKendraDataSource {
    <#
    .SYNOPSIS
        Adds an AWS::Kendra::DataSource resource to the template. Specifies a data source that you use to with an Amazon Kendra index.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Kendra.DataSource')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kendra.DataSource'
