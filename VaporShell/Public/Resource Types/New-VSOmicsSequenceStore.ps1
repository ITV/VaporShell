function New-VSOmicsSequenceStore {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::SequenceStore resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Omics.SequenceStore')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'PropagatedSetLevelTags' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PropagatedSetLevelTags -Value @($PropagatedSetLevelTags)
                }
                'S3AccessPolicy' {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.SequenceStore'
