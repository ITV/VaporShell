function New-VSGuardDutyPublishingDestination {
    <#
    .SYNOPSIS
        Adds an AWS::GuardDuty::PublishingDestination resource to the template.
    ...
    [OutputType('Vaporshell.Resource.GuardDuty.PublishingDestination')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.GuardDuty.PublishingDestination.TagItem"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GuardDuty.PublishingDestination'
