function New-VSSESMailManagerAddonSubscription {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerAddonSubscription resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SES.MailManagerAddonSubscription')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerAddonSubscription'
