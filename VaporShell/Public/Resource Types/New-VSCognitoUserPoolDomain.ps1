function New-VSCognitoUserPoolDomain {
    ...
    [OutputType('Vaporshell.Resource.Cognito.UserPoolDomain')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.UserPoolDomain'
