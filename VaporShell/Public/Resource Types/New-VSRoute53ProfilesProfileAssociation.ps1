function New-VSRoute53ProfilesProfileAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Route53Profiles::ProfileAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53Profiles.ProfileAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Profiles.ProfileAssociation'
