function New-VSKinesisVideoStream {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisVideo::Stream resource to the template.
    ...
    .PARAMETER StreamStorageConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kinesisvideo-stream.html#cfn-kinesisvideo-stream-streamstorageconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.KinesisVideo.Stream')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisVideo.Stream'
