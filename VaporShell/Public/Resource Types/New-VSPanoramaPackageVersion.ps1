function New-VSPanoramaPackageVersion {
    <#
    .SYNOPSIS
        Adds an AWS::Panorama::PackageVersion resource to the template. Registers a package version.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Panorama.PackageVersion')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Panorama.PackageVersion'
