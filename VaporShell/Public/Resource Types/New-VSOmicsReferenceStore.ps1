function New-VSOmicsReferenceStore {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::ReferenceStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Omics.ReferenceStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.ReferenceStore'
