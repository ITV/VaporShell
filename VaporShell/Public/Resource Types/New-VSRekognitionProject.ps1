function New-VSRekognitionProject {
    ...
    .PARAMETER Tags
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rekognition-project.html#cfn-rekognition-project-tags
        UpdateType: Mutable
        Type: List
        ItemType: Tag
    ...
    [OutputType('Vaporshell.Resource.Rekognition.Project')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Rekognition.Project'
