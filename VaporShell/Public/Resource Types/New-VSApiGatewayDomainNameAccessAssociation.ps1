function New-VSApiGatewayDomainNameAccessAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::ApiGateway::DomainNameAccessAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ApiGateway.DomainNameAccessAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGateway.DomainNameAccessAssociation'
