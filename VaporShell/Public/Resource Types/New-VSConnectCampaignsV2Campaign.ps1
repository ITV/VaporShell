function New-VSConnectCampaignsV2Campaign {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign resource to the template.
    ...
    .PARAMETER CommunicationLimitsOverride
    ...
    .PARAMETER Type
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connectcampaignsv2-campaign.html#cfn-connectcampaignsv2-campaign-type
        UpdateType: Mutable
        PrimitiveType: String

    .PARAMETER ChannelSubtypeConfig
    ...
    .PARAMETER ConnectCampaignFlowArn
    ...
    .PARAMETER CommunicationTimeConfig
    ...
    [OutputType('Vaporshell.Resource.ConnectCampaignsV2.Campaign')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign'
