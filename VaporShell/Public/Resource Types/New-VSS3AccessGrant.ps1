function New-VSS3AccessGrant {
    <#
    .SYNOPSIS
        Adds an AWS::S3::AccessGrant resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.S3.AccessGrant')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.AccessGrant'
