function New-VSDeadlineLimit {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Limit resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.Limit')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Limit'
