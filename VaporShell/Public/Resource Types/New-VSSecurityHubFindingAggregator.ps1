function New-VSSecurityHubFindingAggregator {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::FindingAggregator resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.FindingAggregator')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.FindingAggregator'
