function New-VSEC2TransitGatewayMulticastDomain {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::TransitGatewayMulticastDomain resource to the template. Creates a multicast domain using the specified transit gateway.
...
+ StaticSourcesSupport enable | disable
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.TransitGatewayMulticastDomain')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.TransitGatewayMulticastDomain'
