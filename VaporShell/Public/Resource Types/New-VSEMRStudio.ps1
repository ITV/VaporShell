function New-VSEMRStudio {
    <#
    .SYNOPSIS
        Adds an AWS::EMR::Studio resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EMR.Studio')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMR.Studio'
