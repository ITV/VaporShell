function New-VSSageMakerInferenceComponent {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::InferenceComponent resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.InferenceComponent')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.InferenceComponent'
