function New-VSAppConfigExtensionAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::AppConfig::ExtensionAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppConfig.ExtensionAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppConfig.ExtensionAssociation'
