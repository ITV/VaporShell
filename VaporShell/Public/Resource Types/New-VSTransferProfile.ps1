function New-VSTransferProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::Profile resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Transfer.Profile')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                CertificateIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CertificateIds -Value @($CertificateIds)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.Profile'
