function New-VSNetworkManagerConnectPeer {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::ConnectPeer resource to the template.
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.ConnectPeer')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                InsideCidrBlocks {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name InsideCidrBlocks -Value @($InsideCidrBlocks)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.ConnectPeer'
