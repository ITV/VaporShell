function New-VSHealthLakeFHIRDatastore {
    <#
    .SYNOPSIS
        Adds an AWS::HealthLake::FHIRDatastore resource to the template. Creates a Data Store that can ingest and export FHIR formatted data.
...
For more information, see Tag: https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.HealthLake.FHIRDatastore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.HealthLake.FHIRDatastore'
