function New-VSDSQLCluster {
    <#
    .SYNOPSIS
        Adds an AWS::DSQL::Cluster resource to the template.
    ...
    .PARAMETER PolicyDocument
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dsql-cluster.html#cfn-dsql-cluster-policydocument
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.DSQL.Cluster')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DSQL.Cluster'
