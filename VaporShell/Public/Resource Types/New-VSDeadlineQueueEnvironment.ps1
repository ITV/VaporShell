function New-VSDeadlineQueueEnvironment {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::QueueEnvironment resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Deadline.QueueEnvironment')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.QueueEnvironment'
