function New-VSVerifiedPermissionsPolicyTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::PolicyTemplate resource to the template.
    ...
    [OutputType('Vaporshell.Resource.VerifiedPermissions.PolicyTemplate')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.PolicyTemplate'
