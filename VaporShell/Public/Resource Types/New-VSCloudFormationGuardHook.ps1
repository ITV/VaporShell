function New-VSCloudFormationGuardHook {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFormation::GuardHook resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFormation.GuardHook')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TargetOperations {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TargetOperations -Value @($TargetOperations)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFormation.GuardHook'
