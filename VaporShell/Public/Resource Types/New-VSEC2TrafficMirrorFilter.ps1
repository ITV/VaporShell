function New-VSEC2TrafficMirrorFilter {
    ...
    [OutputType('Vaporshell.Resource.EC2.TrafficMirrorFilter')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                NetworkServices {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name NetworkServices -Value @($NetworkServices)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.TrafficMirrorFilter'
