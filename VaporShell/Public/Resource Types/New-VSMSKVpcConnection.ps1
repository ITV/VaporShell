function New-VSMSKVpcConnection {
    <#
    .SYNOPSIS
        Adds an AWS::MSK::VpcConnection resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MSK.VpcConnection')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ClientSubnets {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ClientSubnets -Value @($ClientSubnets)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.VpcConnection'
