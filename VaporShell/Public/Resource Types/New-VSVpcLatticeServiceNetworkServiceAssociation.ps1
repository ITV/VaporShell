function New-VSVpcLatticeServiceNetworkServiceAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::ServiceNetworkServiceAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.VpcLattice.ServiceNetworkServiceAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.ServiceNetworkServiceAssociation'
