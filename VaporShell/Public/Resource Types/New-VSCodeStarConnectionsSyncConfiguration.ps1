function New-VSCodeStarConnectionsSyncConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::CodeStarConnections::SyncConfiguration resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CodeStarConnections.SyncConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeStarConnections.SyncConfiguration'
