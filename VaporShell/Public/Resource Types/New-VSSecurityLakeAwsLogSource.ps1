function New-VSSecurityLakeAwsLogSource {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::AwsLogSource resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityLake.AwsLogSource')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Accounts {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Accounts -Value @($Accounts)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.AwsLogSource'
