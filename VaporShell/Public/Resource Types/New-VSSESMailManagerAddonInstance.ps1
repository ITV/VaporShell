function New-VSSESMailManagerAddonInstance {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerAddonInstance resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerAddonInstance')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerAddonInstance'
