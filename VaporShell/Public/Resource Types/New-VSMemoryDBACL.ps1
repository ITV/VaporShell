function New-VSMemoryDBACL {
    ...
    [OutputType('Vaporshell.Resource.MemoryDB.ACL')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                UserNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name UserNames -Value @($UserNames)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MemoryDB.ACL'
