function New-VSIoTThingGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::ThingGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.ThingGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.ThingGroup'
