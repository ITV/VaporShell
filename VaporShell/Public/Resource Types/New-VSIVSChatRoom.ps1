function New-VSIVSChatRoom {
    <#
    .SYNOPSIS
        Adds an AWS::IVSChat::Room resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IVSChat.Room')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LoggingConfigurationIdentifiers {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LoggingConfigurationIdentifiers -Value @($LoggingConfigurationIdentifiers)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVSChat.Room'
