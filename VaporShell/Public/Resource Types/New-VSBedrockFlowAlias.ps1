function New-VSBedrockFlowAlias {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowAlias resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.FlowAlias')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Bedrock.FlowAlias.FlowAliasRoutingConfigurationListItem"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowAlias'
