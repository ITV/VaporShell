function New-VSConnectApprovedOrigin {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::ApprovedOrigin resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.ApprovedOrigin')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.ApprovedOrigin'
