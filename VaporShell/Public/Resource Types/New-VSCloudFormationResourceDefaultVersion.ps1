...
Conditional: You must specify either TypeVersionArn, or TypeName and VersionId.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudFormation.ResourceDefaultVersion')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFormation.ResourceDefaultVersion'
