function New-VSNetworkManagerConnectAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::ConnectAttachment resource to the template.
    ...
    .PARAMETER RoutingPolicyLabel
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-connectattachment.html#cfn-networkmanager-connectattachment-routingpolicylabel
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.ConnectAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.ConnectAttachment'
