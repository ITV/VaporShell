function New-VSAppSyncChannelNamespace {
    <#
    .SYNOPSIS
        Adds an AWS::AppSync::ChannelNamespace resource to the template.
    ...
    [OutputType('Vaporshell.Resource.AppSync.ChannelNamespace')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AppSync.ChannelNamespace.AuthMode"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                SubscribeAuthModes {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SubscribeAuthModes -Value @($SubscribeAuthModes)
                }
                PublishAuthModes {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name PublishAuthModes -Value @($PublishAuthModes)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppSync.ChannelNamespace'
