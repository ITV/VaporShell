function New-VSOpenSearchServerlessVpcEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::VpcEndpoint resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.VpcEndpoint')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.VpcEndpoint'
