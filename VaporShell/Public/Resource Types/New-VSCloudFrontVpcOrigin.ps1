function New-VSCloudFrontVpcOrigin {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::VpcOrigin resource to the template.
    ...
    .PARAMETER VpcOriginEndpointConfig
    ...
    [OutputType('Vaporshell.Resource.CloudFront.VpcOrigin')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.VpcOrigin'
