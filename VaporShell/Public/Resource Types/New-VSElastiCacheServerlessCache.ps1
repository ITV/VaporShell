function New-VSElastiCacheServerlessCache {
    <#
    .SYNOPSIS
        Adds an AWS::ElastiCache::ServerlessCache resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ElastiCache.ServerlessCache')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                SnapshotArnsToRestore {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SnapshotArnsToRestore -Value @($SnapshotArnsToRestore)
                }
                SubnetIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElastiCache.ServerlessCache'
