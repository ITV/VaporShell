function New-VSPaymentCryptographyKey {
    <#
    .SYNOPSIS
        Adds an AWS::PaymentCryptography::Key resource to the template.
    ...
    .PARAMETER ReplicationRegions
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-paymentcryptography-key.html#cfn-paymentcryptography-key-replicationregions
        UpdateType: Mutable
        Type: List
    ...
    [OutputType('Vaporshell.Resource.PaymentCryptography.Key')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ReplicationRegions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ReplicationRegions -Value @($ReplicationRegions)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PaymentCryptography.Key'
