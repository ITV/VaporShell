function New-VSPaymentCryptographyAlias {
    <#
    .SYNOPSIS
        Adds an AWS::PaymentCryptography::Alias resource to the template.
    ...
    [OutputType('Vaporshell.Resource.PaymentCryptography.Alias')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PaymentCryptography.Alias'
