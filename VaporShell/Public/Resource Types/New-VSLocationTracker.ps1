function New-VSLocationTracker {
    <#
    .SYNOPSIS
        Adds an AWS::Location::Tracker resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Location.Tracker')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Location.Tracker'
