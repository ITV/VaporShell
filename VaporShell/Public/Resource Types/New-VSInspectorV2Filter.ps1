function New-VSInspectorV2Filter {
    <#
    .SYNOPSIS
        Adds an AWS::InspectorV2::Filter resource to the template. Details about a filter.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.InspectorV2.Filter')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.InspectorV2.Filter'
