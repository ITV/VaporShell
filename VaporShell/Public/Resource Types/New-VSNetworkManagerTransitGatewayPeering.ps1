function New-VSNetworkManagerTransitGatewayPeering {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::TransitGatewayPeering resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.NetworkManager.TransitGatewayPeering')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.TransitGatewayPeering'
