function New-VSRedshiftServerlessWorkgroup {
    <#
    .SYNOPSIS
        Adds an AWS::RedshiftServerless::Workgroup resource to the template. The collection of compute resources in Amazon Redshift Serverless.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.RedshiftServerless.Workgroup')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ConfigParameters {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ConfigParameters -Value @($ConfigParameters)
                }
                SecurityGroupIds {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RedshiftServerless.Workgroup'
