function New-VSNetworkManagerTransitGatewayRouteTableAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::TransitGatewayRouteTableAttachment resource to the template.
    ...
    .PARAMETER RoutingPolicyLabel
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-transitgatewayroutetableattachment.html#cfn-networkmanager-transitgatewayroutetableattachment-routingpolicylabel
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.TransitGatewayRouteTableAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.TransitGatewayRouteTableAttachment'
