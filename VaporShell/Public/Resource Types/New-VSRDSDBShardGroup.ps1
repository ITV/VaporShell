function New-VSRDSDBShardGroup {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::DBShardGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RDS.DBShardGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.DBShardGroup'
