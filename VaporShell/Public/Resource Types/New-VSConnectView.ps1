function New-VSConnectView {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::View resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.View')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.View'
