function New-VSEMRWALWorkspace {
    <#
    .SYNOPSIS
        Adds an AWS::EMR::WALWorkspace resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EMR.WALWorkspace')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMR.WALWorkspace'
