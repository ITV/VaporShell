function New-VSIoTTwinMakerScene {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::Scene resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTTwinMaker.Scene')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.Scene'
