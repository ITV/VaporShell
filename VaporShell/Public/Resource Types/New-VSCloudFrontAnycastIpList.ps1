function New-VSCloudFrontAnycastIpList {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::AnycastIpList resource to the template.
    ...
    .PARAMETER IpAddressType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-anycastiplist.html#cfn-cloudfront-anycastiplist-ipaddresstype
        UpdateType: Mutable
    ...
    .PARAMETER IpamCidrConfigs
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudfront-anycastiplist.html#cfn-cloudfront-anycastiplist-ipamcidrconfigs
        UpdateType: Mutable
        Type: List
        ItemType: IpamCidrConfig
    ...
    [OutputType('Vaporshell.Resource.CloudFront.AnycastIpList')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CloudFront.AnycastIpList.IpamCidrConfig"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'IpamCidrConfigs' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name IpamCidrConfigs -Value @($IpamCidrConfigs)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.AnycastIpList'
