function New-VSForecastDatasetGroup {
    ...
    [OutputType('Vaporshell.Resource.Forecast.DatasetGroup')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                DatasetArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DatasetArns -Value @($DatasetArns)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Forecast.DatasetGroup'
