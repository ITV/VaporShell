function New-VSDataZoneEnvironmentActions {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::EnvironmentActions resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.EnvironmentActions')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.EnvironmentActions'
