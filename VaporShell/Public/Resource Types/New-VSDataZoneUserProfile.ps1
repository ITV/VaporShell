function New-VSDataZoneUserProfile {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::UserProfile resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.UserProfile')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.UserProfile'
