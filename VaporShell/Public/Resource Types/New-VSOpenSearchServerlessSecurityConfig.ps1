function New-VSOpenSearchServerlessSecurityConfig {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::SecurityConfig resource to the template.
    ...
    .PARAMETER IamFederationOptions
        ...
        UpdateType: Mutable
        Type: IamFederationConfigOptions
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.SecurityConfig')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.SecurityConfig'
