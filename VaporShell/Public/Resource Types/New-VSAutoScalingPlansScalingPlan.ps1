function New-VSAutoScalingPlansScalingPlan {
    ...
    [OutputType('Vaporshell.Resource.AutoScalingPlans.ScalingPlan')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AutoScalingPlans.ScalingPlan.ScalingInstruction"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                ScalingInstructions {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ScalingInstructions -Value @($ScalingInstructions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScalingPlans.ScalingPlan'
