function New-VSSecurityHubPolicyAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::PolicyAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SecurityHub.PolicyAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.PolicyAssociation'
