function New-VSSignerProfilePermission {
    <#
    .SYNOPSIS
        Adds an AWS::Signer::ProfilePermission resource to the template. Adds cross-account permissions to a signing profile.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Signer.ProfilePermission')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Signer.ProfilePermission'
