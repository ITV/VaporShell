function New-VSNetworkFirewallLoggingConfiguration {
    ...
    [OutputType('Vaporshell.Resource.NetworkFirewall.LoggingConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.LoggingConfiguration'
