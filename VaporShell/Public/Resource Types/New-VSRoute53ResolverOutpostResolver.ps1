function New-VSRoute53ResolverOutpostResolver {
    <#
    .SYNOPSIS
        Adds an AWS::Route53Resolver::OutpostResolver resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Route53Resolver.OutpostResolver')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Resolver.OutpostResolver'
