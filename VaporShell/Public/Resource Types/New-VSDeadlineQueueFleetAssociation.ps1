function New-VSDeadlineQueueFleetAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::QueueFleetAssociation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Deadline.QueueFleetAssociation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.QueueFleetAssociation'
