function New-VSARCZonalShiftAutoshiftObserverNotificationStatus {
    <#
    .SYNOPSIS
        Adds an AWS::ARCZonalShift::AutoshiftObserverNotificationStatus resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCZonalShift.AutoshiftObserverNotificationStatus')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCZonalShift.AutoshiftObserverNotificationStatus'
