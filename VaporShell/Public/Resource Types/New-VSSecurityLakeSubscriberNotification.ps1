function New-VSSecurityLakeSubscriberNotification {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::SubscriberNotification resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityLake.SubscriberNotification')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.SubscriberNotification'
