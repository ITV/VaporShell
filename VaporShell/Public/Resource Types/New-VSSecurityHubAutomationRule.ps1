function New-VSSecurityHubAutomationRule {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRule resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRule')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SecurityHub.AutomationRule.AutomationRulesAction"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRule'
