function New-VSDMSInstanceProfile {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::InstanceProfile resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DMS.InstanceProfile')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.InstanceProfile'
