function New-VSLocationAPIKey {
    <#
    .SYNOPSIS
        Adds an AWS::Location::APIKey resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Location.APIKey')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Location.APIKey'
