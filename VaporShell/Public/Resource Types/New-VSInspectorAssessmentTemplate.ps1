function New-VSInspectorAssessmentTemplate {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Inspector.AssessmentTemplate')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RulesPackageArns {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RulesPackageArns -Value @($RulesPackageArns)
                }
                UserAttributesForFindings {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name UserAttributesForFindings -Value @($UserAttributesForFindings)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Inspector.AssessmentTemplate'
