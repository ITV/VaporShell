function New-VSLexResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::ResourcePolicy resource to the template. Specifies a new resource policy with the specified policy statements.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Lex.ResourcePolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.ResourcePolicy'
