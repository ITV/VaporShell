function New-VSDeadlineFarm {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Farm resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.Farm')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Farm'
