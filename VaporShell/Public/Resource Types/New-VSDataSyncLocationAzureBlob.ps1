function New-VSDataSyncLocationAzureBlob {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationAzureBlob resource to the template. 
    ...
    .PARAMETER AzureBlobSasConfiguration
    ...
    .PARAMETER AzureBlobContainerUrl
    ...
    .PARAMETER AzureBlobAuthenticationType
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataSync.LocationAzureBlob')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationAzureBlob'
