function New-VSAthenaCapacityReservation {
    <#
    .SYNOPSIS
        Adds an AWS::Athena::CapacityReservation resource to the template.
    ...
    .PARAMETER CapacityAssignmentConfiguration
    ...
    [OutputType('Vaporshell.Resource.Athena.CapacityReservation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Athena.CapacityReservation'
