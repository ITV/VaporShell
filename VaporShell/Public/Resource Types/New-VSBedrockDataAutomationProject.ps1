function New-VSBedrockDataAutomationProject {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject resource to the template.
    ...
    .PARAMETER StandardOutputConfiguration
    ...
    .PARAMETER ProjectType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-dataautomationproject.html#cfn-bedrock-dataautomationproject-projecttype
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject'
