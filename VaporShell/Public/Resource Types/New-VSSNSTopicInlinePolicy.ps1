function New-VSSNSTopicInlinePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::SNS::TopicInlinePolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SNS.TopicInlinePolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SNS.TopicInlinePolicy'
