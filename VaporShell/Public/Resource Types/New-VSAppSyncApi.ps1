function New-VSAppSyncApi {
    <#
    .SYNOPSIS
        Adds an AWS::AppSync::Api resource to the template.
    ...
    [OutputType('Vaporshell.Resource.AppSync.Api')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppSync.Api'
