function New-VSRoute53RecoveryControlRoutingControl {
    ...
    [OutputType('Vaporshell.Resource.Route53RecoveryControl.RoutingControl')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53RecoveryControl.RoutingControl'
