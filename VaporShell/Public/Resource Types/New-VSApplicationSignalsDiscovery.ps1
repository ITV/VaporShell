function New-VSApplicationSignalsDiscovery {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationSignals::Discovery resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ApplicationSignals.Discovery')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationSignals.Discovery'
