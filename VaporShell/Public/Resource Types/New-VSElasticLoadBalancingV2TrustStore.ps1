function New-VSElasticLoadBalancingV2TrustStore {
    <#
    .SYNOPSIS
        Adds an AWS::ElasticLoadBalancingV2::TrustStore resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ElasticLoadBalancingV2.TrustStore')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElasticLoadBalancingV2.TrustStore'
