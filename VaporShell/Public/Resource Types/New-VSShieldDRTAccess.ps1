function New-VSShieldDRTAccess {
    <#
    .SYNOPSIS
        Adds an AWS::Shield::DRTAccess resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Shield.DRTAccess')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                LogBucketList {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name LogBucketList -Value @($LogBucketList)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Shield.DRTAccess'
