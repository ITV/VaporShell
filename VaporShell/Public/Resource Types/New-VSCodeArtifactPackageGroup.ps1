function New-VSCodeArtifactPackageGroup {
    <#
    .SYNOPSIS
        Adds an AWS::CodeArtifact::PackageGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CodeArtifact.PackageGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeArtifact.PackageGroup'
