function New-VSGameLiftStreamsApplication {
    <#
    .SYNOPSIS
        Adds an AWS::GameLiftStreams::Application resource to the template.

    .DESCRIPTION
        Adds an AWS::GameLiftStreams::Application resource to the template.

    .LINK
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-gameliftstreams-application.html
    ...
    [OutputType('Vaporshell.Resource.GameLiftStreams.Application')]
    [CmdletBinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ApplicationLogPaths' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ApplicationLogPaths -Value @($ApplicationLogPaths)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLiftStreams.Application'
