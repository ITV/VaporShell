function New-VSIoTSiteWisePortal {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::Portal resource to the template. Creates a portal, which can contain projects and dashboards. Before you can create a portal, you must enable AWS SSO. AWS IoT SiteWise Monitor uses AWS SSO to manage user permissions. For more information, see Enabling AWS SSO: https://docs.aws.amazon.com/iot-sitewise/latest/userguide/monitor-get-started.html#mon-gs-sso in the *AWS IoT SiteWise User Guide*.
...
If you use the AWS IoT Events managed Lambda function: https://docs.aws.amazon.com/iotevents/latest/developerguide/lambda-support.html to manage your emails, you must verify the sender email address in Amazon SES: https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-email-addresses.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTSiteWise.Portal')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.Portal'
