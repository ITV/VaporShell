function New-VSWisdomMessageTemplate {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::MessageTemplate resource to the template.
    ...
    .PARAMETER MessageTemplateAttachments
        ...
        UpdateType: Mutable
        Type: List
        ItemType: MessageTemplateAttachment
    ...
    [OutputType('Vaporshell.Resource.Wisdom.MessageTemplate')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Wisdom.MessageTemplate.MessageTemplateAttachment"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'MessageTemplateAttachments' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name MessageTemplateAttachments -Value @($MessageTemplateAttachments)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.MessageTemplate'
