function New-VSDataSyncLocationFSxOpenZFS {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationFSxOpenZFS resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationFSxOpenZFS')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationFSxOpenZFS'
