function New-VSBedrockGuardrail {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Guardrail resource to the template.
    ...
    .PARAMETER AutomatedReasoningPolicyConfig
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrock-guardrail.html#cfn-bedrock-guardrail-automatedreasoningpolicyconfig
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Guardrail')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Guardrail'
