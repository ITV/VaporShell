function New-VSM2Deployment {
    <#
    .SYNOPSIS
        Adds an AWS::M2::Deployment resource to the template.
    ...
    [OutputType('Vaporshell.Resource.M2.Deployment')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.M2.Deployment'
