function New-VSWorkSpacesWebPortal {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpacesWeb::Portal resource to the template.
    ...
    .PARAMETER SessionLoggerArn
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspacesweb-portal.html#cfn-workspacesweb-portal-sessionloggerarn
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.WorkSpacesWeb.Portal')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpacesWeb.Portal'
