function New-VSIAMGroupPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::IAM::GroupPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IAM.GroupPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IAM.GroupPolicy'
