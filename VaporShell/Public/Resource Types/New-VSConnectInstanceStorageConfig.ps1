function New-VSConnectInstanceStorageConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::InstanceStorageConfig resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Connect.InstanceStorageConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.InstanceStorageConfig'
