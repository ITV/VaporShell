function New-VSNotificationsChannelAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::ChannelAssociation resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.ChannelAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.ChannelAssociation'
