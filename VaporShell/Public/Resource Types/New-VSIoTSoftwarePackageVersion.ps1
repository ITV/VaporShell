function New-VSIoTSoftwarePackageVersion {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::SoftwarePackageVersion resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.SoftwarePackageVersion')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.SoftwarePackageVersion'
