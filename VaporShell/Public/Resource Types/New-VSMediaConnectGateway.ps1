function New-VSMediaConnectGateway {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Gateway resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.Gateway')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaConnect.Gateway.GatewayNetwork"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Networks {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Networks -Value @($Networks)
                }
                EgressCidrBlocks {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EgressCidrBlocks -Value @($EgressCidrBlocks)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Gateway'
