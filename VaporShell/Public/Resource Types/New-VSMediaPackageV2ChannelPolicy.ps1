function New-VSMediaPackageV2ChannelPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackageV2::ChannelPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaPackageV2.ChannelPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaPackageV2.ChannelPolicy'
