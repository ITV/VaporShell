function New-VSECRRegistryScanningConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ECR::RegistryScanningConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ECR.RegistryScanningConfiguration')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ECR.RegistryScanningConfiguration.ScanningRule"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECR.RegistryScanningConfiguration'
