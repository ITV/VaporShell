function New-VSNotificationsNotificationHub {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::NotificationHub resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.NotificationHub')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.NotificationHub'
