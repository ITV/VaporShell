function New-VSManagedBlockchainAccessor {
    <#
    .SYNOPSIS
        Adds an AWS::ManagedBlockchain::Accessor resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ManagedBlockchain.Accessor')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ManagedBlockchain.Accessor'
