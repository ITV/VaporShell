function New-VSDeadlineQueue {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Queue resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.Queue')]
    [cmdletbinding()]
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                AllowedStorageProfileIds {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AllowedStorageProfileIds -Value @($AllowedStorageProfileIds)
                }
                RequiredFileSystemLocationNames {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RequiredFileSystemLocationNames -Value @($RequiredFileSystemLocationNames)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Queue'
