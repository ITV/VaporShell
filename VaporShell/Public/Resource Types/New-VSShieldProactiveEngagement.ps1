function New-VSShieldProactiveEngagement {
    <#
    .SYNOPSIS
        Adds an AWS::Shield::ProactiveEngagement resource to the template.
    ...
    .PARAMETER ProactiveEngagementStatus
    ...
    [OutputType('Vaporshell.Resource.Shield.ProactiveEngagement')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Shield.ProactiveEngagement.EmergencyContact"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                EmergencyContactList {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EmergencyContactList -Value @($EmergencyContactList)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Shield.ProactiveEngagement'
