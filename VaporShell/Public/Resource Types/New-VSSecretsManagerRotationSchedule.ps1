function New-VSSecretsManagerRotationSchedule {
    ...
    .PARAMETER ExternalSecretRotationMetadata
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-secretsmanager-rotationschedule.html#cfn-secretsmanager-rotationschedule-externalsecretrotationmetadata
        UpdateType: Mutable
        Type: List
        ItemType: ExternalSecretRotationMetadataItem
        DuplicatesAllowed: True

    .PARAMETER ExternalSecretRotationRoleArn
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-secretsmanager-rotationschedule.html#cfn-secretsmanager-rotationschedule-externalsecretrotationrolearn
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.SecretsManager.RotationSchedule')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SecretsManager.RotationSchedule.ExternalSecretRotationMetadataItem"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'ExternalSecretRotationMetadata' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ExternalSecretRotationMetadata -Value @($ExternalSecretRotationMetadata)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecretsManager.RotationSchedule'
