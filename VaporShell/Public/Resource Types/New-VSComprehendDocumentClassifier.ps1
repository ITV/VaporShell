function New-VSComprehendDocumentClassifier {
    <#
    .SYNOPSIS
        Adds an AWS::Comprehend::DocumentClassifier resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Comprehend.DocumentClassifier')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Comprehend.DocumentClassifier'
