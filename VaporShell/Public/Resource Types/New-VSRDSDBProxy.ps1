function New-VSRDSDBProxy {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::DBProxy resource to the template.
    ...
    .PARAMETER TargetConnectionNetworkType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbproxy.html#cfn-rds-dbproxy-targetconnectionnetworktype
        UpdateType: Immutable
        PrimitiveType: String

    .PARAMETER DefaultAuthScheme
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbproxy.html#cfn-rds-dbproxy-defaultauthscheme
        UpdateType: Mutable
        PrimitiveType: String
    ...
    .PARAMETER EndpointNetworkType
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbproxy.html#cfn-rds-dbproxy-endpointnetworktype
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.RDS.DBProxy')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.RDS.DBProxy.AuthFormat"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.RDS.DBProxy.TagFormat"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'VpcSubnetIds' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name VpcSubnetIds -Value @($VpcSubnetIds)
                }
                'VpcSecurityGroupIds' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'Auth' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Auth -Value @($Auth)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.DBProxy'
