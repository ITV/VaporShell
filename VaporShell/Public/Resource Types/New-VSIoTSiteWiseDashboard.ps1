function New-VSIoTSiteWiseDashboard {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::Dashboard resource to the template. Creates a dashboard in an AWS IoT SiteWise Monitor project.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTSiteWise.Dashboard')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.Dashboard'
