function New-VSElasticLoadBalancingV2TrustStoreRevocation {
    <#
    .SYNOPSIS
        Adds an AWS::ElasticLoadBalancingV2::TrustStoreRevocation resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ElasticLoadBalancingV2.TrustStoreRevocation')]
    [cmdletbinding()]
    Param
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ElasticLoadBalancingV2.TrustStoreRevocation.RevocationContent"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                RevocationContents {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RevocationContents -Value @($RevocationContents)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElasticLoadBalancingV2.TrustStoreRevocation'
