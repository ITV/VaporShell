function New-VSNotificationsNotificationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Notifications::NotificationConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Notifications.NotificationConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Notifications.NotificationConfiguration'
