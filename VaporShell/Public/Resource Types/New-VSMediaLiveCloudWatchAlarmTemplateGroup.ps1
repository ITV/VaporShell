function New-VSMediaLiveCloudWatchAlarmTemplateGroup {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::CloudWatchAlarmTemplateGroup resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaLive.CloudWatchAlarmTemplateGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.CloudWatchAlarmTemplateGroup'
