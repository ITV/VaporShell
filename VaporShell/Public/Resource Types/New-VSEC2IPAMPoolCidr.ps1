function New-VSEC2IPAMPoolCidr {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::IPAMPoolCidr resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.IPAMPoolCidr')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.IPAMPoolCidr'
