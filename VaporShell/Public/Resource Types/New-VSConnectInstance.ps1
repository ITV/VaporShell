function New-VSConnectInstance {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Instance resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Connect.Instance')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Instance'
