function New-VSServiceCatalogResourceUpdateConstraint {
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ServiceCatalog.ResourceUpdateConstraint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ServiceCatalog.ResourceUpdateConstraint'
