function New-VSConfigStoredQuery {
    <#
    .SYNOPSIS
        Adds an AWS::Config::StoredQuery resource to the template. Provides the details of a stored query.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Config.StoredQuery')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.StoredQuery'
