function New-VSIoTTwinMakerWorkspace {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::Workspace resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTTwinMaker.Workspace')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.Workspace'
