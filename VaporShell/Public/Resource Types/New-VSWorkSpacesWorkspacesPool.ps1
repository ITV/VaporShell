function New-VSWorkSpacesWorkspacesPool {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpaces::WorkspacesPool resource to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkSpaces.WorkspacesPool')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpaces.WorkspacesPool'
