function New-VSSecurityHubSecurityControl {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::SecurityControl resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.SecurityControl')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.SecurityHub.SecurityControl.ParameterConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.SecurityControl'
