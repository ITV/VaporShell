function New-VSPCAConnectorSCEPChallenge {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorSCEP::Challenge resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.PCAConnectorSCEP.Challenge')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorSCEP.Challenge'
