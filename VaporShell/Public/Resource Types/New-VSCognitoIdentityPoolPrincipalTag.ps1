function New-VSCognitoIdentityPoolPrincipalTag {
    <#
    .SYNOPSIS
        Adds an AWS::Cognito::IdentityPoolPrincipalTag resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Cognito.IdentityPoolPrincipalTag')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.IdentityPoolPrincipalTag'
