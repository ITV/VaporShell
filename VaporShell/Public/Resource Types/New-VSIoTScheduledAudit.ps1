...
+ UNAUTHENTICATED_COGNITO_ROLE_OVERLY_PERMISSIVE_CHECK
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoT.ScheduledAudit')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TargetCheckNames {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TargetCheckNames -Value @($TargetCheckNames)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.ScheduledAudit'
