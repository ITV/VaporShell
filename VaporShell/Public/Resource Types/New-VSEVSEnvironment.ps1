function New-VSEVSEnvironment {
    <#
    .SYNOPSIS
        Adds an AWS::EVS::Environment resource to the template.
    ...
    [OutputType('Vaporshell.Resource.EVS.Environment')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EVS.Environment.HostInfoForCreate"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'Hosts' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Hosts -Value @($Hosts)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EVS.Environment'
