function New-VSDataZoneEnvironmentBlueprintConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::EnvironmentBlueprintConfiguration resource to the template.
    ...
    .PARAMETER ProvisioningConfigurations
        ...
        UpdateType: Mutable
        Type: List
        ItemType: ProvisioningConfiguration
    ...
    .PARAMETER EnvironmentRolePermissionBoundary
    ...
    [OutputType('Vaporshell.Resource.DataZone.EnvironmentBlueprintConfiguration')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DataZone.EnvironmentBlueprintConfiguration.RegionalParameter"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DataZone.EnvironmentBlueprintConfiguration.ProvisioningConfiguration"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'RegionalParameters' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name RegionalParameters -Value @($RegionalParameters)
                }
                'ProvisioningConfigurations' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name ProvisioningConfigurations -Value @($ProvisioningConfigurations)
                }
                'EnabledRegions' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EnabledRegions -Value @($EnabledRegions)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.EnvironmentBlueprintConfiguration'
