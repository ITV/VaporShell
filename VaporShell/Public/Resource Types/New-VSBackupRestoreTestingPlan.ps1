function New-VSBackupRestoreTestingPlan {
    <#
    .SYNOPSIS
        Adds an AWS::Backup::RestoreTestingPlan resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Backup.RestoreTestingPlan')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Backup.RestoreTestingPlan'
