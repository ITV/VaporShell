function New-VSCloud9EnvironmentEC2 {
    ...
    [OutputType('Vaporshell.Resource.Cloud9.EnvironmentEC2')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Cloud9.EnvironmentEC2.Repository"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                Repositories {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name Repositories -Value @($Repositories)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cloud9.EnvironmentEC2'
