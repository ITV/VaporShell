function New-VSEC2VerifiedAccessEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessEndpoint resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.VerifiedAccessEndpoint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessEndpoint'
