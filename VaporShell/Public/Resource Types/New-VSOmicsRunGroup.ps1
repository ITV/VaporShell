function New-VSOmicsRunGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::RunGroup resource to the template.
    ...
    [OutputType('Vaporshell.Resource.Omics.RunGroup')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.RunGroup'
