function New-VSDataZoneProject {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Project resource to the template.
    ...
    .PARAMETER UserParameters
        ...
        UpdateType: Mutable
        Type: List
        ItemType: EnvironmentConfigurationUserParameter
    ...
    .PARAMETER ProjectProfileVersion
    ...
    [OutputType('Vaporshell.Resource.DataZone.Project')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DataZone.Project.EnvironmentConfigurationUserParameter"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'UserParameters' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name UserParameters -Value @($UserParameters)
                }
                'GlossaryTerms' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name GlossaryTerms -Value @($GlossaryTerms)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Project'
