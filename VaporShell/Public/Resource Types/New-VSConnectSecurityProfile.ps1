function New-VSConnectSecurityProfile {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::SecurityProfile resource to the template.
    ...
    .PARAMETER GranularAccessControlConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-securityprofile.html#cfn-connect-securityprofile-granularaccesscontrolconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.Connect.SecurityProfile')]
    [CmdletBinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Connect.SecurityProfile.Application"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'AllowedAccessControlTags' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name AllowedAccessControlTags -Value @($AllowedAccessControlTags)
                }
                'Applications' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'TagRestrictedResources' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TagRestrictedResources -Value @($TagRestrictedResources)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                ...
                'HierarchyRestrictedResources' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name HierarchyRestrictedResources -Value @($HierarchyRestrictedResources)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.SecurityProfile'
