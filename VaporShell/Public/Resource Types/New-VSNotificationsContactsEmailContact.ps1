function New-VSNotificationsContactsEmailContact {
    <#
    .SYNOPSIS
        Adds an AWS::NotificationsContacts::EmailContact resource to the template.
    ...
    [OutputType('Vaporshell.Resource.NotificationsContacts.EmailContact')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NotificationsContacts.EmailContact'
