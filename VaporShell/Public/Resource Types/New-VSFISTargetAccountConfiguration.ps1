function New-VSFISTargetAccountConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::FIS::TargetAccountConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.FIS.TargetAccountConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FIS.TargetAccountConfiguration'
