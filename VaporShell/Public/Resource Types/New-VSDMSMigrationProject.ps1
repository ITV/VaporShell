function New-VSDMSMigrationProject {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::MigrationProject resource to the template.
    ...
    [OutputType('Vaporshell.Resource.DMS.MigrationProject')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DMS.MigrationProject.DataProviderDescriptor"
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                TargetDataProviderDescriptors {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name TargetDataProviderDescriptors -Value @($TargetDataProviderDescriptors)
                }
                SourceDataProviderDescriptors {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name SourceDataProviderDescriptors -Value @($SourceDataProviderDescriptors)
                }
                Tags {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.MigrationProject'
