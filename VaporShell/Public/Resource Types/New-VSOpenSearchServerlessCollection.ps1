function New-VSOpenSearchServerlessCollection {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::Collection resource to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.Collection')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.Collection'
