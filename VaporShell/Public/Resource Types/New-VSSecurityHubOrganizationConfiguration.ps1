function New-VSSecurityHubOrganizationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::OrganizationConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.OrganizationConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.OrganizationConfiguration'
