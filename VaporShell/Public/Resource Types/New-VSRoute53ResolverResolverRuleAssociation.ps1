function New-VSRoute53ResolverResolverRuleAssociation {
    ...
    [OutputType('Vaporshell.Resource.Route53Resolver.ResolverRuleAssociation')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53Resolver.ResolverRuleAssociation'
