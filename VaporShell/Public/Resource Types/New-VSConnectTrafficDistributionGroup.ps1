function New-VSConnectTrafficDistributionGroup {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::TrafficDistributionGroup resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Connect.TrafficDistributionGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.TrafficDistributionGroup'
