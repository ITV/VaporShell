function New-VSRedshiftServerlessSnapshot {
    <#
    .SYNOPSIS
        Adds an AWS::RedshiftServerless::Snapshot resource to the template.
    ...
    [OutputType('Vaporshell.Resource.RedshiftServerless.Snapshot')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RedshiftServerless.Snapshot'
