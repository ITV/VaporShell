function New-VSMediaConnectBridge {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Bridge resource to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.Bridge')]
    [cmdletbinding()]
    ...
    (
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaConnect.Bridge.BridgeOutput"
        ...
        [Parameter(Mandatory = $true)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.MediaConnect.Bridge.BridgeSource"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Bridge'
