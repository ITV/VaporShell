function New-VSXRayTransactionSearchConfig {
    <#
    .SYNOPSIS
        Adds an AWS::XRay::TransactionSearchConfig resource to the template.
    ...
    [OutputType('Vaporshell.Resource.XRay.TransactionSearchConfig')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.XRay.TransactionSearchConfig'
