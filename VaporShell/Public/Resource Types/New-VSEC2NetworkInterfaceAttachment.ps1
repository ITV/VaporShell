function New-VSEC2NetworkInterfaceAttachment {
    ...
    .PARAMETER EnaQueueCount
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ec2-networkinterfaceattachment.html#cfn-ec2-networkinterfaceattachment-enaqueuecount
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.EC2.NetworkInterfaceAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.NetworkInterfaceAttachment'
