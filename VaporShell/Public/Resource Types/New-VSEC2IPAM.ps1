function New-VSEC2IPAM {
    ...
    .PARAMETER DefaultResourceDiscoveryOrganizationalUnitExclusions
        ...
        UpdateType: Mutable
        Type: List
        ItemType: IpamOrganizationalUnitExclusion
    ...
    [OutputType('Vaporshell.Resource.EC2.IPAM')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.IPAM.IpamOrganizationalUnitExclusion"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.IPAM.IpamOperatingRegion"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                'DefaultResourceDiscoveryOrganizationalUnitExclusions' {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name DefaultResourceDiscoveryOrganizationalUnitExclusions -Value @($DefaultResourceDiscoveryOrganizationalUnitExclusions)
                }
                'Tags' {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.IPAM'
