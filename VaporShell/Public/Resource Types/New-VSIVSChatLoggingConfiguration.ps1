function New-VSIVSChatLoggingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IVSChat::LoggingConfiguration resource to the template.
    ...
    [OutputType('Vaporshell.Resource.IVSChat.LoggingConfiguration')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVSChat.LoggingConfiguration'
