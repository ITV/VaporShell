function New-VSNetworkManagerSiteToSiteVpnAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::SiteToSiteVpnAttachment resource to the template.
    ...
    .PARAMETER RoutingPolicyLabel
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-networkmanager-sitetositevpnattachment.html#cfn-networkmanager-sitetositevpnattachment-routingpolicylabel
        UpdateType: Immutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.SiteToSiteVpnAttachment')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.SiteToSiteVpnAttachment'
