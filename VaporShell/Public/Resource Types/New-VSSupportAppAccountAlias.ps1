function New-VSSupportAppAccountAlias {
    <#
    .SYNOPSIS
        Adds an AWS::SupportApp::AccountAlias resource to the template.
    ...
    [OutputType('Vaporshell.Resource.SupportApp.AccountAlias')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SupportApp.AccountAlias'
