function New-VSVpcLatticeResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::ResourcePolicy resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VpcLattice.ResourcePolicy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.ResourcePolicy'
