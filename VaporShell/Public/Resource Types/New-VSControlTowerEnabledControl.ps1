function New-VSControlTowerEnabledControl {
    <#
    .SYNOPSIS
        Adds an AWS::ControlTower::EnabledControl resource to the template.
    ...
    [OutputType('Vaporshell.Resource.ControlTower.EnabledControl')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ControlTower.EnabledControl.EnabledControlParameter"
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ControlTower.EnabledControl'
