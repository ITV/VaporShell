function New-VSApiGatewayDomainNameV2 {
    <#
    .SYNOPSIS
        Adds an AWS::ApiGateway::DomainNameV2 resource to the template.
    ...
    .PARAMETER EndpointAccessMode
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigateway-domainnamev2.html#cfn-apigateway-domainnamev2-endpointaccessmode
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.ApiGateway.DomainNameV2')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGateway.DomainNameV2'
