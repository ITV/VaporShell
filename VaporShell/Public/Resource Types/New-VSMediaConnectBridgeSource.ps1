function New-VSMediaConnectBridgeSource {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::BridgeSource resource to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaConnect.BridgeSource')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.BridgeSource'
