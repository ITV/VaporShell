function New-VSCloudFrontKeyGroup {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::KeyGroup resource to the template. A key group.
...
A key group contains a list of public keys that you can use with CloudFront signed URLs and signed cookies: https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/PrivateContent.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CloudFront.KeyGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.KeyGroup'
