function New-VSAPSScraper {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Scraper resource to the template.
    ...
    .PARAMETER ScraperLoggingConfiguration
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-aps-scraper.html#cfn-aps-scraper-scraperloggingconfiguration
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.APS.Scraper')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Scraper'
