function New-VSFMSResourceSet {
    <#
    .SYNOPSIS
        Adds an AWS::FMS::ResourceSet resource to the template.
    ...
    [OutputType('Vaporshell.Resource.FMS.ResourceSet')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FMS.ResourceSet'
