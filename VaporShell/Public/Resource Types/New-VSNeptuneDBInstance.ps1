function New-VSNeptuneDBInstance {
    ...
    .PARAMETER PubliclyAccessible
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptune-dbinstance.html#cfn-neptune-dbinstance-publiclyaccessible
        UpdateType: Mutable
        PrimitiveType: Boolean
    ...
    [OutputType('Vaporshell.Resource.Neptune.DBInstance')]
    [CmdletBinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Neptune.DBInstance'
