function New-VSCloudFrontContinuousDeploymentPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::ContinuousDeploymentPolicy resource to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.ContinuousDeploymentPolicy')]
    [cmdletbinding()]
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.ContinuousDeploymentPolicy'
