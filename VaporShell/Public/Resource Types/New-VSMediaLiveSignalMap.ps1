function New-VSMediaLiveSignalMap {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::SignalMap resource to the template. 
    ...
    .PARAMETER EventBridgeRuleTemplateGroupIdentifiers
    ...
    .PARAMETER CloudWatchAlarmTemplateGroupIdentifiers
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaLive.SignalMap')]
    [cmdletbinding()]
    Param
    (
        ...
        foreach ($key in $PSBoundParameters.Keys | Where-Object {$commonParams -notcontains $_}) {
            switch ($key) {
                ...
                EventBridgeRuleTemplateGroupIdentifiers {
                    ...
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name EventBridgeRuleTemplateGroupIdentifiers -Value @($EventBridgeRuleTemplateGroupIdentifiers)
                }
                CloudWatchAlarmTemplateGroupIdentifiers {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
                    }
                    $ResourceParams["Properties"] | Add-Member -MemberType NoteProperty -Name CloudWatchAlarmTemplateGroupIdentifiers -Value @($CloudWatchAlarmTemplateGroupIdentifiers)
                }
                Default {
                    if (!($ResourceParams["Properties"])) {
                        $ResourceParams.Add("Properties",([PSCustomObject]@{}))
    ...
    End {
        ...
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.SignalMap'
