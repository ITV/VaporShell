function Add-VSPCSComputeNodeGroupSlurmCustomSetting {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::ComputeNodeGroup.SlurmCustomSetting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.PCS.ComputeNodeGroup.SlurmCustomSetting')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.ComputeNodeGroup.SlurmCustomSetting'
