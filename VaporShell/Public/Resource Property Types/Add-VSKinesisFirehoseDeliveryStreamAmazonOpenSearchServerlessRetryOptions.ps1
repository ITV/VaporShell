function Add-VSKinesisFirehoseDeliveryStreamAmazonOpenSearchServerlessRetryOptions {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.AmazonOpenSearchServerlessRetryOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.KinesisFirehose.DeliveryStream.AmazonOpenSearchServerlessRetryOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.AmazonOpenSearchServerlessRetryOptions'
