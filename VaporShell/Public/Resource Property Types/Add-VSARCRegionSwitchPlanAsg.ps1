function Add-VSARCRegionSwitchPlanAsg {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.Asg resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.Asg')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.Asg'
