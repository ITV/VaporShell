function Add-VSS3ExpressAccessPointVpcConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::S3Express::AccessPoint.VpcConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Express.AccessPoint.VpcConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Express.AccessPoint.VpcConfiguration'
