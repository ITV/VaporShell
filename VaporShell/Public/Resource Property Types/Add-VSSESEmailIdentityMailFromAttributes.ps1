function Add-VSSESEmailIdentityMailFromAttributes {
    <#
    .SYNOPSIS
        Adds an AWS::SES::EmailIdentity.MailFromAttributes resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.EmailIdentity.MailFromAttributes'
