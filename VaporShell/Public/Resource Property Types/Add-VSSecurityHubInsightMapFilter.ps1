function Add-VSSecurityHubInsightMapFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::Insight.MapFilter resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.Insight.MapFilter'
