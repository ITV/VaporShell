function Add-VSWorkspacesInstancesWorkspaceInstanceBlockDeviceMapping {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::WorkspaceInstance.BlockDeviceMapping resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.BlockDeviceMapping')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.BlockDeviceMapping'
