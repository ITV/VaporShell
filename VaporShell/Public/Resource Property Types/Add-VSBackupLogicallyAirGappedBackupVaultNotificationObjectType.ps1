function Add-VSBackupLogicallyAirGappedBackupVaultNotificationObjectType {
    <#
    .SYNOPSIS
        Adds an AWS::Backup::LogicallyAirGappedBackupVault.NotificationObjectType resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Backup.LogicallyAirGappedBackupVault.NotificationObjectType'
