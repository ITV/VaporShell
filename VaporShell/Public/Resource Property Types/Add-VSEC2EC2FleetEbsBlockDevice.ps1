function Add-VSEC2EC2FleetEbsBlockDevice {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::EC2Fleet.EbsBlockDevice resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.EC2Fleet.EbsBlockDevice')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.EC2Fleet.EbsBlockDevice'
