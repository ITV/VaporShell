function Add-VSQuickSightAnalysisDataPathValue {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DataPathValue resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.DataPathValue')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DataPathValue'
