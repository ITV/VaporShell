function Add-VSBatchJobDefinitionResourceRetentionPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobDefinition.ResourceRetentionPolicy resource property to the template.
    ...
    .PARAMETER SkipDeregisterOnUpdate
    ...
    [OutputType('Vaporshell.Resource.Batch.JobDefinition.ResourceRetentionPolicy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition.ResourceRetentionPolicy'
