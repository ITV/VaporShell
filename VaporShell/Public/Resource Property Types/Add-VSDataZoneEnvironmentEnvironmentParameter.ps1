function Add-VSDataZoneEnvironmentEnvironmentParameter {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Environment.EnvironmentParameter resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataZone.Environment.EnvironmentParameter')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Environment.EnvironmentParameter'
