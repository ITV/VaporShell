function Add-VSAmplifyAppCacheConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Amplify::App.CacheConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Amplify.App.CacheConfig'
