function Add-VSEC2SpotFleetPerformanceFactorReferenceRequest {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::SpotFleet.PerformanceFactorReferenceRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.SpotFleet.PerformanceFactorReferenceRequest')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.SpotFleet.PerformanceFactorReferenceRequest'
