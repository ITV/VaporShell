function Add-VSBedrockFlowVersionVectorSearchRerankingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowVersion.VectorSearchRerankingConfiguration resource property to the template.
    ...
    .PARAMETER BedrockRerankingConfiguration
    ...
    [OutputType('Vaporshell.Resource.Bedrock.FlowVersion.VectorSearchRerankingConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowVersion.VectorSearchRerankingConfiguration'
