function Add-VSDataZonePolicyGrantGroupPolicyGrantPrincipal {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.GroupPolicyGrantPrincipal resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.GroupPolicyGrantPrincipal')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.GroupPolicyGrantPrincipal'
