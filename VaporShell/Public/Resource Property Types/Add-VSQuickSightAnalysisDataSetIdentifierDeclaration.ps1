function Add-VSQuickSightAnalysisDataSetIdentifierDeclaration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DataSetIdentifierDeclaration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.DataSetIdentifierDeclaration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DataSetIdentifierDeclaration'
