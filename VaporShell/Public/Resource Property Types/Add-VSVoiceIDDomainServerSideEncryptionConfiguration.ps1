function Add-VSVoiceIDDomainServerSideEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::VoiceID::Domain.ServerSideEncryptionConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.VoiceID.Domain.ServerSideEncryptionConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VoiceID.Domain.ServerSideEncryptionConfiguration'
