function Add-VSWAFv2RuleGroupCustomRequestHandling {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.CustomRequestHandling resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.CustomRequestHandling')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.CustomRequestHandling'
