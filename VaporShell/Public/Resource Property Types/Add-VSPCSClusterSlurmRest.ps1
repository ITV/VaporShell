function Add-VSPCSClusterSlurmRest {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster.SlurmRest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.PCS.Cluster.SlurmRest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster.SlurmRest'
