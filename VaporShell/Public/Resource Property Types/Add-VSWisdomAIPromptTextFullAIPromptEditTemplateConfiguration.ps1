function Add-VSWisdomAIPromptTextFullAIPromptEditTemplateConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIPrompt.TextFullAIPromptEditTemplateConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIPrompt.TextFullAIPromptEditTemplateConfiguration'
