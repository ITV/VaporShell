function Add-VSBedrockAgentActionGroupExecutor {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Agent.ActionGroupExecutor resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.Agent.ActionGroupExecutor')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Agent.ActionGroupExecutor'
