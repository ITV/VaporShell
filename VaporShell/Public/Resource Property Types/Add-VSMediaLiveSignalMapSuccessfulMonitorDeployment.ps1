function Add-VSMediaLiveSignalMapSuccessfulMonitorDeployment {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::SignalMap.SuccessfulMonitorDeployment resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.SignalMap.SuccessfulMonitorDeployment')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.SignalMap.SuccessfulMonitorDeployment'
