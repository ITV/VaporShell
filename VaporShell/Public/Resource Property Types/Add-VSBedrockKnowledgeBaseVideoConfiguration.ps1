function Add-VSBedrockKnowledgeBaseVideoConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.VideoConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.KnowledgeBase.VideoConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.VideoConfiguration'
