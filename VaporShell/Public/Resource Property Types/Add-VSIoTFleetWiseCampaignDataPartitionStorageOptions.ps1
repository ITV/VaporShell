function Add-VSIoTFleetWiseCampaignDataPartitionStorageOptions {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.DataPartitionStorageOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.Campaign.DataPartitionStorageOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.DataPartitionStorageOptions'
