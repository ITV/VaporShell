function Add-VSBedrockPromptCachePointBlock {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.CachePointBlock resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Prompt.CachePointBlock')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.CachePointBlock'
