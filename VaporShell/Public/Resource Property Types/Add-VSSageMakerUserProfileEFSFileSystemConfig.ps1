function Add-VSSageMakerUserProfileEFSFileSystemConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.EFSFileSystemConfig resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.UserProfile.EFSFileSystemConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.EFSFileSystemConfig'
