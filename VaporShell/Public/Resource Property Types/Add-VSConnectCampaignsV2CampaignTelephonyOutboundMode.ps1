function Add-VSConnectCampaignsV2CampaignTelephonyOutboundMode {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.TelephonyOutboundMode resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.TelephonyOutboundMode'
