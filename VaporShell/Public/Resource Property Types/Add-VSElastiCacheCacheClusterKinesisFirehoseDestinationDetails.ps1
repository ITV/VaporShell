function Add-VSElastiCacheCacheClusterKinesisFirehoseDestinationDetails {
    <#
    .SYNOPSIS
        Adds an AWS::ElastiCache::CacheCluster.KinesisFirehoseDestinationDetails resource property to the template. The configuration details of the Kinesis Data Firehose destination. Note that this field is marked as required but only if Kinesis Data Firehose was chosen as the destination.

    .DESCRIPTION
        Adds an AWS::ElastiCache::CacheCluster.KinesisFirehoseDestinationDetails resource property to the template.
The configuration details of the Kinesis Data Firehose destination. Note that this field is marked as required but only if Kinesis Data Firehose was chosen as the destination.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElastiCache.CacheCluster.KinesisFirehoseDestinationDetails'
