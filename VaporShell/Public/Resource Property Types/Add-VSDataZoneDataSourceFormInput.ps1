function Add-VSDataZoneDataSourceFormInput {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DataSource.FormInput resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DataSource.FormInput'
