function Add-VSMSKReplicatorReplicationTopicNameConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MSK::Replicator.ReplicationTopicNameConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.Replicator.ReplicationTopicNameConfiguration'
