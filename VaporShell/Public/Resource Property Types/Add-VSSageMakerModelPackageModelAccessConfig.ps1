function Add-VSSageMakerModelPackageModelAccessConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelPackage.ModelAccessConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelPackage.ModelAccessConfig'
