function Add-VSQuickSightDashboardGradientStop {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.GradientStop resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.GradientStop')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.GradientStop'
