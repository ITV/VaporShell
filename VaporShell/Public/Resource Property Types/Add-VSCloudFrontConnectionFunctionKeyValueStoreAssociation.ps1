function Add-VSCloudFrontConnectionFunctionKeyValueStoreAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::ConnectionFunction.KeyValueStoreAssociation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.ConnectionFunction.KeyValueStoreAssociation')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.ConnectionFunction.KeyValueStoreAssociation'
