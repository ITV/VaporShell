function Add-VSQuickSightTemplateHistogramBinOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.HistogramBinOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.HistogramBinOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.HistogramBinOptions'
