function Add-VSQuickSightDashboardParameterDateTimePickerControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ParameterDateTimePickerControl resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ParameterDateTimePickerControl'
