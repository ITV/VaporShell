function Add-VSDataZonePolicyGrantAddToProjectMemberPoolPolicyGrantDetail {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.AddToProjectMemberPoolPolicyGrantDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.AddToProjectMemberPoolPolicyGrantDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.AddToProjectMemberPoolPolicyGrantDetail'
