function Add-VSSageMakerInferenceComponentAlarm {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::InferenceComponent.Alarm resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.InferenceComponent.Alarm')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.InferenceComponent.Alarm'
