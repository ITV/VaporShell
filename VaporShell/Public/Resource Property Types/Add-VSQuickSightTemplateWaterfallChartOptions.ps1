function Add-VSQuickSightTemplateWaterfallChartOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.WaterfallChartOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.WaterfallChartOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.WaterfallChartOptions'
