function Add-VSKinesisAnalyticsApplicationReferenceDataSourceRecordColumn {
    ...
    [OutputType('Vaporshell.Resource.KinesisAnalytics.ApplicationReferenceDataSource.RecordColumn')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisAnalytics.ApplicationReferenceDataSource.RecordColumn'
