function Add-VSQBusinessDataSourceDocumentAttributeTarget {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::DataSource.DocumentAttributeTarget resource property to the template. 
    ...
    .PARAMETER AttributeValueOperator
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.DataSource.DocumentAttributeTarget'
