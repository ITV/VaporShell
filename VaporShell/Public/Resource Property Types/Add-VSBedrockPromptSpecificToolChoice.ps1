function Add-VSBedrockPromptSpecificToolChoice {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.SpecificToolChoice resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.SpecificToolChoice'
