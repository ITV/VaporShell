function Add-VSOmicsVariantStoreSseConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Omics::VariantStore.SseConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Omics.VariantStore.SseConfig'
