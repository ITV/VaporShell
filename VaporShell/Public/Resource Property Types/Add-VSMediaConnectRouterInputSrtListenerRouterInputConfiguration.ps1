function Add-VSMediaConnectRouterInputSrtListenerRouterInputConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.SrtListenerRouterInputConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.SrtListenerRouterInputConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.SrtListenerRouterInputConfiguration'
