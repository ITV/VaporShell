function Add-VSQuickSightTemplateWhatIfRangeScenario {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.WhatIfRangeScenario resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.WhatIfRangeScenario')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.WhatIfRangeScenario'
