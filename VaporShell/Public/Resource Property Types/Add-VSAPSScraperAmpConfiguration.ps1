function Add-VSAPSScraperAmpConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Scraper.AmpConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Scraper.AmpConfiguration'
