function Add-VSWAFv2WebACLRateLimitJA3Fingerprint {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RateLimitJA3Fingerprint resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.RateLimitJA3Fingerprint')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RateLimitJA3Fingerprint'
