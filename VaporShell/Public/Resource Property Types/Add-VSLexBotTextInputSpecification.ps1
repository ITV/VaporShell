function Add-VSLexBotTextInputSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.TextInputSpecification resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.TextInputSpecification'
