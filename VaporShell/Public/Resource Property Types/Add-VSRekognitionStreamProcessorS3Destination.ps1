function Add-VSRekognitionStreamProcessorS3Destination {
    <#
    .SYNOPSIS
        Adds an AWS::Rekognition::StreamProcessor.S3Destination resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Rekognition.StreamProcessor.S3Destination'
