function Add-VSNetworkManagerDirectConnectGatewayAttachmentProposedNetworkFunctionGroupChange {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::DirectConnectGatewayAttachment.ProposedNetworkFunctionGroupChange resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.NetworkManager.DirectConnectGatewayAttachment.ProposedNetworkFunctionGroupChange')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.DirectConnectGatewayAttachment.ProposedNetworkFunctionGroupChange'
