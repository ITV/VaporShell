function Add-VSQuickSightDashboardDecimalPlacesConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DecimalPlacesConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DecimalPlacesConfiguration'
