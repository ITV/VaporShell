function Add-VSQuickSightTemplateCustomColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CustomColor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.CustomColor')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CustomColor'
