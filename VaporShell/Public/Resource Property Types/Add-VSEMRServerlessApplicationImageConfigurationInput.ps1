function Add-VSEMRServerlessApplicationImageConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.ImageConfigurationInput resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.ImageConfigurationInput'
