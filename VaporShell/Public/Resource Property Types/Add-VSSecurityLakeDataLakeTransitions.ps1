function Add-VSSecurityLakeDataLakeTransitions {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::DataLake.Transitions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.DataLake.Transitions'
