function Add-VSLogsTransformerSubstituteString {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Transformer.SubstituteString resource property to the template.
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Logs.Transformer.SubstituteStringEntry"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Transformer.SubstituteString'
