function Add-VSCloudFrontConnectionFunctionConnectionFunctionConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::ConnectionFunction.ConnectionFunctionConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.ConnectionFunction.ConnectionFunctionConfig')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.CloudFront.ConnectionFunction.KeyValueStoreAssociation"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.ConnectionFunction.ConnectionFunctionConfig'
