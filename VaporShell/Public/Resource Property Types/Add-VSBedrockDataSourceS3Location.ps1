function Add-VSBedrockDataSourceS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataSource.S3Location resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataSource.S3Location'
