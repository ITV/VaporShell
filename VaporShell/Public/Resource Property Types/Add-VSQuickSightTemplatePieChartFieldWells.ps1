function Add-VSQuickSightTemplatePieChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PieChartFieldWells resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.PieChartFieldWells')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PieChartFieldWells'
