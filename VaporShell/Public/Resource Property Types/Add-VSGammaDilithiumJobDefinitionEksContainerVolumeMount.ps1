function Add-VSGammaDilithiumJobDefinitionEksContainerVolumeMount {
    <#
    .SYNOPSIS
        Adds an AWS::GammaDilithium::JobDefinition.EksContainerVolumeMount resource property to the template.

    .DESCRIPTION
        Adds an AWS::GammaDilithium::JobDefinition.EksContainerVolumeMount resource property to the template.

    .LINK
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gammadilithium-jobdefinition-ekscontainervolumemount.html
    ...
    [OutputType('Vaporshell.Resource.GammaDilithium.JobDefinition.EksContainerVolumeMount')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GammaDilithium.JobDefinition.EksContainerVolumeMount'
