function Add-VSQuickSightAnalysisTableCellConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TableCellConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TableCellConditionalFormatting')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TableCellConditionalFormatting'
