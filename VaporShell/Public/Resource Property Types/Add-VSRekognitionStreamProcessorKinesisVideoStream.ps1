function Add-VSRekognitionStreamProcessorKinesisVideoStream {
    <#
    .SYNOPSIS
        Adds an AWS::Rekognition::StreamProcessor.KinesisVideoStream resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Rekognition.StreamProcessor.KinesisVideoStream'
