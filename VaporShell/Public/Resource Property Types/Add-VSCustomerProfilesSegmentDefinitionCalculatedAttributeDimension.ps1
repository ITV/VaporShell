function Add-VSCustomerProfilesSegmentDefinitionCalculatedAttributeDimension {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::SegmentDefinition.CalculatedAttributeDimension resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.SegmentDefinition.CalculatedAttributeDimension'
