function Add-VSWAFv2LoggingConfigurationLabelNameCondition {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::LoggingConfiguration.LabelNameCondition resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.LoggingConfiguration.LabelNameCondition')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.LoggingConfiguration.LabelNameCondition'
