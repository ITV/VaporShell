function Add-VSBedrockAgentAgentDescriptor {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Agent.AgentDescriptor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Agent.AgentDescriptor')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Agent.AgentDescriptor'
