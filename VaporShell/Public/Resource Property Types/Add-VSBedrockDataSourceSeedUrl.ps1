function Add-VSBedrockDataSourceSeedUrl {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataSource.SeedUrl resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataSource.SeedUrl'
