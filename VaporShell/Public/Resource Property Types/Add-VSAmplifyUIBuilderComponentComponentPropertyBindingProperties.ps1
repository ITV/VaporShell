function Add-VSAmplifyUIBuilderComponentComponentPropertyBindingProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Component.ComponentPropertyBindingProperties resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AmplifyUIBuilder.Component.ComponentPropertyBindingProperties')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AmplifyUIBuilder.Component.ComponentPropertyBindingProperties'
