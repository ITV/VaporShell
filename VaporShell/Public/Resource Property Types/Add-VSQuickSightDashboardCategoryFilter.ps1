function Add-VSQuickSightDashboardCategoryFilter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.CategoryFilter resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.CategoryFilter')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.CategoryFilter'
