function Add-VSNetworkFirewallFirewallPolicyActionDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::FirewallPolicy.ActionDefinition resource property to the template. A custom action to use in stateless rule actions settings.
