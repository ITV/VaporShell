function Add-VSCodeBuildProjectScopeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::CodeBuild::Project.ScopeConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CodeBuild.Project.ScopeConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeBuild.Project.ScopeConfiguration'
