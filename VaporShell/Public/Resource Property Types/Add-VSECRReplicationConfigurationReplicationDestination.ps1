function Add-VSECRReplicationConfigurationReplicationDestination {
    ...
    [OutputType('Vaporshell.Resource.ECR.ReplicationConfiguration.ReplicationDestination')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECR.ReplicationConfiguration.ReplicationDestination'
