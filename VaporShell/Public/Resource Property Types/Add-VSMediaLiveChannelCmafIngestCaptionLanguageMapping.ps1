function Add-VSMediaLiveChannelCmafIngestCaptionLanguageMapping {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.CmafIngestCaptionLanguageMapping resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.CmafIngestCaptionLanguageMapping')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.CmafIngestCaptionLanguageMapping'
