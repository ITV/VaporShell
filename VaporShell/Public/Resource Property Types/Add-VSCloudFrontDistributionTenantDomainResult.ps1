function Add-VSCloudFrontDistributionTenantDomainResult {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::DistributionTenant.DomainResult resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.DistributionTenant.DomainResult')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.DistributionTenant.DomainResult'
