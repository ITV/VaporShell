function Add-VSCloudTrailEventDataStoreInsightSelector {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::EventDataStore.InsightSelector resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.EventDataStore.InsightSelector'
