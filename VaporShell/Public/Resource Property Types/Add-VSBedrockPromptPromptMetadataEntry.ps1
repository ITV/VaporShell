function Add-VSBedrockPromptPromptMetadataEntry {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.PromptMetadataEntry resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Prompt.PromptMetadataEntry')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.PromptMetadataEntry'
