function Add-VSKinesisAnalyticsV2ApplicationApplicationEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisAnalyticsV2::Application.ApplicationEncryptionConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.KinesisAnalyticsV2.Application.ApplicationEncryptionConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisAnalyticsV2.Application.ApplicationEncryptionConfiguration'
