function Add-VSFSxS3AccessPointAttachmentOpenZFSFileSystemIdentity {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::S3AccessPointAttachment.OpenZFSFileSystemIdentity resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.FSx.S3AccessPointAttachment.OpenZFSFileSystemIdentity')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.S3AccessPointAttachment.OpenZFSFileSystemIdentity'
