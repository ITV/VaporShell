function Add-VSIoTWirelessPartnerAccountSidewalkAccountInfoWithFingerprint {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::PartnerAccount.SidewalkAccountInfoWithFingerprint resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTWireless.PartnerAccount.SidewalkAccountInfoWithFingerprint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.PartnerAccount.SidewalkAccountInfoWithFingerprint'
