function Add-VSMacieFindingsFilterFindingsFilterListItem {
    <#
    .SYNOPSIS
        Adds an AWS::Macie::FindingsFilter.FindingsFilterListItem resource property to the template. Specifies the unique identifier and custom name of a findings filter.
...
Specifies the unique identifier and custom name of a findings filter.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Macie.FindingsFilter.FindingsFilterListItem')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Macie.FindingsFilter.FindingsFilterListItem'
