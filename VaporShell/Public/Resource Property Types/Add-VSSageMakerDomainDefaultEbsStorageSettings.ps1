function Add-VSSageMakerDomainDefaultEbsStorageSettings {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Domain.DefaultEbsStorageSettings resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Domain.DefaultEbsStorageSettings'
