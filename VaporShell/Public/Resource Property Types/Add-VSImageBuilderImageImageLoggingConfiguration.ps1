function Add-VSImageBuilderImageImageLoggingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::Image.ImageLoggingConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.Image.ImageLoggingConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.Image.ImageLoggingConfiguration'
