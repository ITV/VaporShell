function Add-VSQuickSightDashboardWaterfallChartOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.WaterfallChartOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.WaterfallChartOptions'
