function Add-VSLexBotS3BucketLogDestination {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.S3BucketLogDestination resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.S3BucketLogDestination'
