function Add-VSPCAConnectorADTemplateEnrollmentFlagsV4 {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::Template.EnrollmentFlagsV4 resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.Template.EnrollmentFlagsV4'
