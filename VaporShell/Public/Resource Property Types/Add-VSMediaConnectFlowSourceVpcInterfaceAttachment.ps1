function Add-VSMediaConnectFlowSourceVpcInterfaceAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::FlowSource.VpcInterfaceAttachment resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaConnect.FlowSource.VpcInterfaceAttachment')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.FlowSource.VpcInterfaceAttachment'
