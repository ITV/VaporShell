function Add-VSSageMakerPipelineS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Pipeline.S3Location resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Pipeline.S3Location'
