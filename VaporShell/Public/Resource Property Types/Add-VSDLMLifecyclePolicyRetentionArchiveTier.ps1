function Add-VSDLMLifecyclePolicyRetentionArchiveTier {
    <#
    .SYNOPSIS
        Adds an AWS::DLM::LifecyclePolicy.RetentionArchiveTier resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DLM.LifecyclePolicy.RetentionArchiveTier')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DLM.LifecyclePolicy.RetentionArchiveTier'
