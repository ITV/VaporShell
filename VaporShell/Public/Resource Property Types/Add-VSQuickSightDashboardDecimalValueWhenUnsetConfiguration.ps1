function Add-VSQuickSightDashboardDecimalValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DecimalValueWhenUnsetConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DecimalValueWhenUnsetConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DecimalValueWhenUnsetConfiguration'
