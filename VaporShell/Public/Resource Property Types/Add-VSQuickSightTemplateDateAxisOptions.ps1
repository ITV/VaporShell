function Add-VSQuickSightTemplateDateAxisOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DateAxisOptions resource property to the template.
    ...
    .PARAMETER MissingDateVisibility
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.DateAxisOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DateAxisOptions'
