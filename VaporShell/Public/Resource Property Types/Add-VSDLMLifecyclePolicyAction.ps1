function Add-VSDLMLifecyclePolicyAction {
    ...
    [OutputType('Vaporshell.Resource.DLM.LifecyclePolicy.Action')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.DLM.LifecyclePolicy.CrossRegionCopyAction"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DLM.LifecyclePolicy.Action'
