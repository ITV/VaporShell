function Add-VSPCSClusterAuthKey {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster.AuthKey resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster.AuthKey'
