function Add-VSQuickSightDashboardContributionAnalysisDefault {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ContributionAnalysisDefault resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ContributionAnalysisDefault'
