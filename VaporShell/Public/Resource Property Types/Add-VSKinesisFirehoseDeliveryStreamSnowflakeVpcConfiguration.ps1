function Add-VSKinesisFirehoseDeliveryStreamSnowflakeVpcConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.SnowflakeVpcConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.SnowflakeVpcConfiguration'
