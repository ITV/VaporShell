function Add-VSQuickSightAnalysisAssetOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.AssetOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.AssetOptions'
