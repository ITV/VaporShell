function Add-VSSageMakerModelCardTrainingHyperParameter {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelCard.TrainingHyperParameter resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelCard.TrainingHyperParameter'
