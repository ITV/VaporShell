function Add-VSQuickSightTemplateBoxPlotStyleOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.BoxPlotStyleOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.BoxPlotStyleOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.BoxPlotStyleOptions'
