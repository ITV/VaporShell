function Add-VSSESMailManagerRuleSetRuleIsInAddressList {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerRuleSet.RuleIsInAddressList resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerRuleSet.RuleIsInAddressList')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerRuleSet.RuleIsInAddressList'
