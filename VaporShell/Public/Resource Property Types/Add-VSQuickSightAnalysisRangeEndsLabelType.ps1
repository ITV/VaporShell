function Add-VSQuickSightAnalysisRangeEndsLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.RangeEndsLabelType resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.RangeEndsLabelType')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.RangeEndsLabelType'
