function Add-VSLexBotDescriptiveBotBuilderSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.DescriptiveBotBuilderSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.DescriptiveBotBuilderSpecification')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.DescriptiveBotBuilderSpecification'
