function Add-VSDeadlineFleetAcceleratorSelection {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Fleet.AcceleratorSelection resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Fleet.AcceleratorSelection'
