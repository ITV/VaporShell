function Add-VSVerifiedPermissionsIdentitySourceCognitoGroupConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::IdentitySource.CognitoGroupConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.IdentitySource.CognitoGroupConfiguration'
