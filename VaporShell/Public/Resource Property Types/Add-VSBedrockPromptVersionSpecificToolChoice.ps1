function Add-VSBedrockPromptVersionSpecificToolChoice {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.SpecificToolChoice resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.SpecificToolChoice')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.SpecificToolChoice'
