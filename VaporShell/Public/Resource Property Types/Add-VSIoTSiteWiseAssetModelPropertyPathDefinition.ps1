function Add-VSIoTSiteWiseAssetModelPropertyPathDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::AssetModel.PropertyPathDefinition resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.AssetModel.PropertyPathDefinition'
