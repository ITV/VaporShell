function Add-VSPCSQueueSlurmConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Queue.SlurmConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.PCS.Queue.SlurmConfiguration')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.PCS.Queue.SlurmCustomSetting"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Queue.SlurmConfiguration'
