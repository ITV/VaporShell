function Add-VSQuickSightDashboardLineChartDefaultSeriesSettings {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.LineChartDefaultSeriesSettings resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.LineChartDefaultSeriesSettings'
