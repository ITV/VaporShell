function Add-VSConnectCampaignsV2CampaignTimeRange {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.TimeRange resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.TimeRange'
