function Add-VSPCSQueueComputeNodeGroupConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Queue.ComputeNodeGroupConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Queue.ComputeNodeGroupConfiguration'
