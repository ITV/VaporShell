function Add-VSPipesPipeCapacityProviderStrategyItem {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.CapacityProviderStrategyItem resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.CapacityProviderStrategyItem'
