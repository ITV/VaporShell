function Add-VSObservabilityAdminTelemetryRuleLoggingFilter {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::TelemetryRule.LoggingFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.LoggingFilter')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.Filter"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.LoggingFilter'
