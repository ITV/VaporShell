function Add-VSQuickSightAnalysisBoxPlotStyleOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BoxPlotStyleOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.BoxPlotStyleOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BoxPlotStyleOptions'
