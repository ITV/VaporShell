function Add-VSMediaLiveChannelInputChannelLevel {
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.InputChannelLevel')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.InputChannelLevel'
