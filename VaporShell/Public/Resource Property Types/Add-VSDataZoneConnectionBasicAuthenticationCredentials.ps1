function Add-VSDataZoneConnectionBasicAuthenticationCredentials {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Connection.BasicAuthenticationCredentials resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Connection.BasicAuthenticationCredentials')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Connection.BasicAuthenticationCredentials'
