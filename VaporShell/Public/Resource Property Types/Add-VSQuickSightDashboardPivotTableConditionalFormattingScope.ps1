function Add-VSQuickSightDashboardPivotTableConditionalFormattingScope {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PivotTableConditionalFormattingScope resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PivotTableConditionalFormattingScope'
