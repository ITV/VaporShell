function Add-VSQuickSightTemplateSecondaryValueOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SecondaryValueOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.SecondaryValueOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SecondaryValueOptions'
