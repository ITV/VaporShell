function Add-VSBedrockFlowVersionLoopControllerFlowNodeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowVersion.LoopControllerFlowNodeConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.FlowVersion.LoopControllerFlowNodeConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowVersion.LoopControllerFlowNodeConfiguration'
