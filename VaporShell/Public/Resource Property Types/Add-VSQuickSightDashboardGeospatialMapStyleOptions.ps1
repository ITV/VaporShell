function Add-VSQuickSightDashboardGeospatialMapStyleOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.GeospatialMapStyleOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.GeospatialMapStyleOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.GeospatialMapStyleOptions'
