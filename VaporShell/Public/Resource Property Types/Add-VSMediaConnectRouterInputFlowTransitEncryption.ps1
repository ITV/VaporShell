function Add-VSMediaConnectRouterInputFlowTransitEncryption {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.FlowTransitEncryption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.FlowTransitEncryption')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.FlowTransitEncryption'
