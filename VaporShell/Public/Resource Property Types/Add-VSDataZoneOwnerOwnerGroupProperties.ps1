function Add-VSDataZoneOwnerOwnerGroupProperties {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Owner.OwnerGroupProperties resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Owner.OwnerGroupProperties')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Owner.OwnerGroupProperties'
