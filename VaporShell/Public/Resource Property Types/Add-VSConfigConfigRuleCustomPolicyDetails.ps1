function Add-VSConfigConfigRuleCustomPolicyDetails {
    <#
    .SYNOPSIS
        Adds an AWS::Config::ConfigRule.CustomPolicyDetails resource property to the template. 
    ...
    .PARAMETER EnableDebugLogDelivery
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConfigRule.CustomPolicyDetails'
