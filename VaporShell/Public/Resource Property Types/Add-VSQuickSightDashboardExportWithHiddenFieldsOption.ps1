function Add-VSQuickSightDashboardExportWithHiddenFieldsOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ExportWithHiddenFieldsOption resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ExportWithHiddenFieldsOption'
