function Add-VSQuickSightDashboardMaximumLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.MaximumLabelType resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.MaximumLabelType'
