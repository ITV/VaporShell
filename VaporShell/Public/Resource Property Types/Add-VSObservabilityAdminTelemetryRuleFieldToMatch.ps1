function Add-VSObservabilityAdminTelemetryRuleFieldToMatch {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::TelemetryRule.FieldToMatch resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.FieldToMatch')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.FieldToMatch'
