function Add-VSQuickSightTemplatePieChartAggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PieChartAggregatedFieldWells resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.PieChartAggregatedFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PieChartAggregatedFieldWells'
