function Add-VSBedrockAgentOrchestrationExecutor {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Agent.OrchestrationExecutor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Agent.OrchestrationExecutor')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Agent.OrchestrationExecutor'
