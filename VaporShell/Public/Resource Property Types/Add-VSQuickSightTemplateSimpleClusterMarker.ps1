function Add-VSQuickSightTemplateSimpleClusterMarker {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SimpleClusterMarker resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SimpleClusterMarker'
