function Add-VSECSServiceLinearConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.LinearConfiguration resource property to the template.
    ...
    .PARAMETER StepBakeTimeInMinutes
    ...
    [OutputType('Vaporshell.Resource.ECS.Service.LinearConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.LinearConfiguration'
