function Add-VSLexBotTextLogSetting {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.TextLogSetting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.TextLogSetting')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.TextLogSetting'
