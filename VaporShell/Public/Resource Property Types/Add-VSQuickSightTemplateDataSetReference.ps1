function Add-VSQuickSightTemplateDataSetReference {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DataSetReference resource property to the template. Dataset reference.

    .DESCRIPTION
        Adds an AWS::QuickSight::Template.DataSetReference resource property to the template.
Dataset reference.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.DataSetReference')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DataSetReference'
