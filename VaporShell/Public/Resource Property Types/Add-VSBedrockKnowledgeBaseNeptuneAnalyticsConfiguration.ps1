function Add-VSBedrockKnowledgeBaseNeptuneAnalyticsConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.NeptuneAnalyticsConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.KnowledgeBase.NeptuneAnalyticsConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.NeptuneAnalyticsConfiguration'
