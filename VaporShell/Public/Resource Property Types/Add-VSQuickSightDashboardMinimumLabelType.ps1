function Add-VSQuickSightDashboardMinimumLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.MinimumLabelType resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.MinimumLabelType'
