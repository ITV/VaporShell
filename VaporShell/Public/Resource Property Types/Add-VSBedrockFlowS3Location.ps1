function Add-VSBedrockFlowS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.S3Location resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.S3Location'
