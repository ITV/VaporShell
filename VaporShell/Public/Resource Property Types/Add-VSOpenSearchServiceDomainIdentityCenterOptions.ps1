function Add-VSOpenSearchServiceDomainIdentityCenterOptions {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Domain.IdentityCenterOptions resource property to the template.
    ...
    .PARAMETER IdentityCenterApplicationARN
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain.IdentityCenterOptions'
