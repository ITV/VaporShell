function Add-VSQuickSightDashboardAnalysisDefaults {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.AnalysisDefaults resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.AnalysisDefaults'
