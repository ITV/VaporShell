function Add-VSQuickSightAnalysisTableRowConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TableRowConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TableRowConditionalFormatting')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TableRowConditionalFormatting'
