function Add-VSQuickSightAnalysisCustomNarrativeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.CustomNarrativeOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.CustomNarrativeOptions'
