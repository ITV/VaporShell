function Add-VSDataSyncStorageSystemServerConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::StorageSystem.ServerConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataSync.StorageSystem.ServerConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.StorageSystem.ServerConfiguration'
