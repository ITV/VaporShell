function Add-VSQuickSightTemplateNullValueFormatConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.NullValueFormatConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.NullValueFormatConfiguration'
