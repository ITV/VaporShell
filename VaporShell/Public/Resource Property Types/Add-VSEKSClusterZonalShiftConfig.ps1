function Add-VSEKSClusterZonalShiftConfig {
    <#
    .SYNOPSIS
        Adds an AWS::EKS::Cluster.ZonalShiftConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Cluster.ZonalShiftConfig'
