function Add-VSQuickSightTemplateTrendArrowOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TrendArrowOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.TrendArrowOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TrendArrowOptions'
