function Add-VSQuickSightTemplateWordCloudVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.WordCloudVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-wordcloudvisual.html#cfn-quicksight-template-wordcloudvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.WordCloudVisual')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.WordCloudVisual'
