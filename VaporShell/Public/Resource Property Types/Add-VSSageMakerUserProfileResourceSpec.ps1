function Add-VSSageMakerUserProfileResourceSpec {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.ResourceSpec resource property to the template. Specifies the ARN's of a SageMaker image and SageMaker image version, and the instance type that the version runs on.
