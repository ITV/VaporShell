function Add-VSQuickSightTemplateStringParameterDeclaration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.StringParameterDeclaration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.StringParameterDeclaration'
