function Add-VSIoTFleetWiseCampaignStorageMaximumSize {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.StorageMaximumSize resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.StorageMaximumSize'
