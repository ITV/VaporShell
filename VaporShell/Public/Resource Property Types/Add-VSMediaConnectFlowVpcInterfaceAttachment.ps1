function Add-VSMediaConnectFlowVpcInterfaceAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Flow.VpcInterfaceAttachment resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Flow.VpcInterfaceAttachment'
