function Add-VSPCAConnectorADTemplateApplicationPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::PCAConnectorAD::Template.ApplicationPolicy resource property to the template. 
    ...
    .PARAMETER PolicyObjectIdentifier
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCAConnectorAD.Template.ApplicationPolicy'
