function Add-VSDataZonePolicyGrantCreateGlossaryPolicyGrantDetail {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.CreateGlossaryPolicyGrantDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.CreateGlossaryPolicyGrantDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.CreateGlossaryPolicyGrantDetail'
