function Add-VSLexBotDialogAction {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.DialogAction resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.DialogAction'
