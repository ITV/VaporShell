function Add-VSWAFv2WebACLOnSourceDDoSProtectionConfig {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.OnSourceDDoSProtectionConfig resource property to the template.
    ...
    .PARAMETER ALBLowReputationMode
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.OnSourceDDoSProtectionConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.OnSourceDDoSProtectionConfig'
