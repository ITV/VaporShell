function Add-VSQuickSightAnalysisConditionalFormattingSolidColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ConditionalFormattingSolidColor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ConditionalFormattingSolidColor')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ConditionalFormattingSolidColor'
