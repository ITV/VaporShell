function Add-VSQuickSightTemplateMaximumLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.MaximumLabelType resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.MaximumLabelType')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.MaximumLabelType'
