function Add-VSCustomerProfilesSegmentDefinitionProfileTypeDimension {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::SegmentDefinition.ProfileTypeDimension resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.SegmentDefinition.ProfileTypeDimension')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.SegmentDefinition.ProfileTypeDimension'
