function Add-VSLookoutEquipmentInferenceSchedulerDataOutputConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutEquipment::InferenceScheduler.DataOutputConfiguration resource property to the template.
    ...
    .PARAMETER S3OutputConfiguration
    ...
    [OutputType('Vaporshell.Resource.LookoutEquipment.InferenceScheduler.DataOutputConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutEquipment.InferenceScheduler.DataOutputConfiguration'
