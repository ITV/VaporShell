function Add-VSLightsailInstanceSnapshotLocation {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::InstanceSnapshot.Location resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lightsail.InstanceSnapshot.Location')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.InstanceSnapshot.Location'
