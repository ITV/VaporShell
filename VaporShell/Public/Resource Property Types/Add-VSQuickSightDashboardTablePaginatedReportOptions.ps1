function Add-VSQuickSightDashboardTablePaginatedReportOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TablePaginatedReportOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.TablePaginatedReportOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TablePaginatedReportOptions'
