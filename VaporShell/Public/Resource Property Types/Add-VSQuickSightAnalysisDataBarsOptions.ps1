function Add-VSQuickSightAnalysisDataBarsOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DataBarsOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.DataBarsOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DataBarsOptions'
