function Add-VSBedrockIntelligentPromptRouterRoutingCriteria {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::IntelligentPromptRouter.RoutingCriteria resource property to the template.
    ...
    .PARAMETER ResponseQualityDifference
    ...
    [OutputType('Vaporshell.Resource.Bedrock.IntelligentPromptRouter.RoutingCriteria')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.IntelligentPromptRouter.RoutingCriteria'
