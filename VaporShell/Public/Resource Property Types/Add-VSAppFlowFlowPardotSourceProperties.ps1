function Add-VSAppFlowFlowPardotSourceProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.PardotSourceProperties resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Flow.PardotSourceProperties'
