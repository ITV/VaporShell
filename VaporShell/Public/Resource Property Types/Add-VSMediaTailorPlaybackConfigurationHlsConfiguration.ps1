function Add-VSMediaTailorPlaybackConfigurationHlsConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::PlaybackConfiguration.HlsConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.PlaybackConfiguration.HlsConfiguration'
