function Add-VSKendraDataSourceTemplateConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Kendra::DataSource.TemplateConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Kendra.DataSource.TemplateConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kendra.DataSource.TemplateConfiguration'
