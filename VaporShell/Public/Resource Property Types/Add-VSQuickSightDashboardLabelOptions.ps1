function Add-VSQuickSightDashboardLabelOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.LabelOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.LabelOptions'
