function Add-VSDataZonePolicyGrantCreateAssetTypePolicyGrantDetail {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.CreateAssetTypePolicyGrantDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.CreateAssetTypePolicyGrantDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.CreateAssetTypePolicyGrantDetail'
