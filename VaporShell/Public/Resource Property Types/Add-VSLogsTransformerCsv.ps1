function Add-VSLogsTransformerCsv {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Transformer.Csv resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Transformer.Csv'
