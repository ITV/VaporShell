function Add-VSMediaLiveNetworkTags {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Network.Tags resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Network.Tags'
