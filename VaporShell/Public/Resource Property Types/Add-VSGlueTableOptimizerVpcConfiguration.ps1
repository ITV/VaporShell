function Add-VSGlueTableOptimizerVpcConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::TableOptimizer.VpcConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.TableOptimizer.VpcConfiguration'
