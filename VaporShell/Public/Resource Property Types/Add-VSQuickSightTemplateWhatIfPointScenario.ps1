function Add-VSQuickSightTemplateWhatIfPointScenario {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.WhatIfPointScenario resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.WhatIfPointScenario'
