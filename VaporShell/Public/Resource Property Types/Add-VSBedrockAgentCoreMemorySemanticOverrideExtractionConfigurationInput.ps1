function Add-VSBedrockAgentCoreMemorySemanticOverrideExtractionConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.SemanticOverrideExtractionConfigurationInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.SemanticOverrideExtractionConfigurationInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.SemanticOverrideExtractionConfigurationInput'
