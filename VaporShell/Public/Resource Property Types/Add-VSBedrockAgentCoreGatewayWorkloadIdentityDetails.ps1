function Add-VSBedrockAgentCoreGatewayWorkloadIdentityDetails {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Gateway.WorkloadIdentityDetails resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Gateway.WorkloadIdentityDetails')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Gateway.WorkloadIdentityDetails'
