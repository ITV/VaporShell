function Add-VSS3StorageLensAdvancedCostOptimizationMetrics {
    <#
    .SYNOPSIS
        Adds an AWS::S3::StorageLens.AdvancedCostOptimizationMetrics resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.StorageLens.AdvancedCostOptimizationMetrics')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.StorageLens.AdvancedCostOptimizationMetrics'
