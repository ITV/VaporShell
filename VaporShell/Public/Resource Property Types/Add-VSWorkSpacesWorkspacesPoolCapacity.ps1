function Add-VSWorkSpacesWorkspacesPoolCapacity {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpaces::WorkspacesPool.Capacity resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkSpaces.WorkspacesPool.Capacity'
