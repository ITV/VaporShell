function Add-VSQuickSightAnalysisTrendArrowOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TrendArrowOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TrendArrowOptions'
