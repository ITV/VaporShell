function Add-VSQuickSightAnalysisArcConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ArcConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ArcConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ArcConfiguration'
