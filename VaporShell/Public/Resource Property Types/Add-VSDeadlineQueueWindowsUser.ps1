function Add-VSDeadlineQueueWindowsUser {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Queue.WindowsUser resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Queue.WindowsUser'
