function Add-VSEVSEnvironmentLicenseInfo {
    <#
    .SYNOPSIS
        Adds an AWS::EVS::Environment.LicenseInfo resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EVS.Environment.LicenseInfo')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EVS.Environment.LicenseInfo'
