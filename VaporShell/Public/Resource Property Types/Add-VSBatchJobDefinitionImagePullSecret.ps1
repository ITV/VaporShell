function Add-VSBatchJobDefinitionImagePullSecret {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobDefinition.ImagePullSecret resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Batch.JobDefinition.ImagePullSecret')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition.ImagePullSecret'
