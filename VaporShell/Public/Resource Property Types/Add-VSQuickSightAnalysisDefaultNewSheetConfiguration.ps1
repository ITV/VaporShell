function Add-VSQuickSightAnalysisDefaultNewSheetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DefaultNewSheetConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.DefaultNewSheetConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DefaultNewSheetConfiguration'
