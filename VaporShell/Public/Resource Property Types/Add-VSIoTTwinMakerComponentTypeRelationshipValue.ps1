function Add-VSIoTTwinMakerComponentTypeRelationshipValue {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::ComponentType.RelationshipValue resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTTwinMaker.ComponentType.RelationshipValue')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.ComponentType.RelationshipValue'
