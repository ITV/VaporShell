function Add-VSQuickSightAnalysisFunnelChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FunnelChartFieldWells resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FunnelChartFieldWells')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FunnelChartFieldWells'
