function Add-VSBedrockGuardrailTopicsTierConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Guardrail.TopicsTierConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Guardrail.TopicsTierConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Guardrail.TopicsTierConfig'
