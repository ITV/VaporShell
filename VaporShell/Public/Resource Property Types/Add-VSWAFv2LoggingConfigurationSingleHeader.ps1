function Add-VSWAFv2LoggingConfigurationSingleHeader {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::LoggingConfiguration.SingleHeader resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.LoggingConfiguration.SingleHeader'
