function Add-VSAppMeshVirtualNodeTlsValidationContextFileTrust {
    ...
    [OutputType('Vaporshell.Resource.AppMesh.VirtualNode.TlsValidationContextFileTrust')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppMesh.VirtualNode.TlsValidationContextFileTrust'
