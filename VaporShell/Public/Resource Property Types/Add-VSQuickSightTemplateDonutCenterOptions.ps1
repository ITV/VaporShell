function Add-VSQuickSightTemplateDonutCenterOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DonutCenterOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DonutCenterOptions'
