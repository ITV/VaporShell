function Add-VSDataZoneDataSourceRedshiftCredentialConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DataSource.RedshiftCredentialConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DataSource.RedshiftCredentialConfiguration'
