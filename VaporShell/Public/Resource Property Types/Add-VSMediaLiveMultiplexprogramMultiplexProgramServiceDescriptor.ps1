function Add-VSMediaLiveMultiplexprogramMultiplexProgramServiceDescriptor {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Multiplexprogram.MultiplexProgramServiceDescriptor resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaLive.Multiplexprogram.MultiplexProgramServiceDescriptor')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Multiplexprogram.MultiplexProgramServiceDescriptor'
