function Add-VSTransferWorkflowDecryptStepDetails {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::Workflow.DecryptStepDetails resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.Workflow.DecryptStepDetails'
