function Add-VSQuickSightTopicCollectiveConstant {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Topic.CollectiveConstant resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Topic.CollectiveConstant'
