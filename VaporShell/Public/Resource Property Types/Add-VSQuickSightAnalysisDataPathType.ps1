function Add-VSQuickSightAnalysisDataPathType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DataPathType resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DataPathType'
