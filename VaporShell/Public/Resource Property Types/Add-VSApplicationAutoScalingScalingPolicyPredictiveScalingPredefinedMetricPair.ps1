function Add-VSApplicationAutoScalingScalingPolicyPredictiveScalingPredefinedMetricPair {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingPredefinedMetricPair resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingPredefinedMetricPair')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingPredefinedMetricPair'
