function Add-VSQuickSightDashboardPivotTableFieldOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PivotTableFieldOption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.PivotTableFieldOption')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PivotTableFieldOption'
