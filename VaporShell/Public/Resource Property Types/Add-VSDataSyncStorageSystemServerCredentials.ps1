function Add-VSDataSyncStorageSystemServerCredentials {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::StorageSystem.ServerCredentials resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataSync.StorageSystem.ServerCredentials')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.StorageSystem.ServerCredentials'
