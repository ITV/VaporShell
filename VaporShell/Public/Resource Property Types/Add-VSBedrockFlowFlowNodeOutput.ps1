function Add-VSBedrockFlowFlowNodeOutput {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.FlowNodeOutput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.FlowNodeOutput')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.FlowNodeOutput'
