function Add-VSQuickSightTemplateIntegerValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.IntegerValueWhenUnsetConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.IntegerValueWhenUnsetConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.IntegerValueWhenUnsetConfiguration'
