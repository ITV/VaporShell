function Add-VSAmplifyUIBuilderFormFormStyleConfig {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Form.FormStyleConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AmplifyUIBuilder.Form.FormStyleConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AmplifyUIBuilder.Form.FormStyleConfig'
