function Add-VSEvidentlyExperimentRunningStatusObject {
    <#
    .SYNOPSIS
        Adds an AWS::Evidently::Experiment.RunningStatusObject resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Evidently.Experiment.RunningStatusObject'
