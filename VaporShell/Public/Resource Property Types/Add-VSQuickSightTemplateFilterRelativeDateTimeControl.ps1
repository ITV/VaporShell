function Add-VSQuickSightTemplateFilterRelativeDateTimeControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FilterRelativeDateTimeControl resource property to the template.
    ...
    .PARAMETER CommitMode
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-filterrelativedatetimecontrol.html#cfn-quicksight-template-filterrelativedatetimecontrol-commitmode
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.FilterRelativeDateTimeControl')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FilterRelativeDateTimeControl'
