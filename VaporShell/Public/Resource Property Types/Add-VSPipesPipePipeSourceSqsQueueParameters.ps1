function Add-VSPipesPipePipeSourceSqsQueueParameters {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.PipeSourceSqsQueueParameters resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Pipes.Pipe.PipeSourceSqsQueueParameters')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.PipeSourceSqsQueueParameters'
