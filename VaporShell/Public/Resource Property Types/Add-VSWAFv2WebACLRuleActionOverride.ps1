function Add-VSWAFv2WebACLRuleActionOverride {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RuleActionOverride resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.RuleActionOverride')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RuleActionOverride'
