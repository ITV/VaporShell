function Add-VSQuickSightDashboardTextControlPlaceholderOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TextControlPlaceholderOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TextControlPlaceholderOptions'
