function Add-VSGameLiftContainerFleetLogConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerFleet.LogConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.GameLift.ContainerFleet.LogConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerFleet.LogConfiguration'
