function Add-VSRefactorSpacesRouteDefaultRouteInput {
    <#
    .SYNOPSIS
        Adds an AWS::RefactorSpaces::Route.DefaultRouteInput resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RefactorSpaces.Route.DefaultRouteInput'
