function Add-VSCustomerProfilesIntegrationConnectorOperator {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::Integration.ConnectorOperator resource property to the template. <a name="aws-properties-customerprofiles-integration-connectoroperator-description"></a>The ConnectorOperator property type specifies Not currently supported by AWS CloudFormation. for an AWS::CustomerProfiles::Integration: aws-resource-customerprofiles-integration.md.

    .DESCRIPTION
        Adds an AWS::CustomerProfiles::Integration.ConnectorOperator resource property to the template.
<a name="aws-properties-customerprofiles-integration-connectoroperator-description"></a>The ConnectorOperator property type specifies Not currently supported by AWS CloudFormation. for an AWS::CustomerProfiles::Integration: aws-resource-customerprofiles-integration.md.
