function Add-VSARCRegionSwitchPlanAssociatedAlarm {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.AssociatedAlarm resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.AssociatedAlarm')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.AssociatedAlarm'
