function Add-VSCleanRoomsAnalysisTemplateSyntheticDataColumnProperties {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::AnalysisTemplate.SyntheticDataColumnProperties resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.AnalysisTemplate.SyntheticDataColumnProperties')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.AnalysisTemplate.SyntheticDataColumnProperties'
