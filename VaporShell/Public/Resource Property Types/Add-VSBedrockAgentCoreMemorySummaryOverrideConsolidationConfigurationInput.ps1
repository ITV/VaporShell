function Add-VSBedrockAgentCoreMemorySummaryOverrideConsolidationConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.SummaryOverrideConsolidationConfigurationInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.SummaryOverrideConsolidationConfigurationInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.SummaryOverrideConsolidationConfigurationInput'
