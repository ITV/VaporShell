function Add-VSQuickSightTemplateDataBarsOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DataBarsOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.DataBarsOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DataBarsOptions'
