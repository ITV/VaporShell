function Add-VSQuickSightAnalysisTotalAggregationFunction {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TotalAggregationFunction resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TotalAggregationFunction')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TotalAggregationFunction'
