function Add-VSOpenSearchServiceDomainNodeConfig {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Domain.NodeConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain.NodeConfig'
