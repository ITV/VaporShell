function Add-VSPipesPipeBatchJobDependency {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.BatchJobDependency resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Pipes.Pipe.BatchJobDependency')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.BatchJobDependency'
