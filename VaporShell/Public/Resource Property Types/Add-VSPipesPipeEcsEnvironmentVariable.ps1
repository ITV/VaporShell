function Add-VSPipesPipeEcsEnvironmentVariable {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.EcsEnvironmentVariable resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Pipes.Pipe.EcsEnvironmentVariable')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.EcsEnvironmentVariable'
