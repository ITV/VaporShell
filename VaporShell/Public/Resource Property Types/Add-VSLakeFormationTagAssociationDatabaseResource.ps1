function Add-VSLakeFormationTagAssociationDatabaseResource {
    <#
    .SYNOPSIS
        Adds an AWS::LakeFormation::TagAssociation.DatabaseResource resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LakeFormation.TagAssociation.DatabaseResource'
