function Add-VSSageMakerModelQualityJobDefinitionS3Output {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelQualityJobDefinition.S3Output resource property to the template. The Amazon S3 storage location where the results of a monitoring job are saved.

    .DESCRIPTION
        Adds an AWS::SageMaker::ModelQualityJobDefinition.S3Output resource property to the template.
The Amazon S3 storage location where the results of a monitoring job are saved.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.ModelQualityJobDefinition.S3Output')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelQualityJobDefinition.S3Output'
