function Add-VSQuickSightDashboardLongFormatText {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.LongFormatText resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.LongFormatText'
