function Add-VSSSOApplicationPortalOptionsConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::SSO::Application.PortalOptionsConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SSO.Application.PortalOptionsConfiguration'
