function Add-VSQuickSightAnalysisFieldSeriesItem {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FieldSeriesItem resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FieldSeriesItem')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FieldSeriesItem'
