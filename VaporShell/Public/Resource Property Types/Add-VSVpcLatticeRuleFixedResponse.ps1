function Add-VSVpcLatticeRuleFixedResponse {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::Rule.FixedResponse resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.Rule.FixedResponse'
