function Add-VSSecurityLakeDataLakeExpiration {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::DataLake.Expiration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.DataLake.Expiration'
