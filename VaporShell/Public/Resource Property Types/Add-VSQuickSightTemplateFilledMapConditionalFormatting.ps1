function Add-VSQuickSightTemplateFilledMapConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FilledMapConditionalFormatting resource property to the template. 
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Template.FilledMapConditionalFormattingOption"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FilledMapConditionalFormatting'
