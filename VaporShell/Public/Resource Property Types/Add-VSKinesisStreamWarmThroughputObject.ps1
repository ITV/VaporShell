function Add-VSKinesisStreamWarmThroughputObject {
    <#
    .SYNOPSIS
        Adds an AWS::Kinesis::Stream.WarmThroughputObject resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Kinesis.Stream.WarmThroughputObject')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kinesis.Stream.WarmThroughputObject'
