function Add-VSIoTSiteWiseGatewaySiemensIE {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::Gateway.SiemensIE resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTSiteWise.Gateway.SiemensIE')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.Gateway.SiemensIE'
