function Add-VSMediaConnectRouterInputRouterInputTransitEncryption {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.RouterInputTransitEncryption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.RouterInputTransitEncryption')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.RouterInputTransitEncryption'
