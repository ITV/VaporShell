function Add-VSBedrockDataSourceChunkingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataSource.ChunkingConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataSource.ChunkingConfiguration'
