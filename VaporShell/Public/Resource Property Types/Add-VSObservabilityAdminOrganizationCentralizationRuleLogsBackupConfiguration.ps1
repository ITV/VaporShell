function Add-VSObservabilityAdminOrganizationCentralizationRuleLogsBackupConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationCentralizationRule.LogsBackupConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.LogsBackupConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.LogsBackupConfiguration'
