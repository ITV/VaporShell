function Add-VSBedrockKnowledgeBaseS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.S3Location resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.S3Location'
