function Add-VSPinpointCampaignDefaultButtonConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Pinpoint::Campaign.DefaultButtonConfiguration resource property to the template. Specifies the default behavior for a button that appears in an in-app message. You can optionally add button configurations that specifically apply to iOS, Android, or web browser users.
