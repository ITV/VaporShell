function Add-VSEC2VerifiedAccessEndpointPortRange {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessEndpoint.PortRange resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessEndpoint.PortRange'
