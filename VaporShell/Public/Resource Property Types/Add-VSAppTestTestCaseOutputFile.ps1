function Add-VSAppTestTestCaseOutputFile {
    <#
    .SYNOPSIS
        Adds an AWS::AppTest::TestCase.OutputFile resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppTest.TestCase.OutputFile')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppTest.TestCase.OutputFile'
