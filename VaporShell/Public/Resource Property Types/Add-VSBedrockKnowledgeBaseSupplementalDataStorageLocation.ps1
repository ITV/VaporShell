function Add-VSBedrockKnowledgeBaseSupplementalDataStorageLocation {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.SupplementalDataStorageLocation resource property to the template.
    ...
    .PARAMETER SupplementalDataStorageLocationType
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.SupplementalDataStorageLocation'
