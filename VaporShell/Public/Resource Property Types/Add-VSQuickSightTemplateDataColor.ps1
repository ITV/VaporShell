function Add-VSQuickSightTemplateDataColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DataColor resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DataColor'
