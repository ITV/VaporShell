function Add-VSLexBotReplication {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.Replication resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.Replication'
