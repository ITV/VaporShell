function Add-VSIVSChatLoggingConfigurationFirehoseDestinationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IVSChat::LoggingConfiguration.FirehoseDestinationConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IVSChat.LoggingConfiguration.FirehoseDestinationConfiguration'
