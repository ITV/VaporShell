function Add-VSElastiCacheServerlessCacheEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::ElastiCache::ServerlessCache.Endpoint resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElastiCache.ServerlessCache.Endpoint'
