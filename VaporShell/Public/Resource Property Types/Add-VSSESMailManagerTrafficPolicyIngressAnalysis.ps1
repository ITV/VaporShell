function Add-VSSESMailManagerTrafficPolicyIngressAnalysis {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerTrafficPolicy.IngressAnalysis resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressAnalysis')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressAnalysis'
