function Add-VSQuickSightDashboardPivotTotalOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PivotTotalOptions resource property to the template. 
    ...
    .PARAMETER TotalAggregationOptions
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-pivottotaloptions.html#cfn-quicksight-dashboard-pivottotaloptions-totalaggregationoptions
        UpdateType: Mutable
        Type: List
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PivotTotalOptions'
