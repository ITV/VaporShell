function Add-VSVpcLatticeRuleHeaderMatchType {
    <#
    .SYNOPSIS
        Adds an AWS::VpcLattice::Rule.HeaderMatchType resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.VpcLattice.Rule.HeaderMatchType')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VpcLattice.Rule.HeaderMatchType'
