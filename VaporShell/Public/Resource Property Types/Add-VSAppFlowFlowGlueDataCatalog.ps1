function Add-VSAppFlowFlowGlueDataCatalog {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.GlueDataCatalog resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Flow.GlueDataCatalog'
