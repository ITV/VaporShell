function Add-VSQuickSightDashboardDateMeasureField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DateMeasureField resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DateMeasureField')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DateMeasureField'
