function Add-VSECSServiceLogConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.LogConfiguration resource property to the template. 
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ECS.Service.Secret"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.LogConfiguration'
