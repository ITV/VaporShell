function Add-VSEntityResolutionIdMappingWorkflowRule {
    <#
    .SYNOPSIS
        Adds an AWS::EntityResolution::IdMappingWorkflow.Rule resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EntityResolution.IdMappingWorkflow.Rule'
