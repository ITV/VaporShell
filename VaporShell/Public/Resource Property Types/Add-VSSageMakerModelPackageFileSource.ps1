function Add-VSSageMakerModelPackageFileSource {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelPackage.FileSource resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.ModelPackage.FileSource')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelPackage.FileSource'
