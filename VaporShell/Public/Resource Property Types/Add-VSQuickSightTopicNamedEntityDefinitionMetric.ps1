function Add-VSQuickSightTopicNamedEntityDefinitionMetric {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Topic.NamedEntityDefinitionMetric resource property to the template. 
    ...
    .PARAMETER AggregationFunctionParameters
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Topic.NamedEntityDefinitionMetric'
