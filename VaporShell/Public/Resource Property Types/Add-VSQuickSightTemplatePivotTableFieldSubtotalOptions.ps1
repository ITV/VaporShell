function Add-VSQuickSightTemplatePivotTableFieldSubtotalOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PivotTableFieldSubtotalOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PivotTableFieldSubtotalOptions'
