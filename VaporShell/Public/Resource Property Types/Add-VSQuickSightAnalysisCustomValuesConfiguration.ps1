function Add-VSQuickSightAnalysisCustomValuesConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.CustomValuesConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.CustomValuesConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.CustomValuesConfiguration'
