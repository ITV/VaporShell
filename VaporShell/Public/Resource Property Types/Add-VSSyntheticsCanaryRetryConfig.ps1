function Add-VSSyntheticsCanaryRetryConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Synthetics::Canary.RetryConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Synthetics.Canary.RetryConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Synthetics.Canary.RetryConfig'
