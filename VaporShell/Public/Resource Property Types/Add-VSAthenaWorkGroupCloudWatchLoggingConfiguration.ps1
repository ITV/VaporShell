function Add-VSAthenaWorkGroupCloudWatchLoggingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Athena::WorkGroup.CloudWatchLoggingConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Athena.WorkGroup.CloudWatchLoggingConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Athena.WorkGroup.CloudWatchLoggingConfiguration'
