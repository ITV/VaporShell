function Add-VSSecurityHubAutomationRuleV2BooleanFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2.BooleanFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2.BooleanFilter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2.BooleanFilter'
