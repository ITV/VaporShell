function Add-VSCustomerProfilesSegmentDefinitionExtraLengthValueProfileDimension {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::SegmentDefinition.ExtraLengthValueProfileDimension resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.SegmentDefinition.ExtraLengthValueProfileDimension'
