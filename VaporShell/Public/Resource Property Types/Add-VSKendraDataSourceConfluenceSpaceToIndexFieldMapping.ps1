function Add-VSKendraDataSourceConfluenceSpaceToIndexFieldMapping {
    <#
    .SYNOPSIS
        Adds an AWS::Kendra::DataSource.ConfluenceSpaceToIndexFieldMapping resource property to the template. >Maps attributes or field names of Confluence spaces to Amazon Kendra index field names. To create custom fields, use the UpdateIndex API before you map to Confluence fields. For more information, see Mapping data source fields: https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html. The Confluence data source field names must exist in your Confluence custom metadata.

    .DESCRIPTION
        Adds an AWS::Kendra::DataSource.ConfluenceSpaceToIndexFieldMapping resource property to the template.
>Maps attributes or field names of Confluence spaces to Amazon Kendra index field names. To create custom fields, use the UpdateIndex API before you map to Confluence fields. For more information, see Mapping data source fields: https://docs.aws.amazon.com/kendra/latest/dg/field-mapping.html. The Confluence data source field names must exist in your Confluence custom metadata.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Kendra.DataSource.ConfluenceSpaceToIndexFieldMapping')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Kendra.DataSource.ConfluenceSpaceToIndexFieldMapping'
