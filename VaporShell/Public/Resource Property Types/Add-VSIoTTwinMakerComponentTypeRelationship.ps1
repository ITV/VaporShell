function Add-VSIoTTwinMakerComponentTypeRelationship {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::ComponentType.Relationship resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.ComponentType.Relationship'
