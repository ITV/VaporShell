function Add-VSBedrockAgentCoreRuntimeS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Runtime.S3Location resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Runtime.S3Location')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Runtime.S3Location'
