function Add-VSOpenSearchServerlessIndexMappings {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::Index.Mappings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.Index.Mappings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.Index.Mappings'
