function Add-VSSchedulerScheduleEventBridgeParameters {
    <#
    .SYNOPSIS
        Adds an AWS::Scheduler::Schedule.EventBridgeParameters resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Scheduler.Schedule.EventBridgeParameters'
