function Add-VSBedrockFlowKnowledgeBaseOrchestrationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.KnowledgeBaseOrchestrationConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.KnowledgeBaseOrchestrationConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.KnowledgeBaseOrchestrationConfiguration'
