function Add-VSQuickSightDashboardFreeFormLayoutElementBackgroundStyle {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.FreeFormLayoutElementBackgroundStyle resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.FreeFormLayoutElementBackgroundStyle')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.FreeFormLayoutElementBackgroundStyle'
