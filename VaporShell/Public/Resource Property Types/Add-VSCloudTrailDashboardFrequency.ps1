function Add-VSCloudTrailDashboardFrequency {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::Dashboard.Frequency resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.Dashboard.Frequency'
