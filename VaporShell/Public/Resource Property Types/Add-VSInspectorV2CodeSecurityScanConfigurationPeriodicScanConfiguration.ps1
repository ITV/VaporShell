function Add-VSInspectorV2CodeSecurityScanConfigurationPeriodicScanConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::InspectorV2::CodeSecurityScanConfiguration.PeriodicScanConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.InspectorV2.CodeSecurityScanConfiguration.PeriodicScanConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.InspectorV2.CodeSecurityScanConfiguration.PeriodicScanConfiguration'
