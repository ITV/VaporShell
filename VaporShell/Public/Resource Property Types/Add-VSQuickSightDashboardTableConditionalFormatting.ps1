function Add-VSQuickSightDashboardTableConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TableConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.TableConditionalFormatting')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Dashboard.TableConditionalFormattingOption"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TableConditionalFormatting'
