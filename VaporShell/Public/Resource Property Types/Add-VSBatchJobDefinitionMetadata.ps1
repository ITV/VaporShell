function Add-VSBatchJobDefinitionMetadata {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobDefinition.Metadata resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Batch.JobDefinition.Metadata')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition.Metadata'
