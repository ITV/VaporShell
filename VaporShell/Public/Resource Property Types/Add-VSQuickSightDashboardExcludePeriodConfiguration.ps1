function Add-VSQuickSightDashboardExcludePeriodConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ExcludePeriodConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ExcludePeriodConfiguration'
