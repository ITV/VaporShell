function Add-VSMediaConnectRouterNetworkInterfaceRouterNetworkInterfaceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterNetworkInterface.RouterNetworkInterfaceConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterNetworkInterface.RouterNetworkInterfaceConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterNetworkInterface.RouterNetworkInterfaceConfiguration'
