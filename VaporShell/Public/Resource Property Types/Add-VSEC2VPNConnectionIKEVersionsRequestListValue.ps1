function Add-VSEC2VPNConnectionIKEVersionsRequestListValue {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VPNConnection.IKEVersionsRequestListValue resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.VPNConnection.IKEVersionsRequestListValue')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPNConnection.IKEVersionsRequestListValue'
