function Add-VSLookoutMetricsAnomalyDetectorAppFlowConfig {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutMetrics::AnomalyDetector.AppFlowConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.LookoutMetrics.AnomalyDetector.AppFlowConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutMetrics.AnomalyDetector.AppFlowConfig'
