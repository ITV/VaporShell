function Add-VSGameLiftFleetTargetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::Fleet.TargetConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.Fleet.TargetConfiguration'
