function Add-VSPipesPipePipeTargetLambdaFunctionParameters {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.PipeTargetLambdaFunctionParameters resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.PipeTargetLambdaFunctionParameters'
