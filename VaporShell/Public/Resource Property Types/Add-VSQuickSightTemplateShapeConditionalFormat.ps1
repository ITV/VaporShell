function Add-VSQuickSightTemplateShapeConditionalFormat {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ShapeConditionalFormat resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ShapeConditionalFormat'
