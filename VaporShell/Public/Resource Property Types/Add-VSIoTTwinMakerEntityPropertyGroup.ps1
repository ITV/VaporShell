function Add-VSIoTTwinMakerEntityPropertyGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::Entity.PropertyGroup resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.Entity.PropertyGroup'
