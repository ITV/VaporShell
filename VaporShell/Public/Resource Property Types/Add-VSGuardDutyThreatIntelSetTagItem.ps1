function Add-VSGuardDutyThreatIntelSetTagItem {
    <#
    .SYNOPSIS
        Adds an AWS::GuardDuty::ThreatIntelSet.TagItem resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GuardDuty.ThreatIntelSet.TagItem'
