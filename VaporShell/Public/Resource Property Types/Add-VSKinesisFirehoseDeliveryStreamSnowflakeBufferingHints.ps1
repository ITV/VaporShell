function Add-VSKinesisFirehoseDeliveryStreamSnowflakeBufferingHints {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.SnowflakeBufferingHints resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.SnowflakeBufferingHints'
