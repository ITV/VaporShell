function Add-VSECSExpressGatewayServiceSecret {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::ExpressGatewayService.Secret resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.ExpressGatewayService.Secret')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.ExpressGatewayService.Secret'
