function Add-VSFMSPolicyNetworkFirewallPolicy {
    <#
    .SYNOPSIS
        Adds an AWS::FMS::Policy.NetworkFirewallPolicy resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FMS.Policy.NetworkFirewallPolicy'
