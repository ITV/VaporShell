function Add-VSQuickSightTemplateFilterTextFieldControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FilterTextFieldControl resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.FilterTextFieldControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FilterTextFieldControl'
