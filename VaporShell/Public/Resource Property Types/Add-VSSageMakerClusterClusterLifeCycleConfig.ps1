function Add-VSSageMakerClusterClusterLifeCycleConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Cluster.ClusterLifeCycleConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.Cluster.ClusterLifeCycleConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Cluster.ClusterLifeCycleConfig'
