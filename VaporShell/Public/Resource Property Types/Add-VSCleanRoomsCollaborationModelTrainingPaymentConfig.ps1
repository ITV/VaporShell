function Add-VSCleanRoomsCollaborationModelTrainingPaymentConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Collaboration.ModelTrainingPaymentConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Collaboration.ModelTrainingPaymentConfig'
