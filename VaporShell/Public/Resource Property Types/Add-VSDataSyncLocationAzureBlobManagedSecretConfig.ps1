function Add-VSDataSyncLocationAzureBlobManagedSecretConfig {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationAzureBlob.ManagedSecretConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationAzureBlob.ManagedSecretConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationAzureBlob.ManagedSecretConfig'
