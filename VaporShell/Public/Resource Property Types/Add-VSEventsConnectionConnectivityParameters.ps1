function Add-VSEventsConnectionConnectivityParameters {
    <#
    .SYNOPSIS
        Adds an AWS::Events::Connection.ConnectivityParameters resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Events.Connection.ConnectivityParameters'
