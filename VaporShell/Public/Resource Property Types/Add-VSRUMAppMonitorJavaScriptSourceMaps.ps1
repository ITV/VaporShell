function Add-VSRUMAppMonitorJavaScriptSourceMaps {
    <#
    .SYNOPSIS
        Adds an AWS::RUM::AppMonitor.JavaScriptSourceMaps resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.RUM.AppMonitor.JavaScriptSourceMaps')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RUM.AppMonitor.JavaScriptSourceMaps'
