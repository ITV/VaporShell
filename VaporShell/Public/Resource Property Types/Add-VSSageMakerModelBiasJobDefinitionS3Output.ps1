function Add-VSSageMakerModelBiasJobDefinitionS3Output {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelBiasJobDefinition.S3Output resource property to the template. The Amazon S3 storage location where the results of a monitoring job are saved.

    .DESCRIPTION
        Adds an AWS::SageMaker::ModelBiasJobDefinition.S3Output resource property to the template.
The Amazon S3 storage location where the results of a monitoring job are saved.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelBiasJobDefinition.S3Output'
