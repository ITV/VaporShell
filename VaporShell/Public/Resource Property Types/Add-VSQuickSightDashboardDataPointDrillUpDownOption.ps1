function Add-VSQuickSightDashboardDataPointDrillUpDownOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DataPointDrillUpDownOption resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DataPointDrillUpDownOption'
