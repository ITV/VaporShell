function Add-VSQuickSightAnalysisWhatIfRangeScenario {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.WhatIfRangeScenario resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.WhatIfRangeScenario')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.WhatIfRangeScenario'
