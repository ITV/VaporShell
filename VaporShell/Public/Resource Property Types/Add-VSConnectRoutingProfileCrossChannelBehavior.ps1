function Add-VSConnectRoutingProfileCrossChannelBehavior {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::RoutingProfile.CrossChannelBehavior resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.RoutingProfile.CrossChannelBehavior'
