function Add-VSLogsMetricFilterDimension {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::MetricFilter.Dimension resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.MetricFilter.Dimension'
