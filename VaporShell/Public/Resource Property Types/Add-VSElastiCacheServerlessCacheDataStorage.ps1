function Add-VSElastiCacheServerlessCacheDataStorage {
    <#
    .SYNOPSIS
        Adds an AWS::ElastiCache::ServerlessCache.DataStorage resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ElastiCache.ServerlessCache.DataStorage')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElastiCache.ServerlessCache.DataStorage'
