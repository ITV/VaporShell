function Add-VSConnectTaskTemplateField {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::TaskTemplate.Field resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.TaskTemplate.Field'
