function Add-VSQuickSightAnalysisFilledMapAggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FilledMapAggregatedFieldWells resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FilledMapAggregatedFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FilledMapAggregatedFieldWells'
