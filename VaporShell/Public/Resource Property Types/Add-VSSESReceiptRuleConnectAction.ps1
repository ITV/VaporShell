function Add-VSSESReceiptRuleConnectAction {
    <#
    .SYNOPSIS
        Adds an AWS::SES::ReceiptRule.ConnectAction resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.ReceiptRule.ConnectAction'
