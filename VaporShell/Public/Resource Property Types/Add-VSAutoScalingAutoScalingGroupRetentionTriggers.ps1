function Add-VSAutoScalingAutoScalingGroupRetentionTriggers {
    <#
    .SYNOPSIS
        Adds an AWS::AutoScaling::AutoScalingGroup.RetentionTriggers resource property to the template.
    ...
    .PARAMETER TerminateHookAbandon
    ...
    [OutputType('Vaporshell.Resource.AutoScaling.AutoScalingGroup.RetentionTriggers')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScaling.AutoScalingGroup.RetentionTriggers'
