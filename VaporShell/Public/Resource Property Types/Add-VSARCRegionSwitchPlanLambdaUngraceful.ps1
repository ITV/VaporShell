function Add-VSARCRegionSwitchPlanLambdaUngraceful {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.LambdaUngraceful resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.LambdaUngraceful')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.LambdaUngraceful'
