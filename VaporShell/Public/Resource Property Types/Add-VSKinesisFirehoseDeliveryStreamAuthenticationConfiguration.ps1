function Add-VSKinesisFirehoseDeliveryStreamAuthenticationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.AuthenticationConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.KinesisFirehose.DeliveryStream.AuthenticationConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.AuthenticationConfiguration'
