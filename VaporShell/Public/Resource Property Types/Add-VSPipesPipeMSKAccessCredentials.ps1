function Add-VSPipesPipeMSKAccessCredentials {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.MSKAccessCredentials resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.MSKAccessCredentials'
