function Add-VSQuickSightDashboardAxisLabelReferenceOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.AxisLabelReferenceOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.AxisLabelReferenceOptions'
