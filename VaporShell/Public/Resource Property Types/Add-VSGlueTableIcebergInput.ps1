function Add-VSGlueTableIcebergInput {
    <#
    .SYNOPSIS
        Adds an AWS::Glue::Table.IcebergInput resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Glue.Table.IcebergInput')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Glue.Table.IcebergInput'
