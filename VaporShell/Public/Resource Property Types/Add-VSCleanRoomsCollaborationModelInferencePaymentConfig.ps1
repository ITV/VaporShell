function Add-VSCleanRoomsCollaborationModelInferencePaymentConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Collaboration.ModelInferencePaymentConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Collaboration.ModelInferencePaymentConfig'
