function Add-VSWAFv2RuleGroupCookies {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.Cookies resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.Cookies'
