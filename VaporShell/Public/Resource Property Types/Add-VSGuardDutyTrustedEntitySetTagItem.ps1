function Add-VSGuardDutyTrustedEntitySetTagItem {
    <#
    .SYNOPSIS
        Adds an AWS::GuardDuty::TrustedEntitySet.TagItem resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.GuardDuty.TrustedEntitySet.TagItem')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GuardDuty.TrustedEntitySet.TagItem'
