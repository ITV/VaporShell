function Add-VSObservabilityAdminOrganizationCentralizationRuleSourceLogsConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationCentralizationRule.SourceLogsConfiguration resource property to the template.
    ...
    .PARAMETER EncryptedLogGroupStrategy
    ...
    .PARAMETER LogGroupSelectionCriteria
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.SourceLogsConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.SourceLogsConfiguration'
