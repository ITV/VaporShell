function Add-VSAppTestTestCaseSourceDatabaseMetadata {
    <#
    .SYNOPSIS
        Adds an AWS::AppTest::TestCase.SourceDatabaseMetadata resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppTest.TestCase.SourceDatabaseMetadata')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppTest.TestCase.SourceDatabaseMetadata'
