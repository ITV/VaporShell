function Add-VSMediaPackagePackagingConfigurationStreamSelection {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackage::PackagingConfiguration.StreamSelection resource property to the template. Limitations for outputs from the endpoint, based on the video bitrate.
