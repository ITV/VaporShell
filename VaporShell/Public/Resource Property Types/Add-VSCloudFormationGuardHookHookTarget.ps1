function Add-VSCloudFormationGuardHookHookTarget {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFormation::GuardHook.HookTarget resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFormation.GuardHook.HookTarget')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFormation.GuardHook.HookTarget'
