function Add-VSQuickSightDashboardSelectedSheetsFilterScopeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SelectedSheetsFilterScopeConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.SelectedSheetsFilterScopeConfiguration')]
    [cmdletbinding()]
    Param
    (
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Dashboard.SheetVisualScopingConfiguration"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SelectedSheetsFilterScopeConfiguration'
