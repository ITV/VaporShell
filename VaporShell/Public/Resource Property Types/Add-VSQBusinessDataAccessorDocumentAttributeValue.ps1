function Add-VSQBusinessDataAccessorDocumentAttributeValue {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::DataAccessor.DocumentAttributeValue resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.DataAccessor.DocumentAttributeValue'
