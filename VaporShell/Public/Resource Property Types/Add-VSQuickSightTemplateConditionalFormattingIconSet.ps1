function Add-VSQuickSightTemplateConditionalFormattingIconSet {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ConditionalFormattingIconSet resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.ConditionalFormattingIconSet')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ConditionalFormattingIconSet'
