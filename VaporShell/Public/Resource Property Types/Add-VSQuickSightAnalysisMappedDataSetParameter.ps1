function Add-VSQuickSightAnalysisMappedDataSetParameter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.MappedDataSetParameter resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.MappedDataSetParameter'
