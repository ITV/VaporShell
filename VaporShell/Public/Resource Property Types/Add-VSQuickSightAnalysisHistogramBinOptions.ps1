function Add-VSQuickSightAnalysisHistogramBinOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.HistogramBinOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.HistogramBinOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.HistogramBinOptions'
