function Add-VSQuickSightTemplateWaterfallChartColorConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.WaterfallChartColorConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.WaterfallChartColorConfiguration'
