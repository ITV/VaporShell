function Add-VSSecurityHubAutomationRuleV2OcsfBooleanFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2.OcsfBooleanFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfBooleanFilter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfBooleanFilter'
