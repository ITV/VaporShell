function Add-VSMediaLiveSdiSourceTags {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::SdiSource.Tags resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.SdiSource.Tags'
