function Add-VSQuickSightDashboardDefaultFilterControlConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DefaultFilterControlConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DefaultFilterControlConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DefaultFilterControlConfiguration'
