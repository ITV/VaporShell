function Add-VSQuickSightTemplatePeriodToDateComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PeriodToDateComputation resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PeriodToDateComputation'
