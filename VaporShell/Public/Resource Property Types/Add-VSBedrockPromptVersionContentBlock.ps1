function Add-VSBedrockPromptVersionContentBlock {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.ContentBlock resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.ContentBlock')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.ContentBlock'
