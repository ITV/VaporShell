function Add-VSApiGatewayV2RoutingRuleMatchHeaderValue {
    <#
    .SYNOPSIS
        Adds an AWS::ApiGatewayV2::RoutingRule.MatchHeaderValue resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ApiGatewayV2.RoutingRule.MatchHeaderValue')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApiGatewayV2.RoutingRule.MatchHeaderValue'
