function Add-VSQuickSightAnalysisFilterTextAreaControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FilterTextAreaControl resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FilterTextAreaControl')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FilterTextAreaControl'
