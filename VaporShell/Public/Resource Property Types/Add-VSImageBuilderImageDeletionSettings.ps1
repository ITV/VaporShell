function Add-VSImageBuilderImageDeletionSettings {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::Image.DeletionSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.Image.DeletionSettings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.Image.DeletionSettings'
