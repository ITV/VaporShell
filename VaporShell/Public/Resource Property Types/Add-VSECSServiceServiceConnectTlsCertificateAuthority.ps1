function Add-VSECSServiceServiceConnectTlsCertificateAuthority {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.ServiceConnectTlsCertificateAuthority resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.ServiceConnectTlsCertificateAuthority'
