function Add-VSDMSDataProviderIbmDb2zOsSettings {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::DataProvider.IbmDb2zOsSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DMS.DataProvider.IbmDb2zOsSettings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.DataProvider.IbmDb2zOsSettings'
