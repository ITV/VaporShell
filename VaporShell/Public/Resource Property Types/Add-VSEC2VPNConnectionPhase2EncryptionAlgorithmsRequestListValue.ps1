function Add-VSEC2VPNConnectionPhase2EncryptionAlgorithmsRequestListValue {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VPNConnection.Phase2EncryptionAlgorithmsRequestListValue resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VPNConnection.Phase2EncryptionAlgorithmsRequestListValue'
