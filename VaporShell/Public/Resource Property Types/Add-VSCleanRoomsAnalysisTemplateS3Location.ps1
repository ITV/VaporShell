function Add-VSCleanRoomsAnalysisTemplateS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::AnalysisTemplate.S3Location resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.AnalysisTemplate.S3Location')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.AnalysisTemplate.S3Location'
