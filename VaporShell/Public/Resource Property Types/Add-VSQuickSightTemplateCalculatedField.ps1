function Add-VSQuickSightTemplateCalculatedField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CalculatedField resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.CalculatedField')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CalculatedField'
