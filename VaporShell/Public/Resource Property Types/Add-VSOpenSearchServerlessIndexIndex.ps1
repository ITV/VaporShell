function Add-VSOpenSearchServerlessIndexIndex {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchServerless::Index.Index resource property to the template.
    ...
    .PARAMETER KnnAlgoParamEfSearch
    ...
    [OutputType('Vaporshell.Resource.OpenSearchServerless.Index.Index')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchServerless.Index.Index'
