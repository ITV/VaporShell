function Add-VSQuickSightDashboardCalculatedField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.CalculatedField resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.CalculatedField'
