function Add-VSQuickSightTemplateColumnGroupColumnSchema {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ColumnGroupColumnSchema resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ColumnGroupColumnSchema'
