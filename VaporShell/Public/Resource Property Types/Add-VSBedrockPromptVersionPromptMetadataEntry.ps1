function Add-VSBedrockPromptVersionPromptMetadataEntry {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.PromptMetadataEntry resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.PromptMetadataEntry')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.PromptMetadataEntry'
