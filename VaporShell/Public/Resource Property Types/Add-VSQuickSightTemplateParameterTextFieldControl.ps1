function Add-VSQuickSightTemplateParameterTextFieldControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ParameterTextFieldControl resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ParameterTextFieldControl'
