function Add-VSQuickSightAnalysisTableConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TableConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TableConditionalFormatting')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Analysis.TableConditionalFormattingOption"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TableConditionalFormatting'
