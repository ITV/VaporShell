function Add-VSQuickSightDashboardTimeRangeFilterValue {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TimeRangeFilterValue resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.TimeRangeFilterValue')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TimeRangeFilterValue'
