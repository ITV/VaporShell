function Add-VSCloudFrontAnycastIpListIpamCidrConfigResult {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::AnycastIpList.IpamCidrConfigResult resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.AnycastIpList.IpamCidrConfigResult')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.AnycastIpList.IpamCidrConfigResult'
