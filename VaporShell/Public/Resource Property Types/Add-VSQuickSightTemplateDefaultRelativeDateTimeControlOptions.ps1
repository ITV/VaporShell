function Add-VSQuickSightTemplateDefaultRelativeDateTimeControlOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DefaultRelativeDateTimeControlOptions resource property to the template. 
    ...
    .PARAMETER CommitMode
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-defaultrelativedatetimecontroloptions.html#cfn-quicksight-template-defaultrelativedatetimecontroloptions-commitmode
        UpdateType: Mutable
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DefaultRelativeDateTimeControlOptions'
