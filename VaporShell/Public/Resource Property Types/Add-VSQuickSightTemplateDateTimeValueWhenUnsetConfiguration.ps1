function Add-VSQuickSightTemplateDateTimeValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DateTimeValueWhenUnsetConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DateTimeValueWhenUnsetConfiguration'
