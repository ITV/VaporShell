function Add-VSDeadlineFleetMemoryMiBRange {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Fleet.MemoryMiBRange resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Deadline.Fleet.MemoryMiBRange')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Fleet.MemoryMiBRange'
