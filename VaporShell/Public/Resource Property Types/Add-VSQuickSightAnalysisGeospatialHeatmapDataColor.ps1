function Add-VSQuickSightAnalysisGeospatialHeatmapDataColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.GeospatialHeatmapDataColor resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.GeospatialHeatmapDataColor'
