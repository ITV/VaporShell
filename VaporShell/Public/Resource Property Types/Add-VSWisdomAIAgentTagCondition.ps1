function Add-VSWisdomAIAgentTagCondition {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIAgent.TagCondition resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIAgent.TagCondition')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIAgent.TagCondition'
