function Add-VSBedrockAgentCoreMemoryUserPreferenceOverrideExtractionConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.UserPreferenceOverrideExtractionConfigurationInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.UserPreferenceOverrideExtractionConfigurationInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.UserPreferenceOverrideExtractionConfigurationInput'
