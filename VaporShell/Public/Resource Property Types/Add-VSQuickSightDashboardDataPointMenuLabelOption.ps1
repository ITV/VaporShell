function Add-VSQuickSightDashboardDataPointMenuLabelOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DataPointMenuLabelOption resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DataPointMenuLabelOption'
