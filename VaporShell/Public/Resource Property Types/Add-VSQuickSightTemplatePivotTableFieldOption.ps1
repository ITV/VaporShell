function Add-VSQuickSightTemplatePivotTableFieldOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PivotTableFieldOption resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PivotTableFieldOption'
