function Add-VSGameLiftContainerFleetDeploymentConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerFleet.DeploymentConfiguration resource property to the template.
    ...
    .PARAMETER MinimumHealthyPercentage
    ...
    [OutputType('Vaporshell.Resource.GameLift.ContainerFleet.DeploymentConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerFleet.DeploymentConfiguration'
