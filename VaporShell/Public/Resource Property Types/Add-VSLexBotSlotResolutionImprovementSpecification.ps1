function Add-VSLexBotSlotResolutionImprovementSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.SlotResolutionImprovementSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.SlotResolutionImprovementSpecification')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.SlotResolutionImprovementSpecification'
