function Add-VSCloudFrontDistributionGrpcConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::Distribution.GrpcConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.Distribution.GrpcConfig'
