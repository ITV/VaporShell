function Add-VSIoTTopicRuleUserProperty {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::TopicRule.UserProperty resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.TopicRule.UserProperty'
