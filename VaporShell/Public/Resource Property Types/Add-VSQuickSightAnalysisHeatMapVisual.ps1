function Add-VSQuickSightAnalysisHeatMapVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.HeatMapVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-heatmapvisual.html#cfn-quicksight-analysis-heatmapvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.HeatMapVisual'
