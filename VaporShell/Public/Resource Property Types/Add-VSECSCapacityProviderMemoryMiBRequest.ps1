function Add-VSECSCapacityProviderMemoryMiBRequest {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::CapacityProvider.MemoryMiBRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.CapacityProvider.MemoryMiBRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.CapacityProvider.MemoryMiBRequest'
