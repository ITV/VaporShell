function Add-VSQBusinessPluginS3 {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Plugin.S3 resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Plugin.S3'
