function Add-VSPipesPipeBatchRetryStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.BatchRetryStrategy resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.BatchRetryStrategy'
