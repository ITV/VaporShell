function Add-VSEC2EC2FleetAcceleratorTotalMemoryMiBRequest {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::EC2Fleet.AcceleratorTotalMemoryMiBRequest resource property to the template. The minimum and maximum amount of total accelerator memory, in MiB.
