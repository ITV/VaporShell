function Add-VSQuickSightTemplateBinCountOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.BinCountOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.BinCountOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.BinCountOptions'
