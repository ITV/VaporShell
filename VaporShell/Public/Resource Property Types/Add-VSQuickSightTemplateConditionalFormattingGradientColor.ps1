function Add-VSQuickSightTemplateConditionalFormattingGradientColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ConditionalFormattingGradientColor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.ConditionalFormattingGradientColor')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ConditionalFormattingGradientColor'
