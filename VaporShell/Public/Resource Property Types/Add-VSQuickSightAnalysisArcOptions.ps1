function Add-VSQuickSightAnalysisArcOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ArcOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ArcOptions'
