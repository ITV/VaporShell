function Add-VSQuickSightTemplateArcAxisConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ArcAxisConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ArcAxisConfiguration'
