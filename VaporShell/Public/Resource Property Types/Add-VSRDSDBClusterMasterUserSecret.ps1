function Add-VSRDSDBClusterMasterUserSecret {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::DBCluster.MasterUserSecret resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.RDS.DBCluster.MasterUserSecret')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.DBCluster.MasterUserSecret'
