function Add-VSS3StorageLensAdvancedDataProtectionMetrics {
    <#
    .SYNOPSIS
        Adds an AWS::S3::StorageLens.AdvancedDataProtectionMetrics resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.StorageLens.AdvancedDataProtectionMetrics'
