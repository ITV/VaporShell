function Add-VSWorkspacesInstancesVolumeTagSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::Volume.TagSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.Volume.TagSpecification')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.Volume.TagSpecification'
