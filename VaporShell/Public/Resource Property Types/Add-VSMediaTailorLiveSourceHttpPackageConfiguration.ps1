function Add-VSMediaTailorLiveSourceHttpPackageConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::LiveSource.HttpPackageConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaTailor.LiveSource.HttpPackageConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.LiveSource.HttpPackageConfiguration'
