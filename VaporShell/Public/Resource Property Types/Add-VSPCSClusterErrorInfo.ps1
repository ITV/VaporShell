function Add-VSPCSClusterErrorInfo {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster.ErrorInfo resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster.ErrorInfo'
