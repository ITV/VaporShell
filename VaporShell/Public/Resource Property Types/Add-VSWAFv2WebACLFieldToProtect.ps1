function Add-VSWAFv2WebACLFieldToProtect {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.FieldToProtect resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.FieldToProtect')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.FieldToProtect'
