function Add-VSObservabilityAdminTelemetryRuleVPCFlowLogParameters {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::TelemetryRule.VPCFlowLogParameters resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.VPCFlowLogParameters')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.VPCFlowLogParameters'
