function Add-VSBatchJobDefinitionJobTimeout {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobDefinition.JobTimeout resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition.JobTimeout'
