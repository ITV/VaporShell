function Add-VSAPSScraperCloudWatchLogDestination {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Scraper.CloudWatchLogDestination resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.APS.Scraper.CloudWatchLogDestination')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Scraper.CloudWatchLogDestination'
