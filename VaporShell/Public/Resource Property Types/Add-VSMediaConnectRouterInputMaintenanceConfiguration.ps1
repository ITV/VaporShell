function Add-VSMediaConnectRouterInputMaintenanceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.MaintenanceConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.MaintenanceConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.MaintenanceConfiguration'
