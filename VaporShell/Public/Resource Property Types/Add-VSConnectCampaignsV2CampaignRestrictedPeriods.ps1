function Add-VSConnectCampaignsV2CampaignRestrictedPeriods {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.RestrictedPeriods resource property to the template.
    ...
    .PARAMETER RestrictedPeriodList
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ConnectCampaignsV2.Campaign.RestrictedPeriod"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.RestrictedPeriods'
