function Add-VSSageMakerModelPackageSecurityConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelPackage.SecurityConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelPackage.SecurityConfig'
