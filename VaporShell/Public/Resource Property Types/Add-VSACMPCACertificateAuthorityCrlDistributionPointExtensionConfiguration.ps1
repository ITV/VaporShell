function Add-VSACMPCACertificateAuthorityCrlDistributionPointExtensionConfiguration {
    <#
    .SYNOPSIS
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ACMPCA.CertificateAuthority.CrlDistributionPointExtensionConfiguration'
