function Add-VSQuickSightDashboardVisualMenuOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.VisualMenuOption resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.VisualMenuOption')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.VisualMenuOption'
