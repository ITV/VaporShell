function Add-VSARCRegionSwitchPlanTriggerCondition {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.TriggerCondition resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.TriggerCondition')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.TriggerCondition'
