function Add-VSQuickSightDashboardBinCountOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.BinCountOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.BinCountOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.BinCountOptions'
