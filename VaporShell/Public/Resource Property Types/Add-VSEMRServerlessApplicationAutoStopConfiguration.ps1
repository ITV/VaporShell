function Add-VSEMRServerlessApplicationAutoStopConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.AutoStopConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.AutoStopConfiguration'
