function Add-VSSageMakerFeatureGroupTtlDuration {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::FeatureGroup.TtlDuration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.FeatureGroup.TtlDuration'
