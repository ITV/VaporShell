function Add-VSQuickSightDashboardAxisLogarithmicScale {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.AxisLogarithmicScale resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.AxisLogarithmicScale')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.AxisLogarithmicScale'
