function Add-VSQuickSightTemplateTableCellImageSizingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TableCellImageSizingConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TableCellImageSizingConfiguration'
