function Add-VSQuickSightDashboardCustomContentConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.CustomContentConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.CustomContentConfiguration'
