function Add-VSEC2SpotFleetInstanceRequirementsRequest {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::SpotFleet.InstanceRequirementsRequest resource property to the template. The attributes for the instance types. When you specify instance attributes, Amazon EC2 will identify instance types with these attributes.
