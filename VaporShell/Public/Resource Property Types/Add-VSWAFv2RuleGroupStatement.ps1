function Add-VSWAFv2RuleGroupStatement {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.Statement resource property to the template. The processing guidance for a Rule, used by AWS WAF to determine whether a web request matches the rule.
