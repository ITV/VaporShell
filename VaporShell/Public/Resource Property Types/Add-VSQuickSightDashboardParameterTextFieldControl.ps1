function Add-VSQuickSightDashboardParameterTextFieldControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ParameterTextFieldControl resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ParameterTextFieldControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ParameterTextFieldControl'
