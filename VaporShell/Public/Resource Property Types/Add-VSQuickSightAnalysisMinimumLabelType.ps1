function Add-VSQuickSightAnalysisMinimumLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.MinimumLabelType resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.MinimumLabelType'
