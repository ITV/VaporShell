function Add-VSRekognitionStreamProcessorConnectedHomeSettings {
    <#
    .SYNOPSIS
        Adds an AWS::Rekognition::StreamProcessor.ConnectedHomeSettings resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Rekognition.StreamProcessor.ConnectedHomeSettings'
