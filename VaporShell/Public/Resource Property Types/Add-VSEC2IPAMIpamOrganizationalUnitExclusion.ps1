function Add-VSEC2IPAMIpamOrganizationalUnitExclusion {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::IPAM.IpamOrganizationalUnitExclusion resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.IPAM.IpamOrganizationalUnitExclusion')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.IPAM.IpamOrganizationalUnitExclusion'
