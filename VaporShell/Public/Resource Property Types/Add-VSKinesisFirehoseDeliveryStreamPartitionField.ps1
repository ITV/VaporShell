function Add-VSKinesisFirehoseDeliveryStreamPartitionField {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.PartitionField resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.KinesisFirehose.DeliveryStream.PartitionField')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.PartitionField'
