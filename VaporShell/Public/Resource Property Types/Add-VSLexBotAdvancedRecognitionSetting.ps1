function Add-VSLexBotAdvancedRecognitionSetting {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.AdvancedRecognitionSetting resource property to the template. 
    ...
    .PARAMETER AudioRecognitionStrategy
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.AdvancedRecognitionSetting'
