function Add-VSObservabilityAdminOrganizationTelemetryRuleFieldToMatch {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationTelemetryRule.FieldToMatch resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.FieldToMatch')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.FieldToMatch'
