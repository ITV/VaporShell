function Add-VSLexBotSampleUtteranceGenerationSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.SampleUtteranceGenerationSpecification resource property to the template.
    ...
    .PARAMETER BedrockModelSpecification
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.SampleUtteranceGenerationSpecification')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.SampleUtteranceGenerationSpecification'
