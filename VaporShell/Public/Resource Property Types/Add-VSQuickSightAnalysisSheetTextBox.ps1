function Add-VSQuickSightAnalysisSheetTextBox {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SheetTextBox resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.SheetTextBox')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SheetTextBox'
