function Add-VSSageMakerModelBiasJobDefinitionDatasetFormat {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelBiasJobDefinition.DatasetFormat resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.ModelBiasJobDefinition.DatasetFormat')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.ModelBiasJobDefinition.DatasetFormat'
