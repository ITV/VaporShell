function Add-VSIoTFleetWiseCampaignS3Config {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.S3Config resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.S3Config'
