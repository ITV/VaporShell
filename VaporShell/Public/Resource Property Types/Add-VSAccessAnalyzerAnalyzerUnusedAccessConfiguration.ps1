function Add-VSAccessAnalyzerAnalyzerUnusedAccessConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::AccessAnalyzer::Analyzer.UnusedAccessConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AccessAnalyzer.Analyzer.UnusedAccessConfiguration'
