function Add-VSObservabilityAdminOrganizationCentralizationRuleLogsEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationCentralizationRule.LogsEncryptionConfiguration resource property to the template.
    ...
    .PARAMETER EncryptionConflictResolutionStrategy
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.LogsEncryptionConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationCentralizationRule.LogsEncryptionConfiguration'
