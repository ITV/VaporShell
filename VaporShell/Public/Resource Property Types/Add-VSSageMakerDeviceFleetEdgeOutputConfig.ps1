function Add-VSSageMakerDeviceFleetEdgeOutputConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::DeviceFleet.EdgeOutputConfig resource property to the template. The output configuration for storing sample data collected by the fleet.
