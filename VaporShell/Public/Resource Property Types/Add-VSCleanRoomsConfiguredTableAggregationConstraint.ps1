function Add-VSCleanRoomsConfiguredTableAggregationConstraint {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::ConfiguredTable.AggregationConstraint resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.ConfiguredTable.AggregationConstraint'
