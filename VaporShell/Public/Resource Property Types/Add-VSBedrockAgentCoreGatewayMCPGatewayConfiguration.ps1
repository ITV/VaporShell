function Add-VSBedrockAgentCoreGatewayMCPGatewayConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Gateway.MCPGatewayConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Gateway.MCPGatewayConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Gateway.MCPGatewayConfiguration'
