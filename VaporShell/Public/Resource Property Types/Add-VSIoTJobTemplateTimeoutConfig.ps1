function Add-VSIoTJobTemplateTimeoutConfig {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::JobTemplate.TimeoutConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.JobTemplate.TimeoutConfig'
