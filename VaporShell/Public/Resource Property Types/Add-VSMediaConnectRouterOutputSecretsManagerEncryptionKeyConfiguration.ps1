function Add-VSMediaConnectRouterOutputSecretsManagerEncryptionKeyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterOutput.SecretsManagerEncryptionKeyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterOutput.SecretsManagerEncryptionKeyConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterOutput.SecretsManagerEncryptionKeyConfiguration'
