function Add-VSLambdaFunctionTenancyConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::Function.TenancyConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lambda.Function.TenancyConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.Function.TenancyConfig'
