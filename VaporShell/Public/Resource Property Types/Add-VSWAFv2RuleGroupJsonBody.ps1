function Add-VSWAFv2RuleGroupJsonBody {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.JsonBody resource property to the template. The body of a web request, inspected as JSON. The body immediately follows the request headers. This is used in the FieldToMatch specification.
