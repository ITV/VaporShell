function Add-VSOSISPipelineLogPublishingOptions {
    <#
    .SYNOPSIS
        Adds an AWS::OSIS::Pipeline.LogPublishingOptions resource property to the template.
    ...
    .PARAMETER CloudWatchLogDestination
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OSIS.Pipeline.LogPublishingOptions'
