function Add-VSSageMakerModelS3DataSource {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Model.S3DataSource resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Model.S3DataSource'
