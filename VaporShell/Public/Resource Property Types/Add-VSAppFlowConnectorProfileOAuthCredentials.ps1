function Add-VSAppFlowConnectorProfileOAuthCredentials {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::ConnectorProfile.OAuthCredentials resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AppFlow.ConnectorProfile.OAuthCredentials')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.ConnectorProfile.OAuthCredentials'
