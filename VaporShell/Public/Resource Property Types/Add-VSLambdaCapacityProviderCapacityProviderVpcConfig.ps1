function Add-VSLambdaCapacityProviderCapacityProviderVpcConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::CapacityProvider.CapacityProviderVpcConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lambda.CapacityProvider.CapacityProviderVpcConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.CapacityProvider.CapacityProviderVpcConfig'
