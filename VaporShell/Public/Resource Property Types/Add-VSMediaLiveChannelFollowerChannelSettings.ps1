function Add-VSMediaLiveChannelFollowerChannelSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.FollowerChannelSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.FollowerChannelSettings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.FollowerChannelSettings'
