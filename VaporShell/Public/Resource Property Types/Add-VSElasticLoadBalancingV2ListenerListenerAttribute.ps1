function Add-VSElasticLoadBalancingV2ListenerListenerAttribute {
    <#
    .SYNOPSIS
        Adds an AWS::ElasticLoadBalancingV2::Listener.ListenerAttribute resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElasticLoadBalancingV2.Listener.ListenerAttribute'
