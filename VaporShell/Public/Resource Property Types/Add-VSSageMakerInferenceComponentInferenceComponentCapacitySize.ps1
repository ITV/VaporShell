function Add-VSSageMakerInferenceComponentInferenceComponentCapacitySize {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::InferenceComponent.InferenceComponentCapacitySize resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.InferenceComponent.InferenceComponentCapacitySize')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.InferenceComponent.InferenceComponentCapacitySize'
