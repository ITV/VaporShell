function Add-VSQuickSightAnalysisSectionAfterPageBreak {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SectionAfterPageBreak resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.SectionAfterPageBreak')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SectionAfterPageBreak'
