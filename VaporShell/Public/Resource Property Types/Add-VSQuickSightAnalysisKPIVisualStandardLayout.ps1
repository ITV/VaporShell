function Add-VSQuickSightAnalysisKPIVisualStandardLayout {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.KPIVisualStandardLayout resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.KPIVisualStandardLayout')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.KPIVisualStandardLayout'
