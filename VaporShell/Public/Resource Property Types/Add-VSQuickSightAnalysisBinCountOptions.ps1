function Add-VSQuickSightAnalysisBinCountOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BinCountOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BinCountOptions'
