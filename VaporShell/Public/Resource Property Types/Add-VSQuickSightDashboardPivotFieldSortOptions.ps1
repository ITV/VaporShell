function Add-VSQuickSightDashboardPivotFieldSortOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PivotFieldSortOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.PivotFieldSortOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PivotFieldSortOptions'
