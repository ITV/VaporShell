function Add-VSQuickSightAnalysisDonutCenterOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DonutCenterOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DonutCenterOptions'
