function Add-VSAppMeshRouteTcpRouteMatch {
    <#
    .SYNOPSIS
        Adds an AWS::AppMesh::Route.TcpRouteMatch resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AppMesh.Route.TcpRouteMatch')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppMesh.Route.TcpRouteMatch'
