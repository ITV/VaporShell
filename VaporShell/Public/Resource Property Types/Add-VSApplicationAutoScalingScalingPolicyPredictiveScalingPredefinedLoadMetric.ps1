function Add-VSApplicationAutoScalingScalingPolicyPredictiveScalingPredefinedLoadMetric {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingPredefinedLoadMetric resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingPredefinedLoadMetric')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingPredefinedLoadMetric'
