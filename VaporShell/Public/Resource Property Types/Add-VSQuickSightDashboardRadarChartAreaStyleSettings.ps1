function Add-VSQuickSightDashboardRadarChartAreaStyleSettings {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.RadarChartAreaStyleSettings resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.RadarChartAreaStyleSettings')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.RadarChartAreaStyleSettings'
