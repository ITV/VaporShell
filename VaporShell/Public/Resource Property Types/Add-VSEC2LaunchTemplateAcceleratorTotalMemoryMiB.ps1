function Add-VSEC2LaunchTemplateAcceleratorTotalMemoryMiB {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::LaunchTemplate.AcceleratorTotalMemoryMiB resource property to the template. The minimum and maximum amount of total accelerator memory, in MiB.
...
The minimum and maximum amount of total accelerator memory, in MiB.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.LaunchTemplate.AcceleratorTotalMemoryMiB')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.LaunchTemplate.AcceleratorTotalMemoryMiB'
