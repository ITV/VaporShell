function Add-VSQuickSightDashboardFilledMapVisual {
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-filledmapvisual.html#cfn-quicksight-dashboard-filledmapvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
