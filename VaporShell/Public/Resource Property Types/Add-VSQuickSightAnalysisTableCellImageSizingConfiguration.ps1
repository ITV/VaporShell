function Add-VSQuickSightAnalysisTableCellImageSizingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TableCellImageSizingConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TableCellImageSizingConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TableCellImageSizingConfiguration'
