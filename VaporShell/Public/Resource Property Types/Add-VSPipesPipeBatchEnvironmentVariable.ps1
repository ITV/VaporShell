function Add-VSPipesPipeBatchEnvironmentVariable {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.BatchEnvironmentVariable resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.BatchEnvironmentVariable'
