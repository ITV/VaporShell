function Add-VSQuickSightDashboardListControlSelectAllOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ListControlSelectAllOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ListControlSelectAllOptions'
