function Add-VSSESMailManagerRuleSetAddHeaderAction {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerRuleSet.AddHeaderAction resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerRuleSet.AddHeaderAction'
