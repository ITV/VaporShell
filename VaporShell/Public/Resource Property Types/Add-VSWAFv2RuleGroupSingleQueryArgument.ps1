function Add-VSWAFv2RuleGroupSingleQueryArgument {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.SingleQueryArgument')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.SingleQueryArgument'
