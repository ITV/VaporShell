function Add-VSACMPCACertificateKeyUsage {
    <#
    .SYNOPSIS
        Adds an AWS::ACMPCA::Certificate.KeyUsage resource property to the template. Defines one or more purposes for which the key contained in the certificate can be used. Default value for each option is false.
...
Defines one or more purposes for which the key contained in the certificate can be used. Default value for each option is false.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.ACMPCA.Certificate.KeyUsage')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ACMPCA.Certificate.KeyUsage'
