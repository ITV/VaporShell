function Add-VSQBusinessPluginBasicAuthConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Plugin.BasicAuthConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QBusiness.Plugin.BasicAuthConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Plugin.BasicAuthConfiguration'
