function Add-VSQuickSightAnalysisParameterTextAreaControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ParameterTextAreaControl resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ParameterTextAreaControl')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ParameterTextAreaControl'
