function Add-VSDynamoDBGlobalTableGlobalTableWitness {
    <#
    .SYNOPSIS
        Adds an AWS::DynamoDB::GlobalTable.GlobalTableWitness resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DynamoDB.GlobalTable.GlobalTableWitness')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DynamoDB.GlobalTable.GlobalTableWitness'
