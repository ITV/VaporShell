function Add-VSLexBotAllowedInputTypes {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.AllowedInputTypes resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.AllowedInputTypes'
