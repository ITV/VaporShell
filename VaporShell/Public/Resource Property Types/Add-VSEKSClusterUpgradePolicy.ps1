function Add-VSEKSClusterUpgradePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::EKS::Cluster.UpgradePolicy resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Cluster.UpgradePolicy'
