function Add-VSNetworkFirewallFirewallPolicyCustomAction {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::FirewallPolicy.CustomAction resource property to the template. An optional, non-standard action to use for stateless packet handling. You can define this in addition to the standard action that you must specify.
