function Add-VSECSCapacityProviderMemoryGiBPerVCpuRequest {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::CapacityProvider.MemoryGiBPerVCpuRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.CapacityProvider.MemoryGiBPerVCpuRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.CapacityProvider.MemoryGiBPerVCpuRequest'
