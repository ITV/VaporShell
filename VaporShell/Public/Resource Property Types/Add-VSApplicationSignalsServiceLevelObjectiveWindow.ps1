function Add-VSApplicationSignalsServiceLevelObjectiveWindow {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationSignals::ServiceLevelObjective.Window resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ApplicationSignals.ServiceLevelObjective.Window')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationSignals.ServiceLevelObjective.Window'
