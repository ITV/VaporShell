function Add-VSOpenSearchServiceDomainS3VectorsEngine {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Domain.S3VectorsEngine resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchService.Domain.S3VectorsEngine')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain.S3VectorsEngine'
