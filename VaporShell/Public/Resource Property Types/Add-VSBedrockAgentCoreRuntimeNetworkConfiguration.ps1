function Add-VSBedrockAgentCoreRuntimeNetworkConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Runtime.NetworkConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Runtime.NetworkConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Runtime.NetworkConfiguration'
