function Add-VSBedrockDataAutomationProjectImageStandardGenerativeField {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject.ImageStandardGenerativeField resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject.ImageStandardGenerativeField')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject.ImageStandardGenerativeField'
