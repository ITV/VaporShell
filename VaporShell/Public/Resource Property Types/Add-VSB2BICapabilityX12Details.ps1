function Add-VSB2BICapabilityX12Details {
    <#
    .SYNOPSIS
        Adds an AWS::B2BI::Capability.X12Details resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.B2BI.Capability.X12Details'
