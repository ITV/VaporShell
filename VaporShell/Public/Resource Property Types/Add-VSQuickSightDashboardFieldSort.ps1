function Add-VSQuickSightDashboardFieldSort {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.FieldSort resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.FieldSort'
