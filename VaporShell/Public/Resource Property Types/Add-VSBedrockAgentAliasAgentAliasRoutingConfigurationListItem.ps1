function Add-VSBedrockAgentAliasAgentAliasRoutingConfigurationListItem {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::AgentAlias.AgentAliasRoutingConfigurationListItem resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.AgentAlias.AgentAliasRoutingConfigurationListItem'
