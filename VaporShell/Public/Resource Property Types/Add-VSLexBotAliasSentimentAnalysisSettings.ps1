function Add-VSLexBotAliasSentimentAnalysisSettings {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::BotAlias.SentimentAnalysisSettings resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.BotAlias.SentimentAnalysisSettings'
