function Add-VSQuickSightDashboardGeospatialHeatmapColorScale {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.GeospatialHeatmapColorScale resource property to the template.
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Dashboard.GeospatialHeatmapDataColor"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.GeospatialHeatmapColorScale'
