function Add-VSMediaLiveInputMulticastSourceCreateRequest {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Input.MulticastSourceCreateRequest resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Input.MulticastSourceCreateRequest'
