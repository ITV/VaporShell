function Add-VSQuickSightDashboardDataPointTooltipOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DataPointTooltipOption resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DataPointTooltipOption')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DataPointTooltipOption'
