function Add-VSQuickSightTemplateTimeRangeDrillDownFilter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TimeRangeDrillDownFilter resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TimeRangeDrillDownFilter'
