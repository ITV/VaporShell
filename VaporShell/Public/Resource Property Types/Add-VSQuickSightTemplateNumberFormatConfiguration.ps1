function Add-VSQuickSightTemplateNumberFormatConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.NumberFormatConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.NumberFormatConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.NumberFormatConfiguration'
