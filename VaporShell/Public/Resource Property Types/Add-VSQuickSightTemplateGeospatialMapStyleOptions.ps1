function Add-VSQuickSightTemplateGeospatialMapStyleOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.GeospatialMapStyleOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.GeospatialMapStyleOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.GeospatialMapStyleOptions'
