function Add-VSQuickSightDataSetIntegerDatasetParameter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::DataSet.IntegerDatasetParameter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.DataSet.IntegerDatasetParameter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.DataSet.IntegerDatasetParameter'
