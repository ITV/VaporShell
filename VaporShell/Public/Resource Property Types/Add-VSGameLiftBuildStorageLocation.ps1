function Add-VSGameLiftBuildStorageLocation {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::Build.StorageLocation resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.Build.StorageLocation'
