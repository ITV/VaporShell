function Add-VSMediaLiveChannelTimecodeBurninSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.TimecodeBurninSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.TimecodeBurninSettings')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.TimecodeBurninSettings'
