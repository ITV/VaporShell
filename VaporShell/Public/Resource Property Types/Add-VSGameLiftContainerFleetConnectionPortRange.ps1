function Add-VSGameLiftContainerFleetConnectionPortRange {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerFleet.ConnectionPortRange resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerFleet.ConnectionPortRange'
