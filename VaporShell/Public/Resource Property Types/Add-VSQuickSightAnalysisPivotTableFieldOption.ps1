function Add-VSQuickSightAnalysisPivotTableFieldOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.PivotTableFieldOption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.PivotTableFieldOption')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.PivotTableFieldOption'
