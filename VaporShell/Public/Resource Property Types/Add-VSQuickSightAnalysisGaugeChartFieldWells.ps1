function Add-VSQuickSightAnalysisGaugeChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.GaugeChartFieldWells resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.GaugeChartFieldWells')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.GaugeChartFieldWells'
