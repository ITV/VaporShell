function Add-VSQuickSightTemplateComboChartVisual {
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-combochartvisual.html#cfn-quicksight-template-combochartvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
