function Add-VSIoTFleetWiseCampaignStorageMinimumTimeToLive {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.StorageMinimumTimeToLive resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.StorageMinimumTimeToLive'
