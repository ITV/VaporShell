function Add-VSQuickSightAnalysisAggregationSortConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.AggregationSortConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.AggregationSortConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.AggregationSortConfiguration'
