function Add-VSSageMakerSpaceOwnershipSettings {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Space.OwnershipSettings resource property to the template.
    ...
    .PARAMETER OwnerUserProfileName
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Space.OwnershipSettings'
