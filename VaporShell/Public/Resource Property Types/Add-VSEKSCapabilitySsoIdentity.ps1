function Add-VSEKSCapabilitySsoIdentity {
    <#
    .SYNOPSIS
        Adds an AWS::EKS::Capability.SsoIdentity resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EKS.Capability.SsoIdentity')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Capability.SsoIdentity'
