function Add-VSQuickSightAnalysisRadarChartAreaStyleSettings {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.RadarChartAreaStyleSettings resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.RadarChartAreaStyleSettings')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.RadarChartAreaStyleSettings'
