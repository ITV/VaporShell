function Add-VSQuickSightTemplateRadarChartAreaStyleSettings {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.RadarChartAreaStyleSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.RadarChartAreaStyleSettings')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.RadarChartAreaStyleSettings'
