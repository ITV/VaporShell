function Add-VSQuickSightAnalysisGeospatialCoordinateBounds {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.GeospatialCoordinateBounds resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.GeospatialCoordinateBounds')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.GeospatialCoordinateBounds'
