function Add-VSWAFv2RuleGroupImmunityTimeProperty {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.ImmunityTimeProperty resource property to the template. Determines how long a CAPTCHA token remains valid after the client successfully solves a CAPTCHA puzzle.
