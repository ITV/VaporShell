function Add-VSEMRServerlessApplicationMaximumAllowedResources {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.MaximumAllowedResources resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.MaximumAllowedResources'
