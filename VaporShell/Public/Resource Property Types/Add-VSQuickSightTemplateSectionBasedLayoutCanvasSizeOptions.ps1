function Add-VSQuickSightTemplateSectionBasedLayoutCanvasSizeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SectionBasedLayoutCanvasSizeOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.SectionBasedLayoutCanvasSizeOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SectionBasedLayoutCanvasSizeOptions'
