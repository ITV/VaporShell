function Add-VSQuickSightTemplateVisibleRangeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.VisibleRangeOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.VisibleRangeOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.VisibleRangeOptions'
