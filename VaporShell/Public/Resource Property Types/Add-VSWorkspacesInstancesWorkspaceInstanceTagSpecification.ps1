function Add-VSWorkspacesInstancesWorkspaceInstanceTagSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::WorkspaceInstance.TagSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.TagSpecification')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.TagSpecification'
