function Add-VSEMRClusterOnDemandResizingSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::EMR::Cluster.OnDemandResizingSpecification resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMR.Cluster.OnDemandResizingSpecification'
