function Add-VSQuickSightTemplateRadarChartVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.RadarChartVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-radarchartvisual.html#cfn-quicksight-template-radarchartvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.RadarChartVisual')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.RadarChartVisual'
