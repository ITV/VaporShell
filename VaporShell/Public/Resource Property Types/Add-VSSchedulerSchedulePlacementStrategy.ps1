function Add-VSSchedulerSchedulePlacementStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::Scheduler::Schedule.PlacementStrategy resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Scheduler.Schedule.PlacementStrategy'
