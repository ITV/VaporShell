function Add-VSCleanRoomsIdNamespaceAssociationIdMappingConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::IdNamespaceAssociation.IdMappingConfig resource property to the template. 
    ...
    .PARAMETER AllowUseAsDimensionColumn
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.CleanRooms.IdNamespaceAssociation.IdMappingConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.IdNamespaceAssociation.IdMappingConfig'
