function Add-VSMediaConnectBridgeSourceMulticastSourceSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::BridgeSource.MulticastSourceSettings resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.BridgeSource.MulticastSourceSettings'
