function Add-VSSageMakerUserProfileFSxLustreFileSystemConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.FSxLustreFileSystemConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.UserProfile.FSxLustreFileSystemConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.FSxLustreFileSystemConfig'
