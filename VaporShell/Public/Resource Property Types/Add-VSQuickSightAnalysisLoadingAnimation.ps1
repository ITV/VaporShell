function Add-VSQuickSightAnalysisLoadingAnimation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.LoadingAnimation resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.LoadingAnimation'
