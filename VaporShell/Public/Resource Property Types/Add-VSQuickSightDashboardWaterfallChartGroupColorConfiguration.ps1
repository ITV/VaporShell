function Add-VSQuickSightDashboardWaterfallChartGroupColorConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.WaterfallChartGroupColorConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.WaterfallChartGroupColorConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.WaterfallChartGroupColorConfiguration'
