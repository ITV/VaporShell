function Add-VSQBusinessIndexIndexCapacityConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Index.IndexCapacityConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Index.IndexCapacityConfiguration'
