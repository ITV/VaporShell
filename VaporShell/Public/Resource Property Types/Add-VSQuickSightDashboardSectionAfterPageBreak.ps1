function Add-VSQuickSightDashboardSectionAfterPageBreak {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SectionAfterPageBreak resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SectionAfterPageBreak'
