function Add-VSQuickSightDashboardPivotTableDataPathOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PivotTableDataPathOption resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.PivotTableDataPathOption')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PivotTableDataPathOption'
