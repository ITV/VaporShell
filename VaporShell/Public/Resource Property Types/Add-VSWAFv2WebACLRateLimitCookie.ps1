function Add-VSWAFv2WebACLRateLimitCookie {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RateLimitCookie resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RateLimitCookie'
