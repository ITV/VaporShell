function Add-VSQuickSightTemplateConditionalFormattingSolidColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ConditionalFormattingSolidColor resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.ConditionalFormattingSolidColor')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ConditionalFormattingSolidColor'
