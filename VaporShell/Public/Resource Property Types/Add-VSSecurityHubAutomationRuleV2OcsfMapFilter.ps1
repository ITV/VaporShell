function Add-VSSecurityHubAutomationRuleV2OcsfMapFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2.OcsfMapFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfMapFilter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfMapFilter'
