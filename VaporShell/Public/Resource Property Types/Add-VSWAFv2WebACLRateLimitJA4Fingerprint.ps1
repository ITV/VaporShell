function Add-VSWAFv2WebACLRateLimitJA4Fingerprint {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RateLimitJA4Fingerprint resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.RateLimitJA4Fingerprint')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RateLimitJA4Fingerprint'
