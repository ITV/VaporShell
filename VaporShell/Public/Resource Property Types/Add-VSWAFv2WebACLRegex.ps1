function Add-VSWAFv2WebACLRegex {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.Regex resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.Regex')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.Regex'
