function Add-VSDataZoneConnectionSparkGlueArgs {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Connection.SparkGlueArgs resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Connection.SparkGlueArgs')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Connection.SparkGlueArgs'
