function Add-VSQuickSightAnalysisVisualTitleLabelOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.VisualTitleLabelOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.VisualTitleLabelOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.VisualTitleLabelOptions'
