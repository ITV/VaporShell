function Add-VSOpenSearchServiceDomainAIMLOptions {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Domain.AIMLOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.OpenSearchService.Domain.AIMLOptions')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain.AIMLOptions'
