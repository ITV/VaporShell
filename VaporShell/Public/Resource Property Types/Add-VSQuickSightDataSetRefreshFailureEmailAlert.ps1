function Add-VSQuickSightDataSetRefreshFailureEmailAlert {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::DataSet.RefreshFailureEmailAlert resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.DataSet.RefreshFailureEmailAlert')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.DataSet.RefreshFailureEmailAlert'
