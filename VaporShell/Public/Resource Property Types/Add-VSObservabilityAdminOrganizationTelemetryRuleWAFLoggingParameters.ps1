function Add-VSObservabilityAdminOrganizationTelemetryRuleWAFLoggingParameters {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationTelemetryRule.WAFLoggingParameters resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.WAFLoggingParameters')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.FieldToMatch"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.WAFLoggingParameters'
