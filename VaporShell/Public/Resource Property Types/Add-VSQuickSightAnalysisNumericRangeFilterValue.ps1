function Add-VSQuickSightAnalysisNumericRangeFilterValue {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.NumericRangeFilterValue resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.NumericRangeFilterValue')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.NumericRangeFilterValue'
