function Add-VSECSServiceServiceConnectAccessLogConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.ServiceConnectAccessLogConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.Service.ServiceConnectAccessLogConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.ServiceConnectAccessLogConfiguration'
