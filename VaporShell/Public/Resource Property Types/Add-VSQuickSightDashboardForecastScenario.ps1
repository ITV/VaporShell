function Add-VSQuickSightDashboardForecastScenario {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ForecastScenario resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ForecastScenario')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ForecastScenario'
