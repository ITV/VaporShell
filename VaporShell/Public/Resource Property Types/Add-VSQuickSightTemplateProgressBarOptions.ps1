function Add-VSQuickSightTemplateProgressBarOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ProgressBarOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.ProgressBarOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ProgressBarOptions'
