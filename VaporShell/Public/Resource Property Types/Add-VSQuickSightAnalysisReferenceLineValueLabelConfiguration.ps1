function Add-VSQuickSightAnalysisReferenceLineValueLabelConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ReferenceLineValueLabelConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ReferenceLineValueLabelConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ReferenceLineValueLabelConfiguration'
