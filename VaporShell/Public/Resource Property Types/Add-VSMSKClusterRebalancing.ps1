function Add-VSMSKClusterRebalancing {
    <#
    .SYNOPSIS
        Adds an AWS::MSK::Cluster.Rebalancing resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MSK.Cluster.Rebalancing')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.Cluster.Rebalancing'
