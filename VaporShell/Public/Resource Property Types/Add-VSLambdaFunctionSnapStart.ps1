function Add-VSLambdaFunctionSnapStart {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::Function.SnapStart resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.Function.SnapStart'
