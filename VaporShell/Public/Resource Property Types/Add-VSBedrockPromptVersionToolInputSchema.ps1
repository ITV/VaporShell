function Add-VSBedrockPromptVersionToolInputSchema {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.ToolInputSchema resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.ToolInputSchema')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.ToolInputSchema'
