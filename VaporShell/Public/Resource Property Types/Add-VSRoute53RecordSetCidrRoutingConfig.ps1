function Add-VSRoute53RecordSetCidrRoutingConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Route53::RecordSet.CidrRoutingConfig resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53.RecordSet.CidrRoutingConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53.RecordSet.CidrRoutingConfig'
