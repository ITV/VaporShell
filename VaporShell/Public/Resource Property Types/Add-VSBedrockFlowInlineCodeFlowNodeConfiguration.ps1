function Add-VSBedrockFlowInlineCodeFlowNodeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.InlineCodeFlowNodeConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.InlineCodeFlowNodeConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.InlineCodeFlowNodeConfiguration'
