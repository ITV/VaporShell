function Add-VSQuickSightDashboardPaginationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.PaginationConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.PaginationConfiguration'
