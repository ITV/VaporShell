function Add-VSAPSScraperScraperComponent {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Scraper.ScraperComponent resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.APS.Scraper.ScraperComponent')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Scraper.ScraperComponent'
