function Add-VSLookoutEquipmentInferenceSchedulerS3InputConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutEquipment::InferenceScheduler.S3InputConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutEquipment.InferenceScheduler.S3InputConfiguration'
