function Add-VSAppRunnerObservabilityConfigurationTraceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::AppRunner::ObservabilityConfiguration.TraceConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppRunner.ObservabilityConfiguration.TraceConfiguration'
