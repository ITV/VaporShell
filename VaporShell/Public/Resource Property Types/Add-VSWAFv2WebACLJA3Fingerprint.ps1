function Add-VSWAFv2WebACLJA3Fingerprint {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.JA3Fingerprint resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.JA3Fingerprint'
