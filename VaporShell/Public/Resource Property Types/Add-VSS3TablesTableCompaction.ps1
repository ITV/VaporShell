function Add-VSS3TablesTableCompaction {
    <#
    .SYNOPSIS
        Adds an AWS::S3Tables::Table.Compaction resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Tables.Table.Compaction')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Tables.Table.Compaction'
