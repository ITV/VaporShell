function Add-VSAmplifyUIBuilderComponentComponentProperty {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Component.ComponentProperty resource property to the template. The ComponentProperty property specifies the configuration for all of a component's properties. Use ComponentProperty to specify the values to render or bind by default.
