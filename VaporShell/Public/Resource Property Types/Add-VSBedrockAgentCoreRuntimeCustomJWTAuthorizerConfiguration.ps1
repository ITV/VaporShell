function Add-VSBedrockAgentCoreRuntimeCustomJWTAuthorizerConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Runtime.CustomJWTAuthorizerConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Runtime.CustomJWTAuthorizerConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Runtime.CustomJWTAuthorizerConfiguration'
