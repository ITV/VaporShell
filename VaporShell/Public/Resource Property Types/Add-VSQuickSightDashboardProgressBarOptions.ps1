function Add-VSQuickSightDashboardProgressBarOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ProgressBarOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ProgressBarOptions'
