function Add-VSBatchJobDefinitionEFSAuthorizationConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobDefinition.EFSAuthorizationConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobDefinition.EFSAuthorizationConfig'
