function Add-VSCassandraTableWarmThroughput {
    <#
    .SYNOPSIS
        Adds an AWS::Cassandra::Table.WarmThroughput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Cassandra.Table.WarmThroughput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cassandra.Table.WarmThroughput'
