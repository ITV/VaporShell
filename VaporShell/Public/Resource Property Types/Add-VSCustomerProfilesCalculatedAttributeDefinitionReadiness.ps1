function Add-VSCustomerProfilesCalculatedAttributeDefinitionReadiness {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::CalculatedAttributeDefinition.Readiness resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.CalculatedAttributeDefinition.Readiness')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.CalculatedAttributeDefinition.Readiness'
