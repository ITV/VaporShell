function Add-VSSESMailManagerRuleSetRuleIpToEvaluate {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerRuleSet.RuleIpToEvaluate resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerRuleSet.RuleIpToEvaluate'
