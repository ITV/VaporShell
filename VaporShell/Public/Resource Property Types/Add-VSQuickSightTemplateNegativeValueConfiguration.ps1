function Add-VSQuickSightTemplateNegativeValueConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.NegativeValueConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.NegativeValueConfiguration'
