function Add-VSConnectRuleFieldValue {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Rule.FieldValue resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Rule.FieldValue'
