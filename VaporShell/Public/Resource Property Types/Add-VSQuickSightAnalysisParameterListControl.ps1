function Add-VSQuickSightAnalysisParameterListControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ParameterListControl resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ParameterListControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ParameterListControl'
