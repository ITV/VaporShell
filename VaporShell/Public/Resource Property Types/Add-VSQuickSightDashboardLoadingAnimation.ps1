function Add-VSQuickSightDashboardLoadingAnimation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.LoadingAnimation resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.LoadingAnimation'
