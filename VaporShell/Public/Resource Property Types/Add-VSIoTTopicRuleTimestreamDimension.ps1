function Add-VSIoTTopicRuleTimestreamDimension {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::TopicRule.TimestreamDimension resource property to the template. Metadata attributes of the time series that are written in each measure record.
