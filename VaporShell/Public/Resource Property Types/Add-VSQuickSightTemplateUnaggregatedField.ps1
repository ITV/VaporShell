function Add-VSQuickSightTemplateUnaggregatedField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.UnaggregatedField resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.UnaggregatedField')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.UnaggregatedField'
