function Add-VSEMRServerlessApplicationManagedPersistenceMonitoringConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.ManagedPersistenceMonitoringConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EMRServerless.Application.ManagedPersistenceMonitoringConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.ManagedPersistenceMonitoringConfiguration'
