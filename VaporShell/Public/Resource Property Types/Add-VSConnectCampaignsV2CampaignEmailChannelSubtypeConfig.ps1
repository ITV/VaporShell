function Add-VSConnectCampaignsV2CampaignEmailChannelSubtypeConfig {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.EmailChannelSubtypeConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ConnectCampaignsV2.Campaign.EmailChannelSubtypeConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.EmailChannelSubtypeConfig'
