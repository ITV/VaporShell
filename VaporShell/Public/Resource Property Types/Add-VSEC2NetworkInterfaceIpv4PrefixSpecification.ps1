function Add-VSEC2NetworkInterfaceIpv4PrefixSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::NetworkInterface.Ipv4PrefixSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.NetworkInterface.Ipv4PrefixSpecification')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.NetworkInterface.Ipv4PrefixSpecification'
