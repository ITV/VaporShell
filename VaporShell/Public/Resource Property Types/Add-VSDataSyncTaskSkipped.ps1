function Add-VSDataSyncTaskSkipped {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::Task.Skipped resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.Task.Skipped'
