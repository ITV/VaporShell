function Add-VSQuickSightAnalysisPercentVisibleRange {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.PercentVisibleRange resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.PercentVisibleRange')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.PercentVisibleRange'
