function Add-VSS3BucketS3TablesDestination {
    <#
    .SYNOPSIS
        Adds an AWS::S3::Bucket.S3TablesDestination resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.Bucket.S3TablesDestination')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.Bucket.S3TablesDestination'
