function Add-VSPCSComputeNodeGroupSpotOptions {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::ComputeNodeGroup.SpotOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.ComputeNodeGroup.SpotOptions'
