function Add-VSQuickSightTemplateTreeMapSortConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TreeMapSortConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TreeMapSortConfiguration'
