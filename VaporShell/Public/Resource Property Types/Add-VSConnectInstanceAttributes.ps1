function Add-VSConnectInstanceAttributes {
    ...
    .PARAMETER EnhancedContactMonitoring
    ...
    .PARAMETER EnhancedChatMonitoring
    ...
    .PARAMETER MultiPartyConference
    ...
    .PARAMETER MultiPartyChatConference
