function Add-VSControlTowerEnabledBaselineParameter {
    <#
    .SYNOPSIS
        Adds an AWS::ControlTower::EnabledBaseline.Parameter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ControlTower.EnabledBaseline.Parameter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ControlTower.EnabledBaseline.Parameter'
