function Add-VSIoTWirelessWirelessDeviceFPorts {
    <#
    .SYNOPSIS
        Adds an AWS::IoTWireless::WirelessDevice.FPorts resource property to the template. 
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.IoTWireless.WirelessDevice.Application"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTWireless.WirelessDevice.FPorts'
