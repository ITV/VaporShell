function Add-VSSageMakerModelQualityJobDefinitionModelQualityAppSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::ModelQualityJobDefinition.ModelQualityAppSpecification resource property to the template. Container image configuration object for the monitoring job.
