function Add-VSDataZoneProjectProfileRegion {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::ProjectProfile.Region resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.ProjectProfile.Region')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.ProjectProfile.Region'
