function Add-VSMediaConnectGatewayGatewayNetwork {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Gateway.GatewayNetwork resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Gateway.GatewayNetwork'
