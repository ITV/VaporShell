function Add-VSQuickSightDashboardFieldLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.FieldLabelType resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.FieldLabelType'
