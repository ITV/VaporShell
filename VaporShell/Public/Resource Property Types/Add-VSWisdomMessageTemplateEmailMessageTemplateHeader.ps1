function Add-VSWisdomMessageTemplateEmailMessageTemplateHeader {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::MessageTemplate.EmailMessageTemplateHeader resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.MessageTemplate.EmailMessageTemplateHeader')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.MessageTemplate.EmailMessageTemplateHeader'
