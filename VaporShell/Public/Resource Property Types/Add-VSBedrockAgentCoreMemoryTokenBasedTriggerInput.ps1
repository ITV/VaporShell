function Add-VSBedrockAgentCoreMemoryTokenBasedTriggerInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.TokenBasedTriggerInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.TokenBasedTriggerInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.TokenBasedTriggerInput'
