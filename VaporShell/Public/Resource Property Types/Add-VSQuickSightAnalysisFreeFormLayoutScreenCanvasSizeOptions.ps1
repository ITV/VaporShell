function Add-VSQuickSightAnalysisFreeFormLayoutScreenCanvasSizeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FreeFormLayoutScreenCanvasSizeOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FreeFormLayoutScreenCanvasSizeOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FreeFormLayoutScreenCanvasSizeOptions'
