function Add-VSQuickSightTemplateBarChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.BarChartFieldWells resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.BarChartFieldWells')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.BarChartFieldWells'
