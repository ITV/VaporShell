function Add-VSIoTAccountAuditConfigurationDeviceCertExpirationAuditCheckConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::AccountAuditConfiguration.DeviceCertExpirationAuditCheckConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.AccountAuditConfiguration.DeviceCertExpirationAuditCheckConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.AccountAuditConfiguration.DeviceCertExpirationAuditCheckConfiguration'
