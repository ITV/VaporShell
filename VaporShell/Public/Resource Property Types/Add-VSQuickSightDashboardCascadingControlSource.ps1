function Add-VSQuickSightDashboardCascadingControlSource {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.CascadingControlSource resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.CascadingControlSource')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.CascadingControlSource'
