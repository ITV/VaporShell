function Add-VSECSServiceServiceConnectTestTrafficRulesHeader {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.ServiceConnectTestTrafficRulesHeader resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.Service.ServiceConnectTestTrafficRulesHeader')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.ServiceConnectTestTrafficRulesHeader'
