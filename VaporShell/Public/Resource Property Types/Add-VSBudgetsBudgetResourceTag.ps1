function Add-VSBudgetsBudgetResourceTag {
    <#
    .SYNOPSIS
        Adds an AWS::Budgets::Budget.ResourceTag resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Budgets.Budget.ResourceTag'
