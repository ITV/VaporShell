function Add-VSQuickSightAnalysisSheetElementRenderingRule {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SheetElementRenderingRule resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.SheetElementRenderingRule')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SheetElementRenderingRule'
