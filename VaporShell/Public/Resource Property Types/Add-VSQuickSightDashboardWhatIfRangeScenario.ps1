function Add-VSQuickSightDashboardWhatIfRangeScenario {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.WhatIfRangeScenario resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.WhatIfRangeScenario'
