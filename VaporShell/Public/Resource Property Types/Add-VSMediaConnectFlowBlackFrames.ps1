function Add-VSMediaConnectFlowBlackFrames {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Flow.BlackFrames resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Flow.BlackFrames'
