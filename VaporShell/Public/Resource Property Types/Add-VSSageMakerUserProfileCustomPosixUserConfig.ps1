function Add-VSSageMakerUserProfileCustomPosixUserConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.CustomPosixUserConfig resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SageMaker.UserProfile.CustomPosixUserConfig')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.CustomPosixUserConfig'
