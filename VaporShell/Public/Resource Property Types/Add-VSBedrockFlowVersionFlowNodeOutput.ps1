function Add-VSBedrockFlowVersionFlowNodeOutput {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowVersion.FlowNodeOutput resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowVersion.FlowNodeOutput'
