function Add-VSBedrockPromptVersionCachePointBlock {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.CachePointBlock resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.CachePointBlock')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.CachePointBlock'
