function Add-VSQuickSightTemplateFontWeight {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FontWeight resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.FontWeight')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FontWeight'
