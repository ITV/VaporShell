function Add-VSObservabilityAdminOrganizationTelemetryRuleTelemetryDestinationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationTelemetryRule.TelemetryDestinationConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.TelemetryDestinationConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.TelemetryDestinationConfiguration'
