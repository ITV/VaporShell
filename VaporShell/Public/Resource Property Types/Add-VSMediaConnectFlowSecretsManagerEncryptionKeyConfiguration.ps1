function Add-VSMediaConnectFlowSecretsManagerEncryptionKeyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Flow.SecretsManagerEncryptionKeyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.Flow.SecretsManagerEncryptionKeyConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Flow.SecretsManagerEncryptionKeyConfiguration'
