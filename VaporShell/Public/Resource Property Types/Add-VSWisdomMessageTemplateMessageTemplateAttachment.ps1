function Add-VSWisdomMessageTemplateMessageTemplateAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::MessageTemplate.MessageTemplateAttachment resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.MessageTemplate.MessageTemplateAttachment')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.MessageTemplate.MessageTemplateAttachment'
