function Add-VSConfigConfigRuleEvaluationModeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Config::ConfigRule.EvaluationModeConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConfigRule.EvaluationModeConfiguration'
