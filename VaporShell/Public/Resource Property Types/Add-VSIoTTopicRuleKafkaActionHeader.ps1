function Add-VSIoTTopicRuleKafkaActionHeader {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::TopicRule.KafkaActionHeader resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.TopicRule.KafkaActionHeader')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.TopicRule.KafkaActionHeader'
