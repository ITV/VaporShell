function Add-VSImageBuilderLifecyclePolicyRecipeSelection {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::LifecyclePolicy.RecipeSelection resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.LifecyclePolicy.RecipeSelection'
