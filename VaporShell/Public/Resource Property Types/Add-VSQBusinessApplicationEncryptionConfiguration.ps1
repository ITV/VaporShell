function Add-VSQBusinessApplicationEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Application.EncryptionConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QBusiness.Application.EncryptionConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Application.EncryptionConfiguration'
