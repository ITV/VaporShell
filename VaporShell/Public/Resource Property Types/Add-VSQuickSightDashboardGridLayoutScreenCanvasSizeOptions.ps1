function Add-VSQuickSightDashboardGridLayoutScreenCanvasSizeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.GridLayoutScreenCanvasSizeOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.GridLayoutScreenCanvasSizeOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.GridLayoutScreenCanvasSizeOptions'
