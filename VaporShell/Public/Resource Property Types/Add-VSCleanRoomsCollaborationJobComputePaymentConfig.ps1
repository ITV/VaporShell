function Add-VSCleanRoomsCollaborationJobComputePaymentConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Collaboration.JobComputePaymentConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.Collaboration.JobComputePaymentConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Collaboration.JobComputePaymentConfig'
