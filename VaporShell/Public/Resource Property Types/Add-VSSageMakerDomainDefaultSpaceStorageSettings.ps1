function Add-VSSageMakerDomainDefaultSpaceStorageSettings {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Domain.DefaultSpaceStorageSettings resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Domain.DefaultSpaceStorageSettings'
