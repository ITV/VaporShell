function Add-VSQuickSightDashboardNumericAxisOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.NumericAxisOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.NumericAxisOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.NumericAxisOptions'
