function Add-VSVerifiedPermissionsPolicyEntityIdentifier {
    <#
    .SYNOPSIS
        Adds an AWS::VerifiedPermissions::Policy.EntityIdentifier resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.VerifiedPermissions.Policy.EntityIdentifier'
