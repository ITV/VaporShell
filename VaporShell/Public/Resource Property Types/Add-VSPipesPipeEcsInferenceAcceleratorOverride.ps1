function Add-VSPipesPipeEcsInferenceAcceleratorOverride {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.EcsInferenceAcceleratorOverride resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.EcsInferenceAcceleratorOverride'
