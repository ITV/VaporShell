function Add-VSConnectRuleRuleTriggerEventSource {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Rule.RuleTriggerEventSource resource property to the template.
    ...
    .PARAMETER IntegrationAssociationArn
    ...
    [OutputType('Vaporshell.Resource.Connect.Rule.RuleTriggerEventSource')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Rule.RuleTriggerEventSource'
