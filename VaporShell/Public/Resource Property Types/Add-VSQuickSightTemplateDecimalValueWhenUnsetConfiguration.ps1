function Add-VSQuickSightTemplateDecimalValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.DecimalValueWhenUnsetConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.DecimalValueWhenUnsetConfiguration'
