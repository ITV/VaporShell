function Add-VSQuickSightDashboardArcOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ArcOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ArcOptions'
