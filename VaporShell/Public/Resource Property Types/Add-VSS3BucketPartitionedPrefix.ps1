function Add-VSS3BucketPartitionedPrefix {
    <#
    .SYNOPSIS
        Adds an AWS::S3::Bucket.PartitionedPrefix resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.Bucket.PartitionedPrefix')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.Bucket.PartitionedPrefix'
