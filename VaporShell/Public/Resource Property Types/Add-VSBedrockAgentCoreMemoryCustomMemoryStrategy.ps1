function Add-VSBedrockAgentCoreMemoryCustomMemoryStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.CustomMemoryStrategy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.CustomMemoryStrategy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.CustomMemoryStrategy'
