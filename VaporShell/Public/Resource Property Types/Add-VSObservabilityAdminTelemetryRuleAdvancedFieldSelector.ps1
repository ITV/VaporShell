function Add-VSObservabilityAdminTelemetryRuleAdvancedFieldSelector {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::TelemetryRule.AdvancedFieldSelector resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.AdvancedFieldSelector')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.TelemetryRule.AdvancedFieldSelector'
