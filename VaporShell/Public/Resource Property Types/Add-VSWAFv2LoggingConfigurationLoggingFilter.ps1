function Add-VSWAFv2LoggingConfigurationLoggingFilter {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::LoggingConfiguration.LoggingFilter resource property to the template. 
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.WAFv2.LoggingConfiguration.Filter"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.LoggingConfiguration.LoggingFilter'
