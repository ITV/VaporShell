function Add-VSDataSyncLocationObjectStorageCmkSecretConfig {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationObjectStorage.CmkSecretConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationObjectStorage.CmkSecretConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationObjectStorage.CmkSecretConfig'
