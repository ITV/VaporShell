function Add-VSIoTFleetWiseVehicleStateTemplateUpdateStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Vehicle.StateTemplateUpdateStrategy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.Vehicle.StateTemplateUpdateStrategy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Vehicle.StateTemplateUpdateStrategy'
