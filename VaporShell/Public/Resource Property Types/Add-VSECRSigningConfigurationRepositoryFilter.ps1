function Add-VSECRSigningConfigurationRepositoryFilter {
    <#
    .SYNOPSIS
        Adds an AWS::ECR::SigningConfiguration.RepositoryFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECR.SigningConfiguration.RepositoryFilter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECR.SigningConfiguration.RepositoryFilter'
