function Add-VSQuickSightDashboardDataColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DataColor resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DataColor')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DataColor'
