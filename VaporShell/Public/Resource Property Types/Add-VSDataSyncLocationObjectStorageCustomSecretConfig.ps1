function Add-VSDataSyncLocationObjectStorageCustomSecretConfig {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationObjectStorage.CustomSecretConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationObjectStorage.CustomSecretConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationObjectStorage.CustomSecretConfig'
