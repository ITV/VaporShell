function Add-VSBedrockFlowVersionFieldForReranking {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowVersion.FieldForReranking resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.FlowVersion.FieldForReranking')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowVersion.FieldForReranking'
