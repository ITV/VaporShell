function Add-VSBedrockPromptToolInputSchema {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.ToolInputSchema resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Prompt.ToolInputSchema')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.ToolInputSchema'
