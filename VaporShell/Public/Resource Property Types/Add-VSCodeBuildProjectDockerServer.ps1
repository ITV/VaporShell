function Add-VSCodeBuildProjectDockerServer {
    <#
    .SYNOPSIS
        Adds an AWS::CodeBuild::Project.DockerServer resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CodeBuild.Project.DockerServer')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CodeBuild.Project.DockerServer'
