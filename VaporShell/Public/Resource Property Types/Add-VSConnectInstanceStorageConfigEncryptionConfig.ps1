function Add-VSConnectInstanceStorageConfigEncryptionConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::InstanceStorageConfig.EncryptionConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.InstanceStorageConfig.EncryptionConfig'
