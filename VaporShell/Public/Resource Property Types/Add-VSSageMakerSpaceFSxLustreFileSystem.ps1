function Add-VSSageMakerSpaceFSxLustreFileSystem {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Space.FSxLustreFileSystem resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Space.FSxLustreFileSystem'
