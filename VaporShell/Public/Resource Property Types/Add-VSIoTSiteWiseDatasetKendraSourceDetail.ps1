function Add-VSIoTSiteWiseDatasetKendraSourceDetail {
    <#
    .SYNOPSIS
        Adds an AWS::IoTSiteWise::Dataset.KendraSourceDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTSiteWise.Dataset.KendraSourceDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTSiteWise.Dataset.KendraSourceDetail'
