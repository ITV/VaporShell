function Add-VSOSISPipelineResourcePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::OSIS::Pipeline.ResourcePolicy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.OSIS.Pipeline.ResourcePolicy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OSIS.Pipeline.ResourcePolicy'
