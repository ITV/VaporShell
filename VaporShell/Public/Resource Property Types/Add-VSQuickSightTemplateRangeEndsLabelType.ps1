function Add-VSQuickSightTemplateRangeEndsLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.RangeEndsLabelType resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.RangeEndsLabelType')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.RangeEndsLabelType'
