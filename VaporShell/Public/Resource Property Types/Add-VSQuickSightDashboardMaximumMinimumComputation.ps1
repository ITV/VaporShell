function Add-VSQuickSightDashboardMaximumMinimumComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.MaximumMinimumComputation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.MaximumMinimumComputation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.MaximumMinimumComputation'
