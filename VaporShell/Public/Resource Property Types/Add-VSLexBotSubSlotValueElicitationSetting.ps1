function Add-VSLexBotSubSlotValueElicitationSetting {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.SubSlotValueElicitationSetting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.SubSlotValueElicitationSetting')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.SubSlotValueElicitationSetting'
