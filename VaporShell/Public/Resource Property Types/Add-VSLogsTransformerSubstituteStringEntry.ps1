function Add-VSLogsTransformerSubstituteStringEntry {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Transformer.SubstituteStringEntry resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Logs.Transformer.SubstituteStringEntry')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Transformer.SubstituteStringEntry'
