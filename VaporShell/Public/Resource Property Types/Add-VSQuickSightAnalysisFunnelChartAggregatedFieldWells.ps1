function Add-VSQuickSightAnalysisFunnelChartAggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FunnelChartAggregatedFieldWells resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FunnelChartAggregatedFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FunnelChartAggregatedFieldWells'
