function Add-VSEventsEndpointEndpointEventBus {
    <#
    .SYNOPSIS
        Adds an AWS::Events::Endpoint.EndpointEventBus resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Events.Endpoint.EndpointEventBus'
