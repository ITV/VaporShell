function Add-VSBCMDataExportsExportResourceTag {
    <#
    .SYNOPSIS
        Adds an AWS::BCMDataExports::Export.ResourceTag resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.BCMDataExports.Export.ResourceTag')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BCMDataExports.Export.ResourceTag'
