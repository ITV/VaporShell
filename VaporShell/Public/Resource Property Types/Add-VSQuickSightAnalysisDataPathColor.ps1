function Add-VSQuickSightAnalysisDataPathColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.DataPathColor resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.DataPathColor'
