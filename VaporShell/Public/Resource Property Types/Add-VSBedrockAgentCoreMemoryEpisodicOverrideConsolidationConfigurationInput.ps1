function Add-VSBedrockAgentCoreMemoryEpisodicOverrideConsolidationConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.EpisodicOverrideConsolidationConfigurationInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.EpisodicOverrideConsolidationConfigurationInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.EpisodicOverrideConsolidationConfigurationInput'
