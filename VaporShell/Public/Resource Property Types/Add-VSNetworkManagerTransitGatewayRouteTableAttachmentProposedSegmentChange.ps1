function Add-VSNetworkManagerTransitGatewayRouteTableAttachmentProposedSegmentChange {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::TransitGatewayRouteTableAttachment.ProposedSegmentChange resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.TransitGatewayRouteTableAttachment.ProposedSegmentChange'
