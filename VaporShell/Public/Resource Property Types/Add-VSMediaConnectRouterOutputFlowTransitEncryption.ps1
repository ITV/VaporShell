function Add-VSMediaConnectRouterOutputFlowTransitEncryption {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterOutput.FlowTransitEncryption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterOutput.FlowTransitEncryption')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterOutput.FlowTransitEncryption'
