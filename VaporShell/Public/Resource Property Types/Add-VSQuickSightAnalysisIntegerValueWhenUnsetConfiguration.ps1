function Add-VSQuickSightAnalysisIntegerValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.IntegerValueWhenUnsetConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.IntegerValueWhenUnsetConfiguration'
