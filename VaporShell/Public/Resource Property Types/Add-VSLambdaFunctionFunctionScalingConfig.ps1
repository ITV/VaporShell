function Add-VSLambdaFunctionFunctionScalingConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::Function.FunctionScalingConfig resource property to the template.
    ...
    .PARAMETER MinExecutionEnvironments
    ...
    .PARAMETER MaxExecutionEnvironments
    ...
    [OutputType('Vaporshell.Resource.Lambda.Function.FunctionScalingConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.Function.FunctionScalingConfig'
