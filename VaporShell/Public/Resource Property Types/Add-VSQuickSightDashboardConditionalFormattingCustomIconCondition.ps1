function Add-VSQuickSightDashboardConditionalFormattingCustomIconCondition {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ConditionalFormattingCustomIconCondition resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ConditionalFormattingCustomIconCondition')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ConditionalFormattingCustomIconCondition'
