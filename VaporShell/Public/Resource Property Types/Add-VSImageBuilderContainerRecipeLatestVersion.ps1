function Add-VSImageBuilderContainerRecipeLatestVersion {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::ContainerRecipe.LatestVersion resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.ContainerRecipe.LatestVersion')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.ContainerRecipe.LatestVersion'
