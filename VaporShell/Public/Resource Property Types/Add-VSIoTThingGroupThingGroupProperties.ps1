function Add-VSIoTThingGroupThingGroupProperties {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::ThingGroup.ThingGroupProperties resource property to the template. 
    ...
    .PARAMETER ThingGroupDescription
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.ThingGroup.ThingGroupProperties'
