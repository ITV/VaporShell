function Add-VSAppFlowConnectorProfileGoogleAnalyticsConnectorProfileCredentials {
    <#
    .SYNOPSIS
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.ConnectorProfile.GoogleAnalyticsConnectorProfileCredentials'
