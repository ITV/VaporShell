function Add-VSSageMakerMonitoringScheduleCsv {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::MonitoringSchedule.Csv resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.MonitoringSchedule.Csv'
