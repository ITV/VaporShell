function Add-VSRolesAnywhereTrustAnchorSourceData {
    <#
    .SYNOPSIS
        Adds an AWS::RolesAnywhere::TrustAnchor.SourceData resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RolesAnywhere.TrustAnchor.SourceData'
