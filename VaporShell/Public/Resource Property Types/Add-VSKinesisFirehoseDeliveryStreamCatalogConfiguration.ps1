function Add-VSKinesisFirehoseDeliveryStreamCatalogConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.CatalogConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.KinesisFirehose.DeliveryStream.CatalogConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.CatalogConfiguration'
