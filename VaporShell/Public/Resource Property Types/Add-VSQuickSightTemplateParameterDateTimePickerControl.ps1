function Add-VSQuickSightTemplateParameterDateTimePickerControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ParameterDateTimePickerControl resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.ParameterDateTimePickerControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ParameterDateTimePickerControl'
