function Add-VSWAFv2WebACLRateLimitHeader {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RateLimitHeader resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RateLimitHeader'
