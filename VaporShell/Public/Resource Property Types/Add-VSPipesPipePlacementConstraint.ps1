function Add-VSPipesPipePlacementConstraint {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.PlacementConstraint resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Pipes.Pipe.PlacementConstraint')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.PlacementConstraint'
