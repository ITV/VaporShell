function Add-VSLocationAPIKeyAndroidApp {
    <#
    .SYNOPSIS
        Adds an AWS::Location::APIKey.AndroidApp resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Location.APIKey.AndroidApp')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Location.APIKey.AndroidApp'
