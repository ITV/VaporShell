function Add-VSQuickSightAnalysisStringDefaultValues {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.StringDefaultValues resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.StringDefaultValues'
