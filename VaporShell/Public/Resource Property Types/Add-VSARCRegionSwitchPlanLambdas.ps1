function Add-VSARCRegionSwitchPlanLambdas {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.Lambdas resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.Lambdas')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.Lambdas'
