function Add-VSQuickSightAnalysisFunnelChartVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FunnelChartVisual resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FunnelChartVisual')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FunnelChartVisual'
