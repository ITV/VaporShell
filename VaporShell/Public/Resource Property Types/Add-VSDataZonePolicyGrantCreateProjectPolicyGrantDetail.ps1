function Add-VSDataZonePolicyGrantCreateProjectPolicyGrantDetail {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.CreateProjectPolicyGrantDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.CreateProjectPolicyGrantDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.CreateProjectPolicyGrantDetail'
