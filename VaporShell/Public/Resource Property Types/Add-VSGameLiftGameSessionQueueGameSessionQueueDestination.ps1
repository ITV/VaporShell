function Add-VSGameLiftGameSessionQueueGameSessionQueueDestination {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::GameSessionQueue.GameSessionQueueDestination resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.GameLift.GameSessionQueue.GameSessionQueueDestination')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.GameSessionQueue.GameSessionQueueDestination'
