function Add-VSWAFv2RuleGroupRateLimitQueryString {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.RateLimitQueryString resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.RateLimitQueryString'
