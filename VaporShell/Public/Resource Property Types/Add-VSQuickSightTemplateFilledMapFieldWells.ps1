function Add-VSQuickSightTemplateFilledMapFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FilledMapFieldWells resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FilledMapFieldWells'
