function Add-VSQuickSightAnalysisFieldSortOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FieldSortOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FieldSortOptions'
