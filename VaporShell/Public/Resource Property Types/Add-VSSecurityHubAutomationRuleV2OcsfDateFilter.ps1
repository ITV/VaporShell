function Add-VSSecurityHubAutomationRuleV2OcsfDateFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2.OcsfDateFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfDateFilter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2.OcsfDateFilter'
