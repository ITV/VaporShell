function Add-VSMediaLiveNetworkRoute {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Network.Route resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.MediaLive.Network.Route')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Network.Route'
