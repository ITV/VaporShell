function Add-VSSESMailManagerTrafficPolicyIngressTlsProtocolToEvaluate {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerTrafficPolicy.IngressTlsProtocolToEvaluate resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressTlsProtocolToEvaluate'
