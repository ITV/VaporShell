function Add-VSQuickSightAnalysisGeospatialWindowOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.GeospatialWindowOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.GeospatialWindowOptions'
