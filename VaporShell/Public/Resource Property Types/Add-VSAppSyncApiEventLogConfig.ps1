function Add-VSAppSyncApiEventLogConfig {
    <#
    .SYNOPSIS
        Adds an AWS::AppSync::Api.EventLogConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppSync.Api.EventLogConfig'
