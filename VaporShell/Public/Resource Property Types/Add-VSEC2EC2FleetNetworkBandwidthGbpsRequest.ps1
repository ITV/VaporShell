function Add-VSEC2EC2FleetNetworkBandwidthGbpsRequest {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::EC2Fleet.NetworkBandwidthGbpsRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.EC2Fleet.NetworkBandwidthGbpsRequest')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.EC2Fleet.NetworkBandwidthGbpsRequest'
