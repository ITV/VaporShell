function Add-VSQuickSightDashboardNumericSeparatorConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.NumericSeparatorConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.NumericSeparatorConfiguration'
