function Add-VSWAFv2RuleGroupCustomHTTPHeader {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.CustomHTTPHeader resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.CustomHTTPHeader')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.CustomHTTPHeader'
