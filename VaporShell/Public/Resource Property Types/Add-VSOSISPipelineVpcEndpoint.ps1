function Add-VSOSISPipelineVpcEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::OSIS::Pipeline.VpcEndpoint resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OSIS.Pipeline.VpcEndpoint'
