function Add-VSSageMakerSpaceEFSFileSystem {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Space.EFSFileSystem resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Space.EFSFileSystem'
