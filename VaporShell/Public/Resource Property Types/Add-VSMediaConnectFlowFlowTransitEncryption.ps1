function Add-VSMediaConnectFlowFlowTransitEncryption {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Flow.FlowTransitEncryption resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.Flow.FlowTransitEncryption')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Flow.FlowTransitEncryption'
