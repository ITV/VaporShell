function Add-VSQuickSightTemplateMaximumMinimumComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.MaximumMinimumComputation resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.MaximumMinimumComputation'
