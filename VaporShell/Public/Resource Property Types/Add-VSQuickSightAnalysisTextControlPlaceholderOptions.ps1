function Add-VSQuickSightAnalysisTextControlPlaceholderOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TextControlPlaceholderOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TextControlPlaceholderOptions'
