function Add-VSBedrockKnowledgeBaseVideoSegmentationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.VideoSegmentationConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.KnowledgeBase.VideoSegmentationConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.VideoSegmentationConfiguration'
