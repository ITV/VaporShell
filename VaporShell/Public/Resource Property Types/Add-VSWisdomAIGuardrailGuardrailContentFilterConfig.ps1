function Add-VSWisdomAIGuardrailGuardrailContentFilterConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIGuardrail.GuardrailContentFilterConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIGuardrail.GuardrailContentFilterConfig'
