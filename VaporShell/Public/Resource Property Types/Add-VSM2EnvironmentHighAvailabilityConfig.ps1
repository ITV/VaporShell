function Add-VSM2EnvironmentHighAvailabilityConfig {
    <#
    .SYNOPSIS
        Adds an AWS::M2::Environment.HighAvailabilityConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.M2.Environment.HighAvailabilityConfig'
