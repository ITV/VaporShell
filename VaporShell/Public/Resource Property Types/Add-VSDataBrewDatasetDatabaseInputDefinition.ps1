function Add-VSDataBrewDatasetDatabaseInputDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::DataBrew::Dataset.DatabaseInputDefinition resource property to the template. Connection information for dataset input files stored in a database.
