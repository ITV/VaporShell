function Add-VSAppRunnerServiceKeyValuePair {
    <#
    .SYNOPSIS
        Adds an AWS::AppRunner::Service.KeyValuePair resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AppRunner.Service.KeyValuePair')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppRunner.Service.KeyValuePair'
