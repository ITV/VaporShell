function Add-VSSageMakerInferenceComponentInferenceComponentContainerSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::InferenceComponent.InferenceComponentContainerSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.InferenceComponent.InferenceComponentContainerSpecification')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.InferenceComponent.InferenceComponentContainerSpecification'
