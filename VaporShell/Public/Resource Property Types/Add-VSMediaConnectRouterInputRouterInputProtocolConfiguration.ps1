function Add-VSMediaConnectRouterInputRouterInputProtocolConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.RouterInputProtocolConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.RouterInputProtocolConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.RouterInputProtocolConfiguration'
