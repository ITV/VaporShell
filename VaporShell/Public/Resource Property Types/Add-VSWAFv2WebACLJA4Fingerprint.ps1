function Add-VSWAFv2WebACLJA4Fingerprint {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.JA4Fingerprint resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.JA4Fingerprint')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.JA4Fingerprint'
