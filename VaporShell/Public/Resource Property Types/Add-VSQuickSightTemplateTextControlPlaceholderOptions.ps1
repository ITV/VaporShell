function Add-VSQuickSightTemplateTextControlPlaceholderOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TextControlPlaceholderOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.TextControlPlaceholderOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TextControlPlaceholderOptions'
