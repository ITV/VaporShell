function Add-VSQuickSightTemplateSheetTextBox {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SheetTextBox resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SheetTextBox'
