function Add-VSDataZoneUserProfileIamUserProfileDetails {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::UserProfile.IamUserProfileDetails resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.UserProfile.IamUserProfileDetails'
