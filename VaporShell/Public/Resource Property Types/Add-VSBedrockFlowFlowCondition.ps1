function Add-VSBedrockFlowFlowCondition {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.FlowCondition resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.Flow.FlowCondition')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.FlowCondition'
