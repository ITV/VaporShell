function Add-VSPCSComputeNodeGroupErrorInfo {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::ComputeNodeGroup.ErrorInfo resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.PCS.ComputeNodeGroup.ErrorInfo')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.ComputeNodeGroup.ErrorInfo'
