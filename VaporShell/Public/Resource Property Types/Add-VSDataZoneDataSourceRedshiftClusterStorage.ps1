function Add-VSDataZoneDataSourceRedshiftClusterStorage {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DataSource.RedshiftClusterStorage resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DataSource.RedshiftClusterStorage'
