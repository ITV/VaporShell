function Add-VSObservabilityAdminS3TableIntegrationLogSource {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::S3TableIntegration.LogSource resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.S3TableIntegration.LogSource')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.S3TableIntegration.LogSource'
