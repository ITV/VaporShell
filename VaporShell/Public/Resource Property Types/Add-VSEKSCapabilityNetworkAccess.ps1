function Add-VSEKSCapabilityNetworkAccess {
    <#
    .SYNOPSIS
        Adds an AWS::EKS::Capability.NetworkAccess resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EKS.Capability.NetworkAccess')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Capability.NetworkAccess'
