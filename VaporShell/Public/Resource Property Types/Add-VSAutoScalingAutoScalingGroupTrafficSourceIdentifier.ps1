function Add-VSAutoScalingAutoScalingGroupTrafficSourceIdentifier {
    <#
    .SYNOPSIS
        Adds an AWS::AutoScaling::AutoScalingGroup.TrafficSourceIdentifier resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AutoScaling.AutoScalingGroup.TrafficSourceIdentifier')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScaling.AutoScalingGroup.TrafficSourceIdentifier'
