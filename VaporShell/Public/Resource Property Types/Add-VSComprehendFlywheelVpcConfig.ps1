function Add-VSComprehendFlywheelVpcConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Comprehend::Flywheel.VpcConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Comprehend.Flywheel.VpcConfig'
