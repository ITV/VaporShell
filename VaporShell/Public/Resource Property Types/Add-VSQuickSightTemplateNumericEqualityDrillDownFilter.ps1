function Add-VSQuickSightTemplateNumericEqualityDrillDownFilter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.NumericEqualityDrillDownFilter resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.NumericEqualityDrillDownFilter')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.NumericEqualityDrillDownFilter'
