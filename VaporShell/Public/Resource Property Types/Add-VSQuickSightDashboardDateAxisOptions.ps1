function Add-VSQuickSightDashboardDateAxisOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DateAxisOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DateAxisOptions'
