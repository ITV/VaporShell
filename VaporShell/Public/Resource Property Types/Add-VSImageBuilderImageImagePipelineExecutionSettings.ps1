function Add-VSImageBuilderImageImagePipelineExecutionSettings {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::Image.ImagePipelineExecutionSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.Image.ImagePipelineExecutionSettings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.Image.ImagePipelineExecutionSettings'
