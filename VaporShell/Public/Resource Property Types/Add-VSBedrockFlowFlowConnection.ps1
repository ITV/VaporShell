function Add-VSBedrockFlowFlowConnection {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.FlowConnection resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.Flow.FlowConnection')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.FlowConnection'
