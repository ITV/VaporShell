function Add-VSDeadlineFleetAcceleratorTotalMemoryMiBRange {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Fleet.AcceleratorTotalMemoryMiBRange resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Fleet.AcceleratorTotalMemoryMiBRange'
