function Add-VSQuickSightDashboardFilledMapShapeConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.FilledMapShapeConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.FilledMapShapeConditionalFormatting')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.FilledMapShapeConditionalFormatting'
