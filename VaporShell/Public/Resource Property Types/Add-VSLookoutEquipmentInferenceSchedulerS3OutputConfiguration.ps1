function Add-VSLookoutEquipmentInferenceSchedulerS3OutputConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::LookoutEquipment::InferenceScheduler.S3OutputConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.LookoutEquipment.InferenceScheduler.S3OutputConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LookoutEquipment.InferenceScheduler.S3OutputConfiguration'
