function Add-VSS3BucketRecordExpiration {
    <#
    .SYNOPSIS
        Adds an AWS::S3::Bucket.RecordExpiration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.Bucket.RecordExpiration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.Bucket.RecordExpiration'
