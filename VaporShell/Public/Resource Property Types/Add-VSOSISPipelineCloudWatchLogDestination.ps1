function Add-VSOSISPipelineCloudWatchLogDestination {
    <#
    .SYNOPSIS
        Adds an AWS::OSIS::Pipeline.CloudWatchLogDestination resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OSIS.Pipeline.CloudWatchLogDestination'
