function Add-VSQuickSightDashboardInsightConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.InsightConfiguration resource property to the template.
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Dashboard.Computation"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.InsightConfiguration'
