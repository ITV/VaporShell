function Add-VSCognitoLogDeliveryConfigurationCloudWatchLogsConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Cognito::LogDeliveryConfiguration.CloudWatchLogsConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.LogDeliveryConfiguration.CloudWatchLogsConfiguration'
