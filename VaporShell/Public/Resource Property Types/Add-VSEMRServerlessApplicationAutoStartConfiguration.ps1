function Add-VSEMRServerlessApplicationAutoStartConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.AutoStartConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.AutoStartConfiguration'
