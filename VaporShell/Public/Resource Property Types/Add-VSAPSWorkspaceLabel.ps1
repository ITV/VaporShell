function Add-VSAPSWorkspaceLabel {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Workspace.Label resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.APS.Workspace.Label')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Workspace.Label'
