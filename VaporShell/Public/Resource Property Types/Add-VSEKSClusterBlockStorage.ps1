function Add-VSEKSClusterBlockStorage {
    <#
    .SYNOPSIS
        Adds an AWS::EKS::Cluster.BlockStorage resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EKS.Cluster.BlockStorage'
