function Add-VSGammaDilithiumJobDefinitionMountPoints {
    <#
    .SYNOPSIS
        Adds an AWS::GammaDilithium::JobDefinition.MountPoints resource property to the template.

    .DESCRIPTION
        Adds an AWS::GammaDilithium::JobDefinition.MountPoints resource property to the template.

    .LINK
        http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-gammadilithium-jobdefinition-mountpoints.html
    ...
    [OutputType('Vaporshell.Resource.GammaDilithium.JobDefinition.MountPoints')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GammaDilithium.JobDefinition.MountPoints'
