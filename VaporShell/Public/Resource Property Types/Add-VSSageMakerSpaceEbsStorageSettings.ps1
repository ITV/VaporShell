function Add-VSSageMakerSpaceEbsStorageSettings {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Space.EbsStorageSettings resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Space.EbsStorageSettings'
