function Add-VSQuickSightTemplateSheetElementConfigurationOverrides {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SheetElementConfigurationOverrides resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SheetElementConfigurationOverrides'
