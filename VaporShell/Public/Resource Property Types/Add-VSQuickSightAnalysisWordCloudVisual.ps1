function Add-VSQuickSightAnalysisWordCloudVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.WordCloudVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-wordcloudvisual.html#cfn-quicksight-analysis-wordcloudvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.WordCloudVisual'
