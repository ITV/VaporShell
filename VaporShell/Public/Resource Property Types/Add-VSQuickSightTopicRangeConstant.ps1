function Add-VSQuickSightTopicRangeConstant {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Topic.RangeConstant resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Topic.RangeConstant'
