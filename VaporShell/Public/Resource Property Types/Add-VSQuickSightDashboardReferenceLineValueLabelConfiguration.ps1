function Add-VSQuickSightDashboardReferenceLineValueLabelConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ReferenceLineValueLabelConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ReferenceLineValueLabelConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ReferenceLineValueLabelConfiguration'
