function Add-VSQuickSightAnalysisFreeFormLayoutElementBorderStyle {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FreeFormLayoutElementBorderStyle resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FreeFormLayoutElementBorderStyle'
