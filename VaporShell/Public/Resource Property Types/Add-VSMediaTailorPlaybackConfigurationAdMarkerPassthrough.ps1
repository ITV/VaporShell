function Add-VSMediaTailorPlaybackConfigurationAdMarkerPassthrough {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::PlaybackConfiguration.AdMarkerPassthrough resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.PlaybackConfiguration.AdMarkerPassthrough'
