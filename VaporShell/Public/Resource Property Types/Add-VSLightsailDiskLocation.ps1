function Add-VSLightsailDiskLocation {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::Disk.Location resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.Disk.Location'
