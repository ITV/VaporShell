function Add-VSQuickSightDashboardEntity {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.Entity resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.Entity')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.Entity'
