function Add-VSQuickSightDashboardSheetTextBox {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SheetTextBox resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.SheetTextBox')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SheetTextBox'
