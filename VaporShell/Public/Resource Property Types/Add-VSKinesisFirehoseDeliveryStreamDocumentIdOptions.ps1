function Add-VSKinesisFirehoseDeliveryStreamDocumentIdOptions {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisFirehose::DeliveryStream.DocumentIdOptions resource property to the template. 
    ...
    .PARAMETER DefaultDocumentIdFormat
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisFirehose.DeliveryStream.DocumentIdOptions'
