function Add-VSPipesPipeEcsResourceRequirement {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.EcsResourceRequirement resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Pipes.Pipe.EcsResourceRequirement')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.EcsResourceRequirement'
