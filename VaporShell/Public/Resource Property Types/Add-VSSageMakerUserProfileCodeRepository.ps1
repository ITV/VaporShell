function Add-VSSageMakerUserProfileCodeRepository {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.CodeRepository resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.CodeRepository'
