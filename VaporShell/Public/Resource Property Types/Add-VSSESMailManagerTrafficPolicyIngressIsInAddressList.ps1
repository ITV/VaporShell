function Add-VSSESMailManagerTrafficPolicyIngressIsInAddressList {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerTrafficPolicy.IngressIsInAddressList resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressIsInAddressList')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressIsInAddressList'
