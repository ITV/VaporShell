function Add-VSCloudTrailTrailAggregationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::CloudTrail::Trail.AggregationConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudTrail.Trail.AggregationConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudTrail.Trail.AggregationConfiguration'
