function Add-VSDataZoneProjectProfileAwsAccount {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::ProjectProfile.AwsAccount resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.ProjectProfile.AwsAccount')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.ProjectProfile.AwsAccount'
