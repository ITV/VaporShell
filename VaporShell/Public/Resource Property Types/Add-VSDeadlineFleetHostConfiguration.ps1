function Add-VSDeadlineFleetHostConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Deadline::Fleet.HostConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Deadline.Fleet.HostConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Deadline.Fleet.HostConfiguration'
