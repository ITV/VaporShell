function Add-VSMediaLiveChannelScte20PlusEmbeddedDestinationSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.Scte20PlusEmbeddedDestinationSettings resource property to the template. The configuration of SCTE-20 plus embedded captions in the output.
