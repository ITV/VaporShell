function Add-VSQuickSightAnalysisBinWidthOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BinWidthOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.BinWidthOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BinWidthOptions'
