function Add-VSBedrockFlowPerformanceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.PerformanceConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.PerformanceConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.PerformanceConfiguration'
