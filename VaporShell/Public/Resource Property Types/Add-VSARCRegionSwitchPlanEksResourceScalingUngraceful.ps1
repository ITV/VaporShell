function Add-VSARCRegionSwitchPlanEksResourceScalingUngraceful {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.EksResourceScalingUngraceful resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.EksResourceScalingUngraceful')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.EksResourceScalingUngraceful'
