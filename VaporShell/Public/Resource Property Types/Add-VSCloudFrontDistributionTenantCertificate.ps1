function Add-VSCloudFrontDistributionTenantCertificate {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::DistributionTenant.Certificate resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.DistributionTenant.Certificate')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.DistributionTenant.Certificate'
