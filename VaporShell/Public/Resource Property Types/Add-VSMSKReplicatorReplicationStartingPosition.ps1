function Add-VSMSKReplicatorReplicationStartingPosition {
    <#
    .SYNOPSIS
        Adds an AWS::MSK::Replicator.ReplicationStartingPosition resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MSK.Replicator.ReplicationStartingPosition'
