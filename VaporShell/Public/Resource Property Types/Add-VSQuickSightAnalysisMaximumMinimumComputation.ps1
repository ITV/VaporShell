function Add-VSQuickSightAnalysisMaximumMinimumComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.MaximumMinimumComputation resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.MaximumMinimumComputation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.MaximumMinimumComputation'
