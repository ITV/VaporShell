function Add-VSAppFlowConnectorLambdaConnectorProvisioningConfig {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Connector.LambdaConnectorProvisioningConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Connector.LambdaConnectorProvisioningConfig'
