function Add-VSQuickSightAnalysisTableStyleTarget {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TableStyleTarget resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.TableStyleTarget')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TableStyleTarget'
