function Add-VSCustomerProfilesSegmentDefinitionSourceSegment {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::SegmentDefinition.SourceSegment resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.SegmentDefinition.SourceSegment'
