function Add-VSDataBrewJobDatabaseTableOutputOptions {
    <#
    .SYNOPSIS
        Adds an AWS::DataBrew::Job.DatabaseTableOutputOptions resource property to the template. Represents options that specify how and where DataBrew writes the database output generated by recipe jobs.
