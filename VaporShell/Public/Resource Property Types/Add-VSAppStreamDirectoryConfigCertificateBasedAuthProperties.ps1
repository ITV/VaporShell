function Add-VSAppStreamDirectoryConfigCertificateBasedAuthProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AppStream::DirectoryConfig.CertificateBasedAuthProperties resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppStream.DirectoryConfig.CertificateBasedAuthProperties'
