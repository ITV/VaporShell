function Add-VSDataZoneDataSourceRedshiftServerlessStorage {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DataSource.RedshiftServerlessStorage resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.DataSource.RedshiftServerlessStorage')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DataSource.RedshiftServerlessStorage'
