function Add-VSDMSDataProviderIbmDb2LuwSettings {
    <#
    .SYNOPSIS
        Adds an AWS::DMS::DataProvider.IbmDb2LuwSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DMS.DataProvider.IbmDb2LuwSettings')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DMS.DataProvider.IbmDb2LuwSettings'
