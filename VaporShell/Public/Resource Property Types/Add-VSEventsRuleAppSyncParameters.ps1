function Add-VSEventsRuleAppSyncParameters {
    <#
    .SYNOPSIS
        Adds an AWS::Events::Rule.AppSyncParameters resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Events.Rule.AppSyncParameters'
