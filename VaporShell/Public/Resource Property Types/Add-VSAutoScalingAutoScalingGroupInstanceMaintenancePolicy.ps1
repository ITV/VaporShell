function Add-VSAutoScalingAutoScalingGroupInstanceMaintenancePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::AutoScaling::AutoScalingGroup.InstanceMaintenancePolicy resource property to the template. 
    ...
    .PARAMETER MaxHealthyPercentage
    ...
    .PARAMETER MinHealthyPercentage
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScaling.AutoScalingGroup.InstanceMaintenancePolicy'
