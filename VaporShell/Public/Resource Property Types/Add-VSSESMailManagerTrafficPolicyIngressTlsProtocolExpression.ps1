function Add-VSSESMailManagerTrafficPolicyIngressTlsProtocolExpression {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerTrafficPolicy.IngressTlsProtocolExpression resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressTlsProtocolExpression')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerTrafficPolicy.IngressTlsProtocolExpression'
