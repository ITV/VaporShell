function Add-VSIoTTwinMakerComponentTypeCompositeComponentType {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::ComponentType.CompositeComponentType resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.ComponentType.CompositeComponentType'
