function Add-VSMediaTailorSourceLocationHttpConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaTailor::SourceLocation.HttpConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaTailor.SourceLocation.HttpConfiguration'
