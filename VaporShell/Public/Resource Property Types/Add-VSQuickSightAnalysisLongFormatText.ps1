function Add-VSQuickSightAnalysisLongFormatText {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.LongFormatText resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.LongFormatText')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.LongFormatText'
