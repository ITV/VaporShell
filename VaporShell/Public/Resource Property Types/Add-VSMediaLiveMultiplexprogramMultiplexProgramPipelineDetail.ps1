function Add-VSMediaLiveMultiplexprogramMultiplexProgramPipelineDetail {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Multiplexprogram.MultiplexProgramPipelineDetail resource property to the template.
    ...
    .PARAMETER ActiveChannelPipeline
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Multiplexprogram.MultiplexProgramPipelineDetail'
