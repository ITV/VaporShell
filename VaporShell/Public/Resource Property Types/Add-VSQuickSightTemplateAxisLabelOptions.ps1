function Add-VSQuickSightTemplateAxisLabelOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.AxisLabelOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.AxisLabelOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.AxisLabelOptions'
