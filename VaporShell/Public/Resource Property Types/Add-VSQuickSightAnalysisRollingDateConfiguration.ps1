function Add-VSQuickSightAnalysisRollingDateConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.RollingDateConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.RollingDateConfiguration'
