function Add-VSImageBuilderImagePipelineAutoDisablePolicy {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::ImagePipeline.AutoDisablePolicy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.ImagePipeline.AutoDisablePolicy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.ImagePipeline.AutoDisablePolicy'
