function Add-VSMediaConnectBridgeFailoverConfig {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::Bridge.FailoverConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.Bridge.FailoverConfig'
