function Add-VSDataZoneDataSourceSageMakerRunConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::DataSource.SageMakerRunConfigurationInput resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.DataSource.SageMakerRunConfigurationInput'
