function Add-VSQuickSightDashboardExplicitHierarchy {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ExplicitHierarchy resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ExplicitHierarchy')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ExplicitHierarchy'
