function Add-VSTimestreamTablePartitionKey {
    <#
    .SYNOPSIS
        Adds an AWS::Timestream::Table.PartitionKey resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Timestream.Table.PartitionKey'
