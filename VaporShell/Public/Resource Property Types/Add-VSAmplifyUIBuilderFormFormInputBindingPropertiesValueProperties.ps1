function Add-VSAmplifyUIBuilderFormFormInputBindingPropertiesValueProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Form.FormInputBindingPropertiesValueProperties resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AmplifyUIBuilder.Form.FormInputBindingPropertiesValueProperties'
