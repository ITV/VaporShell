function Add-VSEC2CapacityReservationCapacityAllocation {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::CapacityReservation.CapacityAllocation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EC2.CapacityReservation.CapacityAllocation')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.CapacityReservation.CapacityAllocation'
