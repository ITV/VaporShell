function Add-VSMediaLiveChannelInputLossBehavior {
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.InputLossBehavior')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.InputLossBehavior'
