function Add-VSDynamoDBTableS3BucketSource {
    <#
    .SYNOPSIS
        Adds an AWS::DynamoDB::Table.S3BucketSource resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DynamoDB.Table.S3BucketSource'
