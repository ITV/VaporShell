function Add-VSGroundStationDataflowEndpointGroupV2SocketAddress {
    <#
    .SYNOPSIS
        Adds an AWS::GroundStation::DataflowEndpointGroupV2.SocketAddress resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.GroundStation.DataflowEndpointGroupV2.SocketAddress')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GroundStation.DataflowEndpointGroupV2.SocketAddress'
