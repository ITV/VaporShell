function Add-VSAppMeshRouteHttpQueryParameterMatch {
    <#
    .SYNOPSIS
        Adds an AWS::AppMesh::Route.HttpQueryParameterMatch resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.AppMesh.Route.HttpQueryParameterMatch')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppMesh.Route.HttpQueryParameterMatch'
