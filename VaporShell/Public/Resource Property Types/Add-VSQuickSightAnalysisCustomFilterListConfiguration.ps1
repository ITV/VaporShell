function Add-VSQuickSightAnalysisCustomFilterListConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.CustomFilterListConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.CustomFilterListConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.CustomFilterListConfiguration'
