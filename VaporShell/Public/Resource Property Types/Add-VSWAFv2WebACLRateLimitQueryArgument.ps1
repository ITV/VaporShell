function Add-VSWAFv2WebACLRateLimitQueryArgument {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RateLimitQueryArgument resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RateLimitQueryArgument'
