function Add-VSBedrockDataAutomationProjectModalityRoutingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject.ModalityRoutingConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject.ModalityRoutingConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject.ModalityRoutingConfiguration'
