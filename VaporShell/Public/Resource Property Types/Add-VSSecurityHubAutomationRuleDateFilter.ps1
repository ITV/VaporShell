function Add-VSSecurityHubAutomationRuleDateFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRule.DateFilter resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRule.DateFilter'
