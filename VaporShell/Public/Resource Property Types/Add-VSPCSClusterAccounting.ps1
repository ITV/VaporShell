function Add-VSPCSClusterAccounting {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster.Accounting resource property to the template.
    ...
    .PARAMETER DefaultPurgeTimeInDays
    ...
    [OutputType('Vaporshell.Resource.PCS.Cluster.Accounting')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster.Accounting'
