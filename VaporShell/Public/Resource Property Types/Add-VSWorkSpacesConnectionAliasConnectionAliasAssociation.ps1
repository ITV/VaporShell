function Add-VSWorkSpacesConnectionAliasConnectionAliasAssociation {
    <#
    .SYNOPSIS
        Adds an AWS::WorkSpaces::ConnectionAlias.ConnectionAliasAssociation resource property to the template. Describes a connection alias association that is used for cross-Region redirection. For more information, see  Cross-Region Redirection for Amazon WorkSpaces: https://docs.aws.amazon.com/workspaces/latest/adminguide/cross-region-redirection.html.
