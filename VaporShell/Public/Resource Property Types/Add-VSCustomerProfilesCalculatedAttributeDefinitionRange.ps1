function Add-VSCustomerProfilesCalculatedAttributeDefinitionRange {
    <#
    .SYNOPSIS
        Adds an AWS::CustomerProfiles::CalculatedAttributeDefinition.Range resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CustomerProfiles.CalculatedAttributeDefinition.Range')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CustomerProfiles.CalculatedAttributeDefinition.Range'
