function Add-VSCleanRoomsIdMappingTableIdMappingTableInputSource {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::IdMappingTable.IdMappingTableInputSource resource property to the template. 
    ...
    .PARAMETER IdNamespaceAssociationId
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.IdMappingTable.IdMappingTableInputSource'
