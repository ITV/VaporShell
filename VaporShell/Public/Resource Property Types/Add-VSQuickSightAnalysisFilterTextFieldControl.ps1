function Add-VSQuickSightAnalysisFilterTextFieldControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FilterTextFieldControl resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.FilterTextFieldControl')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FilterTextFieldControl'
