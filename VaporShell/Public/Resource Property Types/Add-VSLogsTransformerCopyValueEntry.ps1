function Add-VSLogsTransformerCopyValueEntry {
    <#
    .SYNOPSIS
        Adds an AWS::Logs::Transformer.CopyValueEntry resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Logs.Transformer.CopyValueEntry'
