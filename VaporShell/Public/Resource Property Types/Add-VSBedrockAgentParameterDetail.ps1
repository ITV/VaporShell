function Add-VSBedrockAgentParameterDetail {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Agent.ParameterDetail resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Agent.ParameterDetail'
