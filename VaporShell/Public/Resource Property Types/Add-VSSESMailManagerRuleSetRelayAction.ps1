function Add-VSSESMailManagerRuleSetRelayAction {
    <#
    .SYNOPSIS
        Adds an AWS::SES::MailManagerRuleSet.RelayAction resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.MailManagerRuleSet.RelayAction'
