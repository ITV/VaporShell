function Add-VSEC2VPNConnectionVpnTunnelOptionsSpecification {
    ...
    .PARAMETER Phase2EncryptionAlgorithms
    ...
    .PARAMETER Phase2DHGroupNumbers
    ...
    .PARAMETER TunnelInsideIpv6Cidr
    ...
    .PARAMETER Phase1DHGroupNumbers
    ...
    .PARAMETER EnableTunnelLifecycleControl
    ...
    .PARAMETER RekeyMarginTimeSeconds
    ...
    .PARAMETER Phase2LifetimeSeconds
    ...
    .PARAMETER Phase2IntegrityAlgorithms
    ...
    .PARAMETER Phase1IntegrityAlgorithms
    ...
    .PARAMETER Phase1LifetimeSeconds
    ...
    .PARAMETER Phase1EncryptionAlgorithms
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase2EncryptionAlgorithmsRequestListValue"
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase2DHGroupNumbersRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.IKEVersionsRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase1DHGroupNumbersRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase2IntegrityAlgorithmsRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase1IntegrityAlgorithmsRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
        ...
        [Parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.EC2.VPNConnection.Phase1EncryptionAlgorithmsRequestListValue"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
