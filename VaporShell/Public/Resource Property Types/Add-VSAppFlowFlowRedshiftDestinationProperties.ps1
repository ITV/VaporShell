function Add-VSAppFlowFlowRedshiftDestinationProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.RedshiftDestinationProperties resource property to the template. The properties that are applied when Amazon Redshift is being used as a destination.
