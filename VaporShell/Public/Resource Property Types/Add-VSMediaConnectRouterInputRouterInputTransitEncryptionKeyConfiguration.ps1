function Add-VSMediaConnectRouterInputRouterInputTransitEncryptionKeyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.RouterInputTransitEncryptionKeyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.RouterInputTransitEncryptionKeyConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.RouterInputTransitEncryptionKeyConfiguration'
