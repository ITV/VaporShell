function Add-VSCognitoUserPoolPreTokenGenerationConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Cognito::UserPool.PreTokenGenerationConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Cognito.UserPool.PreTokenGenerationConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cognito.UserPool.PreTokenGenerationConfig'
