function Add-VSQuickSightDashboardSimpleClusterMarker {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SimpleClusterMarker resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.SimpleClusterMarker')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SimpleClusterMarker'
