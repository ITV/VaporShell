function Add-VSQuickSightAnalysisSheetControlInfoIconLabelOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SheetControlInfoIconLabelOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.SheetControlInfoIconLabelOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SheetControlInfoIconLabelOptions'
