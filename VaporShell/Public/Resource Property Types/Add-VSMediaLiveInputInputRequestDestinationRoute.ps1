function Add-VSMediaLiveInputInputRequestDestinationRoute {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Input.InputRequestDestinationRoute resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Input.InputRequestDestinationRoute')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Input.InputRequestDestinationRoute'
