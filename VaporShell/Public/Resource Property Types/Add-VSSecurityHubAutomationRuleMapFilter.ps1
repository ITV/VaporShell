function Add-VSSecurityHubAutomationRuleMapFilter {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRule.MapFilter resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRule.MapFilter'
