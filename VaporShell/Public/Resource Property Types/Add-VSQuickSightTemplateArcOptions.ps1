function Add-VSQuickSightTemplateArcOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ArcOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.ArcOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ArcOptions'
