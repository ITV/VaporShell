function Add-VSSESEmailIdentityFeedbackAttributes {
    <#
    .SYNOPSIS
        Adds an AWS::SES::EmailIdentity.FeedbackAttributes resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.SES.EmailIdentity.FeedbackAttributes')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.EmailIdentity.FeedbackAttributes'
