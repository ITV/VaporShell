function Add-VSAmplifyUIBuilderFormFileUploaderFieldConfig {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Form.FileUploaderFieldConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AmplifyUIBuilder.Form.FileUploaderFieldConfig'
