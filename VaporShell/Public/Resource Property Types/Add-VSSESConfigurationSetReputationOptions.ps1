function Add-VSSESConfigurationSetReputationOptions {
    <#
    .SYNOPSIS
        Adds an AWS::SES::ConfigurationSet.ReputationOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SES.ConfigurationSet.ReputationOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SES.ConfigurationSet.ReputationOptions'
