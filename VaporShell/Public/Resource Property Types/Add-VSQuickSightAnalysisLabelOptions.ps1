function Add-VSQuickSightAnalysisLabelOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.LabelOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.LabelOptions'
