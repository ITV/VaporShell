function Add-VSRoute53RecordSetGroupCoordinates {
    <#
    .SYNOPSIS
        Adds an AWS::Route53::RecordSetGroup.Coordinates resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Route53.RecordSetGroup.Coordinates')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Route53.RecordSetGroup.Coordinates'
