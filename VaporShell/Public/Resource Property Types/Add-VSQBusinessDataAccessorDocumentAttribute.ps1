function Add-VSQBusinessDataAccessorDocumentAttribute {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::DataAccessor.DocumentAttribute resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QBusiness.DataAccessor.DocumentAttribute')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.DataAccessor.DocumentAttribute'
