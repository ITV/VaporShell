function Add-VSBedrockFlowPromptInputVariable {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.PromptInputVariable resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Bedrock.Flow.PromptInputVariable')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.PromptInputVariable'
