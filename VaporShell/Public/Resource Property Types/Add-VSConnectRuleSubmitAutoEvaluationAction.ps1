function Add-VSConnectRuleSubmitAutoEvaluationAction {
    <#
    .SYNOPSIS
        Adds an AWS::Connect::Rule.SubmitAutoEvaluationAction resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Connect.Rule.SubmitAutoEvaluationAction'
