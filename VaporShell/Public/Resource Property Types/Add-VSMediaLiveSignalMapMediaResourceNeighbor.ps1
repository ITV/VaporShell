function Add-VSMediaLiveSignalMapMediaResourceNeighbor {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::SignalMap.MediaResourceNeighbor resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.SignalMap.MediaResourceNeighbor'
