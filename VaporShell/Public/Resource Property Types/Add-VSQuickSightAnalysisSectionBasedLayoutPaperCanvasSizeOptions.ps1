function Add-VSQuickSightAnalysisSectionBasedLayoutPaperCanvasSizeOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SectionBasedLayoutPaperCanvasSizeOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.SectionBasedLayoutPaperCanvasSizeOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SectionBasedLayoutPaperCanvasSizeOptions'
