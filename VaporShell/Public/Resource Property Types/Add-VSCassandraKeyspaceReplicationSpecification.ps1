function Add-VSCassandraKeyspaceReplicationSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Cassandra::Keyspace.ReplicationSpecification resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cassandra.Keyspace.ReplicationSpecification'
