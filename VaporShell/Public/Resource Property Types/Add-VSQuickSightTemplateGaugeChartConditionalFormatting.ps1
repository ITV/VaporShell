function Add-VSQuickSightTemplateGaugeChartConditionalFormatting {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.GaugeChartConditionalFormatting resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.GaugeChartConditionalFormatting')]
    [cmdletbinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Template.GaugeChartConditionalFormattingOption"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.GaugeChartConditionalFormatting'
