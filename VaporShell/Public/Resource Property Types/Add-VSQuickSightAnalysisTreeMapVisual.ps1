function Add-VSQuickSightAnalysisTreeMapVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.TreeMapVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-treemapvisual.html#cfn-quicksight-analysis-treemapvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.TreeMapVisual'
