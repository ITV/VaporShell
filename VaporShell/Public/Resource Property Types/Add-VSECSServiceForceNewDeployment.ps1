function Add-VSECSServiceForceNewDeployment {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.ForceNewDeployment resource property to the template.
    ...
    .PARAMETER EnableForceNewDeployment
    ...
    .PARAMETER ForceNewDeploymentNonce
    ...
    [OutputType('Vaporshell.Resource.ECS.Service.ForceNewDeployment')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.ForceNewDeployment'
