function Add-VSBedrockPromptVersionPromptInputVariable {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.PromptInputVariable resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.PromptVersion.PromptInputVariable')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.PromptInputVariable'
