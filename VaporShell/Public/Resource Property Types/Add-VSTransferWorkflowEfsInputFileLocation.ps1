function Add-VSTransferWorkflowEfsInputFileLocation {
    <#
    .SYNOPSIS
        Adds an AWS::Transfer::Workflow.EfsInputFileLocation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Transfer.Workflow.EfsInputFileLocation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Transfer.Workflow.EfsInputFileLocation'
