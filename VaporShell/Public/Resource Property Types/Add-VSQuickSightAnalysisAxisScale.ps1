function Add-VSQuickSightAnalysisAxisScale {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.AxisScale resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.AxisScale')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.AxisScale'
