function Add-VSACMPCACertificateCustomAttribute {
    <#
    .SYNOPSIS
    ...
    [OutputType('Vaporshell.Resource.ACMPCA.Certificate.CustomAttribute')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ACMPCA.Certificate.CustomAttribute'
