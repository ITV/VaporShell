function Add-VSAmplifyUIBuilderFormFormInputValueProperty {
    <#
    .SYNOPSIS
        Adds an AWS::AmplifyUIBuilder::Form.FormInputValueProperty resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.AmplifyUIBuilder.Form.FormInputValueProperty')]
    [cmdletbinding()]
    Param
    (
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.AmplifyUIBuilder.Form.FormInputValueProperty"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AmplifyUIBuilder.Form.FormInputValueProperty'
