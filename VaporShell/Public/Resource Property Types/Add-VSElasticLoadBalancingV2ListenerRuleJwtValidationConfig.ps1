function Add-VSElasticLoadBalancingV2ListenerRuleJwtValidationConfig {
    <#
    .SYNOPSIS
        Adds an AWS::ElasticLoadBalancingV2::ListenerRule.JwtValidationConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ElasticLoadBalancingV2.ListenerRule.JwtValidationConfig')]
    [CmdletBinding()]
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.ElasticLoadBalancingV2.ListenerRule.JwtValidationActionAdditionalClaim"
                if ([string]$($_.PSTypeNames) -match "($(($allowedTypes|ForEach-Object{[RegEx]::Escape($_)}) -join '|'))") {
                    $true
                }
                else {
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ElasticLoadBalancingV2.ListenerRule.JwtValidationConfig'
