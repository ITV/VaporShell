function Add-VSQuickSightAnalysisSmallMultiplesAxisProperties {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SmallMultiplesAxisProperties resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SmallMultiplesAxisProperties'
