function Add-VSPipesPipeSelfManagedKafkaAccessConfigurationCredentials {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.SelfManagedKafkaAccessConfigurationCredentials resource property to the template.
    ...
    .PARAMETER ClientCertificateTlsAuth
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.SelfManagedKafkaAccessConfigurationCredentials'
