function Add-VSEC2LaunchTemplateReference {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::LaunchTemplate.Reference resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.LaunchTemplate.Reference'
