function Add-VSQuickSightTemplatePercentileAggregation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.PercentileAggregation resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.PercentileAggregation')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.PercentileAggregation'
