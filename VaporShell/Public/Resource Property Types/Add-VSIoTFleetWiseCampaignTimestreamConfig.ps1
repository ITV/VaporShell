function Add-VSIoTFleetWiseCampaignTimestreamConfig {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.TimestreamConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.TimestreamConfig'
