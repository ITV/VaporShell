function Add-VSQuickSightAnalysisBarChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BarChartFieldWells resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BarChartFieldWells'
