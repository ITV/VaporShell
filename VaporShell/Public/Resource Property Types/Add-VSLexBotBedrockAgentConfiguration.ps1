function Add-VSLexBotBedrockAgentConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.BedrockAgentConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.BedrockAgentConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.BedrockAgentConfiguration'
