function Add-VSFSxVolumeUserAndGroupQuotas {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::Volume.UserAndGroupQuotas resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.FSx.Volume.UserAndGroupQuotas')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.Volume.UserAndGroupQuotas'
