function Add-VSS3OutpostsBucketFilterTag {
    <#
    .SYNOPSIS
        Adds an AWS::S3Outposts::Bucket.FilterTag resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Outposts.Bucket.FilterTag'
