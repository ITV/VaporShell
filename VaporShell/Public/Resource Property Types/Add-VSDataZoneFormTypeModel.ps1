function Add-VSDataZoneFormTypeModel {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::FormType.Model resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.FormType.Model')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.FormType.Model'
