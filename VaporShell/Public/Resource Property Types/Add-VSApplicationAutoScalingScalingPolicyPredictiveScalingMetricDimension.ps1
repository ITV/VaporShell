function Add-VSApplicationAutoScalingScalingPolicyPredictiveScalingMetricDimension {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingMetricDimension resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingMetricDimension')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingMetricDimension'
