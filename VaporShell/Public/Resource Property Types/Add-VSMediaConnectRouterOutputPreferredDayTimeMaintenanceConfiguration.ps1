function Add-VSMediaConnectRouterOutputPreferredDayTimeMaintenanceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterOutput.PreferredDayTimeMaintenanceConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterOutput.PreferredDayTimeMaintenanceConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterOutput.PreferredDayTimeMaintenanceConfiguration'
