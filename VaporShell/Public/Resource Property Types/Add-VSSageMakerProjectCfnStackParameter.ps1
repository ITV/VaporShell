function Add-VSSageMakerProjectCfnStackParameter {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Project.CfnStackParameter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.Project.CfnStackParameter')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Project.CfnStackParameter'
