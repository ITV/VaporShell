function Add-VSSageMakerInferenceComponentInferenceComponentComputeResourceRequirements {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::InferenceComponent.InferenceComponentComputeResourceRequirements resource property to the template. 
    ...
    .PARAMETER NumberOfAcceleratorDevicesRequired
    ...
    .PARAMETER MaxMemoryRequiredInMb
    ...
    .PARAMETER MinMemoryRequiredInMb
    ...
    .PARAMETER NumberOfCpuCoresRequired
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.InferenceComponent.InferenceComponentComputeResourceRequirements'
