function Add-VSQuickSightTemplateLocalNavigationConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.LocalNavigationConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.LocalNavigationConfiguration'
