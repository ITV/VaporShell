function Add-VSSageMakerUserProfileRStudioServerProAppSettings {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.RStudioServerProAppSettings resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.RStudioServerProAppSettings'
