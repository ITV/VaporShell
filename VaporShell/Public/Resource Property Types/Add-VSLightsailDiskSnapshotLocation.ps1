function Add-VSLightsailDiskSnapshotLocation {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::DiskSnapshot.Location resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lightsail.DiskSnapshot.Location')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.DiskSnapshot.Location'
