function Add-VSSecurityHubAutomationRuleV2DateRange {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRuleV2.DateRange resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SecurityHub.AutomationRuleV2.DateRange')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRuleV2.DateRange'
