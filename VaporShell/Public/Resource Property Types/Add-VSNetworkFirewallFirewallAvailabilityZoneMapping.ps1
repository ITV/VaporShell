function Add-VSNetworkFirewallFirewallAvailabilityZoneMapping {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::Firewall.AvailabilityZoneMapping resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.NetworkFirewall.Firewall.AvailabilityZoneMapping')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.Firewall.AvailabilityZoneMapping'
