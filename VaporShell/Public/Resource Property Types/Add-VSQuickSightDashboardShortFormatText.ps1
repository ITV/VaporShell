function Add-VSQuickSightDashboardShortFormatText {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ShortFormatText resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ShortFormatText'
