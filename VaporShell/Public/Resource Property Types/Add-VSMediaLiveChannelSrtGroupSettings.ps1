function Add-VSMediaLiveChannelSrtGroupSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.SrtGroupSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaLive.Channel.SrtGroupSettings')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.SrtGroupSettings'
