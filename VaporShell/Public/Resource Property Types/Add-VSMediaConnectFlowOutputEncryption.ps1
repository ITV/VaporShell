function Add-VSMediaConnectFlowOutputEncryption {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::FlowOutput.Encryption resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.FlowOutput.Encryption'
