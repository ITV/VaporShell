function Add-VSDataZonePolicyGrantCreateFormTypePolicyGrantDetail {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.CreateFormTypePolicyGrantDetail resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.CreateFormTypePolicyGrantDetail')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.CreateFormTypePolicyGrantDetail'
