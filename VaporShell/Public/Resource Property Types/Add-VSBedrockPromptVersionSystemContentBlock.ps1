function Add-VSBedrockPromptVersionSystemContentBlock {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::PromptVersion.SystemContentBlock resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.PromptVersion.SystemContentBlock'
