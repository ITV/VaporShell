function Add-VSAppSyncFunctionConfigurationAppSyncRuntime {
    <#
    .SYNOPSIS
        Adds an AWS::AppSync::FunctionConfiguration.AppSyncRuntime resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppSync.FunctionConfiguration.AppSyncRuntime'
