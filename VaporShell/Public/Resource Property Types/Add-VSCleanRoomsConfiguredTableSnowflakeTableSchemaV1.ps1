function Add-VSCleanRoomsConfiguredTableSnowflakeTableSchemaV1 {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::ConfiguredTable.SnowflakeTableSchemaV1 resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.ConfiguredTable.SnowflakeTableSchemaV1'
