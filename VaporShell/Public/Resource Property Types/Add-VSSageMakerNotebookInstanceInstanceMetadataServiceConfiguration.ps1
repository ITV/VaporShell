function Add-VSSageMakerNotebookInstanceInstanceMetadataServiceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::NotebookInstance.InstanceMetadataServiceConfiguration resource property to the template.
    ...
    .PARAMETER MinimumInstanceMetadataServiceVersion
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.NotebookInstance.InstanceMetadataServiceConfiguration'
