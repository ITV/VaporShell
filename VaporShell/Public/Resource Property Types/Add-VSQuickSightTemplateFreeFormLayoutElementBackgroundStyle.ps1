function Add-VSQuickSightTemplateFreeFormLayoutElementBackgroundStyle {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FreeFormLayoutElementBackgroundStyle resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.FreeFormLayoutElementBackgroundStyle')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FreeFormLayoutElementBackgroundStyle'
