function Add-VSMediaConnectFlowOutputInterface {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::FlowOutput.Interface resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.FlowOutput.Interface'
