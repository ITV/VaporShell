function Add-VSLambdaFunctionLoggingConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::Function.LoggingConfig resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.Function.LoggingConfig'
