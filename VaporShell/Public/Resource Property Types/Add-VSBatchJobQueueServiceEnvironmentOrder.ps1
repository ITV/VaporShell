function Add-VSBatchJobQueueServiceEnvironmentOrder {
    <#
    .SYNOPSIS
        Adds an AWS::Batch::JobQueue.ServiceEnvironmentOrder resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Batch.JobQueue.ServiceEnvironmentOrder')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Batch.JobQueue.ServiceEnvironmentOrder'
