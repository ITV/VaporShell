function Add-VSBedrockAgentCoreMemoryEpisodicOverrideExtractionConfigurationInput {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.EpisodicOverrideExtractionConfigurationInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.EpisodicOverrideExtractionConfigurationInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.EpisodicOverrideExtractionConfigurationInput'
