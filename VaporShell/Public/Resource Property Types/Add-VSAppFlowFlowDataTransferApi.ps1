function Add-VSAppFlowFlowDataTransferApi {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.DataTransferApi resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Flow.DataTransferApi'
