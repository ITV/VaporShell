function Add-VSBedrockGuardrailContentFiltersTierConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Guardrail.ContentFiltersTierConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Guardrail.ContentFiltersTierConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Guardrail.ContentFiltersTierConfig'
