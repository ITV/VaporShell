function Add-VSQuickSightDataSourceOAuthParameters {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::DataSource.OAuthParameters resource property to the template.
    ...
    .PARAMETER IdentityProviderVpcConnectionProperties
    ...
    .PARAMETER IdentityProviderResourceUri
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.DataSource.OAuthParameters'
