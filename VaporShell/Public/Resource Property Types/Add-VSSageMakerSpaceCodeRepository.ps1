function Add-VSSageMakerSpaceCodeRepository {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Space.CodeRepository resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Space.CodeRepository'
