function Add-VSCleanRoomsCollaborationDataEncryptionMetadata {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Collaboration.DataEncryptionMetadata resource property to the template.
    ...
    .PARAMETER AllowJoinsOnColumnsWithDifferentNames
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Collaboration.DataEncryptionMetadata'
