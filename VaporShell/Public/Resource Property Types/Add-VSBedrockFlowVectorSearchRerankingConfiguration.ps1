function Add-VSBedrockFlowVectorSearchRerankingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.VectorSearchRerankingConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.VectorSearchRerankingConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.VectorSearchRerankingConfiguration'
