function Add-VSQuickSightAnalysisColumnSort {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ColumnSort resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ColumnSort'
