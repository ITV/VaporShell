function Add-VSQuickSightAnalysisStringValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.StringValueWhenUnsetConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.StringValueWhenUnsetConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.StringValueWhenUnsetConfiguration'
