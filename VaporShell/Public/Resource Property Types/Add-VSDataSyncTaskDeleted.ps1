function Add-VSDataSyncTaskDeleted {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::Task.Deleted resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.Task.Deleted'
