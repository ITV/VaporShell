function Add-VSOpenSearchServiceDomainIdp {
    <#
    .SYNOPSIS
        Adds an AWS::OpenSearchService::Domain.Idp resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.OpenSearchService.Domain.Idp'
