function Add-VSImageBuilderImageRecipeLatestVersion {
    <#
    .SYNOPSIS
        Adds an AWS::ImageBuilder::ImageRecipe.LatestVersion resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ImageBuilder.ImageRecipe.LatestVersion')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ImageBuilder.ImageRecipe.LatestVersion'
