function Add-VSQuickSightDashboardTrendArrowOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TrendArrowOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.TrendArrowOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TrendArrowOptions'
