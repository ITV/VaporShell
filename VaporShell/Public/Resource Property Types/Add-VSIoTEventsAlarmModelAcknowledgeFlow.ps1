function Add-VSIoTEventsAlarmModelAcknowledgeFlow {
    <#
    .SYNOPSIS
        Adds an AWS::IoTEvents::AlarmModel.AcknowledgeFlow resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTEvents.AlarmModel.AcknowledgeFlow')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTEvents.AlarmModel.AcknowledgeFlow'
