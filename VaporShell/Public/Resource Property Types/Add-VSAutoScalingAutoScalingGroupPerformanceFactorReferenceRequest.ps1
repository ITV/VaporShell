function Add-VSAutoScalingAutoScalingGroupPerformanceFactorReferenceRequest {
    <#
    .SYNOPSIS
        Adds an AWS::AutoScaling::AutoScalingGroup.PerformanceFactorReferenceRequest resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScaling.AutoScalingGroup.PerformanceFactorReferenceRequest'
