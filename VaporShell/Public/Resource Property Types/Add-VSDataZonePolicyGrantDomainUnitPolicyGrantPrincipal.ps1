function Add-VSDataZonePolicyGrantDomainUnitPolicyGrantPrincipal {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::PolicyGrant.DomainUnitPolicyGrantPrincipal resource property to the template.
    ...
    .PARAMETER DomainUnitGrantFilter
    ...
    .PARAMETER DomainUnitDesignation
    ...
    [OutputType('Vaporshell.Resource.DataZone.PolicyGrant.DomainUnitPolicyGrantPrincipal')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.PolicyGrant.DomainUnitPolicyGrantPrincipal'
