function Add-VSMediaConnectFlowOutputSecretsManagerEncryptionKeyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::FlowOutput.SecretsManagerEncryptionKeyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.FlowOutput.SecretsManagerEncryptionKeyConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.FlowOutput.SecretsManagerEncryptionKeyConfiguration'
