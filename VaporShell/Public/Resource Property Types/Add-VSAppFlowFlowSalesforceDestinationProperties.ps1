function Add-VSAppFlowFlowSalesforceDestinationProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.SalesforceDestinationProperties resource property to the template. The properties that are applied when Salesforce is being used as a destination.
