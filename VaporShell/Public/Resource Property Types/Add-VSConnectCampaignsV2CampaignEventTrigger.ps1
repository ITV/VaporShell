function Add-VSConnectCampaignsV2CampaignEventTrigger {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.EventTrigger resource property to the template.
    ...
    .PARAMETER CustomerProfilesDomainArn
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.EventTrigger'
