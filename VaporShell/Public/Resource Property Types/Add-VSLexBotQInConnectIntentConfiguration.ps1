function Add-VSLexBotQInConnectIntentConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.QInConnectIntentConfiguration resource property to the template.
    ...
    .PARAMETER QInConnectAssistantConfiguration
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.QInConnectIntentConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.QInConnectIntentConfiguration'
