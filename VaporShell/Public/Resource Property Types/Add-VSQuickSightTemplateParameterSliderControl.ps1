function Add-VSQuickSightTemplateParameterSliderControl {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ParameterSliderControl resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.ParameterSliderControl')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ParameterSliderControl'
