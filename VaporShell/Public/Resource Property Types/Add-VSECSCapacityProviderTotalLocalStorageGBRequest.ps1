function Add-VSECSCapacityProviderTotalLocalStorageGBRequest {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::CapacityProvider.TotalLocalStorageGBRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.CapacityProvider.TotalLocalStorageGBRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.CapacityProvider.TotalLocalStorageGBRequest'
