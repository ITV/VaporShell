function Add-VSMediaConnectBridgeSourceVpcInterfaceAttachment {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::BridgeSource.VpcInterfaceAttachment resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.BridgeSource.VpcInterfaceAttachment')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.BridgeSource.VpcInterfaceAttachment'
