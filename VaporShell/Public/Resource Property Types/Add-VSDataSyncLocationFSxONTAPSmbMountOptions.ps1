function Add-VSDataSyncLocationFSxONTAPSmbMountOptions {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationFSxONTAP.SmbMountOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationFSxONTAP.SmbMountOptions'
