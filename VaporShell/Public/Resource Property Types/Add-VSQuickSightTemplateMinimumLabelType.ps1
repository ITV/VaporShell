function Add-VSQuickSightTemplateMinimumLabelType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.MinimumLabelType resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.MinimumLabelType')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.MinimumLabelType'
