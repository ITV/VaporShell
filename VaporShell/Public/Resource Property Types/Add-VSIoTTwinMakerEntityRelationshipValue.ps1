function Add-VSIoTTwinMakerEntityRelationshipValue {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::Entity.RelationshipValue resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.Entity.RelationshipValue'
