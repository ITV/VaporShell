function Add-VSQuickSightDashboardImageMenuOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ImageMenuOption resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ImageMenuOption'
