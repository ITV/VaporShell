function Add-VSQuickSightDashboardDonutCenterOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DonutCenterOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DonutCenterOptions')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DonutCenterOptions'
