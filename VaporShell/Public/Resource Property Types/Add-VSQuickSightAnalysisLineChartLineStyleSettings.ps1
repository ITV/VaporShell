function Add-VSQuickSightAnalysisLineChartLineStyleSettings {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.LineChartLineStyleSettings resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.LineChartLineStyleSettings')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.LineChartLineStyleSettings'
