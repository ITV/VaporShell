function Add-VSWAFRegionalByteMatchSetFieldToMatch {
    <#
    .SYNOPSIS
        Adds an AWS::WAFRegional::ByteMatchSet.FieldToMatch resource property to the template. **Note**
...
If the value of Type is any other value, omit Data.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFRegional.ByteMatchSet.FieldToMatch')]
    [cmdletbinding()]
    Param
    (
