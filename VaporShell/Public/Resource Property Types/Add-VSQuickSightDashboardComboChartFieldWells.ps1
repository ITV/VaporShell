function Add-VSQuickSightDashboardComboChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ComboChartFieldWells resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ComboChartFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ComboChartFieldWells'
