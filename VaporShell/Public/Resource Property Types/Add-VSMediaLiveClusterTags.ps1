function Add-VSMediaLiveClusterTags {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Cluster.Tags resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Cluster.Tags'
