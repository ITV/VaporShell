function Add-VSBedrockDataAutomationProjectVideoExtractionCategory {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject.VideoExtractionCategory resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject.VideoExtractionCategory')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject.VideoExtractionCategory'
