function Add-VSWAFv2WebACLResponseInspectionStatusCode {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.ResponseInspectionStatusCode resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WAFv2.WebACL.ResponseInspectionStatusCode')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.ResponseInspectionStatusCode'
