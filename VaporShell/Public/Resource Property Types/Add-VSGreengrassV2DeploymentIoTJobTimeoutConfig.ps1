function Add-VSGreengrassV2DeploymentIoTJobTimeoutConfig {
    <#
    .SYNOPSIS
        Adds an AWS::GreengrassV2::Deployment.IoTJobTimeoutConfig resource property to the template.
    ...
    .PARAMETER InProgressTimeoutInMinutes
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GreengrassV2.Deployment.IoTJobTimeoutConfig'
