function Add-VSQuickSightDashboardStringParameter {
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.StringParameter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.StringParameter'
