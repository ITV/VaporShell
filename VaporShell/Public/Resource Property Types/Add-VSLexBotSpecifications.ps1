function Add-VSLexBotSpecifications {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.Specifications resource property to the template.
    ...
    .PARAMETER SlotTypeName
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-specifications.html#cfn-lex-bot-specifications-slottypename
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.Specifications')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.Specifications'
