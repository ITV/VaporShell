function Add-VSQuickSightDashboardTotalAggregationComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.TotalAggregationComputation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.TotalAggregationComputation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.TotalAggregationComputation'
