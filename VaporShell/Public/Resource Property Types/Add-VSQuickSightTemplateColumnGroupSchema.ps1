function Add-VSQuickSightTemplateColumnGroupSchema {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ColumnGroupSchema resource property to the template. 
    ...
    .PARAMETER ColumnGroupColumnSchemaList
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.ColumnGroupSchema')]
    [cmdletbinding()]
    Param
    (
        [parameter(Mandatory = $false)]
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.QuickSight.Template.ColumnGroupColumnSchema"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ColumnGroupSchema'
