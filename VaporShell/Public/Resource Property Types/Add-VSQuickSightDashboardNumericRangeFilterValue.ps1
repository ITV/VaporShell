function Add-VSQuickSightDashboardNumericRangeFilterValue {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.NumericRangeFilterValue resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.NumericRangeFilterValue'
