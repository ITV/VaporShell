function Add-VSECSServiceServiceConnectClientAlias {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.ServiceConnectClientAlias resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.ServiceConnectClientAlias'
