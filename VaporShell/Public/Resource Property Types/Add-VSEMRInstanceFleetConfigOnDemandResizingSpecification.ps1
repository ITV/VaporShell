function Add-VSEMRInstanceFleetConfigOnDemandResizingSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::EMR::InstanceFleetConfig.OnDemandResizingSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EMR.InstanceFleetConfig.OnDemandResizingSpecification')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMR.InstanceFleetConfig.OnDemandResizingSpecification'
