function Add-VSQuickSightDashboardExportHiddenFieldsOption {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ExportHiddenFieldsOption resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ExportHiddenFieldsOption')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ExportHiddenFieldsOption'
