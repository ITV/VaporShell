function Add-VSBedrockKnowledgeBaseQueryGenerationColumn {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.QueryGenerationColumn resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.QueryGenerationColumn'
