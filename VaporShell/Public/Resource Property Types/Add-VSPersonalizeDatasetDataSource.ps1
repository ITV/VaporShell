function Add-VSPersonalizeDatasetDataSource {
    <#
    .SYNOPSIS
        Adds an AWS::Personalize::Dataset.DataSource resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Personalize.Dataset.DataSource'
