function Add-VSCleanRoomsConfiguredTableDifferentialPrivacyColumn {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::ConfiguredTable.DifferentialPrivacyColumn resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.ConfiguredTable.DifferentialPrivacyColumn'
