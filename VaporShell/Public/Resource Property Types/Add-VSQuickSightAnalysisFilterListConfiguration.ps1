function Add-VSQuickSightAnalysisFilterListConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FilterListConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FilterListConfiguration'
