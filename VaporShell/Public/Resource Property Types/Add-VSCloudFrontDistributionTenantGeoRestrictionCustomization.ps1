function Add-VSCloudFrontDistributionTenantGeoRestrictionCustomization {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::DistributionTenant.GeoRestrictionCustomization resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CloudFront.DistributionTenant.GeoRestrictionCustomization')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.DistributionTenant.GeoRestrictionCustomization'
