function Add-VSAppFlowFlowAmplitudeSourceProperties {
    <#
    .SYNOPSIS
        Adds an AWS::AppFlow::Flow.AmplitudeSourceProperties resource property to the template. The properties that are applied when Amplitude is being used as a source.
...
The properties that are applied when Amplitude is being used as a source.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Flow.AmplitudeSourceProperties'
