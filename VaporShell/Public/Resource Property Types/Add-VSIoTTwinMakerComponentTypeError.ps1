function Add-VSIoTTwinMakerComponentTypeError {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::ComponentType.Error resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTTwinMaker.ComponentType.Error')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.ComponentType.Error'
