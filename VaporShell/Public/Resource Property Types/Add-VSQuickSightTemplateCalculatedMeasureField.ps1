function Add-VSQuickSightTemplateCalculatedMeasureField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CalculatedMeasureField resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CalculatedMeasureField'
