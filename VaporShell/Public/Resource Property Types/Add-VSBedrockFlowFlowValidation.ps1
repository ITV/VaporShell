function Add-VSBedrockFlowFlowValidation {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.FlowValidation resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.FlowValidation'
