function Add-VSQuickSightAnalysisFontWeight {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.FontWeight resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.FontWeight'
