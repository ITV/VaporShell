function Add-VSApplicationAutoScalingScalingPolicyPredictiveScalingCustomizedLoadMetric {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingCustomizedLoadMetric resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationAutoScaling.ScalingPolicy.PredictiveScalingCustomizedLoadMetric'
