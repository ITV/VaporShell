function Add-VSBedrockAgentCoreMemoryUserPreferenceMemoryStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Memory.UserPreferenceMemoryStrategy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Memory.UserPreferenceMemoryStrategy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Memory.UserPreferenceMemoryStrategy'
