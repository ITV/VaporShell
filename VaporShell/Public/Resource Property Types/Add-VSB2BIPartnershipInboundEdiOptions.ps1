function Add-VSB2BIPartnershipInboundEdiOptions {
    <#
    .SYNOPSIS
        Adds an AWS::B2BI::Partnership.InboundEdiOptions resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.B2BI.Partnership.InboundEdiOptions')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.B2BI.Partnership.InboundEdiOptions'
