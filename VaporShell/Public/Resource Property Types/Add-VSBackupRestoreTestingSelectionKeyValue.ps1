function Add-VSBackupRestoreTestingSelectionKeyValue {
    <#
    .SYNOPSIS
        Adds an AWS::Backup::RestoreTestingSelection.KeyValue resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Backup.RestoreTestingSelection.KeyValue'
