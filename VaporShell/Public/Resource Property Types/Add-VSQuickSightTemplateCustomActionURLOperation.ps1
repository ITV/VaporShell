function Add-VSQuickSightTemplateCustomActionURLOperation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CustomActionURLOperation resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CustomActionURLOperation'
