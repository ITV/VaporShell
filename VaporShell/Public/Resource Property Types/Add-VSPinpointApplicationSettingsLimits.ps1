function Add-VSPinpointApplicationSettingsLimits {
    <#
    .SYNOPSIS
        Adds an AWS::Pinpoint::ApplicationSettings.Limits resource property to the template. Specifies the default sending limits for campaigns in the application.
