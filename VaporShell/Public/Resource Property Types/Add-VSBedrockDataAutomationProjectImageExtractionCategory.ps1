function Add-VSBedrockDataAutomationProjectImageExtractionCategory {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject.ImageExtractionCategory resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject.ImageExtractionCategory')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject.ImageExtractionCategory'
