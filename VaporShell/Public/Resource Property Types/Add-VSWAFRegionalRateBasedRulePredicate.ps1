function Add-VSWAFRegionalRateBasedRulePredicate {
    <#
    .SYNOPSIS
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.WAFRegional.RateBasedRule.Predicate')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFRegional.RateBasedRule.Predicate'
