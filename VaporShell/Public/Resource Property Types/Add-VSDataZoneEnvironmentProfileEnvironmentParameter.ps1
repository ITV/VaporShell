function Add-VSDataZoneEnvironmentProfileEnvironmentParameter {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::EnvironmentProfile.EnvironmentParameter resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.DataZone.EnvironmentProfile.EnvironmentParameter')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.EnvironmentProfile.EnvironmentParameter'
