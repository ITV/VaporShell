function Add-VSEntityResolutionMatchingWorkflowIntermediateSourceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::EntityResolution::MatchingWorkflow.IntermediateSourceConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EntityResolution.MatchingWorkflow.IntermediateSourceConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EntityResolution.MatchingWorkflow.IntermediateSourceConfiguration'
