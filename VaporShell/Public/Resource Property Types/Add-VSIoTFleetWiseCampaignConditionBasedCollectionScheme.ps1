function Add-VSIoTFleetWiseCampaignConditionBasedCollectionScheme {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::Campaign.ConditionBasedCollectionScheme resource property to the template.
    ...
    .PARAMETER MinimumTriggerIntervalMs
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.Campaign.ConditionBasedCollectionScheme')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.Campaign.ConditionBasedCollectionScheme'
