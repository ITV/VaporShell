function Add-VSBedrockKnowledgeBaseOpenSearchServerlessFieldMapping {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.OpenSearchServerlessFieldMapping resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.OpenSearchServerlessFieldMapping'
