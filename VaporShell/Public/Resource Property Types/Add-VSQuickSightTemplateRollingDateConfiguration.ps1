function Add-VSQuickSightTemplateRollingDateConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.RollingDateConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.RollingDateConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.RollingDateConfiguration'
