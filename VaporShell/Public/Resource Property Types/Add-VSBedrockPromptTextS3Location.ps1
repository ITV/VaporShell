function Add-VSBedrockPromptTextS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.TextS3Location resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.TextS3Location'
