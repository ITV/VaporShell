function Add-VSQuickSightTemplateLoadingAnimation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.LoadingAnimation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.LoadingAnimation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.LoadingAnimation'
