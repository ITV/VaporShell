function Add-VSDataZoneConnectionAthenaPropertiesInput {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Connection.AthenaPropertiesInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Connection.AthenaPropertiesInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Connection.AthenaPropertiesInput'
