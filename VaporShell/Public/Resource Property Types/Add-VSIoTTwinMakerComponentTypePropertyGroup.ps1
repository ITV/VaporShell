function Add-VSIoTTwinMakerComponentTypePropertyGroup {
    <#
    .SYNOPSIS
        Adds an AWS::IoTTwinMaker::ComponentType.PropertyGroup resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.IoTTwinMaker.ComponentType.PropertyGroup')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTTwinMaker.ComponentType.PropertyGroup'
