function Add-VSQuickSightAnalysisSecondaryValueOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.SecondaryValueOptions resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.SecondaryValueOptions'
