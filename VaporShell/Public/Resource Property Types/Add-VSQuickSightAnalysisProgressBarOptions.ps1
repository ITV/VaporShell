function Add-VSQuickSightAnalysisProgressBarOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ProgressBarOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ProgressBarOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ProgressBarOptions'
