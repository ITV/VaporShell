function Add-VSBedrockFlowFlowNodeInput {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.FlowNodeInput resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.FlowNodeInput'
