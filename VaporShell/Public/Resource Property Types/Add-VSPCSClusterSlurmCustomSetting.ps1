function Add-VSPCSClusterSlurmCustomSetting {
    <#
    .SYNOPSIS
        Adds an AWS::PCS::Cluster.SlurmCustomSetting resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.PCS.Cluster.SlurmCustomSetting'
