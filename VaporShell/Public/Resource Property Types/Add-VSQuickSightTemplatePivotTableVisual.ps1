function Add-VSQuickSightTemplatePivotTableVisual {
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-template-pivottablevisual.html#cfn-quicksight-template-pivottablevisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
