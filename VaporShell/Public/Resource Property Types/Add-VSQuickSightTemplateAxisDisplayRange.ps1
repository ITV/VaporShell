function Add-VSQuickSightTemplateAxisDisplayRange {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.AxisDisplayRange resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.AxisDisplayRange'
