function Add-VSQuickSightTemplateFreeFormLayoutElementBorderStyle {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.FreeFormLayoutElementBorderStyle resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.FreeFormLayoutElementBorderStyle')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.FreeFormLayoutElementBorderStyle'
