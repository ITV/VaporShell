function Add-VSIoTSoftwarePackageVersionS3Location {
    <#
    .SYNOPSIS
        Adds an AWS::IoT::SoftwarePackageVersion.S3Location resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoT.SoftwarePackageVersion.S3Location')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoT.SoftwarePackageVersion.S3Location'
