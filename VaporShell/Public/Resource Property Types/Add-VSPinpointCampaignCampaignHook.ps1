function Add-VSPinpointCampaignCampaignHook {
    <#
    .SYNOPSIS
        Adds an AWS::Pinpoint::Campaign.CampaignHook resource property to the template. Specifies settings for invoking an Lambda function that customizes a segment for a campaign.
