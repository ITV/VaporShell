function Add-VSQuickSightDashboardSectionStyle {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SectionStyle resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SectionStyle'
