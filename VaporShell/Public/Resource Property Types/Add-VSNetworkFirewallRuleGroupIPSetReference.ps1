function Add-VSNetworkFirewallRuleGroupIPSetReference {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::RuleGroup.IPSetReference resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.NetworkFirewall.RuleGroup.IPSetReference')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.RuleGroup.IPSetReference'
