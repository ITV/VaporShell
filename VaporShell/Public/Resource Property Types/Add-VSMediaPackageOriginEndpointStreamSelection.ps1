function Add-VSMediaPackageOriginEndpointStreamSelection {
    <#
    .SYNOPSIS
        Adds an AWS::MediaPackage::OriginEndpoint.StreamSelection resource property to the template. Limitations for outputs from the endpoint, based on the video bitrate.
