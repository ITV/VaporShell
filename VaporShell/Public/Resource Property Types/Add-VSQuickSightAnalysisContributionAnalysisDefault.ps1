function Add-VSQuickSightAnalysisContributionAnalysisDefault {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ContributionAnalysisDefault resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ContributionAnalysisDefault')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ContributionAnalysisDefault'
