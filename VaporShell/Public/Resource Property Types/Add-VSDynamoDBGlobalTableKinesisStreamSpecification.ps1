function Add-VSDynamoDBGlobalTableKinesisStreamSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::DynamoDB::GlobalTable.KinesisStreamSpecification resource property to the template.
    ...
    .PARAMETER ApproximateCreationDateTimePrecision
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DynamoDB.GlobalTable.KinesisStreamSpecification'
