function Add-VSQuickSightTemplateArcConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.ArcConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.ArcConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.ArcConfiguration'
