function Add-VSConnectCampaignsV2CampaignSmsOutboundMode {
    <#
    .SYNOPSIS
        Adds an AWS::ConnectCampaignsV2::Campaign.SmsOutboundMode resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ConnectCampaignsV2.Campaign.SmsOutboundMode')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ConnectCampaignsV2.Campaign.SmsOutboundMode'
