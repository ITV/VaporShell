function Add-VSQuickSightDashboardInnerFilter {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.InnerFilter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.InnerFilter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.InnerFilter'
