function Add-VSQuickSightDashboardIntegerValueWhenUnsetConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.IntegerValueWhenUnsetConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.IntegerValueWhenUnsetConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.IntegerValueWhenUnsetConfiguration'
