function Add-VSBedrockDataAutomationProjectAudioStandardGenerativeField {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::DataAutomationProject.AudioStandardGenerativeField resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.DataAutomationProject.AudioStandardGenerativeField')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.DataAutomationProject.AudioStandardGenerativeField'
