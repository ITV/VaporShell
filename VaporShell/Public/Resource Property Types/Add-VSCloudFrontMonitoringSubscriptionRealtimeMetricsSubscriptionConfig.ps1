function Add-VSCloudFrontMonitoringSubscriptionRealtimeMetricsSubscriptionConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CloudFront::MonitoringSubscription.RealtimeMetricsSubscriptionConfig resource property to the template. 
    ...
    .PARAMETER RealtimeMetricsSubscriptionStatus
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CloudFront.MonitoringSubscription.RealtimeMetricsSubscriptionConfig'
