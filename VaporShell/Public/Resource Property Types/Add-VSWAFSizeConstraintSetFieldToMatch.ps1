function Add-VSWAFSizeConstraintSetFieldToMatch {
    <#
    .SYNOPSIS
        Adds an AWS::WAF::SizeConstraintSet.FieldToMatch resource property to the template. The part of a web request that you want to inspect, such as a specified header or a query string.
