function Add-VSBedrockAgentCoreGatewayClaimMatchValueType {
    <#
    .SYNOPSIS
        Adds an AWS::BedrockAgentCore::Gateway.ClaimMatchValueType resource property to the template.
    ...
    .PARAMETER MatchValueStringList
    ...
    [OutputType('Vaporshell.Resource.BedrockAgentCore.Gateway.ClaimMatchValueType')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.BedrockAgentCore.Gateway.ClaimMatchValueType'
