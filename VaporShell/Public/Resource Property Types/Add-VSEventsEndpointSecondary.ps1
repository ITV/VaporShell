function Add-VSEventsEndpointSecondary {
    <#
    .SYNOPSIS
        Adds an AWS::Events::Endpoint.Secondary resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Events.Endpoint.Secondary'
