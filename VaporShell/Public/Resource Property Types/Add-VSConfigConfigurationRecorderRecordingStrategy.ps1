function Add-VSConfigConfigurationRecorderRecordingStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::Config::ConfigurationRecorder.RecordingStrategy resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConfigurationRecorder.RecordingStrategy'
