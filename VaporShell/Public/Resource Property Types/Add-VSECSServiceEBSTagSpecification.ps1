function Add-VSECSServiceEBSTagSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::Service.EBSTagSpecification resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.Service.EBSTagSpecification'
