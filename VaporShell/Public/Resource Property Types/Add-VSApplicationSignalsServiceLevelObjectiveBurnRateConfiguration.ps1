function Add-VSApplicationSignalsServiceLevelObjectiveBurnRateConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ApplicationSignals::ServiceLevelObjective.BurnRateConfiguration resource property to the template.
    ...
    .PARAMETER LookBackWindowMinutes
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ApplicationSignals.ServiceLevelObjective.BurnRateConfiguration'
