function Add-VSMPAApprovalTeamApprovalStrategy {
    <#
    .SYNOPSIS
        Adds an AWS::MPA::ApprovalTeam.ApprovalStrategy resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MPA.ApprovalTeam.ApprovalStrategy')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MPA.ApprovalTeam.ApprovalStrategy'
