function Add-VSQuickSightDashboardDataPathType {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.DataPathType resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.DataPathType')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.DataPathType'
