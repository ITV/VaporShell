function Add-VSQuickSightDashboardGeospatialPointStyleOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.GeospatialPointStyleOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.GeospatialPointStyleOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.GeospatialPointStyleOptions'
