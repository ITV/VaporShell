function Add-VSQuickSightDashboardWaterfallVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.WaterfallVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-waterfallvisual.html#cfn-quicksight-dashboard-waterfallvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.WaterfallVisual'
