function Add-VSSecurityHubAutomationRuleWorkflowUpdate {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityHub::AutomationRule.WorkflowUpdate resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityHub.AutomationRule.WorkflowUpdate'
