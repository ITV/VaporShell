function Add-VSSageMakerClusterClusterOrchestratorEksConfig {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::Cluster.ClusterOrchestratorEksConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.Cluster.ClusterOrchestratorEksConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.Cluster.ClusterOrchestratorEksConfig'
