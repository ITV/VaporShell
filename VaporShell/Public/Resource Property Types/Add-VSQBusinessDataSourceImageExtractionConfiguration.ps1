function Add-VSQBusinessDataSourceImageExtractionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::DataSource.ImageExtractionConfiguration resource property to the template.
    ...
    .PARAMETER ImageExtractionStatus
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.DataSource.ImageExtractionConfiguration'
