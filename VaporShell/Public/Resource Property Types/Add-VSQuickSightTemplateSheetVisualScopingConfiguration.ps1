function Add-VSQuickSightTemplateSheetVisualScopingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.SheetVisualScopingConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.SheetVisualScopingConfiguration'
