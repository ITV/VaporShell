function Add-VSQuickSightAnalysisCustomColor {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.CustomColor resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.CustomColor')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.CustomColor'
