function Add-VSEC2VerifiedAccessInstanceS3 {
    <#
    .SYNOPSIS
        Adds an AWS::EC2::VerifiedAccessInstance.S3 resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.VerifiedAccessInstance.S3'
