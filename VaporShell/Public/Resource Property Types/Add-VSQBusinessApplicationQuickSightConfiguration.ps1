function Add-VSQBusinessApplicationQuickSightConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QBusiness::Application.QuickSightConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QBusiness.Application.QuickSightConfiguration'
