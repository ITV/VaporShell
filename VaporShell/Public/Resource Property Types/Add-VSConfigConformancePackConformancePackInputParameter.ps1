function Add-VSConfigConformancePackConformancePackInputParameter {
    ...
    [OutputType('Vaporshell.Resource.Config.ConformancePack.ConformancePackInputParameter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Config.ConformancePack.ConformancePackInputParameter'
