function Add-VSRolesAnywhereProfileMappingRule {
    <#
    .SYNOPSIS
        Adds an AWS::RolesAnywhere::Profile.MappingRule resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RolesAnywhere.Profile.MappingRule'
