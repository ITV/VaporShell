function Add-VSBedrockPromptToolSpecification {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.ToolSpecification resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Prompt.ToolSpecification')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.ToolSpecification'
