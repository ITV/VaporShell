function Add-VSQuickSightAnalysisWaterfallVisual {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.WaterfallVisual resource property to the template.
    ...
    .PARAMETER VisualContentAltText
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-analysis-waterfallvisual.html#cfn-quicksight-analysis-waterfallvisual-visualcontentalttext
        UpdateType: Mutable
        PrimitiveType: String
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.WaterfallVisual')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.WaterfallVisual'
