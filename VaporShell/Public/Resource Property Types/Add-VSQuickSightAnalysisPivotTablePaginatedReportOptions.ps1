function Add-VSQuickSightAnalysisPivotTablePaginatedReportOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.PivotTablePaginatedReportOptions resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.PivotTablePaginatedReportOptions')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.PivotTablePaginatedReportOptions'
