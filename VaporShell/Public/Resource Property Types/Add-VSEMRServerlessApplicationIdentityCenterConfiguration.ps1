function Add-VSEMRServerlessApplicationIdentityCenterConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::EMRServerless::Application.IdentityCenterConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EMRServerless.Application.IdentityCenterConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EMRServerless.Application.IdentityCenterConfiguration'
