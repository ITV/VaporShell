function Add-VSLambdaVersionFunctionScalingConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::Version.FunctionScalingConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Lambda.Version.FunctionScalingConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.Version.FunctionScalingConfig'
