function Add-VSWAFv2RuleGroupHeaders {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.Headers resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.Headers'
