function Add-VSS3BucketMetadataTableEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::S3::Bucket.MetadataTableEncryptionConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3.Bucket.MetadataTableEncryptionConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3.Bucket.MetadataTableEncryptionConfiguration'
