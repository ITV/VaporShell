function Add-VSECSCapacityProviderNetworkInterfaceCountRequest {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::CapacityProvider.NetworkInterfaceCountRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.CapacityProvider.NetworkInterfaceCountRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.CapacityProvider.NetworkInterfaceCountRequest'
