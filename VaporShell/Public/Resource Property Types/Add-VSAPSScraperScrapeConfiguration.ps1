function Add-VSAPSScraperScrapeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::APS::Scraper.ScrapeConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.APS.Scraper.ScrapeConfiguration'
