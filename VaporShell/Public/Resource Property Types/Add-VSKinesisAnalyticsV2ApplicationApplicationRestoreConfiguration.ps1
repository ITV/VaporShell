function Add-VSKinesisAnalyticsV2ApplicationApplicationRestoreConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisAnalyticsV2::Application.ApplicationRestoreConfiguration resource property to the template.
    ...
    .PARAMETER ApplicationRestoreType
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisAnalyticsV2.Application.ApplicationRestoreConfiguration'
