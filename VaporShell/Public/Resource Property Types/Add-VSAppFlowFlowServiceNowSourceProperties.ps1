function Add-VSAppFlowFlowServiceNowSourceProperties {
    ...
    [OutputType('Vaporshell.Resource.AppFlow.Flow.ServiceNowSourceProperties')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppFlow.Flow.ServiceNowSourceProperties'
