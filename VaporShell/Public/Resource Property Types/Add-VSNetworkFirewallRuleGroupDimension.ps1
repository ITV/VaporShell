function Add-VSNetworkFirewallRuleGroupDimension {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkFirewall::RuleGroup.Dimension resource property to the template. The value to use in an Amazon CloudWatch custom metric dimension. This is used in the PublishMetrics custom action. A CloudWatch custom metric dimension is a name/value pair that's part of the identity of a metric.

    .DESCRIPTION
        Adds an AWS::NetworkFirewall::RuleGroup.Dimension resource property to the template.
...
For more information about CloudWatch custom metric dimensions, see Publishing Custom Metrics: https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/publishingMetrics.html#usingDimensions in the Amazon CloudWatch User Guide: https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkFirewall.RuleGroup.Dimension'
