function Add-VSTimestreamTableSchema {
    <#
    .SYNOPSIS
        Adds an AWS::Timestream::Table.Schema resource property to the template.
    ...
    .PARAMETER CompositePartitionKey
    ...
    (
        ...
        [ValidateScript( {
                $allowedTypes = "Vaporshell.Resource.Timestream.Table.PartitionKey"
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Timestream.Table.Schema'
