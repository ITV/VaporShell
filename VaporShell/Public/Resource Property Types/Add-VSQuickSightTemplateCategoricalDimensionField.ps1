function Add-VSQuickSightTemplateCategoricalDimensionField {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CategoricalDimensionField resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CategoricalDimensionField'
