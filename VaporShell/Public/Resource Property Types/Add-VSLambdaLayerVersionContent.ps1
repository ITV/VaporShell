function Add-VSLambdaLayerVersionContent {
    <#
    .SYNOPSIS
        Adds an AWS::Lambda::LayerVersion.Content resource property to the template. A ZIP archive that contains the contents of an Lambda layer: https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html.
...
A ZIP archive that contains the contents of an Lambda layer: https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.Lambda.LayerVersion.Content')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lambda.LayerVersion.Content'
