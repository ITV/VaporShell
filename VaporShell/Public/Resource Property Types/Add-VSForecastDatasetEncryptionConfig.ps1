function Add-VSForecastDatasetEncryptionConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Forecast::Dataset.EncryptionConfig resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Forecast.Dataset.EncryptionConfig'
