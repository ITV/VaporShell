function Add-VSARCRegionSwitchPlanDocumentDbUngraceful {
    <#
    .SYNOPSIS
        Adds an AWS::ARCRegionSwitch::Plan.DocumentDbUngraceful resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ARCRegionSwitch.Plan.DocumentDbUngraceful')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ARCRegionSwitch.Plan.DocumentDbUngraceful'
