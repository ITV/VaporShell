function Add-VSLaunchWizardDeploymentTags {
    <#
    .SYNOPSIS
        Adds an AWS::LaunchWizard::Deployment.Tags resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.LaunchWizard.Deployment.Tags'
