function Add-VSLightsailInstanceDisk {
    <#
    .SYNOPSIS
        Adds an AWS::Lightsail::Instance.Disk resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lightsail.Instance.Disk'
