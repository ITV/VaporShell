...
The minimum and maximum number of accelerators (GPUs, FPGAs, or AWS Inferentia chips on an instance. To exclude accelerator-enabled instance types, set Max to 0.
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.EC2.EC2Fleet.AcceleratorCountRequest')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EC2.EC2Fleet.AcceleratorCountRequest'
