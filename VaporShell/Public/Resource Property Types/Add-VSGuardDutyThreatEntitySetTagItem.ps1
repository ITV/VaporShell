function Add-VSGuardDutyThreatEntitySetTagItem {
    <#
    .SYNOPSIS
        Adds an AWS::GuardDuty::ThreatEntitySet.TagItem resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.GuardDuty.ThreatEntitySet.TagItem')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GuardDuty.ThreatEntitySet.TagItem'
