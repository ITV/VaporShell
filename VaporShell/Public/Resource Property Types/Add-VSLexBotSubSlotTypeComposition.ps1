function Add-VSLexBotSubSlotTypeComposition {
    <#
    .SYNOPSIS
        Adds an AWS::Lex::Bot.SubSlotTypeComposition resource property to the template.
    ...
    .PARAMETER SlotTypeName
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-subslottypecomposition.html#cfn-lex-bot-subslottypecomposition-slottypename
        UpdateType: Mutable
    ...
    [OutputType('Vaporshell.Resource.Lex.Bot.SubSlotTypeComposition')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Lex.Bot.SubSlotTypeComposition'
