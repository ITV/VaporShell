function Add-VSQuickSightDashboardSheetElementRenderingRule {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SheetElementRenderingRule resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SheetElementRenderingRule'
