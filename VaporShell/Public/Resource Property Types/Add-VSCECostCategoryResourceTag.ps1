function Add-VSCECostCategoryResourceTag {
    <#
    .SYNOPSIS
        Adds an AWS::CE::CostCategory.ResourceTag resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CE.CostCategory.ResourceTag')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CE.CostCategory.ResourceTag'
