function Add-VSObservabilityAdminOrganizationTelemetryRuleELBLoadBalancerLoggingParameters {
    <#
    .SYNOPSIS
        Adds an AWS::ObservabilityAdmin::OrganizationTelemetryRule.ELBLoadBalancerLoggingParameters resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.ELBLoadBalancerLoggingParameters')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ObservabilityAdmin.OrganizationTelemetryRule.ELBLoadBalancerLoggingParameters'
