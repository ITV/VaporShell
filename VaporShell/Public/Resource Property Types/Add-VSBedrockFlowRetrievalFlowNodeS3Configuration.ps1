function Add-VSBedrockFlowRetrievalFlowNodeS3Configuration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.RetrievalFlowNodeS3Configuration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.RetrievalFlowNodeS3Configuration'
