function Add-VSWAFv2RuleGroupRateLimitCookie {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.RateLimitCookie resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.RateLimitCookie'
