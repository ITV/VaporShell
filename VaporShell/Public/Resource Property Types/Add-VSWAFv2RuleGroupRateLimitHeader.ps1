function Add-VSWAFv2RuleGroupRateLimitHeader {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::RuleGroup.RateLimitHeader resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.RateLimitHeader'
