function Add-VSNetworkManagerConnectAttachmentConnectAttachmentOptions {
    <#
    .SYNOPSIS
        Adds an AWS::NetworkManager::ConnectAttachment.ConnectAttachmentOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.NetworkManager.ConnectAttachment.ConnectAttachmentOptions'
