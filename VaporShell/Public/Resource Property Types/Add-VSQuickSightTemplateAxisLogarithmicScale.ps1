function Add-VSQuickSightTemplateAxisLogarithmicScale {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.AxisLogarithmicScale resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.AxisLogarithmicScale')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.AxisLogarithmicScale'
