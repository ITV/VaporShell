function Add-VSQuickSightAnalysisComparisonConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.ComparisonConfiguration resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.ComparisonConfiguration')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.ComparisonConfiguration'
