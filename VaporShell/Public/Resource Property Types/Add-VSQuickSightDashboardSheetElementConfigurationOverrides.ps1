function Add-VSQuickSightDashboardSheetElementConfigurationOverrides {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SheetElementConfigurationOverrides resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SheetElementConfigurationOverrides'
