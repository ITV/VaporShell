function Add-VSQuickSightTemplateCustomContentConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.CustomContentConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.CustomContentConfiguration'
