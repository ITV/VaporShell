function Add-VSQuickSightTemplateTableSortConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.TableSortConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.TableSortConfiguration'
