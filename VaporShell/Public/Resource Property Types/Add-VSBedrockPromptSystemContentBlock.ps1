function Add-VSBedrockPromptSystemContentBlock {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Prompt.SystemContentBlock resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Prompt.SystemContentBlock')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Prompt.SystemContentBlock'
