function Add-VSS3ExpressAccessPointPublicAccessBlockConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::S3Express::AccessPoint.PublicAccessBlockConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.S3Express.AccessPoint.PublicAccessBlockConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.S3Express.AccessPoint.PublicAccessBlockConfiguration'
