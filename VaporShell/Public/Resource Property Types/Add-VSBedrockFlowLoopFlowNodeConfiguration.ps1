function Add-VSBedrockFlowLoopFlowNodeConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::Flow.LoopFlowNodeConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.Flow.LoopFlowNodeConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.Flow.LoopFlowNodeConfiguration'
