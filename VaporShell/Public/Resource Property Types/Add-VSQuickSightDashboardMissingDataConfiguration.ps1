function Add-VSQuickSightDashboardMissingDataConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.MissingDataConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.MissingDataConfiguration'
