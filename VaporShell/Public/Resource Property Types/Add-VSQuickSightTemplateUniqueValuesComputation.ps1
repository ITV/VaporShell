function Add-VSQuickSightTemplateUniqueValuesComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.UniqueValuesComputation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.UniqueValuesComputation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.UniqueValuesComputation'
