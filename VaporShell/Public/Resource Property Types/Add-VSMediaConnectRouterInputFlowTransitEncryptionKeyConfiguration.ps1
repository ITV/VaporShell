function Add-VSMediaConnectRouterInputFlowTransitEncryptionKeyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::MediaConnect::RouterInput.FlowTransitEncryptionKeyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.MediaConnect.RouterInput.FlowTransitEncryptionKeyConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaConnect.RouterInput.FlowTransitEncryptionKeyConfiguration'
