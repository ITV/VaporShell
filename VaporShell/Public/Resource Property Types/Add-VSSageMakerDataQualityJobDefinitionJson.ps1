function Add-VSSageMakerDataQualityJobDefinitionJson {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::DataQualityJobDefinition.Json resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.DataQualityJobDefinition.Json')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.DataQualityJobDefinition.Json'
