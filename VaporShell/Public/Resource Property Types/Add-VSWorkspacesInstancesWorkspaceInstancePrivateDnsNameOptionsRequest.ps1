function Add-VSWorkspacesInstancesWorkspaceInstancePrivateDnsNameOptionsRequest {
    <#
    .SYNOPSIS
        Adds an AWS::WorkspacesInstances::WorkspaceInstance.PrivateDnsNameOptionsRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.PrivateDnsNameOptionsRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WorkspacesInstances.WorkspaceInstance.PrivateDnsNameOptionsRequest'
