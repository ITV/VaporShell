function Add-VSGameLiftContainerFleetDeploymentDetails {
    <#
    .SYNOPSIS
        Adds an AWS::GameLift::ContainerFleet.DeploymentDetails resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.GameLift.ContainerFleet.DeploymentDetails'
