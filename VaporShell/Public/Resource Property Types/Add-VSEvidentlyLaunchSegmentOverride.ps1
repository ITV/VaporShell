function Add-VSEvidentlyLaunchSegmentOverride {
    <#
    .SYNOPSIS
        Adds an AWS::Evidently::Launch.SegmentOverride resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Evidently.Launch.SegmentOverride'
