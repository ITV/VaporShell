function Add-VSMediaLiveChannelBandwidthReductionFilterSettings {
    <#
    .SYNOPSIS
        Adds an AWS::MediaLive::Channel.BandwidthReductionFilterSettings resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.MediaLive.Channel.BandwidthReductionFilterSettings'
