function Add-VSIoTFleetWiseDecoderManifestCanInterface {
    <#
    .SYNOPSIS
        Adds an AWS::IoTFleetWise::DecoderManifest.CanInterface resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.IoTFleetWise.DecoderManifest.CanInterface')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.IoTFleetWise.DecoderManifest.CanInterface'
