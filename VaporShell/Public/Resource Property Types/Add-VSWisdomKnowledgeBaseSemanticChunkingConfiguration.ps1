function Add-VSWisdomKnowledgeBaseSemanticChunkingConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::KnowledgeBase.SemanticChunkingConfiguration resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.KnowledgeBase.SemanticChunkingConfiguration'
