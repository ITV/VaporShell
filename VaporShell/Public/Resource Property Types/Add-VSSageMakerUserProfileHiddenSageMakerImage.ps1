function Add-VSSageMakerUserProfileHiddenSageMakerImage {
    <#
    .SYNOPSIS
        Adds an AWS::SageMaker::UserProfile.HiddenSageMakerImage resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.SageMaker.UserProfile.HiddenSageMakerImage')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SageMaker.UserProfile.HiddenSageMakerImage'
