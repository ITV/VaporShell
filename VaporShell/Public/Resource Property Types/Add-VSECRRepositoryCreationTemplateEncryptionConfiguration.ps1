function Add-VSECRRepositoryCreationTemplateEncryptionConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::ECR::RepositoryCreationTemplate.EncryptionConfiguration resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECR.RepositoryCreationTemplate.EncryptionConfiguration'
