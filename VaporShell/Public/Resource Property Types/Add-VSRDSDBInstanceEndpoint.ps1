function Add-VSRDSDBInstanceEndpoint {
    <#
    .SYNOPSIS
        Adds an AWS::RDS::DBInstance.Endpoint resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.RDS.DBInstance.Endpoint'
