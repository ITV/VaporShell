function Add-VSDataZoneConnectionAmazonQPropertiesInput {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Connection.AmazonQPropertiesInput resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Connection.AmazonQPropertiesInput')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Connection.AmazonQPropertiesInput'
