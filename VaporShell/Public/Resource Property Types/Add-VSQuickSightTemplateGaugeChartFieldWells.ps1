function Add-VSQuickSightTemplateGaugeChartFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.GaugeChartFieldWells resource property to the template. 
    ...
    .FUNCTIONALITY
        Vaporshell
    #>
    [OutputType('Vaporshell.Resource.QuickSight.Template.GaugeChartFieldWells')]
    [cmdletbinding()]
    Param
    (
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.GaugeChartFieldWells'
