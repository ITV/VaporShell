function Add-VSAutoScalingAutoScalingGroupAvailabilityZoneDistribution {
    <#
    .SYNOPSIS
        Adds an AWS::AutoScaling::AutoScalingGroup.AvailabilityZoneDistribution resource property to the template.
    ...
    .PARAMETER CapacityDistributionStrategy
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AutoScaling.AutoScalingGroup.AvailabilityZoneDistribution'
