function Add-VSAppMeshVirtualGatewayVirtualGatewayHttp2ConnectionPool {
    ...
    [OutputType('Vaporshell.Resource.AppMesh.VirtualGateway.VirtualGatewayHttp2ConnectionPool')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.AppMesh.VirtualGateway.VirtualGatewayHttp2ConnectionPool'
