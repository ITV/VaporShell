function Add-VSPipesPipeSageMakerPipelineParameter {
    <#
    .SYNOPSIS
        Adds an AWS::Pipes::Pipe.SageMakerPipelineParameter resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Pipes.Pipe.SageMakerPipelineParameter')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Pipes.Pipe.SageMakerPipelineParameter'
