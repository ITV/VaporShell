function Add-VSFSxFileSystemDataReadCacheConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::FSx::FileSystem.DataReadCacheConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.FSx.FileSystem.DataReadCacheConfiguration')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.FSx.FileSystem.DataReadCacheConfiguration'
