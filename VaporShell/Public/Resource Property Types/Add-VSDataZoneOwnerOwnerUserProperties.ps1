function Add-VSDataZoneOwnerOwnerUserProperties {
    <#
    .SYNOPSIS
        Adds an AWS::DataZone::Owner.OwnerUserProperties resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataZone.Owner.OwnerUserProperties')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataZone.Owner.OwnerUserProperties'
