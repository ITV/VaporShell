function Add-VSCassandraTableTargetTrackingScalingPolicyConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::Cassandra::Table.TargetTrackingScalingPolicyConfiguration resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Cassandra.Table.TargetTrackingScalingPolicyConfiguration')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Cassandra.Table.TargetTrackingScalingPolicyConfiguration'
