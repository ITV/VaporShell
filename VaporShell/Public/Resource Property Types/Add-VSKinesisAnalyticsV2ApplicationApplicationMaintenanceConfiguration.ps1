function Add-VSKinesisAnalyticsV2ApplicationApplicationMaintenanceConfiguration {
    <#
    .SYNOPSIS
        Adds an AWS::KinesisAnalyticsV2::Application.ApplicationMaintenanceConfiguration resource property to the template.
    ...
    .PARAMETER ApplicationMaintenanceWindowStartTime
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.KinesisAnalyticsV2.Application.ApplicationMaintenanceConfiguration'
