function Add-VSWAFv2WebACLRegexMatchStatement {
    <#
    .SYNOPSIS
        Adds an AWS::WAFv2::WebACL.RegexMatchStatement resource property to the template. A rule statement used to search web request components for a match against a single regular expression.

    .DESCRIPTION
        Adds an AWS::WAFv2::WebACL.RegexMatchStatement resource property to the template.
A rule statement used to search web request components for a match against a single regular expression.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.WebACL.RegexMatchStatement'
