function Add-VSQuickSightAnalysisBarChartAggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BarChartAggregatedFieldWells resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Analysis.BarChartAggregatedFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BarChartAggregatedFieldWells'
