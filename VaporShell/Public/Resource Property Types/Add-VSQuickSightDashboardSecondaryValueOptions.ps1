function Add-VSQuickSightDashboardSecondaryValueOptions {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.SecondaryValueOptions resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.SecondaryValueOptions'
