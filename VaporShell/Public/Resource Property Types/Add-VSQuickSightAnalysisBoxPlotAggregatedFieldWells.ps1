function Add-VSQuickSightAnalysisBoxPlotAggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Analysis.BoxPlotAggregatedFieldWells resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Analysis.BoxPlotAggregatedFieldWells'
