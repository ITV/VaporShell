function Add-VSWAFv2RuleGroupSingleHeader {
    <#
    .SYNOPSIS
    ...
    [OutputType('Vaporshell.Resource.WAFv2.RuleGroup.SingleHeader')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.WAFv2.RuleGroup.SingleHeader'
