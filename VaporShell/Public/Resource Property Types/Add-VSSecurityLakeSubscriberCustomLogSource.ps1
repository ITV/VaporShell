function Add-VSSecurityLakeSubscriberCustomLogSource {
    <#
    .SYNOPSIS
        Adds an AWS::SecurityLake::Subscriber.CustomLogSource resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.SecurityLake.Subscriber.CustomLogSource'
