function Add-VSBedrockFlowVersionPromptInputVariable {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::FlowVersion.PromptInputVariable resource property to the template. 
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.FlowVersion.PromptInputVariable'
