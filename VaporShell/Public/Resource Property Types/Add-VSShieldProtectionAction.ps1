function Add-VSShieldProtectionAction {
    <#
    .SYNOPSIS
        Adds an AWS::Shield::Protection.Action resource property to the template.
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Shield.Protection.Action'
