function Add-VSBedrockKnowledgeBaseNeptuneAnalyticsFieldMapping {
    <#
    .SYNOPSIS
        Adds an AWS::Bedrock::KnowledgeBase.NeptuneAnalyticsFieldMapping resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Bedrock.KnowledgeBase.NeptuneAnalyticsFieldMapping')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Bedrock.KnowledgeBase.NeptuneAnalyticsFieldMapping'
