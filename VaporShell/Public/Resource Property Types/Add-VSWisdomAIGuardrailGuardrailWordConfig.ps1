function Add-VSWisdomAIGuardrailGuardrailWordConfig {
    <#
    .SYNOPSIS
        Adds an AWS::Wisdom::AIGuardrail.GuardrailWordConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Wisdom.AIGuardrail.GuardrailWordConfig')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Wisdom.AIGuardrail.GuardrailWordConfig'
