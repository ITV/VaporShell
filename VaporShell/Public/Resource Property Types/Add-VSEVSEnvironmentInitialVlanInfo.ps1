function Add-VSEVSEnvironmentInitialVlanInfo {
    <#
    .SYNOPSIS
        Adds an AWS::EVS::Environment.InitialVlanInfo resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.EVS.Environment.InitialVlanInfo')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.EVS.Environment.InitialVlanInfo'
