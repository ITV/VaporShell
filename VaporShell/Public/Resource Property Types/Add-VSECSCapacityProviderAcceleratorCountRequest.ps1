function Add-VSECSCapacityProviderAcceleratorCountRequest {
    <#
    .SYNOPSIS
        Adds an AWS::ECS::CapacityProvider.AcceleratorCountRequest resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.ECS.CapacityProvider.AcceleratorCountRequest')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.ECS.CapacityProvider.AcceleratorCountRequest'
