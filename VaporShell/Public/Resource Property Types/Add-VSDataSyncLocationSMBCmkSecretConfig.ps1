function Add-VSDataSyncLocationSMBCmkSecretConfig {
    <#
    .SYNOPSIS
        Adds an AWS::DataSync::LocationSMB.CmkSecretConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.DataSync.LocationSMB.CmkSecretConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataSync.LocationSMB.CmkSecretConfig'
