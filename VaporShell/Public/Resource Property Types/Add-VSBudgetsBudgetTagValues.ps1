function Add-VSBudgetsBudgetTagValues {
    <#
    .SYNOPSIS
        Adds an AWS::Budgets::Budget.TagValues resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.Budgets.Budget.TagValues')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.Budgets.Budget.TagValues'
