function Add-VSQuickSightTemplateGrowthRateComputation {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Template.GrowthRateComputation resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Template.GrowthRateComputation')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Template.GrowthRateComputation'
