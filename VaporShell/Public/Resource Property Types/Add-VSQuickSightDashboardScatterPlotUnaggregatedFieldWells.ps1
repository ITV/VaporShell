function Add-VSQuickSightDashboardScatterPlotUnaggregatedFieldWells {
    <#
    .SYNOPSIS
        Adds an AWS::QuickSight::Dashboard.ScatterPlotUnaggregatedFieldWells resource property to the template.
    ...
    .PARAMETER Category
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-scatterplotunaggregatedfieldwells.html#cfn-quicksight-dashboard-scatterplotunaggregatedfieldwells-category
        UpdateType: Mutable
        Type: List
    ...
    .PARAMETER Label
        Documentation: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-quicksight-dashboard-scatterplotunaggregatedfieldwells.html#cfn-quicksight-dashboard-scatterplotunaggregatedfieldwells-label
        UpdateType: Mutable
        Type: List
        ItemType: DimensionField
        DuplicatesAllowed: True
    ...
    [OutputType('Vaporshell.Resource.QuickSight.Dashboard.ScatterPlotUnaggregatedFieldWells')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.QuickSight.Dashboard.ScatterPlotUnaggregatedFieldWells'
