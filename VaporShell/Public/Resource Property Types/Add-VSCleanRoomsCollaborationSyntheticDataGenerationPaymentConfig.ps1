function Add-VSCleanRoomsCollaborationSyntheticDataGenerationPaymentConfig {
    <#
    .SYNOPSIS
        Adds an AWS::CleanRooms::Collaboration.SyntheticDataGenerationPaymentConfig resource property to the template.
    ...
    [OutputType('Vaporshell.Resource.CleanRooms.Collaboration.SyntheticDataGenerationPaymentConfig')]
    [CmdletBinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.CleanRooms.Collaboration.SyntheticDataGenerationPaymentConfig'
