function Add-VSDataBrewDatasetDataCatalogInputDefinition {
    <#
    .SYNOPSIS
        Adds an AWS::DataBrew::Dataset.DataCatalogInputDefinition resource property to the template. Represents how metadata stored in the AWS Glue Data Catalog is defined in a DataBrew dataset.
