function Add-VSDataBrewDatasetDataCatalogInputDefinition {
    ...
    [OutputType('Vaporshell.Resource.DataBrew.Dataset.DataCatalogInputDefinition')]
    [cmdletbinding()]
    ...
    End {
        $obj | Add-ObjectDetail -TypeName 'Vaporshell.Resource.DataBrew.Dataset.DataCatalogInputDefinition'
