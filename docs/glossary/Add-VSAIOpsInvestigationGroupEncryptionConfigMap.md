# Add-VSAIOpsInvestigationGroupEncryptionConfigMap
...
```
Add-VSAIOpsInvestigationGroupEncryptionConfigMap [[-EncryptionConfigurationType] <Object>]
 [[-KmsKeyId] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Vaporshell.Resource.AIOps.InvestigationGroup.EncryptionConfigMap
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-aiops-investigationgroup-encryptionconfigmap.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-aiops-investigationgroup-encryptionconfigmap.html)
