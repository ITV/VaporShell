...
### Custom (Default)
```
Add-PolicyAction [-Custom] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Action
```
Add-PolicyAction [-Action] <String[]> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
