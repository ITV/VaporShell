# Add-VSAmplifyDomainCertificateSettings
...
```
Add-VSAmplifyDomainCertificateSettings [[-CertificateType] <Object>] [[-CustomCertificateArn] <Object>]
...
### Vaporshell.Resource.Amplify.Domain.CertificateSettings
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplify-domain-certificatesettings.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplify-domain-certificatesettings.html)
