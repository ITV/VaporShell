...
### Single (Default)
```
Add-SAMEnvironmentVariable [-Name] <String> [-Value] <Object> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```

### Hashtable
```
Add-SAMEnvironmentVariable [-Hashtable] <Hashtable> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
