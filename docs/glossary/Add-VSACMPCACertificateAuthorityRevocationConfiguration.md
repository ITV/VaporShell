...
```
Add-VSACMPCACertificateAuthorityRevocationConfiguration [[-OcspConfiguration] <Object>]
 [[-CrlConfiguration] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
