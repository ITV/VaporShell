# Add-VSAmplifyUIBuilderComponentComponentBindingPropertiesValue
...
```
Add-VSAmplifyUIBuilderComponentComponentBindingPropertiesValue [[-DefaultValue] <Object>] [[-Type] <Object>]
 [[-BindingProperties] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Vaporshell.Resource.AmplifyUIBuilder.Component.ComponentBindingPropertiesValue
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplifyuibuilder-component-componentbindingpropertiesvalue.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-amplifyuibuilder-component-componentbindingpropertiesvalue.html)
