...
```
Add-VSACMPCACertificateAuthoritySubject [[-Organization] <Object>] [[-OrganizationalUnit] <Object>]
 [[-Locality] <Object>] [[-Title] <Object>] [[-GivenName] <Object>] [[-GenerationQualifier] <Object>]
 [[-Initials] <Object>] [[-CustomAttributes] <Object>] [[-SerialNumber] <Object>] [[-State] <Object>]
 [[-Country] <Object>] [[-Surname] <Object>] [[-DistinguishedNameQualifier] <Object>] [[-CommonName] <Object>]
 [[-Pseudonym] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
