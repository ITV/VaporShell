# Add-VSACMPCACertificateExtendedKeyUsage
...
```
Add-VSACMPCACertificateExtendedKeyUsage [[-ExtendedKeyUsageType] <Object>]
 [[-ExtendedKeyUsageObjectIdentifier] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Vaporshell.Resource.ACMPCA.Certificate.ExtendedKeyUsage
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificate-extendedkeyusage.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificate-extendedkeyusage.html)
