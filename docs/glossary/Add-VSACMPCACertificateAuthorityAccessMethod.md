# Add-VSACMPCACertificateAuthorityAccessMethod
...
```
Add-VSACMPCACertificateAuthorityAccessMethod [[-CustomObjectIdentifier] <Object>]
 [[-AccessMethodType] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Vaporshell.Resource.ACMPCA.CertificateAuthority.AccessMethod
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-accessmethod.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-accessmethod.html)
