...
### String (Default)
```
Add-UserData [-String] <Object> [-Replace <Hashtable>] [-Persist] [-UseJoin]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### File
```
Add-UserData [-File] <String> [-Replace <Hashtable>] [-Persist] [-UseJoin] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
