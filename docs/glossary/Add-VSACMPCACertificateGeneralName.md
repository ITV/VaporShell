# Add-VSACMPCACertificateGeneralName
...
```
Add-VSACMPCACertificateGeneralName [[-UniformResourceIdentifier] <Object>] [[-DnsName] <Object>]
 [[-EdiPartyName] <Object>] [[-RegisteredId] <Object>] [[-Rfc822Name] <Object>] [[-OtherName] <Object>]
 [[-IpAddress] <Object>] [[-DirectoryName] <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Vaporshell.Resource.ACMPCA.Certificate.GeneralName
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificate-generalname.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificate-generalname.html)
