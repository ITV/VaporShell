# Add-VSACMPCACertificateAuthorityEdiPartyName
...
```
Add-VSACMPCACertificateAuthorityEdiPartyName [-PartyName] <Object> [[-NameAssigner] <Object>]
...
### Vaporshell.Resource.ACMPCA.CertificateAuthority.EdiPartyName
## NOTES

## RELATED LINKS

[http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-edipartyname.html](http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-acmpca-certificateauthority-edipartyname.html)
